...
content = content.replace(
  /border: 1px solid #e9ecef; bo" \/>",/g,
  'border: 1px solid #e9ecef; box-shadow: 0 4px 6px rgba(0,0,0,0.05);\\" />",',
);
...
content = content.replace(
  /"ion:",,0\.05\);\\" \/>",x 6px rgba\(0,0,0,0\.05\);\\" \/>",/g,
  '"ion:",',
);
content = content.replace(
  /"ution:",,0\.05\);\\" \/>",x 6px rgba\(0,0,0,0\.05\);\\" \/>",/g,
  '"ution:",',
);
