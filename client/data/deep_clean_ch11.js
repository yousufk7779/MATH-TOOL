...
const mapping = [
  ...
  {
    key: "Example 3. Find the area of the shaded region",
    file: "example_3.svg",
  },
  {
    key: "1. Find the area of a sector of a circle with radius 6 cm",
    file: "ex11_1_q1.svg",
  },
  {
    key: "2. Find the area of a quadrant of a circle whose circumference is 22 cm",
    file: "ex11_1_q2.svg",
  },
  ...
  {
    key: "13. A round table cover has six equal designs",
    file: "ex11_1_q13.svg",
  },
  {
    key: "14. Tick the correct answer in the following",
    file: "ex11_1_q14.svg",
  },
];
...
mapping.forEach((item) => {
  ...
  if (match) {
    ...
    if (fs.existsSync(fullPath)) {
      ...
      svg = svg.replace(
        /stroke="stroke="black" stroke-width="2" fill="none""/g,
      ...
      console.log(
        `Cleaned and re-embedded ${item.file} for ${item.key.substring(0, 20)}...`,
      );
    } else {
