...
export const c7Civ8: ChapterContent = {
  ...
  introduction:
    "A chain of markets links the producer of cotton to the buyer of the shirt.",
  definitions: [],
  keyPoints: [],
  formulas: [],
  crux: [],
  mcqs: [
    ...
    },
    {
      id: "c7c8-mcq-4",
      question:
        "The arrangement where merchants provide yarn and receive finished cloth is called:",
      options: [
        "Direct system",
        "Putting-out system",
        "Barter system",
    ...
    },
    {
      id: "c7c8-mcq-7",
      question:
        "Who receives the lowest wages in the garment exporting factory?",
    ...
    },
    {
      ...
      options: [
        "Increasing taxes",
        "Reducing dependence on merchants",
        "Closing markets",
        "Building factories",
      ],
      correctAnswer: "b",
