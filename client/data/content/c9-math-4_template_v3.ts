  ...
  mcqs: [
    {
      ...
      answer: "Quadrant II",
      explanation: "Since x is negative and y is positive, the point is in the second quadrant."
    },
    {
      question: "The distance of the point (4, 3) from the x-axis is:",
      options: ["4 units", "3 units", "7 units", "5 units"],
      answer: "3 units",
      explanation: "Distance from the x-axis is the absolute value of the y-coordinate."
    },
    {
    ...
    },
    {
      ...
      explanation: "The x-coordinate is positive on the right side of the y-axis."
    },
    {
    ...
    },
    {
      ...
      answer: "0",
      explanation: "Any point on the x-axis has a height of 0 relative to the axis."
    },
    {
    ...
    },
    {
      ...
      answer: "(-2, 0)",
      explanation: "Points with negative x-coordinates lie to the left of the y-axis."
    },
    {
  ...
  htmlExercises: {
    "ex4-1": `
      ...
      <div class="container">
        ...
        <div class="question">2. (Street Plan) : A city has two main roads which cross each other at the centre of the city. These two roads are along the North-South direction and East-West direction. All the other streets of the city run parallel to these roads and are 200 m apart. There are about 5 streets in each direction. Using 1cm = 200 m, draw a model of the city on your notebook. Represent the roads/streets by single lines. There are many cross-streets in your model. A particular cross-street is made by two streets, one running in the North - South direction and another in the East - West direction. Each cross street is referred to in the following manner : If the 2nd street running in the North - South direction and 5th in the East - West direction meet at some crossing, then we will call this cross-street (2, 5). Using this convention, find:</div>
        <div class="solution">
          <span class="subpart">(i) how many cross - streets can be referred to as (4, 3).</span><br/>
          Only <strong>one</strong> cross-street can be referred to as (4, 3).<br/><br/>
          <span class="subpart">(ii) how many cross - streets can be referred to as (3, 4).</span><br/>
    ...
    "ex4-2": `
      ...
      <div class="container">
        ...
        <div class="solution">
          ...
          The name of horizontal and vertical lines are <strong>x-axis</strong> and <strong>y-axis</strong> respectively.<br/><br/>
          <span class="subpart">(ii) What is the name of each part of the plane formed by these two lines?</span><br/>
          The name of each part of the plane formed by these two lines is a <strong>Quadrant</strong>.<br/><br/>
          <span class="subpart">(iii) Write the name of the point where these two lines intersect.</span><br/>
          The name of the point where these two lines intersect is the <strong>Origin</strong>.
        </div>

        <div class="question">2. See Fig. 4.14, and write the following:</div>
        <img src="data:image/png;base64,%%GRAPH1%%" class="ex-img" alt="NCERT Figure 4.14">
        <div class="solution">
    ...
    "ex4-3": `
      ...
      <div class="container">
        ...
        <div class="question">2. Plot the points (x, y) given in the following table on the plane, choosing suitable units of distance on the axes.</div>
        <table style="width: 100%; border-collapse: collapse; border: 1px solid rgba(66, 165, 245, 0.2); margin: 15px 0; text-align: center;">
          <tr style="background: rgba(66, 165, 245, 0.2);">
        ...
        <div class="solution">
          To plot these points, we choose 1 unit = 1 cm on both axes.
          - (-2, 8): 2 units left, 8 units up.
          - (0, -1.25): Stay on y-axis, 1.25 units down.
