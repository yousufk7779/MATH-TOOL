...
export const c7Sci11: ChapterContent = {
  id: "c7-sci-11",
  number: 11,
  title: "Light",
  introduction:
    '<span style="color: #FFFFFF;">Light is a form of energy that enables us to see objects. It travels in a straight line. Reflection is the bouncing back of light from a surface. Mirrors and lenses are used to form images.</span>',
  definitions: [
    {
      term: "Basic Concepts",
      description:
        '<span style="color: #FFFFFF;">Plane mirrors form erect and same-sized images. Concave mirrors can form real or virtual images. Convex lenses are used as magnifying glasses.</span>',
    },
  ],
  keyPoints: [
  ...
  exercises: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          number: "6",
          question:
            "What is a virtual image? Give one situation where it is formed.",
          solution: [
