...
export const sstCiv3: ChapterContent = {
  ...
  keyPoints: [
    ...
    "Communalism happens when religion is expressed loudly in politics, and one religion tries to brutally dominate another. It is a major threat to democracy.",
  ...
  isHtmlView: true,
  htmlOverview:
    '<div style="padding: 10px; color: #fff; text-align: justify; font-family: sans-serif;">\n    <p style="line-height: 1.6; font-size: 17px;">In a democracy, everyone is equal. But does this equality exist in our daily lives? We often see people divided by their gender, religion, or the caste they are born into. Let\'s see how these dangerous social divisions affect our democratic politics.</p>\n    <h3 style="color: #42A5F5; text-align: left; margin-top: 20px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 5px;">Key Definitions</h3>\n    <p style="line-height: 1.5; margin-bottom: 10px;"><b style="color: #42A5F5;">Patriarchy:</b> A system that values men more and gives them power over women. It is a society ruled by men.</p>\n    <p style="line-height: 1.5; margin-bottom: 10px;"><b style="color: #42A5F5;">Feminist:</b> A woman or a man who strongly believes in equal rights and opportunities for women and men.</p>\n    <p style="line-height: 1.5; margin-bottom: 10px;"><b style="color: #42A5F5;">Secular State:</b> A state that does not have any official religion and completely prohibits discrimination on the grounds of religion.</p>\n    <p style="line-height: 1.5; margin-bottom: 10px;"><b style="color: #42A5F5;">Communalism:</b> A highly dangerous belief where one considers their religion superior to others, often leading to hatred and violence.</p>\n    <p style="line-height: 1.5; margin-bottom: 10px;"><b style="color: #42A5F5;">Caste Hierarchy:</b> A ladder-like social structure where different caste groups are placed from highest to lowest.</p>\n    <h3 style="color: #42A5F5; text-align: left; margin-top: 25px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 5px;">Important Points</h3>\n    <ul style="text-align: left; padding-left: 20px; line-height: 1.6; font-size: 16px;">\n        <li style="margin-bottom: 8px;">Gender division is not biological but based on social expectations. The \'sexual division of labour\' forces women to do all household chores while men work outside.</li>\n        <li style="margin-bottom: 8px;">The Equal Remuneration Act, 1976 firmly provides that equal wages should be paid to equal work.</li>\n        <li style="margin-bottom: 8px;">Women\'s political representation in India is very low. However, 1/3rd of seats are reserved for women in local government bodies (Panchayats).</li>\n        <li style="margin-bottom: 8px;">Communalism happens when religion is expressed loudly in politics, and one religion tries to brutally dominate another. It is a major threat to democracy.</li>\n        <li style="margin-bottom: 8px;">To counter communalism, India chose to be a Secular State. The Constitution gives everyone the freedom to practice any religion.</li>\n        <li style="margin-bottom: 8px;">Caste is unique to India. In earlier times, your caste decided your profession and you couldn\'t change it.</li>\n        <li style="margin-bottom: 8px;">While the old caste system is slowly breaking down due to education and city life, caste is still deeply rooted in Indian politics (vote banks).</li>\n    </ul>\n    <h3 style="color: #42A5F5; text-align: left; margin-top: 25px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 5px;">Summary</h3>\n    <p style="line-height: 1.6; font-size: 16px;">Democracy bravely tries to accommodate social differences. Gender discrimination remains a stark reality; political empowerment is key to solving it. Communalism divides people; a strongly secular constitution protects our unity. Caste inequalities are a stubborn reality of India, deeply influencing political elections.</p>\n</div>',
  htmlExercises: {
    "sc3-ex-1":
      '<div style="padding: 10px; color: #fff; text-align: justify; font-family: sans-serif;">\n    <div style="margin-bottom: 25px; ">\n        <p style="color: #42A5F5; font-weight: bold; margin-bottom: 8px; font-size: 17px;">Q1. State different forms of actively communal politics with one example each.</p>\n        <p style="color: #E0E0E0; line-height: 1.6; font-size: 15px; margin-top: 5px;">1. Everyday beliefs: People deeply believe in religious prejudices and stereotypes. Example: Thinking people of another religion are inherently wicked.</p>\n        <p style="color: #E0E0E0; line-height: 1.6; font-size: 15px; margin-top: 5px;">2. Political Dominance: One religious community tries to politically dominate others. Example: A majority religion forcefully making laws only in their favor.</p>\n        <p style="color: #E0E0E0; line-height: 1.6; font-size: 15px; margin-top: 5px;">3. Political Mobilization: Using incredibly emotional religious symbols and religious leaders to desperately gather votes. Example: Using \'religious fatwas\' during elections.</p>\n        <p style="color: #E0E0E0; line-height: 1.6; font-size: 15px; margin-top: 5px;">4. Communal Violence: The ugliest form, actively leading to riots and massacres. Example: The painful India-Pakistan partition riots.</p>\n    </div>\n</div>',
  },
};
