...
export const c7Civ4: ChapterContent = {
    ...
    introduction: "Society teaches us what behaviour is acceptable for girls and boys.",
    definitions: [],
    keyPoints: [],
    formulas: [],
    crux: [],
    mcqs: [
        {
            id: "c7c4-mcq-1",
            question: "The Samoa Islands are part of a large group of small islands in which ocean?",
        ...
        },
        {
            ...
            options: ["Carrying two bags", "Working both inside and outside the home", "Having two jobs", "Studying and playing"],
            correctAnswer: "b"
        },
        {
            id: "c7c4-mcq-4",
            question: "Most of the housework done by women is:",
            options: ["Easy and fast", "Invisible and unpaid", "Paid and respected", "Visible and simple"],
            correctAnswer: "b"
        },
        {
            id: "c7c4-mcq-5",
        ...
        {
            id: "c7c4-mcq-7",
            question: "Who is primarily responsible for 'Care-giving' in most societies?",
