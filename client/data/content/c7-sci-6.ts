...
export const c7Sci6: ChapterContent = {
  id: "c7-sci-6",
  number: 6,
  title: "Respiration in Organisms",
  introduction:
    '<span style="color: #FFFFFF;">All living organisms respire to get energy from food. Respiration can be aerobic (using oxygen) or anaerobic (without oxygen). Humans and other animals breathe in oxygen and breathe out carbon dioxide.</span>',
  definitions: [
    {
      term: "Basic Concepts",
      description:
        '<span style="color: #FFFFFF;">Cellular respiration is the breakdown of food in cells to release energy. Breathing is the physical process of inhaling and exhaling air.</span>',
    },
  ],
  keyPoints: [
  ...
  exercises: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          number: "4",
          question:
            "Take three test-tubes. Fill 3/4th of each with water. Label them A, B and C. Keep a snail in test-tube A, a water plant in test-tube B and in C, keep both snail and plant. Which test-tube would have the highest concentration of CO2?",
          solution: [
