...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <div style="background: rgba(142, 45, 226, 0.08); border: 1.5px solid \${themeColor}; border-radius: 12px; padding: 18px; margin-bottom: 25px;">
    <h2 class="text-center" style="color: \${themeColor}; margin: 0 0 6px 0; font-size: 20px; font-weight: bold;">🌱 Quick Glossary &amp; Core Developmental Concepts</h2>
    ...
    <div style="display: flex; flex-direction: column; gap: 12px;">
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid \${themeColor}; border-radius: 6px;">
        <b style="color: \${themeColor}; font-size: 16px; display: block; margin-bottom: 4px;">1. Growth vs. Development:</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid \${themeColor}; border-radius: 6px;">
        <b style="color: \${themeColor}; font-size: 16px; display: block; margin-bottom: 4px;">2. Cephalocaudal vs. Proximodistal Sequences:</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid \${themeColor}; border-radius: 6px;">
        <b style="color: \${themeColor}; font-size: 16px; display: block; margin-bottom: 4px;">3. G. Stanley Hall's Formulation of Adolescence:</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid \${themeColor}; border-radius: 6px;">
        <b style="color: \${themeColor}; font-size: 16px; display: block; margin-bottom: 4px;">4. Identity Crisis (Erik Erikson):</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid \${themeColor}; border-radius: 6px;">
        <b style="color: \${themeColor}; font-size: 16px; display: block; margin-bottom: 4px;">5. Gang Age vs. Toy Age:</b>
  ...
  <!-- SECTION 4.1 -->
  <h2 style="color: \${themeColor}; border-bottom: 2px solid \${themeColor}; padding-bottom: 6px; margin-top: 30px;">4.1 Growth and development: meaning and principles</h2>

  <p>Every educator and parent must understand that human beings do not arrive in the world as static, miniature adults. The human organism undergoes an astonishing journey of transformation across the lifespan. In educational psychology, the twin concepts of <b style="color: \${themeColor};">Growth</b> and <b style="color: \${themeColor};">Development</b> form the bedrock upon which curricula, teaching methodologies, and behavioral guidance systems are designed.</p>

  <h3 style="color: \${themeColor}; margin-top: 24px;">(i) Conceptual Meaning and Distinction</h3>
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid \${themeColor}; border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">1. Meaning of Growth:</b>
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid \${themeColor}; border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">2. Meaning of Development:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <h3 style="color: \${themeColor}; margin-top: 24px;">(ii) Fundamental Principles of Growth and Development</h3>
  ...
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">1. Principle of Continuity:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">2. Principle of Sequential Direction (Cephalocaudal &amp; Proximodistal):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
        Development follows an orderly, predictable directional pathway:
        <br />&bull; <b style="color: \${themeColor};">Cephalocaudal Trend (Head to Tail):</b> The head develops and comes under voluntary control first. The baby lifts its head, then learns to steady its trunk, then sits, crawls, and finally walks with its legs.
        <br />&bull; <b style="color: \${themeColor};">Proximodistal Trend (Center to Periphery):</b> Control radiates from the central spinal axis outward. The infant controls large arm muscles before attaining fine motor control of fingers to hold a pen.
      </p>
    </div>

    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">3. Principle of Individual Differences:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">4. Principle of General to Specific Responses:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">5. Principle of Interrelation and Integration:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">6. Principle of Predictability:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">7. Principle of Interaction between Heredity and Environment:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <!-- SECTION 4.2 -->
  <h2 style="color: \${themeColor}; border-bottom: 2px solid \${themeColor}; padding-bottom: 6px; margin-top: 35px;">4.2 Overview of stages of growth and development (infancy, childhood &amp; adolescence)</h2>
  ...
  <h3 style="color: \${themeColor}; margin-top: 20px;">(i) Stage of Infancy (Birth to 2 / 3 Years)</h3>
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid \${themeColor}; border-radius: 8px; padding: 14px 16px; margin: 14px 0;">
    <p style="margin: 0 0 8px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: \${themeColor};">Core Developmental Features:</b> Infancy is characterized by the most explosive rate of physical growth and sensory-motor learning in the entire human lifespan.
    </p>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0; color: #FFFFFF;">
      <li><b style="color: \${themeColor};">Rapid Neuromuscular Mastery:</b> Transitioning from involuntary primitive reflexes (sucking, grasping) to crawling, standing, and walking unassisted.</li>
      <li><b style="color: \${themeColor};">Language Foundation:</b> Progression from reflexive crying and babbling to single words and two-word telegraphic utterances.</li>
      <li><b style="color: \${themeColor};">Attachment &amp; Trust:</b> Complete biological dependence on maternal caregivers; establishing primary psychosocial trust (Erikson's <i>Trust vs. Mistrust</i>).</li>
    </ul>
  </div>

  <h3 style="color: \${themeColor}; margin-top: 24px;">(ii) Stage of Childhood (3 to 12 Years)</h3>
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 14px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">1. Early Childhood (3 to 6 Years &mdash; Toy Age / Pre-Gang Age):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">2. Later Childhood (6 to 12 Years &mdash; Elementary School / Gang Age):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <h3 style="color: \${themeColor}; margin-top: 24px;">(iii) Stage of Adolescence (12/13 to 18/19 Years)</h3>
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid \${themeColor}; border-radius: 8px; padding: 14px 16px; margin: 14px 0;">
    <p style="margin: 0 0 8px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
  ...
  <!-- SECTION 4.3 -->
  <h2 style="color: \${themeColor}; border-bottom: 2px solid \${themeColor}; padding-bottom: 6px; margin-top: 35px;">4.3 Adolescence: characteristics, needs and problems</h2>

  <p>In 1904, the father of adolescent psychology, <b style="color: \${themeColor};">G. Stanley Hall</b>, published his monumental work declaring adolescence as a period of <b>"Storm and Stress"</b> (<i>Sturm und Drang</i>). The adolescent stands on an emotional tightrope between childhood's past and adulthood's future:</p>

  <h3 style="color: \${themeColor}; margin-top: 20px;">(i) Salient Characteristics of Adolescence</h3>
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 14px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">1. Physiological Metamorphosis &amp; Puberty:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">2. Emotional Volatility and Mood Lability:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">3. Emergence of Abstract Intellectual Operations:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">4. Peer Loyalty and Hero-Worship:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <h3 style="color: \${themeColor}; margin-top: 24px;">(ii) Fundamental Needs of Adolescents</h3>
  <ul style="padding-left: 20px; line-height: 1.8; color: #FFFFFF;">
    <li><b style="color: \${themeColor};">1. Physiological Needs:</b> High-protein balanced nutrition to fuel rapid bodily growth, adequate sleep, and sound scientific sex education to allay fears about pubertal bodily changes.</li>
    <li><b style="color: \${themeColor};">2. Need for Autonomy and Independence:</b> Freedom from suffocating parental surveillance and the right to make personal choices regarding friendships, clothing, and hobbies.</li>
    <li><b style="color: \${themeColor};">3. Need for Emotional Security and Acceptance:</b> Unconditional love and validation from family and teachers without constant nagging, humiliation, or comparison.</li>
    <li><b style="color: \${themeColor};">4. Need for Peer Status and Belongingness:</b> Yearning to feel valued and accepted within their peer subculture without facing ostracism.</li>
    <li><b style="color: \${themeColor};">5. Need for Vocational Guidance:</b> Clear direction regarding future career avenues matching their aptitudes to banish existential economic dread.</li>
  </ul>

  <h3 style="color: \${themeColor}; margin-top: 24px;">(iii) Major Problems and Pitfalls of Adolescents</h3>
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 14px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #EF4444; border-radius: 8px; padding: 14px 16px;">
      <b style="color: #F87171; font-size: 16px;">⚡ 1. Identity Crisis &amp; Existential Ambiguity:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #EF4444; border-radius: 8px; padding: 14px 16px;">
      <b style="color: #F87171; font-size: 16px;">⚡ 2. The 'Generation Gap' and Family Warfare:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #EF4444; border-radius: 8px; padding: 14px 16px;">
      <b style="color: #F87171; font-size: 16px;">⚡ 3. Body Dysmorphia and Eating Disorders:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #EF4444; border-radius: 8px; padding: 14px 16px;">
      <b style="color: #F87171; font-size: 16px;">⚡ 4. Delinquency and Substance Dependency:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <!-- SECTION 4.4 -->
  <h2 style="color: \${themeColor}; border-bottom: 2px solid \${themeColor}; padding-bottom: 6px; margin-top: 35px;">4.4 Role of parents in dealing with problems of adolescents</h2>
  ...
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 14px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">1. Adopting an Authoritative Rearing Style:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">2. Bridging the Generation Gap through Active Listening:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">3. Eradicating Destructive Comparison:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">4. Providing Scientific Sex Education &amp; Emotional Support:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <!-- SECTION 4.5 -->
  <h2 style="color: \${themeColor}; border-bottom: 2px solid \${themeColor}; padding-bottom: 6px; margin-top: 35px;">4.5 Role of teachers in dealing with problems of adolescents</h2>
  ...
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 14px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">1. Eradication of Public Humiliation &amp; Sarcasm:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">2. Channeling Turbulent Energy through Sublimation:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">3. Organizing Adolescent Education Programs (AEP):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: \${themeColor}; font-size: 16px;">4. Career &amp; Vocational Counseling:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <div style="background: rgba(15, 23, 42, 0.85); border: 1.5px solid \${themeColor}; border-radius: 10px; padding: 16px; margin: 25px 0;">
    ...
    <div style="overflow-x: auto;">
      <table style="width: 100%; border-collapse: collapse; font-size: 14px; color: #F8FAFC;">
        <thead>
          <tr style="background: rgba(142, 45, 226, 0.25); border-bottom: 2px solid \${themeColor};">
        ...
        <tbody>
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
            <td style="padding: 10px; font-weight: bold; color: \${themeColor};">Nature &amp; Scope</td>
          ...
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
            <td style="padding: 10px; font-weight: bold; color: \${themeColor};">Measurability</td>
          ...
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
            <td style="padding: 10px; font-weight: bold; color: \${themeColor};">Time Span</td>
          ...
          <tr>
            <td style="padding: 10px; font-weight: bold; color: \${themeColor};">Dependence</td>
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <div style="background: rgba(142, 45, 226, 0.08); border-left: 4px solid \${themeColor}; border-radius: 6px; padding: 14px 16px; margin-bottom: 24px;">
  ...
  <div style="margin: 18px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q1: Distinguish between Growth and Development.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: \${themeColor};">Growth</b> is quantitative and limited to physical, structural bodily increases (height, weight) ending at maturity. <b style="color: \${themeColor};">Development</b> is a qualitative and quantitative progressive, lifelong process encompassing physical, mental, emotional, and social functional enhancements from conception to death.
    </p>
  </div>

  <!-- Q2 -->
  <div style="margin: 18px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q2: Explain the Cephalocaudal principle of development.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      The <b style="color: \${themeColor};">Cephalocaudal</b> principle states that development progresses vertically from head to toe. An infant gains neuromuscular control over its head and neck before its torso, and masters sitting before crawling or walking with its legs.
    </p>
  </div>

  <!-- Q3 -->
  <div style="margin: 18px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q3: Explain the Proximodistal principle of development.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      The <b style="color: \${themeColor};">Proximodistal</b> principle states that development radiates outward from the central longitudinal axis of the body to the peripheral extremities. An infant gains control over its torso and arm muscles before developing fine finger coordination.
    </p>
  </div>

  <!-- Q4 -->
  <div style="margin: 18px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q4: Why did G. Stanley Hall describe adolescence as a period of "Storm and Stress"?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: \${themeColor};">G. Stanley Hall</b> termed adolescence a period of <i>"Storm and Stress"</i> (Sturm und Drang) because it is characterized by intense pubertal hormonal upheavals, extreme emotional volatility, acute identity conflicts, and friction with parental and societal authority.
    </p>
  </div>

  <!-- Q5 -->
  <div style="margin: 18px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q5: Mention two key characteristics of the Infancy stage.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      (1) <b style="color: \${themeColor};">Explosive rate of physical and motor growth</b>, progressing from involuntary reflexes to independent walking; (2) <b style="color: \${themeColor};">Total biological and emotional dependence</b> on caregivers (establishing primary psychosocial trust).
    </p>
  </div>

  <!-- Q6 -->
  <div style="margin: 18px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q6: Why is Early Childhood often referred to as the 'Toy Age' or 'Questioning Age'?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      It is called the <b style="color: \${themeColor};">Toy Age</b> because children spend the majority of their waking hours in imaginative play with toys, and the <b style="color: \${themeColor};">Questioning Age</b> due to their insatiable curiosity about the surrounding environment (constantly asking <i>"Why?"</i> and <i>"What?"</i>).
    </p>
  </div>

  <!-- Q7 -->
  <div style="margin: 18px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q7: Why is Later Childhood known as the 'Gang Age'?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      Later childhood (6–12 years) is termed the <b style="color: \${themeColor};">Gang Age</b> because children form tightly-knit, same-sex peer groups or gangs, developing fierce loyalty to group rules, codes of conduct, and cooperative team sports.
    </p>
  </div>

  <!-- Q8 -->
  <div style="margin: 18px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q8: State two fundamental psychological needs of adolescents.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      (1) <b style="color: \${themeColor};">Need for Autonomy and Independence</b> from parental over-control; (2) <b style="color: \${themeColor};">Need for Peer Status and Belongingness</b>, feeling accepted and respected within their peer subculture.
    </p>
  </div>

  <!-- Q9 -->
  <div style="margin: 18px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q9: What is meant by 'Identity Crisis' according to Erik Erikson?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      According to <b style="color: \${themeColor};">Erik Erikson</b>, an <b style="color: \${themeColor};">Identity Crisis</b> is the psychological struggle of adolescence (<i>Identity vs. Role Confusion</i>) where youth must reconcile their childhood self-concept with impending adult expectations, vocational choices, and philosophical values.
    </p>
  </div>

  <!-- Q10 -->
  <div style="margin: 18px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q10: What is the 'Generation Gap' in the context of adolescent problems?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      The <b style="color: \${themeColor};">Generation Gap</b> refers to the sharp psychological, cultural, and ideological divide between conservative parents and modern adolescents regarding values, lifestyle, dress, career goals, and digital technology.
    </p>
  </div>

  <!-- Q11 -->
  <div style="margin: 18px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q11: State two major roles of parents in easing adolescent stress.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      (1) <b style="color: \${themeColor};">Adopting an Authoritative parenting style</b> with high warmth and democratic communication; (2) <b style="color: \${themeColor};">Completely eliminating toxic comparison</b> of the child with siblings or topper peers.
    </p>
  </div>

  <!-- Q12 -->
  <div style="margin: 18px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q12: How can teachers channel the aggressive energy of adolescents through sublimation?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      Teachers can channel raw aggressive adolescent drives into <b style="color: \${themeColor};">competitive sports, martial arts, athletic leagues, NCC, NSS, and drama societies</b>, converting dangerous hostility into teamwork and disciplined excellence.
    </p>
  </div>
  ...
  <div style="margin: 20px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q13: Differentiate systematically between Growth and Development across four fundamental parameters.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      ...
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: \${themeColor};">1. Scope:</b> Growth is limited to physical and anatomical changes (cellular multiplication), whereas Development is holistic, encompassing cognitive, emotional, social, and motor domains.</li>
        <li><b style="color: \${themeColor};">2. Nature:</b> Growth is purely quantitative (measurable in kg, cm), while Development is both quantitative and qualitative (functional maturity and behavioral poise).</li>
        <li><b style="color: \${themeColor};">3. Duration:</b> Growth ceases around 18–20 years of age with biological maturity, whereas Development continues uninterruptedly across the entire lifespan (womb to tomb).</li>
        <li><b style="color: \${themeColor};">4. Interdependence:</b> Development can continue even after physical growth has halted; conversely, physical growth does not guarantee mature emotional development.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q14 -->
  <div style="margin: 20px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q14: Explain the Principles of Continuity, Individual Differences, and General to Specific Responses.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      These core principles govern the universal trajectory of human development:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: \${themeColor};">1. Principle of Continuity:</b> Development is unbroken and cumulative. No milestone emerges abruptly; complex skills (like fluent speech) represent months of gradual continuous preparation.</li>
        <li><b style="color: \${themeColor};">2. Principle of Individual Differences:</b> While the sequence of milestones is uniform, the tempo and rate of development vary uniquely for every child due to genetic and environmental interactions.</li>
        <li><b style="color: \${themeColor};">3. General to Specific Responses:</b> The infant initially responds to environmental stimuli with total-body mass movements before mastering localized, refined motor responses (e.g., thrashing whole body before pointing a finger).</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q15 -->
  <div style="margin: 20px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q15: Describe the prominent physical, motor, and emotional characteristics of the Infancy stage.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Infancy (Birth to 2/3 years) lays the biological foundation for all future growth:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: \${themeColor};">1. Rapid Physical Metamorphosis:</b> The infant triples its birth weight in the first year and doubles its height by the third year, with rapid brain growth.</li>
        <li><b style="color: \${themeColor};">2. Neuromuscular Motor Mastery:</b> Transitioning rapidly from involuntary primitive reflexes to head-holding, rolling over, sitting, crawling, and upright bipedal walking.</li>
        <li><b style="color: \${themeColor};">3. Emotional Dependency &amp; Attachment:</b> Formation of primary attachment bonds with the mother; emotions are undifferentiated excitement that progressively splits into distress and delight.</li>
        <li><b style="color: \${themeColor};">4. Sensorimotor Intelligence:</b> Exploring the external universe through direct sensory inputs and physical motor actions (Piaget's sensorimotor stage).</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q16 -->
  <div style="margin: 20px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q16: Compare the developmental characteristics of Early Childhood and Later Childhood.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Early and Later childhood represent distinctly contrasting developmental phases:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: \${themeColor};">1. Social Orientation:</b> Early Childhood (3–6 yrs) is egocentric and home-centered (Toy Age), whereas Later Childhood (6–12 yrs) is peer-centered and gang-oriented (Gang Age).</li>
        <li><b style="color: \${themeColor};">2. Cognitive Development:</b> Early childhood thinking is intuitive, pre-logical, and symbolic, whereas later childhood displays concrete logical reasoning and classification skills.</li>
        <li><b style="color: \${themeColor};">3. Physical Growth:</b> Early childhood features rapid bodily lengthening, whereas later childhood displays slow, steady, and stable physical growth.</li>
        <li><b style="color: \${themeColor};">4. Play Patterns:</b> Early childhood centers on solitary and parallel play; later childhood revolves around cooperative, organized team sports with explicit rules.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q17 -->
  <div style="margin: 20px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q17: Discuss four major problems faced by adolescents in contemporary society.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Modern adolescents face acute psychosocial and cultural challenges:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: \${themeColor};">1. Acute Identity Crisis:</b> Struggling to answer <i>"Who am I?"</i> amidst conflicting social expectations, leading to severe role confusion and self-doubt.</li>
        <li><b style="color: \${themeColor};">2. Academic Overload &amp; Examination Terror:</b> Ruthless competition for board examination marks and competitive entrance tests triggering chronic anxiety and depression.</li>
        <li><b style="color: \${themeColor};">3. Digital Satiation &amp; Body Dysmorphia:</b> Obsessive comparison on social media platforms leading to eating disorders and crippling body dissatisfaction.</li>
        <li><b style="color: \${themeColor};">4. Substance Abuse &amp; Delinquent Vulnerability:</b> Susceptibility to toxic peer pressure involving vaping, alcohol, drugs, or antisocial conduct to escape distress.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q18 -->
  <div style="margin: 20px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q18: Analyze the psychological and social needs of adolescents and their educational significance.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Meeting adolescent needs is essential for preventing delinquency and fostering growth:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: \${themeColor};">1. Need for Autonomy:</b> Adolescents need legitimate independence to make personal decisions; schools must provide democratic student councils and leadership roles.</li>
        <li><b style="color: \${themeColor};">2. Need for Peer Recognition:</b> Adolescents yearn for status and belongingness; educators should organize group projects that foster positive peer cooperation.</li>
        <li><b style="color: \${themeColor};">3. Need for Emotional Catharsis:</b> Adolescents need safe emotional outlets; providing creative arts, sports, and confidential counseling prevents emotional explosions.</li>
        <li><b style="color: \${themeColor};">4. Need for Vocational Direction:</b> Systematic career counseling helps students align ambitions with realistic aptitudes, eliminating existential panic.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q19 -->
  <div style="margin: 20px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q19: Explain the essential duties of parents in guiding adolescents through pubertal turbulence.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Parents serve as the primary emotional anchor during pubertal upheaval:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: \${themeColor};">1. Authoritative Parenting:</b> Balancing warmth, affection, and active open listening with firm, reasonable, and democratically negotiated guidelines.</li>
        <li><b style="color: \${themeColor};">2. Empathy over Lectures:</b> Listening without interrupting or passing harsh moral judgment when the adolescent confides fears, heartbreaks, or doubts.</li>
        <li><b style="color: \${themeColor};">3. Healthy Sexual Guidance:</b> Demystifying pubertal bodily changes (menstruation, voice deepening, nocturnal emissions) with scientific biological facts.</li>
        <li><b style="color: \${themeColor};">4. Abolition of Sibling Comparison:</b> Respecting the adolescent's unique individuality without making degrading comparisons to high-achieving siblings.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q20 -->
  <div style="margin: 20px 0;">
    <h3 style="color: \${themeColor}; font-size: 16px; margin-bottom: 6px;">Q20: Discuss how teachers can act as counselors and mentors in solving adolescent behavioral issues.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Teachers must transcend traditional authoritarian pedagogy to become transformative mentors:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: \${themeColor};">1. Eradicating Public Sarcasm:</b> Rebuking adolescents privately with constructive empathy, as public humiliation triggers destructive rebellion or mutism.</li>
        <li><b style="color: \${themeColor};">2. Facilitating Sublimation:</b> Channeling boundless physical and aggressive energy into athletic tournaments, debates, creative drama, and social service.</li>
        <li><b style="color: \${themeColor};">3. Early Identification of Warning Signals:</b> Spotting signs of clinical depression, sudden academic drops, self-harm scars, or substance abuse for prompt referral.</li>
        <li><b style="color: \${themeColor};">4. Organizing Adolescent Life Skills Programs:</b> Conducting interactive workshops on stress management, sex education, cyber safety, and career planning.</li>
      </ul>
    </div>
  </div>
  ...
  <div style="margin: 22px 0;">
    ...
    <div style="color: #FFFFFF; line-height: 1.75;">
      ...
      <p><b style="color: \${themeColor};">II. Major Principles of Development:</b><br />
      (1) <b style="color: \${themeColor};">Principle of Continuity:</b> Development is an unbroken, cumulative process where complex skills build continuously upon simpler precursors.<br />
      (2) <b style="color: \${themeColor};">Principle of Sequential Direction:</b> Operates via Cephalocaudal (head-to-toe motor mastery) and Proximodistal (center-to-periphery coordination) sequences.<br />
      (3) <b style="color: \${themeColor};">Principle of Individual Differences:</b> Each student matures at their own unique internal tempo based on hereditary endowment and environmental factors.<br />
      (4) <b style="color: \${themeColor};">Principle of General to Specific Responses:</b> Mass, uncoordinated motor responses precede refined, localized precision.<br />
      (5) <b style="color: \${themeColor};">Principle of Interrelation:</b> Physical, intellectual, emotional, and social development are deeply interdependent.<br />
      (6) <b style="color: \${themeColor};">Principle of Interaction (Heredity &times; Environment):</b> Biological potential is realized only through supportive environmental stimulation.</p>

      <p><b style="color: \${themeColor};">III. Pedagogical and Curricular Implications:</b><br />
  ...
  <div style="margin: 22px 0;">
    ...
    <div style="color: #FFFFFF; line-height: 1.75;">
      ...
      <p><b style="color: \${themeColor};">II. Comparative Analysis across Three Cardinal Epochs:</b><br />
      (1) <b style="color: \${themeColor};">Infancy (Birth to 2/3 Years):</b> Characterized by explosive physical growth, sensorimotor cognitive operations, rapid reflex-to-voluntary motor transition, total biological dependency, and establishing Erikson's foundational crisis of <i>Trust vs. Mistrust</i>.<br />
      (2) <b style="color: \${themeColor};">Childhood (3 to 12 Years):</b> Divided into <i>Early Childhood</i> (3–6 yrs; Toy Age, insatiable curiosity, pre-operational symbolic play) and <i>Later Childhood</i> (6–12 yrs; Gang Age, stable physical growth, concrete operational logic, elementary schooling, and <i>Industry vs. Inferiority</i>).<br />
      (3) <b style="color: \${themeColor};">Adolescence (12 to 18/19 Years):</b> Pubertal metamorphosis, reproductive maturity, G. Stanley Hall's <i>Storm and Stress</i>, formal operational abstract reasoning, intense peer conformity, and Erikson's crisis of <i>Identity vs. Role Confusion</i>.</p>

      <p><b style="color: \${themeColor};">III. Educational Synthesis:</b><br />
  ...
  <div style="margin: 22px 0;">
    ...
    <div style="color: #FFFFFF; line-height: 1.75;">
      ...
      <p><b style="color: \${themeColor};">II. Key Developmental Characteristics &amp; Core Needs:</b><br />
      (1) <b style="color: \${themeColor};">Characteristics:</b> Rapid physical growth spurt, sexual maturation, emotional lability, formal operational abstract reasoning, hero-worship, and fierce peer allegiance.<br />
      (2) <b style="color: \${themeColor};">Vital Needs:</b> High-protein physical nutrition, need for emotional security, need for autonomy and self-direction, need for peer status, and need for clear vocational pathways.</p>

      <p><b style="color: \${themeColor};">III. Severe Psychosocial Problems:</b><br />
      ...
      <p><b style="color: \${themeColor};">IV. Remedial Conclusion:</b><br />
  ...
  <div style="margin: 22px 0;">
    ...
    <div style="color: #FFFFFF; line-height: 1.75;">
      ...
      <p><b style="color: \${themeColor};">II. Strategic Measures for Parents:</b><br />
      (1) Practice <b style="color: \${themeColor};">Authoritative Parenting</b> (high warmth + firm democratic guidelines).<br />
      (2) Bridge the <b style="color: \${themeColor};">Generation Gap</b> through non-judgmental, active empathetic listening.<br />
      ...
      <p><b style="color: \${themeColor};">III. Strategic Measures for Teachers &amp; Schools:</b><br />
      (1) Act as empathetic mentors, totally abolishing sarcasm, ridicule, and corporal punishment.<br />
      (2) Channel aggressive drives through <b style="color: \${themeColor};">Sublimation</b> into sports, athletics, NCC, NSS, and arts.<br />
      (3) Implement the <b style="color: \${themeColor};">Adolescent Education Program (AEP)</b> for life skills, cyber security, and substance abuse awareness.<br />
  ...
  <div style="margin: 22px 0;">
    ...
    <div style="color: #FFFFFF; line-height: 1.75;">
      ...
      (1) <b style="color: \${themeColor};">Primary Triggers:</b> Pubertal physical changes combined with severe authoritarian parental pressure and unrealistic academic expectations.<br />
      (2) <b style="color: \${themeColor};">Psychological Crises:</b> Acute Identity vs. Role Confusion, Body Dysmorphia, and Intergenerational Conflict (Generation Gap).<br />
      (3) <b style="color: \${themeColor};">Manifested Symptoms:</b> Food deprivation, emotional lability, scholastic decline, and cognitive daydreaming.</p>

      <p><b style="color: \${themeColor};">II. Four-Tiered Psycho-Educational Remediation Blueprint:</b><br />
      (1) <b style="color: \${themeColor};">Parental Re-Orientation:</b> Counsel the father to immediately cease authoritarian threats and grade ultimatums, adopting authoritative warmth and active listening.<br />
      (2) <b style="color: \${themeColor};">Individual Cognitive Counseling:</b> School counselor helps Sneha dismantle irrational body image distortions, rebuild core self-esteem, and process pubertal maturation.<br />
      (3) <b style="color: \${themeColor};">Sublimation through Creative Arts &amp; Sports:</b> Encourage Sneha to join the school drama society or badminton team to channel anxious energy into creative mastery.<br />
      (4) <b style="color: \${themeColor};">Academic Restructuring:</b> Teachers provide supportive remedial micro-goals, celebrating effort rather than raw marks, restoring Sneha's academic confidence.</p>
    </div>
  </div>
