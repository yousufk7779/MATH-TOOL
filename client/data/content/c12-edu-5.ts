...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <div style="background: rgba(255, 138, 101, 0.08); border: 1.5px solid #FF8A65; border-radius: 12px; padding: 18px; margin-bottom: 25px;">
    <h2 class="text-center" style="color: #FF8A65; font-weight: bold; margin: 0 0 6px 0; font-size: 20px; font-weight: bold;">💻 Quick Glossary &amp; Core Educational Technology Concepts</h2>
    ...
    <div style="display: flex; flex-direction: column; gap: 12px;">
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FF8A65; border-radius: 6px;">
        <b style="color: #FF8A65; font-size: 16px; display: block; margin-bottom: 4px;">1. Educational Technology (G.O.M. Leith):</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FF8A65; border-radius: 6px;">
        <b style="color: #FF8A65; font-size: 16px; display: block; margin-bottom: 4px;">2. Hardware vs. Software Approaches (A.A. Lumsdaine):</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FF8A65; border-radius: 6px;">
        <b style="color: #FF8A65; font-size: 16px; display: block; margin-bottom: 4px;">3. Information &amp; Communication Technology (ICT):</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FF8A65; border-radius: 6px;">
        <b style="color: #FF8A65; font-size: 16px; display: block; margin-bottom: 4px;">4. Blended Learning:</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FF8A65; border-radius: 6px;">
        <b style="color: #FF8A65; font-size: 16px; display: block; margin-bottom: 4px;">5. Flipped Classroom / Flipped Learning:</b>
  ...
  <!-- SECTION 5.1 -->
  <h2 style="color: #FF8A65; font-weight: bold; border-bottom: 2px solid #FF8A65; padding-bottom: 6px; margin-top: 30px;">5.1 Educational Technology- meaning and principles</h2>

  <p>Human civilisation has entered the knowledge age, driven by an unprecedented explosion of information, telecommunications, and digital science. In this dynamic landscape, education can no longer remain tethered to medieval chalk-and-talk methods. <b style="color: #FF8A65;">Educational Technology (ET)</b> represents the systematic marriage between the science of learning and the art of teaching, revolutionising how knowledge is organized, communicated, and internalized.</p>

  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 24px;">(i) Etymological Origin &amp; Authoritative Definitions</h3>
  ...
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #FF8A65; border-radius: 8px; padding: 14px 16px; margin: 18px 0;">
    <p style="margin: 0 0 10px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #FF8A65;">1. G. O. M. Leith:</b> <i>"Educational technology is the application of scientific knowledge and learning conditions to improve the effectiveness and efficiency of teaching and training."</i>
    </p>
    <p style="margin: 0 0 10px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #FF8A65;">2. Robert A. Cox:</b> <i>"Educational technology is the application of scientific process to man's learning conditions."</i>
    </p>
    <p style="margin: 0 0 10px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #FF8A65;">3. Dr. Shiv K. Mitra:</b> <i>"Educational technology can be conceived as an application of modern skills and techniques to the requirements of education and training."</i>
    </p>
    <p style="margin: 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #FF8A65;">4. AECT (USA):</b> <i>"Educational technology is the study and ethical practice of facilitating learning and improving performance by creating, using, and managing appropriate technological processes and resources."</i>
    </p>
  </div>

  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 24px;">(ii) Technology in Education vs. Technology of Education</h3>
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">1. Technology in Education (Hardware View):</b>
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">2. Technology of Education (Software View):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 24px;">(iii) Fundamental Principles of Educational Technology</h3>
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">1. Principle of Goal-Orientation (Behavioral Objectives):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">2. Principle of Active Learner Participation:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">3. Principle of Immediate Reinforcement &amp; Feedback:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">4. Principle of Individualized Pacing:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">5. Principle of Multi-Sensory Appeal:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <!-- SECTION 5.2 -->
  <h2 style="color: #FF8A65; font-weight: bold; border-bottom: 2px solid #FF8A65; padding-bottom: 6px; margin-top: 35px;">5.2 Hardware &amp; software approaches to educational technology</h2>

  <p>In 1964, eminent psychologist <b style="color: #FF8A65;">Arthur A. Lumsdaine</b> pioneered the classic binary classification of educational technology into the <b>Hardware Approach (ET-1)</b> and the <b>Software Approach (ET-2)</b>:</p>
  ...
  <div style="display: flex; flex-direction: column; gap: 14px; margin: 18px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #38EF7D; border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-weight: bold; font-size: 16px;">🖥️ 1. The Hardware Approach (ET-1):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
        <b style="color: #FF8A65; font-weight: bold;">Philosophical Roots:</b> Rooted firmly in physical sciences and electrical/mechanical engineering.
        <br /><b style="color: #FF8A65; font-weight: bold;">Operational Nature:</b> Focuses on the production, maintenance, and deployment of physical hardware machines. Includes radio, educational television, audio recorders, film projectors, LCD projectors, computers, digital tablets, and interactive flat panels.
        <br /><b style="color: #FF8A65; font-weight: bold;">Pedagogical Function:</b> Acts as the mechanical delivery carrier. It enables mass dissemination of instruction across vast geographic distances, overcoming teacher shortages and bringing world-class laboratories onto classroom screens.
      </p>
    </div>

    <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #00C6FF; border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-weight: bold; font-size: 16px;">🧠 2. The Software Approach (ET-2):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
        <b style="color: #FF8A65; font-weight: bold;">Philosophical Roots:</b> Rooted deeply in behavioral sciences, learning psychology, psycholinguistics, and pedagogy.
        <br /><b style="color: #FF8A65; font-weight: bold;">Operational Nature:</b> Focuses on the intangible content and instructional architecture: programmed learning materials, lesson plans, instructional software programs, behavioral objectives, evaluation rubrics, and pedagogic simulations.
        <br /><b style="color: #FF8A65; font-weight: bold;">Pedagogical Function:</b> Focuses on modifying student behavior, engineering cognitive comprehension, and systematically guiding thought processes toward mastery learning.
      </p>
    </div>
  </div>
  ...
  <!-- SECTION 5.3 -->
  <h2 style="color: #FF8A65; font-weight: bold; border-bottom: 2px solid #FF8A65; padding-bottom: 6px; margin-top: 35px;">5.3 Role of ICT in learning-teaching</h2>

  <p><b style="color: #FF8A65;">Information and Communication Technology (ICT)</b> refers to an integrated technological infrastructure comprising computing hardware, telecommunications, broadband connectivity, digital software, and multimedia networks. In 21st-century education, ICT has transformed from an auxiliary visual aid into the central neurological system of education:</p>

  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">1. Universal Democratization and Borderless Access:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">2. Multi-Sensory Cognitive Simulation &amp; Virtual Labs:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">3. Individualized Learning and Cognitive Autonomy:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">4. Automated Assessment &amp; Instant Pedagogical Analytics:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <!-- SECTION 5.4 -->
  <h2 style="color: #FF8A65; font-weight: bold; border-bottom: 2px solid #FF8A65; padding-bottom: 6px; margin-top: 35px;">5.4 Concept of modern learning models: Online learning, Blended Learning, Flipped Learning</h2>
  ...
  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 24px;">(i) Online Learning (E-Learning / Virtual Education)</h3>
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #FF8A65; border-radius: 8px; padding: 14px 16px; margin: 14px 0;">
    <p style="margin: 0 0 8px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #FF8A65;">Concept &amp; Delivery:</b> Online learning is a fully web-mediated educational format where instruction, content delivery, student-teacher interaction, and assessment occur entirely across digital networks without requiring physical co-presence.
    </p>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0; color: #FFFFFF;">
      <li><b style="color: #FF8A65;">Synchronous Online Learning:</b> Real-time live interaction where educators and students convene concurrently via video conferencing tools (Zoom, Google Meet, Microsoft Teams), participating in live polls and instant chats.</li>
      <li><b style="color: #FF8A65;">Asynchronous Online Learning:</b> Flexible, self-paced learning where instructional materials (recorded video lectures, readings, discussion forums) are accessed at the student's convenience without concurrent live login.</li>
    </ul>
  </div>

  <!-- MODEL 2: BLENDED LEARNING -->
  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 24px;">(ii) Blended Learning (Hybrid Learning Model)</h3>
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #FF8A65; border-radius: 8px; padding: 14px 16px; margin: 14px 0;">
    <p style="margin: 0 0 8px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #FF8A65;">Concept &amp; Philosophy:</b> Blended Learning is the optimal pedagogical synthesis combining the best attributes of traditional face-to-face classroom teaching with structured online digital instruction. It does not simply layer technology on top of traditional classes; it redesigns the instructional ecosystem.
    </p>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0; color: #FFFFFF;">
      <li><b style="color: #FF8A65;">The Best of Both Worlds:</b> Preserves the human warmth, social camaraderie, and immediate teacher mentorship of brick-and-mortar schools, while incorporating the flexibility, rich multimedia animations, and individualized pacing of digital e-learning.</li>
      <li><b style="color: #FF8A65;">Popular Operational Models:</b> <i>Station Rotation Model</i> (students rotate between teacher-led small groups and digital stations); <i>Flex Model</i> (online platform serves as primary spine while teachers provide targeted breakout interventions).</li>
    </ul>
  </div>

  <!-- MODEL 3: FLIPPED LEARNING -->
  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 24px;">(iii) Flipped Learning (The Flipped Classroom Model)</h3>
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #FF8A65; border-radius: 8px; padding: 14px 16px; margin: 14px 0;">
    <p style="margin: 0 0 8px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #FF8A65;">Concept &amp; Pedagogical Inversion:</b> Pioneered by high school chemistry teachers Jonathan Bergmann and Aaron Sams (2007), the <b style="color: #FF8A65;">Flipped Classroom</b> radically inverts traditional instructional chronology:
    </p>
  ...
  <div style="background: rgba(15, 23, 42, 0.85); border: 1.5px solid #FF8A65; border-radius: 10px; padding: 16px; margin: 25px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 17px; font-weight: bold; margin: 0 0 12px 0;">
    ...
    <div style="overflow-x: auto;">
      <table style="width: 100%; border-collapse: collapse; font-size: 14px; color: #F8FAFC;">
        <thead>
          <tr style="background: rgba(255, 138, 101, 0.25); border-bottom: 2px solid #FF8A65;">
        ...
        <tbody>
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
            <td style="padding: 10px; font-weight: bold; color: #FF8A65;">Primary Location</td>
          ...
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
            <td style="padding: 10px; font-weight: bold; color: #FF8A65;">Classroom Role</td>
          ...
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
            <td style="padding: 10px; font-weight: bold; color: #FF8A65;">Teacher's Function</td>
          ...
          <tr>
            <td style="padding: 10px; font-weight: bold; color: #FF8A65;">Chief Advantage</td>
  ...
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #38EF7D; border-radius: 8px; padding: 14px 16px; margin: 20px 0;">
    <h4 style="color: #FF8A65; font-weight: bold; margin: 0 0 6px 0; font-size: 16px; font-weight: bold;">
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <div style="background: rgba(255, 138, 101, 0.08); border-left: 4px solid #FF8A65; border-radius: 6px; padding: 14px 16px; margin-bottom: 24px;">
    <h3 style="color: #FF8A65; font-weight: bold; margin: 0 0 6px 0; font-size: 18px; font-weight: bold;">🎯 Golden 25 Board Examination Q &amp; A Blueprint</h3>
  ...
  <!-- ======================================================================== -->
  <h2 style="color: #FF8A65; font-weight: bold; border-bottom: 2px solid #FF8A65; padding-bottom: 6px; margin-top: 25px;">
    Section A: Very Short Answer Questions (1 &amp; 2 Marks)
  </h2>

  <!-- Q1 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q1: Define Educational Technology according to G. O. M. Leith.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      According to <b style="color: #FF8A65;">G. O. M. Leith</b>, <i>"Educational technology is the application of scientific knowledge and learning conditions to improve the effectiveness and efficiency of teaching and training."</i>
    </p>
  </div>

  <!-- Q2 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q2: What are the Greek root words of 'Technology'?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      Technology is derived from the Greek words <b style="color: #FF8A65;">"Techne"</b> (meaning art, skill, or craft) and <b style="color: #FF8A65;">"Logos"</b> (meaning science, discourse, or systematic study).
    </p>
  </div>

  <!-- Q3 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q3: Distinguish between 'Technology in Education' and 'Technology of Education'.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #FF8A65;">Technology in Education</b> refers to using physical machinery and gadgets (smartboards, projectors), while <b style="color: #FF8A65;">Technology of Education</b> refers to applying psychological learning principles, instructional designs, and behavioral objectives.
    </p>
  </div>

  <!-- Q4 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q4: Who classified Educational Technology into Hardware and Software approaches?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      The eminent psychologist and educational technologist <b style="color: #FF8A65;">Arthur A. Lumsdaine</b> (1964) classified educational technology into Hardware (ET-1) and Software (ET-2) approaches.
    </p>
  </div>

  <!-- Q5 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q5: What is the Hardware Approach (ET-1)? Give two examples.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      The <b style="color: #FF8A65;">Hardware Approach</b> is based on physical sciences and mechanical/electronic engineering that mechanizes information transmission. Examples: (1) <b style="color: #FF8A65;">LCD Projectors</b>; (2) <b style="color: #FF8A65;">Interactive Smartboards</b>.
    </p>
  </div>

  <!-- Q6 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q6: What is the Software Approach (ET-2)? Give two examples.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      The <b style="color: #FF8A65;">Software Approach</b> is rooted in behavioral sciences and learning psychology, focusing on modifying student behavior. Examples: (1) <b style="color: #FF8A65;">Programmed Learning Modules</b>; (2) <b style="color: #FF8A65;">Formative Assessment Rubrics</b>.
    </p>
  </div>

  <!-- Q7 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q7: State what ICT stands for in modern education.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      ICT stands for <b style="color: #FF8A65;">Information and Communication Technology</b>, representing the unified convergence of computing, telecommunications, internet, and multimedia technologies.
    </p>
  </div>

  <!-- Q8 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q8: State two vital advantages of ICT in the teaching-learning process.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      (1) <b style="color: #FF8A65;">Universal Democratization:</b> Providing borderless access to quality digital textbooks and lectures; (2) <b style="color: #FF8A65;">Multi-Sensory Engagement:</b> Rendering abstract concepts visible via 3D interactive simulations.
    </p>
  </div>

  <!-- Q9 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q9: Differentiate between Synchronous and Asynchronous online learning.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #FF8A65;">Synchronous</b> learning occurs in real time with live concurrent interaction (e.g., live Zoom lectures), whereas <b style="color: #FF8A65;">Asynchronous</b> learning is self-paced where learners access pre-recorded materials and discussion forums at their own time.
    </p>
  </div>

  <!-- Q10 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q10: What is meant by Blended Learning?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #FF8A65;">Blended Learning</b> (or Hybrid Learning) is a pedagogical approach that integrates traditional face-to-face classroom teaching with structured online digital educational instruction.
    </p>
  </div>

  <!-- Q11 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q11: Explain the core concept of a 'Flipped Classroom'.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      A <b style="color: #FF8A65;">Flipped Classroom</b> inverts traditional schooling: students watch instructional video lectures at home at their own pace, while classroom hours are dedicated to active problem-solving and discussions under teacher mentorship.
    </p>
  </div>

  <!-- Q12 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q12: State two major principles of Educational Technology.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      (1) <b style="color: #FF8A65;">Principle of Purposefulness:</b> Direct alignment with clear behavioral learning objectives; (2) <b style="color: #FF8A65;">Principle of Individualized Pacing:</b> Enabling learners to progress according to their unique cognitive speed.
    </p>
  </div>
  ...
  <!-- ======================================================================== -->
  <h2 style="color: #FF8A65; font-weight: bold; border-bottom: 2px solid #FF8A65; padding-bottom: 6px; margin-top: 35px;">
    Section B: Short Answer Questions (4 Marks)
  </h2>

  <!-- Q13 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q13: Explain four fundamental principles of Educational Technology.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      ...
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FF8A65;">1. Principle of Goal-Orientation:</b> Technology is a means, not an end; it must serve specific behavioral objectives (cognitive, affective, psychomotor).</li>
        <li><b style="color: #FF8A65;">2. Principle of Active Learner Response:</b> Students learn best by doing; interactive quizzes, simulations, and feedback loops prevent passive boredom.</li>
        <li><b style="color: #FF8A65;">3. Principle of Immediate Reinforcement:</b> Immediate knowledge of test results reinforces correct neural pathways and extinguishes misconceptions.</li>
        <li><b style="color: #FF8A65;">4. Principle of Individualized Pacing:</b> Accommodating individual differences by allowing students to pause, rewind, and re-examine complex concepts.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q14 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q14: Compare Hardware and Software approaches across four distinct parameters.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Hardware and Software approaches differ fundamentally across key dimensions:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FF8A65;">1. Theoretical Origin:</b> Hardware originates from physical sciences and engineering, whereas Software stems from behavioral psychology and linguistics.</li>
        <li><b style="color: #FF8A65;">2. Primary Focus:</b> Hardware emphasizes machines, electronics, and devices; Software emphasizes learning content, instructional strategies, and behavioral modification.</li>
        <li><b style="color: #FF8A65;">3. Pedagogical Role:</b> Hardware serves as the physical carrier of information; Software serves as the educational message and cognitive organizer.</li>
        <li><b style="color: #FF8A65;">4. Nomenclature:</b> Hardware is known as <i>Technology in Education</i>; Software is known as <i>Technology of Education</i>.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q15 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q15: Discuss how Hardware and Software approaches are mutually interdependent.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Hardware and Software represent the two indivisible sides of the same educational coin:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FF8A65;">1. The Metaphor of Body and Soul:</b> Hardware represents the physical body (machinery), while software represents the living soul (instructional content).</li>
        <li><b style="color: #FF8A65;">2. Hardware without Software:</b> A high-end interactive flat panel or computer lab without high-quality pedagogic software is an inert, useless collection of metal and silicon.</li>
        <li><b style="color: #FF8A65;">3. Software without Hardware:</b> A brilliantly designed digital curriculum or 3D simulation cannot reach students without electronic hardware to display and run it.</li>
        <li><b style="color: #FF8A65;">4. Symbiotic Synergy:</b> Maximum learning efficiency is attained only when advanced hardware perfectly transmits scientifically designed psychological software.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q16 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q16: Describe the role of ICT in democratizing education and catering to individualized learning.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      ICT has radically democratized global educational opportunities:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FF8A65;">1. Eradicating Geographic Barriers:</b> Students in remote, disadvantaged rural regions access identical curriculum materials through national digital repositories (DIKSHA, e-Pathshala).</li>
        <li><b style="color: #FF8A65;">2. Self-Paced Progression:</b> Unlike rigid traditional classrooms, ICT allows learners to control learning tempo, speeding ahead or repeating challenging lessons.</li>
        <li><b style="color: #FF8A65;">3. Multi-Sensory Accommodation:</b> Visual learners benefit from infographics, auditory learners from podcasts, and kinesthetic learners from interactive digital simulations.</li>
        <li><b style="color: #FF8A65;">4. Inclusive Education for CWSN:</b> Screen readers, text-to-speech software, and braille digital devices empower children with special needs.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q17 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q17: Analyze the benefits and challenges of Online Learning in the Indian context.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Online learning represents immense promise alongside real infrastructural hurdles:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FF8A65;">1. Chief Benefits:</b> Complete spatial flexibility, access to top-tier university professors via MOOCs (SWAYAM), paperless digital archives, and cost-effective upskilling.</li>
        <li><b style="color: #FF8A65;">2. The Digital Divide:</b> Disparities in smartphone ownership, erratic rural electricity, and lack of high-speed broadband exclude millions of marginalized children.</li>
        <li><b style="color: #FF8A65;">3. Lack of Social Interaction:</b> Deprives youth of peer camaraderie, physical sports, and emotional bonding, risking social isolation.</li>
        <li><b style="color: #FF8A65;">4. Screen Fatigue &amp; Discipline:</b> Prolonged screen exposure causes ocular strain, and asynchronous modules require immense personal self-discipline.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q18 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q18: Explain Blended Learning and how it combines the strengths of traditional and digital schooling.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Blended Learning harmonizes conventional warmth with digital efficacy:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FF8A65;">1. Conceptual Synthesis:</b> It strategically blends physical face-to-face instruction with online self-directed learning, avoiding the extremes of pure chalk-and-talk or isolated screen time.</li>
        <li><b style="color: #FF8A65;">2. Retaining Human Mentorship:</b> Preserves the irreplaceable moral guidance, emotional warmth, laboratory work, and collaborative sports of the brick-and-mortar school.</li>
        <li><b style="color: #FF8A65;">3. Harnessing Digital Flexibility:</b> Integrates cloud-based assignments, diagnostic quizzes, and animated simulations that students can explore at their own pace.</li>
        <li><b style="color: #FF8A65;">4. Enhanced Teacher Productivity:</b> Frees educators from repetitive lecturing, allowing them to focus on small-group mentoring and remedial assistance.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q19 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q19: Illustrate the operational mechanism of a Flipped Classroom (Before-Class vs. In-Class activities).</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      The Flipped Classroom inverts traditional pedagogical workflow:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FF8A65;">1. Before-Class Phase (At Home):</b> Students independently watch short, structured digital video lectures (10–15 mins) and complete self-check quizzes, acquiring foundational knowledge.</li>
        <li><b style="color: #FF8A65;">2. In-Class Phase (In School):</b> Instead of listening passively, students engage in debates, hands-on scientific experiments, case studies, and advanced problem-solving in groups.</li>
        <li><b style="color: #FF8A65;">3. The Teacher's Role:</b> Shifts from a formal lecturer into an active coach circulating the room, clarifying doubts, and offering real-time scaffolding.</li>
        <li><b style="color: #FF8A65;">4. Elimination of Homework Frustration:</b> Difficult cognitive applications are completed in the classroom with teacher support, rather than at home in solitary distress.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q20 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q20: Discuss how ICT transforms the teacher's role from an authoritarian lecturer to a facilitator.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      In an ICT-enabled classroom, the teacher undergoes a radical pedagogical transformation:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FF8A65;">1. From Information Dispenser to Learning Architect:</b> The teacher is no longer the sole custodian of facts (which are readily available online), but the curator and designer of learning experiences.</li>
        <li><b style="color: #FF8A65;">2. Facilitator of Critical Thinking:</b> Guiding students to evaluate, filter, and critically synthesize internet information rather than memorizing raw textbooks.</li>
        <li><b style="color: #FF8A65;">3. Diagnostician &amp; Mentor:</b> Using digital analytics to identify student learning gaps and providing individualized emotional and academic guidance.</li>
        <li><b style="color: #FF8A65;">4. Life-Skills Coach:</b> Fostering cyber ethics, digital safety, collaborative teamwork, and creative problem-solving skills.</li>
      </ul>
    </div>
  </div>
  ...
  <div style="margin: 22px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q21: Comprehensive Exposition of Educational Technology: Meaning, Scope, Principles, and Difference between Technology in and of Education.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #FF8A65;">I. Conceptual Meaning &amp; Scope:</b><br />
      ...
      <p><b style="color: #FF8A65;">II. Fundamental Principles of Educational Technology:</b><br />
      (1) <b style="color: #FF8A65;">Goal-Orientation:</b> Direct linkage with explicit behavioral objectives.<br />
      (2) <b style="color: #FF8A65;">Active Learner Response:</b> Interactive problem-solving rather than passive viewing.<br />
      (3) <b style="color: #FF8A65;">Immediate Feedback:</b> Prompt reinforcement accelerating retention.<br />
      (4) <b style="color: #FF8A65;">Individualized Pacing:</b> Accommodating diverse cognitive speeds.<br />
      (5) <b style="color: #FF8A65;">Multi-Sensory Stimulation:</b> Engaging sight, sound, and touch.</p>

      <p><b style="color: #FF8A65;">III. Technology IN vs. Technology OF Education:</b><br />
  ...
  <!-- Q22 -->
  <div style="margin: 22px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q22: Detailed Classification and Comparative Analysis of Hardware and Software Approaches to Educational Technology.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #FF8A65;">I. Introduction &amp; Lumsdaine's Framework:</b><br />
      ...
      <p><b style="color: #FF8A65;">II. Comparative Breakdown across Core Dimensions:</b><br />
      (1) <b style="color: #FF8A65;">Disciplinary Roots:</b> Hardware originates in physical sciences and electrical engineering; Software originates in behavioral psychology and psycholinguistics.<br />
      (2) <b style="color: #FF8A65;">Core Instruments:</b> Hardware comprises computers, LCD projectors, interactive screens, and radio; Software comprises programmed learning texts, instructional apps, curriculum algorithms, and evaluation tools.<br />
      (3) <b style="color: #FF8A65;">Pedagogical Function:</b> Hardware delivers information across mass audiences; Software alters student cognitive structures and shapes behavioral modification.<br />
      (4) <b style="color: #FF8A65;">Cost &amp; Maintenance:</b> Hardware requires heavy capital expenditure and physical maintenance; Software demands cognitive expertise and continuous curriculum revision.</p>

      <p><b style="color: #FF8A65;">III. Inseparable Symbiosis:</b><br />
  ...
  <!-- Q23 -->
  <div style="margin: 22px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q23: The Revolutionary Role of ICT in Modern Teaching-Learning and NEP 2020 Digital Initiatives.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #FF8A65;">I. Conceptual Convergence of ICT:</b><br />
      ...
      <p><b style="color: #FF8A65;">II. Major Pillars of ICT Transformation:</b><br />
      (1) <b style="color: #FF8A65;">Universal Access &amp; Equity:</b> Eradicates rural-urban educational disparities by delivering high-caliber open educational resources (OER) to every connected device.<br />
      (2) <b style="color: #FF8A65;">Interactive Multi-Sensory Simulations:</b> Complex scientific phenomena (molecular geometry, astrophysics) become visually tangible through virtual laboratories and 3D simulations.<br />
      (3) <b style="color: #FF8A65;">Continuous Diagnostic Analytics:</b> Real-time digital assessments provide instant feedback, pin-pointing learning gaps.<br />
      (4) <b style="color: #FF8A65;">Administrative &amp; Pedagogical Efficiency:</b> Automates grading, student tracking, and digital lesson repositories.</p>

      <p><b style="color: #FF8A65;">III. Alignment with NEP 2020:</b><br />
  ...
  <!-- Q24 -->
  <div style="margin: 22px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q24: Critical Examination of Modern Learning Models: Online Learning, Blended Learning, and Flipped Classrooms.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #FF8A65;">I. The Paradigm Shift in Educational Delivery:</b><br />
      ...
      <p><b style="color: #FF8A65;">II. Analytical Evaluation of the Three Models:</b><br />
      (1) <b style="color: #FF8A65;">Online Learning:</b> 100% web-based delivery (synchronous live classes and asynchronous modules). Offers unmatched geographic freedom and self-pacing, but faces challenges of student isolation, screen fatigue, and the digital divide.<br />
      (2) <b style="color: #FF8A65;">Blended Learning:</b> Harmonious hybrid of face-to-face classroom teaching with digital e-learning. Retains vital social-emotional bonding, peer interaction, and sports while providing personalized digital resources and flexible scheduling.<br />
      (3) <b style="color: #FF8A65;">Flipped Classroom:</b> Chronological inversion of teaching. Direct instruction occurs at home via video lessons, while classroom time is liberated for interactive debate, problem-solving, and laboratory exploration under teacher scaffolding.</p>

      <p><b style="color: #FF8A65;">III. Synthesis for Future Schools:</b><br />
  ...
  <!-- Q25 -->
  <div style="margin: 22px 0;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q25: Real-World Pedagogical Case Study: Implementation of a Flipped Blended Learning Model in a Senior Secondary School.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #FF8A65;">Case Context:</b><br />
      ...
      <p><b style="color: #FF8A65;">I. Diagnostic Identification:</b><br />
      ...
      <p><b style="color: #FF8A65;">II. Four-Stage Implementation Blueprint:</b><br />
      (1) <b style="color: #FF8A65;">Stage 1 &mdash; Digital Content Curation (At Home):</b> Teachers curate and record 10-to-12-minute engaging video modules integrated with DIKSHA animations. Students watch these at home at their own pace, accompanied by 3 quick check-in questions.<br />
      (2) <b style="color: #FF8A65;">Stage 2 &mdash; Classroom Re-Engineering (In School):</b> Lectures are eliminated. The classroom is arranged into collaborative pods. Class begins with a 5-minute quiz to identify misconceptions, followed by 35 minutes of active problem-solving, debates, and lab experiments.<br />
      (3) <b style="color: #FF8A65;">Stage 3 &mdash; Teacher as Personal Coach:</b> The teacher circulates among student groups, providing personalized scaffolding, guiding struggling learners, and challenging gifted students with advanced cases.<br />
      (4) <b style="color: #FF8A65;">Stage 4 &mdash; Digital Equity &amp; Parent Alignment:</b> School computer labs are kept open after hours for students without home internet, and parents are briefed on supporting self-paced video viewing rather than forcing traditional rote homework.</p>
    </div>
  </div>
