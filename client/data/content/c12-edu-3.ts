...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <div style="background: rgba(17, 153, 142, 0.07); border: 1.5px solid #11998E; border-radius: 12px; padding: 18px; margin-bottom: 25px;">
    <h2 class="text-center" style="color: #11998E; font-weight: bold; margin: 0 0 6px 0; font-size: 20px; font-weight: bold;">⚖️ Quick Glossary &amp; Core Adjustment Concepts</h2>
    ...
    <div style="display: flex; flex-direction: column; gap: 12px;">
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #11998E; border-radius: 6px;">
        <b style="color: #11998E; font-size: 16px; display: block; margin-bottom: 4px;">1. Adjustment (Shaffer's Definition):</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #11998E; border-radius: 6px;">
        <b style="color: #11998E; font-size: 16px; display: block; margin-bottom: 4px;">2. Maladjustment:</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #11998E; border-radius: 6px;">
        <b style="color: #11998E; font-size: 16px; display: block; margin-bottom: 4px;">3. Defense Mechanisms (Ego Defenses):</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #11998E; border-radius: 6px;">
        <b style="color: #11998E; font-size: 16px; display: block; margin-bottom: 4px;">4. Rationalization (Sour Grapes &amp; Sweet Lemon):</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #11998E; border-radius: 6px;">
        <b style="color: #11998E; font-size: 16px; display: block; margin-bottom: 4px;">5. Sublimation:</b>
  ...
  <!-- SECTION 3.1 -->
  <h2 style="color: #11998E; font-weight: bold; border-bottom: 2px solid #11998E; padding-bottom: 6px; margin-top: 30px;">3.1 Concept and Meaning of Adjustment and Maladjustment</h2>

  <p>Every living organism enters a world fraught with biological challenges, physical barriers, and environmental complexities. From the moment of birth to the final breath, life is an unbroken chain of adaptations. In educational psychology, the concept of <b style="color: #11998E;">Adjustment</b> is derived from the Latin roots <i>"ad"</i> (meaning toward) and <i>"juxtare"</i> (meaning to bring close or fit together). It represents the art of living in harmony with oneself, with fellow human beings, and with the surrounding physical and social universe.</p>

  <h3 style="color: #11998E; font-weight: bold; margin-top: 24px;">(i) Authoritative Definitions of Adjustment</h3>
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #11998E; border-radius: 8px; padding: 14px 16px; margin: 18px 0;">
    <p style="margin: 0 0 10px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #11998E;">1. L. S. Shaffer:</b> <i>"Adjustment is the process by which a living organism maintains a balance between its needs and the circumstances that influence the satisfaction of these needs."</i>
    </p>
    <p style="margin: 0 0 10px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #11998E;">2. Gates and Others:</b> <i>"Adjustment is a continual process in which a person varies his behaviour to produce a more harmonious relationship between himself and his environment."</i>
    </p>
    <p style="margin: 0 0 10px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #11998E;">3. Boring, Langfeld, and Weld:</b> <i>"Adjustment is the process of finding and adopting modes of behavior suitable to the environment or to the changes in the environment."</i>
    </p>
    <p style="margin: 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #11998E;">4. B. F. Skinner:</b> <i>"Adjustment is an achievement in which an individual has harmonized his desires with the demands of society."</i>
    </p>
  </div>

  <h3 style="color: #11998E; font-weight: bold; margin-top: 24px;">(ii) Dual Perspectives: Adjustment as an Achievement vs. Adjustment as a Process</h3>
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(17, 153, 142, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #11998E; font-size: 16px;">1. Adjustment as an Achievement (Static Outcome):</b>
  ...
  <!-- SECTION 3.2 -->
  <h2 style="color: #11998E; font-weight: bold; border-bottom: 2px solid #11998E; padding-bottom: 6px; margin-top: 35px;">3.2 Characteristics of a Well-Adjusted Person</h2>
  ...
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(17, 153, 142, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #11998E; font-size: 16px;">1. Accurate Self-Knowledge and Unconditional Self-Acceptance:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(17, 153, 142, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #11998E; font-size: 16px;">2. Emotional Maturity and High Frustration Tolerance:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(17, 153, 142, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #11998E; font-size: 16px;">3. Warm and Altruistic Social Relationships:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(17, 153, 142, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #11998E; font-size: 16px;">4. Realistic Level of Aspiration:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(17, 153, 142, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #11998E; font-size: 16px;">5. Adaptability and Openness to Change:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(17, 153, 142, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #11998E; font-size: 16px;">6. Integrated Philosophy of Life:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <!-- SECTION 3.3 -->
  <h2 style="color: #11998E; font-weight: bold; border-bottom: 2px solid #11998E; padding-bottom: 6px; margin-top: 35px;">3.3 Causes of Maladjustment: Subjective, Objective, and Social</h2>
  ...
  <div style="display: flex; flex-direction: column; gap: 14px; margin: 18px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #11998E; border-radius: 8px; padding: 14px 16px;">
      <b style="color: #11998E; font-size: 16px;">1. Subjective (Internal / Personal) Causes:</b>
      <ul style="padding-left: 20px; line-height: 1.8; margin: 6px 0 0 0; color: #FFFFFF;">
        <li><b style="color: #11998E;">Physical Deformities and Sensory Defects:</b> Chronic illnesses, severe physical handicaps, speech impediments (stammering), obesity, or perceived facial flaws frequently foster a devastating sense of physical inferiority.</li>
        <li><b style="color: #11998E;">Disparity in Level of Aspiration:</b> When an adolescent's goals far exceed their innate intellectual or creative capacity, every examination produces crushing frustration, guilt, and bitter despair.</li>
        <li><b style="color: #11998E;">Extreme Cognitive Rigidity &amp; Emotional Immaturity:</b> Inability to tolerate ambiguity, black-and-white thinking, and hypersensitivity to constructive feedback.</li>
        <li><b style="color: #11998E;">Unconscious Emotional Conflicts:</b> Repressed guilt, forbidden desires, and deep unresolved childhood psychic trauma lingering in the unconscious mind.</li>
      </ul>
    </div>

    <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #11998E; border-radius: 8px; padding: 14px 16px;">
      <b style="color: #11998E; font-size: 16px;">2. Objective (External / Physical &amp; Material) Causes:</b>
      <ul style="padding-left: 20px; line-height: 1.8; margin: 6px 0 0 0; color: #FFFFFF;">
        <li><b style="color: #11998E;">Severe Socio-Economic Deprivation:</b> Extreme poverty, chronic malnutrition, lack of adequate clothing, textbook scarcity, and congested squalid housing disrupt a student's normal cognitive and physical development.</li>
        <li><b style="color: #11998E;">Inadequate School Infrastructure:</b> Overcrowded, suffocating classrooms lacking basic ventilation, unhygienic sanitation, and absence of playgrounds or sports facilities.</li>
        <li><b style="color: #11998E;">Environmental Crises and Displacement:</b> Natural disasters, regional conflicts, loss of family livelihood, or sudden forced migrations destroying familiar support systems.</li>
      </ul>
    </div>

    <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #11998E; border-radius: 8px; padding: 14px 16px;">
      <b style="color: #11998E; font-size: 16px;">3. Social (Cultural &amp; Relational) Causes:</b>
      <ul style="padding-left: 20px; line-height: 1.8; margin: 6px 0 0 0; color: #FFFFFF;">
        <li><b style="color: #11998E;">Dysfunctional Home Climate:</b> Domestic violence, parental divorce, alcoholism, sibling favoritism, constant parental comparison, and excessively authoritarian or neglectful parenting.</li>
        <li><b style="color: #11998E;">Toxic School Environment:</b> Sarcastic ridicule by educators, cruel classroom bullying, corporal punishment, and cut-throat grading systems that label underperforming students as "worthless".</li>
        <li><b style="color: #11998E;">Cultural Conflicts &amp; Delinquent Peer Subcultures:</b> Clashing values between traditional home expectations and modern lifestyle trends, coupled with seduction into antisocial adolescent gangs.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- SECTION 3.4 -->
  <h2 style="color: #11998E; font-weight: bold; border-bottom: 2px solid #11998E; padding-bottom: 6px; margin-top: 35px;">3.4 Symptoms of Maladjustment</h2>
  ...
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(17, 153, 142, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #11998E; font-size: 16px;">1. Emotional Symptoms:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(17, 153, 142, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #11998E; font-size: 16px;">2. Behavioral and Antisocial Symptoms:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(17, 153, 142, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #11998E; font-size: 16px;">3. Physical and Psychosomatic Symptoms:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(17, 153, 142, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #11998E; font-size: 16px;">4. Scholastic and Cognitive Symptoms:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <!-- SECTION 3.5 -->
  <h2 style="color: #11998E; font-weight: bold; border-bottom: 2px solid #11998E; padding-bottom: 6px; margin-top: 35px;">3.5 Defense Mechanisms to Curb Maladjustment</h2>

  <p>When an individual's conscious problem-solving strategies fail to resolve frustration or overcome barriers, intense psychological anxiety threatens the integrity of the conscious self. To shield the <b style="color: #11998E;">Ego</b> from humiliation, guilt, and emotional disintegration, the human psyche activates unconscious psychological maneuvers termed <b style="color: #11998E;">Defense Mechanisms</b> (or Mental Mechanisms). While direct methods tackle the actual barrier, defense mechanisms operate by distorting or disguising reality. As prescribed in the official syllabus, four major defense mechanisms are examined in detail:</p>

  <!-- MECHANISM 1: RATIONALIZATION -->
  <h3 style="color: #11998E; font-weight: bold; margin-top: 24px;">(i) Rationalization with Examples</h3>
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #11998E; border-radius: 8px; padding: 14px 16px; margin: 14px 0;">
    <p style="margin: 0 0 8px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #11998E;">Concept &amp; Mechanism:</b> Rationalization is a cognitive defense mechanism where an individual invents socially acceptable, logical-sounding excuses to justify an ego-deflating failure, unacceptable desire, or embarrassing blunder, completely disguising the real, unflattering truth.
    </p>
    ...
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0; color: #FFFFFF;">
      <li>
        <b style="color: #11998E;">1. The 'Sour Grapes' Mechanism:</b> Derived from Aesop's fable where the fox, unable to jump high enough to reach the tempting grapes, walked away declaring that <i>"the grapes are sour anyway."</i><br />
      ...
      <li>
        <b style="color: #11998E;">2. The 'Sweet Lemon' Mechanism:</b> When an individual is forced to accept an inferior, disappointing, or painful outcome, they convince themselves and others that it is the best possible blessing in disguise.<br />
  ...
  <h3 style="color: #11998E; font-weight: bold; margin-top: 24px;">(ii) Sublimation with Examples</h3>
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #11998E; border-radius: 8px; padding: 14px 16px; margin: 14px 0;">
    <p style="margin: 0 0 8px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #11998E;">Concept &amp; Mechanism:</b> Sigmund Freud considered <b style="color: #11998E;">Sublimation</b> the highest, most mature, and universally constructive defense mechanism. It is the process of redirecting socially unacceptable, primitive, or destructive impulses (such as uninhibited aggression, hostility, or intense sexual libido) into culturally elevated, socially valuable, and intellectually creative activities.
    </p>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0; color: #FFFFFF;">
      <li>
        <b style="color: #11998E;">Real-Life Example 1 (Aggression &rarr; Sports/Martial Arts):</b> An adolescent boy with violent aggressive tendencies and frequent physical street fights is enrolled in boxing, martial arts, or military training. His dangerous aggression is transformed into disciplined championship athletic glory.
      </li>
      <li>
        <b style="color: #11998E;">Real-Life Example 2 (Libidinal/Emotional Frustration &rarr; Literary Genius):</b> An individual who suffers painful unrequited love or severe emotional rejection channels their yearning into writing timeless romantic poetry, painting masterpieces, or composing symphonies (legendarily seen in the life of poet-saint Goswami Tulsidas).
      </li>
    </ul>
  </div>

  <!-- MECHANISM 3: ESCAPISM -->
  <h3 style="color: #11998E; font-weight: bold; margin-top: 24px;">(iii) Escapism with Examples</h3>
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #11998E; border-radius: 8px; padding: 14px 16px; margin: 14px 0;">
    <p style="margin: 0 0 8px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #11998E;">Concept &amp; Mechanism:</b> <b style="color: #11998E;">Escapism</b> is the habitual psychological practice of seeking distraction, relief, and mental flight from unpleasant, stressful, or threatening real-world responsibilities through activities that provide immediate temporary gratification while evading the core problem.
    </p>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0; color: #FFFFFF;">
      <li>
        <b style="color: #11998E;">Real-Life Example 1 (Digital Bingeing):</b> A Class 12 student facing an overwhelming syllabus and upcoming board examinations spends 8 to 10 consecutive hours binge-watching digital web series or endlessly scrolling reels to avoid the severe anxiety of opening their physics textbook.
      </li>
      <li>
        <b style="color: #11998E;">Real-Life Example 2 (Sleep / Chemical Flight):</b> An individual caught in toxic domestic arguments retreats to their bedroom and sleeps for 14 hours a day, or turns to alcohol and sedatives to numb conscious awareness of their problems.
      </li>
    </ul>
  </div>

  <!-- MECHANISM 4: FANTASY AND DAYDREAMING -->
  <h3 style="color: #11998E; font-weight: bold; margin-top: 24px;">(iv) Fantasy and Daydreaming with Examples</h3>
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #11998E; border-radius: 8px; padding: 14px 16px; margin: 14px 0;">
    <p style="margin: 0 0 8px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #11998E;">Concept &amp; Mechanism:</b> <b style="color: #11998E;">Fantasy and Daydreaming</b> involves retreating into an imaginary internal dreamworld created by the mind, where all unfulfilled desires, romantic ambitions, power urges, and social triumphs are effortlessly and instantly gratified without facing real-world risks or labor.
    </p>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0; color: #FFFFFF;">
      <li>
        <b style="color: #11998E;">The 'Conquering Hero' Fantasy:</b> A shy, physically frail student who is routinely overlooked in school spends class hours daydreaming that they are a world-famous military general or Olympic gold medalist being wildly cheered by thousands of spectators.
      </li>
      <li>
        <b style="color: #11998E;">The 'Suffering Hero' (Martyr) Fantasy:</b> An adolescent who feels neglected by parents imagines falling terminally ill or dying tragically, visualizing their remorseful parents weeping uncontrollably at their bedside and begging for forgiveness.
      </li>
      <li>
        <b style="color: #11998E;">Educational Valuation:</b> While modest daydreaming can foster poetic imagination and harmless creative relaxation, chronic indulgence detaches the adolescent from reality, produces scholastic bankruptcy, and leads toward schizoid withdrawal.
      </li>
    </ul>
  </div>
  ...
  <div style="background: rgba(15, 23, 42, 0.85); border: 1.5px solid #11998E; border-radius: 10px; padding: 16px; margin: 25px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 17px; font-weight: bold; margin: 0 0 12px 0;">
    ...
    <div style="overflow-x: auto;">
      <table style="width: 100%; border-collapse: collapse; font-size: 14px; color: #F8FAFC;">
        <thead>
          <tr style="background: rgba(17, 153, 142, 0.25); border-bottom: 2px solid #11998E;">
        ...
        <tbody>
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
            <td style="padding: 10px; font-weight: bold; color: #11998E;">Conscious Awareness</td>
            <td style="padding: 10px;">Conscious, deliberate, and rational.</td>
            <td style="padding: 10px;">Largely unconscious and automatic.</td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
            <td style="padding: 10px; font-weight: bold; color: #11998E;">Target of Action</td>
          ...
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
            <td style="padding: 10px; font-weight: bold; color: #11998E;">Common Techniques</td>
          ...
          <tr>
            <td style="padding: 10px; font-weight: bold; color: #11998E;">Permanent Solution</td>
  ...
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #38EF7D; border-radius: 8px; padding: 14px 16px; margin: 20px 0;">
    <h4 style="color: #11998E; font-weight: bold; margin: 0 0 6px 0; font-size: 16px; font-weight: bold;">
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <div style="background: rgba(17, 153, 142, 0.08); border-left: 4px solid #11998E; border-radius: 6px; padding: 14px 16px; margin-bottom: 24px;">
    <h3 style="color: #11998E; font-weight: bold; margin: 0 0 6px 0; font-size: 18px; font-weight: bold;">🎯 Golden 25 Board Examination Q &amp; A Blueprint</h3>
  ...
  <!-- ======================================================================== -->
  <h2 style="color: #11998E; font-weight: bold; border-bottom: 2px solid #11998E; padding-bottom: 6px; margin-top: 25px;">
    Section A: Very Short Answer Questions (1 &amp; 2 Marks)
  </h2>

  <!-- Q1 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q1: Define Adjustment according to L. S. Shaffer.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      According to <b style="color: #11998E;">L. S. Shaffer</b>, <i>"Adjustment is the process by which a living organism maintains a balance between its needs and the circumstances that influence the satisfaction of these needs."</i>
    </p>
  </div>

  <!-- Q2 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q2: What is meant by Maladjustment?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #11998E;">Maladjustment</b> is the chronic inability or failure of an individual to adapt to their environment or resolve internal conflicts, resulting in persistent emotional friction, psychological distress, and antisocial or abnormal behavior.
    </p>
  </div>

  <!-- Q3 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q3: Differentiate between adjustment as a 'process' and adjustment as an 'achievement'.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      As a <b style="color: #11998E;">Process</b>, adjustment is an ongoing, lifelong cycle of coping with emerging needs and barriers. As an <b style="color: #11998E;">Achievement</b>, it is the actual state of efficiency, contentment, and psychological harmony attained by an individual at any given time.
    </p>
  </div>

  <!-- Q4 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q4: State two subjective causes of maladjustment in school children.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      (1) <b style="color: #11998E;">Physical sensory handicaps or speech defects</b> producing deep inferiority feelings; (2) <b style="color: #11998E;">Unrealistic level of aspiration</b> far exceeding innate intellectual capabilities.
    </p>
  </div>

  <!-- Q5 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q5: State two objective causes of maladjustment.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      (1) Extreme <b style="color: #11998E;">socio-economic destitution</b> and lack of basic learning materials; (2) <b style="color: #11998E;">Overcrowded, suffocating classrooms</b> lacking ventilation and recreational spaces.
    </p>
  </div>

  <!-- Q6 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q6: State two social causes of maladjustment originating from the family.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      (1) <b style="color: #11998E;">Broken homes or bitter parental discord</b> creating chronic emotional insecurity; (2) <b style="color: #11998E;">Authoritarian parenting</b> marked by harsh corporal punishment and unfair sibling comparison.
    </p>
  </div>

  <!-- Q7 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q7: Mention two psychosomatic or physical symptoms of maladjustment in students.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      (1) Habitual <b style="color: #11998E;">nail-biting, thumb-sucking, and facial tics</b>; (2) Psychosomatic <b style="color: #11998E;">morning headaches and stomach aches</b> occurring specifically on examination days.
    </p>
  </div>

  <!-- Q8 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q8: What are Defense Mechanisms? Who introduced this concept?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #11998E;">Defense Mechanisms</b> are unconscious psychological strategies used by the Ego to protect itself against overwhelming anxiety, guilt, and threats to self-esteem. The concept was pioneered by <b style="color: #11998E;">Sigmund Freud</b> and systematically expanded by his daughter <b style="color: #11998E;">Anna Freud</b>.
    </p>
  </div>

  <!-- Q9 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q9: Define Rationalization.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #11998E;">Rationalization</b> is a defense mechanism whereby an individual devises plausible, socially acceptable explanations or excuses to justify an embarrassing failure or unacceptable behavior, thereby protecting their personal pride.
    </p>
  </div>

  <!-- Q10 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q10: Distinguish between 'Sour Grapes' and 'Sweet Lemon' rationalization.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      In <b style="color: #11998E;">Sour Grapes</b>, an individual claims an unattainable goal was defective or undesirable anyway (e.g., <i>"I didn't want that scholarship, it involves too much headache"</i>). In <b style="color: #11998E;">Sweet Lemon</b>, an individual claims an unwanted, inferior situation they are forced to endure is wonderful (e.g., <i>"Failing this exam is great because it gave me extra free time"</i>).
    </p>
  </div>

  <!-- Q11 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q11: Why is Sublimation considered the most healthy and mature defense mechanism?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      Unlike other defense mechanisms that distort reality or evade duty, <b style="color: #11998E;">Sublimation</b> channels destructive, unacceptable impulses (such as raw aggression) into socially admired, productive, and culturally enriching avenues (like competitive sports, literature, or art).
    </p>
  </div>

  <!-- Q12 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q12: How does Fantasy/Daydreaming differ from Escapism?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #11998E;">Escapism</b> involves taking actual physical or behavioral flight from stressful tasks (e.g., excessive sleeping, bingeing social media), whereas <b style="color: #11998E;">Fantasy/Daydreaming</b> involves retreating into an internal mental universe of imaginary triumphs where unfulfilled desires are instantly gratified.
    </p>
  </div>
  ...
  <!-- ======================================================================== -->
  <h2 style="color: #11998E; font-weight: bold; border-bottom: 2px solid #11998E; padding-bottom: 6px; margin-top: 35px;">
    Section B: Short Answer Questions (4 Marks)
  </h2>

  <!-- Q13 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q13: Explain four major characteristics of a well-adjusted person.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      ...
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #11998E;">1. Accurate Self-Insight:</b> They hold a realistic assessment of their strengths and limitations, accepting themselves without destructive delusions of grandeur or inferiority.</li>
        <li><b style="color: #11998E;">2. Emotional Balance:</b> They maintain high frustration tolerance and emotional poise, responding to setbacks with rational problem-solving rather than childish rage.</li>
        <li><b style="color: #11998E;">3. Warm Social Relationships:</b> They can form intimate, empathetic friendships, cooperate harmoniously in teams, and respect the dignity of others.</li>
        <li><b style="color: #11998E;">4. Realistic Level of Aspiration:</b> They set academic and vocational goals that are challenging yet attainable, precisely calibrated to their abilities.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q14 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q14: Describe how dysfunctional parental attitudes contribute to child maladjustment.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      ...
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #11998E;">1. Authoritarian Harshness:</b> Constant corporal punishment, verbal belittling, and rigid rules breed either rebellious defiance or timid, chronic anxiety.</li>
        <li><b style="color: #11998E;">2. Toxic Sibling Comparison:</b> Repeatedly praising one child while humiliating another fosters deep feelings of inadequacy, jealousy, and sibling hostility.</li>
        <li><b style="color: #11998E;">3. Over-Protection:</b> Sheltering a child from every minor difficulty prevents them from developing self-reliance and coping resilience.</li>
        <li><b style="color: #11998E;">4. Marital Warfare:</b> Constant domestic fighting or domestic violence destroys the child's foundational sense of physical and emotional security.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q15 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q15: Discuss the symptoms of maladjustment classified under emotional, behavioral, and academic domains.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Maladjustment manifests across multiple interconnected life domains:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #11998E;">1. Emotional Domain:</b> Pervasive anxiety, extreme emotional lability, irrational phobias, depressive despondency, and persistent feelings of guilt and isolation.</li>
        <li><b style="color: #11998E;">2. Behavioral Domain:</b> Antisocial acts such as habitual lying, shoplifting or stealing from peers, bullying younger students, truancy, and vandalism.</li>
        <li><b style="color: #11998E;">3. Somatic/Physical Domain:</b> Motor tics, stammering, nail-biting, chronic fatigue, headaches, and insomnia prior to tests.</li>
        <li><b style="color: #11998E;">4. Academic Domain:</b> Unexplained precipitous drops in school marks, lack of classroom attention, procrastination, and excessive daydreaming.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q16 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q16: Explain the mechanism of Rationalization with two distinct real-life illustrations.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      ...
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #11998E;">1. The Psychological Function:</b> It protects the student's fragile ego and self-esteem from the painful admission of personal incompetence, laziness, or intellectual defeat.</li>
        <li><b style="color: #11998E;">2. Illustration 1 (Examination Failure):</b> A student who neglected their studies all semester and failed a mathematics paper claims: <i>"The teacher deliberately set an out-of-syllabus paper because she holds a personal grudge against me."</i></li>
        <li><b style="color: #11998E;">3. Illustration 2 (Sports Rejection):</b> An athlete dropped from the school football team declares: <i>"Football is a barbaric game that leads to knee fractures anyway; I am glad I can now focus on pure academics."</i> (Sour Grapes).</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q17 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q17: Analyze Sublimation as a positive coping strategy with suitable educational examples.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Sublimation stands out as the most socially and culturally beneficial defense mechanism:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #11998E;">1. Constructive Redirection:</b> Rather than repressing instinctual energy (which leads to neurosis), sublimation channels raw emotional and biological drives into creative, productive outlets.</li>
        <li><b style="color: #11998E;">2. Educational Example 1 (Aggression &rarr; Athletics):</b> An adolescent with high aggressive energy is encouraged to join rugby, track, or boxing, converting anti-social hostility into athletic teamwork and sportsmanship.</li>
        <li><b style="color: #11998E;">3. Educational Example 2 (Anxiety &rarr; Creative Arts):</b> A student troubled by deep emotional turmoil expresses their inner pain through painting, creative writing, or drama, producing profound works of art.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q18 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q18: Examine the psychological dangers of chronic Escapism and Daydreaming among adolescents.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      While occasional fantasy offers innocent relaxation, chronic escapism carries grave risks:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #11998E;">1. Severe Academic Bankruptcy:</b> Substituting real study with 8-hour digital scrolling or classroom daydreaming leads directly to examination failure and school drop-out.</li>
        <li><b style="color: #11998E;">2. Detachment from Objective Reality:</b> The adolescent begins to prefer the effortless, flattering world of fantasy over real-world effort, eroding their problem-solving muscle.</li>
        <li><b style="color: #11998E;">3. Deepening Inferiority:</b> Every time the student returns from their fantasy to the unchanged, unmastered reality, their sense of helplessness and self-disgust intensifies.</li>
        <li><b style="color: #11998E;">4. Risk of Schizoid Withdrawal:</b> Prolonged chronic daydreaming can blossom into clinical detachment, severe social alienation, and depressive withdrawal.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q19 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q19: Differentiate between Direct Problem-Solving Methods and Indirect Defense Mechanisms.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Adjustment methods fall into two distinctly contrasting operational categories:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #11998E;">1. Operational Level:</b> Direct methods are fully conscious, intentional, and logical, whereas defense mechanisms operate unconsciously and automatically.</li>
        <li><b style="color: #11998E;">2. Problem Target:</b> Direct methods attack the real environmental barrier (e.g., doubling study hours to pass), whereas defense mechanisms attack only the internal feeling of anxiety.</li>
        <li><b style="color: #11998E;">3. Handling of Reality:</b> Direct methods respect objective facts, whereas defense mechanisms distort, deny, or evade reality.</li>
        <li><b style="color: #11998E;">4. Ultimate Outcome:</b> Direct methods achieve genuine permanent adjustment; defense mechanisms provide temporary relief but chronic reliance results in maladjustment.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q20 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q20: How can an authoritarian school environment foster maladjustment among students?</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      A school should be a nourishing emotional ecosystem. An authoritarian school breeds maladjustment through:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #11998E;">1. Sarcastic Ridicule &amp; Public Shaming:</b> Teachers who humiliate struggling students in front of their peers shatter self-esteem, driving victims into truancy or mutism.</li>
        <li><b style="color: #11998E;">2. Rigid, Examination-Centric Pedagogy:</b> Obsession with rote memorization without room for creative play or athletic expression produces chronic exam terror.</li>
        <li><b style="color: #11998E;">3. Lack of Counseling &amp; Anti-Bullying Oversight:</b> Turning a blind eye to classroom bullying leaves vulnerable students defenseless, provoking severe anxiety disorders.</li>
        <li><b style="color: #11998E;">4. Suppression of Student Autonomy:</b> Dictatorial discipline prevents pupils from developing mature decision-making and democratic social skills.</li>
      </ul>
    </div>
  </div>
  ...
  <div style="margin: 22px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q21: Comprehensive Analysis of the Concept of Adjustment and the Complete Profile of a Well-Adjusted Personality.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #11998E;">I. Conceptual Foundations &amp; Definition:</b><br />
      ...
      <p><b style="color: #11998E;">II. The Six Pillars of a Well-Adjusted Personality:</b><br />
      (1) <b style="color: #11998E;">Accurate Self-Insight:</b> Clear awareness of personal strengths, flaws, and emotional triggers without self-deception.<br />
      (2) <b style="color: #11998E;">Emotional Poise:</b> High frustration tolerance, resilience in the face of temporary defeat, and freedom from violent emotional extremes.<br />
      (3) <b style="color: #11998E;">Warm Social Adaptability:</b> Capacity for empathy, genuine cooperative team spirit, and respect for divergent viewpoints.<br />
      (4) <b style="color: #11998E;">Congruent Level of Aspiration:</b> Alignment between goals and innate abilities, preventing chronic frustration.<br />
      (5) <b style="color: #11998E;">Flexibility in Novel Situations:</b> Readiness to adapt habits when life circumstances change.<br />
      (6) <b style="color: #11998E;">Guiding Moral Compass:</b> An integrated philosophy of life providing existential meaning, integrity, and resilience.</p>

      <p><b style="color: #11998E;">III. Educational Implications:</b><br />
  ...
  <!-- Q22 -->
  <div style="margin: 22px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q22: Detailed Classification and Analytical Exposition of the Causes of Maladjustment.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #11998E;">I. Introduction:</b><br />
      ...
      <p><b style="color: #11998E;">II. Three Interacting Dimensions of Causation:</b><br />
      (1) <b style="color: #11998E;">Subjective (Personal) Causes:</b> Severe physical deformities, sensory impairments, speech disorders (stammering), emotional instability, and an exaggerated level of aspiration that inevitably triggers crushing failure.<br />
      (2) <b style="color: #11998E;">Objective (Physical &amp; Material) Causes:</b> Destitution, severe poverty, lack of basic learning infrastructure, squalid living conditions, and sudden environmental crises or displacement that deprive a child of basic survival stability.<br />
      (3) <b style="color: #11998E;">Social (Relational &amp; Institutional) Causes:</b> Broken homes, domestic abuse, authoritarian child-rearing, sibling favoritism, ruthless classroom bullying, sarcastic educators, and delinquent peer subcultures.</p>

      <p><b style="color: #11998E;">III. Preventive Educational Interventions:</b><br />
  ...
  <!-- Q23 -->
  <div style="margin: 22px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q23: Exhaustive Examination of the Four Defense Mechanisms: Rationalization, Sublimation, Escapism, and Fantasy.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #11998E;">I. The Freudian Concept of Ego-Defense:</b><br />
      ...
      <p><b style="color: #11998E;">II. Detailed Analysis of the Four Prescribed Mechanisms:</b><br />
      (1) <b style="color: #11998E;">Rationalization:</b> Fabricating plausible, socially acceptable justifications for failure. Manifests as <i>Sour Grapes</i> (devaluing unattainable goals) or <i>Sweet Lemon</i> (overvaluing forced, poor outcomes).<br />
      (2) <b style="color: #11998E;">Sublimation:</b> The most mature mechanism, redirecting primitive aggressive or sexual drives into noble, creative, and socially commendable channels (e.g., athletics, painting, social work).<br />
      (3) <b style="color: #11998E;">Escapism:</b> Behavioral avoidance of uncomfortable tasks through excessive sleeping, digital binge-scrolling, or substance use, offering temporary relief while worsening the root problem.<br />
      (4) <b style="color: #11998E;">Fantasy &amp; Daydreaming:</b> Withdrawing into an imaginary world of instant wish-fulfillment (e.g., the 'Conquering Hero' or 'Suffering Martyr' fantasies). Chronic reliance paralyzes real-world initiative.</p>

      <p><b style="color: #11998E;">III. Pedagogical Guidance:</b><br />
  ...
  <!-- Q24 -->
  <div style="margin: 22px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q24: The Strategic Role of the Teacher and School Guidance Cell in Detecting and Remedying Maladjustment.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #11998E;">I. The Teacher as Frontline Mental Health Guardian:</b><br />
      ...
      <p><b style="color: #11998E;">II. Strategic Measures for Schools:</b><br />
      (1) <b style="color: #11998E;">Eradicating Humiliation:</b> Total abolition of sarcasm, public shaming, and corporal punishment, replacing them with praise and constructive feedback.<br />
      (2) <b style="color: #11998E;">Establishing Guidance &amp; Counseling Cells:</b> Appointing qualified school counselors who provide confidential, non-judgmental therapy and emotional guidance.<br />
      (3) <b style="color: #11998E;">Diversified Co-Curricular Programs:</b> Organizing sports, debates, drama, music, and art to provide constructive channels for sublimation.<br />
      (4) <b style="color: #11998E;">Active Parent-Teacher Partnerships:</b> Conducting regular, supportive parent-teacher dialogues to align home and school environments and eliminate toxic sibling comparisons.</p>

      <p><b style="color: #11998E;">III. Alignment with NEP 2020:</b><br />
  ...
  <!-- Q25 -->
  <div style="margin: 22px 0;">
    <h3 style="color: #11998E; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q25: Real-World Adolescent Case Study: Diagnostic Evaluation and Educational Remediation Strategy.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #11998E;">Case Profile:</b><br />
      ...
      <p><b style="color: #11998E;">I. Diagnostic Clinical Breakdown:</b><br />
      (1) <b style="color: #11998E;">Primary Stressor:</b> Severe domestic pressure and toxic comparison with his high-achieving brother.<br />
      (2) <b style="color: #11998E;">Manifested Symptoms:</b> Behavioral truancy, scholastic decline, and cognitive attention deficits.<br />
      (3) <b style="color: #11998E;">Active Defense Mechanisms:</b> Escapism (digital gaming), Fantasy (daydreaming), and Rationalization (sweet lemon comparison with historical dropouts).</p>

      <p><b style="color: #11998E;">II. Four-Step Psycho-Educational Remediation Strategy:</b><br />
      (1) <b style="color: #11998E;">Parental Counseling:</b> Sensitize Aarav's parents to immediately cease comparing him to his brother, adopting an authoritative parenting style with unconditional acceptance.<br />
      (2) <b style="color: #11998E;">Individual Counseling:</b> Help Aarav dismantle his rationalizations, confront his fear of failure, and rebuild self-worth.<br />
      (3) <b style="color: #11998E;">Direct Problem-Solving:</b> Break his syllabus into manageable daily study goals, applying structured time management to replace mobile escapism.<br />
      (4) <b style="color: #11998E;">Sublimation through Extracurriculars:</b> Encourage Aarav to channel his energy into school sports or technical clubs to experience genuine real-world achievement.</p>
    </div>
  </div>
