...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <div style="background: rgba(0, 198, 255, 0.06); border: 1.5px solid #00C6FF; border-radius: 12px; padding: 18px; margin-bottom: 25px;">
    <h2 class="text-center" style="color: #00C6FF; font-weight: bold; margin: 0 0 6px 0; font-size: 20px; font-weight: bold;">🧠 Quick Glossary &amp; Core Mental Health Concepts</h2>
    ...
    <div style="display: flex; flex-direction: column; gap: 12px;">
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #00C6FF; border-radius: 6px;">
        <b style="color: #00C6FF; font-size: 16px; display: block; margin-bottom: 4px;">1. Mental Health (WHO Definition):</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #00C6FF; border-radius: 6px;">
        <b style="color: #00C6FF; font-size: 16px; display: block; margin-bottom: 4px;">2. Mental Hygiene:</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #00C6FF; border-radius: 6px;">
        <b style="color: #00C6FF; font-size: 16px; display: block; margin-bottom: 4px;">3. Eustress vs. Distress:</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #00C6FF; border-radius: 6px;">
        <b style="color: #00C6FF; font-size: 16px; display: block; margin-bottom: 4px;">4. Body Dysmorphic Disorder (BDD):</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #00C6FF; border-radius: 6px;">
        <b style="color: #00C6FF; font-size: 16px; display: block; margin-bottom: 4px;">5. Authoritative Parenting:</b>
  ...
  <!-- SECTION 2.1 -->
  <h2 style="color: #00C6FF; font-weight: bold; border-bottom: 2px solid #00C6FF; padding-bottom: 6px; margin-top: 30px;">2.1 Mental health: definition and meaning</h2>
  ...
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(0, 198, 255, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-size: 16px;">1. Realistic Self-Insight and Self-Acceptance:</b>
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(0, 198, 255, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-size: 16px;">2. Emotional Equilibrium and Self-Regulation:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(0, 198, 255, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-size: 16px;">3. Warm and Satisfying Interpersonal Relationships:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(0, 198, 255, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-size: 16px;">4. Purposeful Living and Social Adaptability:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <!-- SECTION 2.2 -->
  <h2 style="color: #00C6FF; font-weight: bold; border-bottom: 2px solid #00C6FF; padding-bottom: 6px; margin-top: 35px;">2.2 Factors impacting mental health: stress, relationship disorders, dysmorphia, substance abuse</h2>
  ...
  <h3 style="color: #00C6FF; font-weight: bold; margin-top: 20px;">(i) Chronic Psychological Stress</h3>
  ...
  <h3 style="color: #00C6FF; font-weight: bold; margin-top: 24px;">(ii) Relationship Disorders &amp; Interpersonal Trauma</h3>
  ...
  <h3 style="color: #00C6FF; font-weight: bold; margin-top: 24px;">(iii) Body Dysmorphic Disorder (Dysmorphia / BDD)</h3>
  <p>In our contemporary era of Instagram, TikTok, and algorithmically curated photo-filtering apps, body image dissatisfaction has evolved into a clinical epidemic. <b style="color: #00C6FF;">Body Dysmorphia</b> is a psychiatric disorder where an adolescent becomes obsessively fixated on perceived minor or imaginary physical defects (e.g., skin blemishes, body weight, facial symmetry, height). This leads to compulsive mirror-checking, extreme social withdrawal, severe depression, and fatal eating disorders like <i>Anorexia Nervosa</i> and <i>Bulimia</i>.</p>

  <h3 style="color: #00C6FF; font-weight: bold; margin-top: 24px;">(iv) Substance Abuse &amp; Chemical Dependency</h3>
  ...
  <!-- SECTION 2.3 -->
  <h2 style="color: #00C6FF; font-weight: bold; border-bottom: 2px solid #00C6FF; padding-bottom: 6px; margin-top: 35px;">2.3 Causes of poor mental health: personal, social and hereditary</h2>
  ...
  <div style="display: flex; flex-direction: column; gap: 14px; margin: 18px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #00C6FF; border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-size: 16px;">1. Personal and Psychological Causes:</b>
      <ul style="padding-left: 20px; line-height: 1.8; margin: 6px 0 0 0; color: #FFFFFF;">
        <li><b style="color: #00C6FF;">Cognitive Distortions:</b> Habits of catastrophizing minor failures, all-or-nothing thinking, and extreme self-blame.</li>
        <li><b style="color: #00C6FF;">Physical Ill-Health &amp; Biochemical Imbalances:</b> Chronic illnesses, severe nutritional deficiencies, and neurotransmitter dysregulations (such as depleted serotonin, dopamine, or GABA levels in the brain).</li>
        <li><b style="color: #00C6FF;">Unresolved Childhood Trauma:</b> Repressed memories of physical, emotional, or sexual abuse that fester in the unconscious mind.</li>
      </ul>
    </div>

    <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #00C6FF; border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-size: 16px;">2. Social and Environmental Causes:</b>
      <ul style="padding-left: 20px; line-height: 1.8; margin: 6px 0 0 0; color: #FFFFFF;">
        <li><b style="color: #00C6FF;">Dysfunctional Home Atmosphere:</b> Broken homes, constant domestic warfare between parents, alcoholism in the family, or authoritarian parenting.</li>
        <li><b style="color: #00C6FF;">School-Related Stressors:</b> Vicious classroom bullying, public humiliation by insensitive teachers, cut-throat grade rankings, and lack of recreational sports.</li>
        <li><b style="color: #00C6FF;">Socio-Economic Deprivation &amp; Digital Overload:</b> Severe poverty, social discrimination, unemployment fear, and toxic digital social media culture.</li>
      </ul>
    </div>

    <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #00C6FF; border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-size: 16px;">3. Hereditary and Genetic Causes:</b>
      <ul style="padding-left: 20px; line-height: 1.8; margin: 6px 0 0 0; color: #FFFFFF;">
        <li><b style="color: #00C6FF;">Genetic Vulnerability:</b> Twin and family studies demonstrate that predispositions to clinical depression, bipolar affective disorder, schizophrenia, and anxiety disorders have strong genetic linkages.</li>
        <li><b style="color: #00C6FF;">Inborn Temperament:</b> Neurobiological differences in sensory reactivity and nervous system fragility inherited at birth.</li>
      </ul>
    </div>
  </div>

  <!-- SECTION 2.4 -->
  <h2 style="color: #00C6FF; font-weight: bold; border-bottom: 2px solid #00C6FF; padding-bottom: 6px; margin-top: 35px;">2.4 Stress in children and adolescents: meaning, causes, types and management</h2>

  <h3 style="color: #00C6FF; font-weight: bold; margin-top: 20px;">(i) Meaning of Stress and Hans Selye's Formulation</h3>
  <p>The concept of biological stress was pioneered by the Austrian-Canadian endocrinologist <b style="color: #00C6FF;">Hans Selye</b>, who defined stress as: <i>"The non-specific response of the body to any demand made upon it."</i> Any physical, emotional, or environmental stimulus that disrupts the body's internal physiological equilibrium (homeostasis) is termed a <b>Stressor</b>.</p>

  <h3 style="color: #00C6FF; font-weight: bold; margin-top: 24px;">(ii) The Two Fundamental Faces of Stress: Eustress vs. Distress</h3>
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(16, 185, 129, 0.4); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-weight: bold; font-size: 16px;">🌱 1. Eustress (Positive, Constructive Stress):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(239, 68, 68, 0.4); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-weight: bold; font-size: 16px;">⚡ 2. Distress (Negative, Destructive Stress):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <h3 style="color: #00C6FF; font-weight: bold; margin-top: 24px;">(iii) Multi-Tiered Stress Management Strategies</h3>
  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: #00C6FF;">1. Cognitive Restructuring:</b> Challenging irrational catastrophizing thoughts (e.g., replacing *"If I don't score 95%, my life is ruined"* with *"A test score is a feedback on my preparation, not a measure of my human worth"*).</li>
    <li><b style="color: #00C6FF;">2. Physiological Regulation:</b> Daily 30 minutes of aerobic exercise, diaphragmatic deep breathing (Pranayama), progressive muscle relaxation, and enforcing strict 8-hour sleep hygiene.</li>
    <li><b style="color: #00C6FF;">3. Time &amp; Task Management:</b> Breaking monolithic textbooks into manageable micro-goals (Pomodoro technique), eliminating digital multitasking during study hours.</li>
    <li><b style="color: #00C6FF;">4. Creative Emotional Catharsis:</b> Channeling stress into art, music, journaling, sports, and confiding in trusted counselors or friends.</li>
  </ul>

  <!-- SECTION 2.5 -->
  <h2 style="color: #00C6FF; font-weight: bold; border-bottom: 2px solid #00C6FF; padding-bottom: 6px; margin-top: 35px;">2.5 Role of parents and teachers in the achievement of sound mental health</h2>
  ...
  <h3 style="color: #00C6FF; font-weight: bold; margin-top: 20px;">(i) The Crucial Role of Parents</h3>
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 14px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(0, 198, 255, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-size: 16px;">1. Adopting an Authoritative Parenting Style:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(0, 198, 255, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-size: 16px;">2. Complete Elimination of Toxic Comparison:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(0, 198, 255, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-size: 16px;">3. Providing a Non-Judgmental Emotional Safety Valve:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <h3 style="color: #00C6FF; font-weight: bold; margin-top: 24px;">(ii) The Vital Role of Teachers &amp; School Environment</h3>
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 14px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(0, 198, 255, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-size: 16px;">1. Cultivating an Anxiety-Free, Joyful Classroom:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(0, 198, 255, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-size: 16px;">2. Early Detection of Warning Signals:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(0, 198, 255, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #00C6FF; font-size: 16px;">3. Institutionalizing Guidance Cells &amp; Peer Support:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <div style="background: rgba(0, 198, 255, 0.08); border-left: 4px solid #00C6FF; border-radius: 6px; padding: 14px 16px; margin-bottom: 24px;">
    <h3 style="color: #00C6FF; font-weight: bold; margin: 0 0 6px 0; font-size: 18px; font-weight: bold;">🎯 Golden 25 Board Examination Q &amp; A Blueprint</h3>
  ...
  <!-- ======================================================================== -->
  <h2 style="color: #00C6FF; font-weight: bold; border-bottom: 2px solid #00C6FF; padding-bottom: 6px; margin-top: 25px;">
    Section A: Very Short Answer Questions (1 &amp; 2 Marks)
  </h2>

  <!-- Q1 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q1: Define Mental Health according to the World Health Organization (WHO).</h3>
    <p style="color: #FFFFFF; margin: 0;">
      According to the <b style="color: #00C6FF;">WHO</b>, mental health is a state of mental wellbeing that enables individuals to realize their abilities, cope with the normal stresses of life, learn and work productively, and contribute fruitfully to their community.
    </p>
  </div>

  <!-- Q2 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q2: Who pioneered the modern 'Mental Hygiene' movement?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      The Mental Hygiene movement was pioneered by <b style="color: #00C6FF;">Clifford Beers</b> in the United States following the publication of his autobiographical book <i>"A Mind That Found Itself"</i> (1908).
    </p>
  </div>

  <!-- Q3 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q3: Differentiate between Eustress and Distress.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #00C6FF;">Eustress</b> is positive, constructive stress that motivates, focuses energy, and enhances performance. <b style="color: #00C6FF;">Distress</b> is negative, debilitating stress that exceeds coping capacity and causes physical, emotional, and mental breakdown.
    </p>
  </div>

  <!-- Q4 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q4: What is Body Dysmorphic Disorder (Dysmorphia)?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #00C6FF;">Body Dysmorphic Disorder (BDD)</b> is an obsessive mental health condition where an individual obsessively worries over perceived minor or non-existent flaws in their physical appearance, leading to severe anxiety and social avoidance.
    </p>
  </div>

  <!-- Q5 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q5: State two personal causes of poor mental health in students.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      (1) <b style="color: #00C6FF;">Low self-esteem</b> and persistent negative self-talk; (2) <b style="color: #00C6FF;">Unrealistic perfectionism</b> where a student views anything less than 100% as a catastrophic failure.
    </p>
  </div>

  <!-- Q6 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q6: State two social causes of poor mental health originating from the school environment.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      (1) Chronic <b style="color: #00C6FF;">peer bullying and cyber-harassment</b>; (2) Public <b style="color: #00C6FF;">humiliation or harsh sarcasm</b> by insensitive educators in front of classmates.
    </p>
  </div>

  <!-- Q7 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q7: Name two hereditary or genetic factors linked to mental health vulnerability.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      (1) Family genetic predisposition to <b style="color: #00C6FF;">bipolar and depressive disorders</b>; (2) Inborn <b style="color: #00C6FF;">neurobiological hypersensitivity</b> to environmental stressors.
    </p>
  </div>

  <!-- Q8 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q8: State the Yerkes-Dodson Law in relation to stress and academic performance.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      The <b style="color: #00C6FF;">Yerkes-Dodson Law</b> dictates an inverted-U relationship: performance increases with physiological or mental arousal (Eustress) up to an optimal peak, beyond which further stress (Distress) causes severe performance deterioration.
    </p>
  </div>

  <!-- Q9 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q9: What is substance abuse? Give two examples commonly observed among youth.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #00C6FF;">Substance abuse</b> is the harmful, compulsive, and hazardous use of psychoactive substances for mood alteration or anxiety escape. Common examples include nicotine/vaping and alcohol consumption.
    </p>
  </div>

  <!-- Q10 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q10: Mention two early behavioral warning signs of depression in an adolescent student.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      (1) Sudden <b style="color: #00C6FF;">withdrawal from friends and social activities</b>; (2) Drastic, unexplained <b style="color: #00C6FF;">drop in academic grades</b> accompanied by chronic fatigue and lethargy.
    </p>
  </div>

  <!-- Q11 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q11: How does social media contribute to body dysmorphia among teenagers?</h3>
    <p style="color: #FFFFFF; margin: 0;">
  ...
  <!-- Q12 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q12: State two physiological techniques for immediate stress reduction during examinations.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      (1) <b style="color: #00C6FF;">Diaphragmatic deep breathing</b> (4-7-8 breathing) to activate the parasympathetic nervous system; (2) <b style="color: #00C6FF;">Progressive muscle relaxation</b> to release physical tension from the neck and shoulders.
    </p>
  </div>
  ...
  <!-- ======================================================================== -->
  <h2 style="color: #00C6FF; font-weight: bold; border-bottom: 2px solid #00C6FF; padding-bottom: 6px; margin-top: 30px;">
  ...
  <div style="margin: 20px 0; background: rgba(15, 23, 42, 0.7); border-radius: 8px; padding: 14px 16px;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16.5px; margin-bottom: 8px;">Q13: Explain four major characteristics of a mentally healthy individual.</h3>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0;">
      <li><b style="color: #00C6FF;">1. Accurate Self-Perception and Acceptance:</b> Possesses realistic knowledge of one's abilities, weaknesses, and emotional triggers without self-hatred.</li>
      <li><b style="color: #00C6FF;">2. Emotional Stability and Resilience:</b> Remains composed during adversity, possesses healthy frustration tolerance, and bounces back from setbacks.</li>
      <li><b style="color: #00C6FF;">3. Satisfying Social Adjustment:</b> Capable of forming deep, empathetic, and trusting friendships while respecting personal boundaries.</li>
      <li><b style="color: #00C6FF;">4. Purposeful Self-Direction:</b> Sets clear, achievable goals, makes independent decisions, and works productively for community welfare.</li>
    </ul>
  </div>

  <!-- Q14 -->
  <div style="margin: 20px 0; background: rgba(15, 23, 42, 0.7); border-radius: 8px; padding: 14px 16px;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16.5px; margin-bottom: 8px;">Q14: Discuss how chronic stress and relationship disorders negatively affect adolescent wellbeing.</h3>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0;">
      <li><b style="color: #00C6FF;">1. Cognitive Impairment:</b> Sustained high cortisol levels shrink hippocampal synapses, crippling working memory, focus, and analytical problem-solving.</li>
      <li><b style="color: #00C6FF;">2. Psychosomatic Ailments:</b> Unrelieved stress causes chronic tension headaches, gastrointestinal upset, insomnia, and compromised immune resistance.</li>
      <li><b style="color: #00C6FF;">3. Attachment and Trust Breakdown:</b> Relational betrayal or domestic trauma produces emotional numbness, attachment disorders, and fear of intimacy.</li>
      <li><b style="color: #00C6FF;">4. Vulnerability to Depressive Illness:</b> Persistent relationship friction and chronic stress generate feelings of helplessness and clinical depression.</li>
    </ul>
  </div>

  <!-- Q15 -->
  <div style="margin: 20px 0; background: rgba(15, 23, 42, 0.7); border-radius: 8px; padding: 14px 16px;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16.5px; margin-bottom: 8px;">Q15: Analyze the impact of body dysmorphia and social media comparison on teenagers.</h3>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0;">
      <li><b style="color: #00C6FF;">1. Obsessive Preoccupation with Flaws:</b> Teenagers spend hours agonizing over minor skin blemishes, facial features, or body weight in mirrors.</li>
      <li><b style="color: #00C6FF;">2. Severe Social Avoidance:</b> Sufferers refuse to attend school, attend family functions, or appear in photographs due to intense appearance shame.</li>
      <li><b style="color: #00C6FF;">3. Trigger for Deadly Eating Disorders:</b> Fixation on achieving unrealistic digital aesthetics triggers Anorexia Nervosa and Bulimia.</li>
      <li><b style="color: #00C6FF;">4. Severe Depression and Self-Harm:</b> Body dysmorphia is statistically linked to high rates of severe adolescent depression and self-harming ideation.</li>
    </ul>
  </div>

  <!-- Q16 -->
  <div style="margin: 20px 0; background: rgba(15, 23, 42, 0.7); border-radius: 8px; padding: 14px 16px;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16.5px; margin-bottom: 8px;">Q16: Explain the hereditary and environmental causes of poor mental health.</h3>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0;">
      <li><b style="color: #00C6FF;">1. Genetic Predisposition:</b> Offspring of parents with clinical depression or bipolar disorders inherit genetic susceptibilities in brain neurochemistry.</li>
      <li><b style="color: #00C6FF;">2. Neurobiological Vulnerability:</b> Inherited variations in serotonin receptors and autonomic nervous system reactivity make certain children easily distressed.</li>
      <li><b style="color: #00C6FF;">3. Dysfunctional Family Environment:</b> Severe parental conflict, neglect, domestic violence, and emotional coldness undermine psychological security.</li>
      <li><b style="color: #00C6FF;">4. Toxic Academic Atmosphere:</b> Excessive academic pressure, lack of leisure, and school bullying trigger latent vulnerabilities into active illness.</li>
    </ul>
  </div>

  <!-- Q17 -->
  <div style="margin: 20px 0; background: rgba(15, 23, 42, 0.7); border-radius: 8px; padding: 14px 16px;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16.5px; margin-bottom: 8px;">Q17: Distinguish between acute stress and chronic stress with four points of difference.</h3>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0;">
      <li><b style="color: #00C6FF;">1. Duration:</b> Acute stress is short-lived (e.g., giving an oral speech); chronic stress persists continuously over months (e.g., toxic family home).</li>
      <li><b style="color: #00C6FF;">2. Physiological Recovery:</b> In acute stress, the body returns quickly to homeostasis; in chronic stress, the fight-or-flight system is perpetually activated.</li>
      <li><b style="color: #00C6FF;">3. Health Consequences:</b> Acute stress is manageable and rarely causes organic harm; chronic stress causes hypertension, depression, and immune burnout.</li>
      <li><b style="color: #00C6FF;">4. Performance Impact:</b> Acute stress can enhance momentary focus; chronic stress permanently impairs cognitive memory and executive functioning.</li>
    </ul>
  </div>

  <!-- Q18 -->
  <div style="margin: 20px 0; background: rgba(15, 23, 42, 0.7); border-radius: 8px; padding: 14px 16px;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16.5px; margin-bottom: 8px;">Q18: Describe four effective cognitive and behavioral stress management techniques for students.</h3>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0;">
      <li><b style="color: #00C6FF;">1. Cognitive Restructuring:</b> Replacing catastrophic, irrational thoughts (*"I will fail and ruin my future"*) with realistic, empowering affirmations.</li>
      <li><b style="color: #00C6FF;">2. Structured Time Management:</b> Using the Pomodoro technique (25 min study + 5 min rest) and breaking bulky syllabi into small, achievable steps.</li>
      <li><b style="color: #00C6FF;">3. Mindfulness Meditation and Pranayama:</b> Daily 15-minute conscious breath regulation to quiet the sympathetic nervous system and center focus.</li>
      <li><b style="color: #00C6FF;">4. Regular Aerobic Exercise:</b> Physical sports and brisk walking release endorphins that naturally neutralize cortisol and elevate mood.</li>
    </ul>
  </div>

  <!-- Q19 -->
  <div style="margin: 20px 0; background: rgba(15, 23, 42, 0.7); border-radius: 8px; padding: 14px 16px;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16.5px; margin-bottom: 8px;">Q19: Explain four concrete roles parents should play to safeguard their child's mental health.</h3>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0;">
      <li><b style="color: #00C6FF;">1. Unconditional Emotional Acceptance:</b> Reassuring the child that parental love is not contingent on board exam marks or class ranks.</li>
      <li><b style="color: #00C6FF;">2. Active, Empathetic Listening:</b> Setting aside undivided daily time to listen to the teenager's feelings without lecturing, mocking, or judging.</li>
      <li><b style="color: #00C6FF;">3. Avoiding Harmful Comparison:</b> Strictly refusing to compare the student with classmates, cousins, or siblings, respecting individual pacing.</li>
      <li><b style="color: #00C6FF;">4. Promoting Healthy Lifestyle Balance:</b> Enforcing regular sleep hours, nutritious meals, screen-time boundaries, and time for physical play.</li>
    </ul>
  </div>

  <!-- Q20 -->
  <div style="margin: 20px 0; background: rgba(15, 23, 42, 0.7); border-radius: 8px; padding: 14px 16px;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 16.5px; margin-bottom: 8px;">Q20: Discuss four proactive steps teachers can implement to foster a mentally healthy classroom.</h3>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0;">
      <li><b style="color: #00C6FF;">1. Creating a Fear-Free Learning Space:</b> Banning all sarcasm, ridicule, and corporal punishment, making mistakes a natural part of inquiry.</li>
      <li><b style="color: #00C6FF;">2. Spotting Early Warning Signs:</b> Vigilantly identifying students exhibiting sudden withdrawal, extreme fatigue, or falling grades and offering gentle support.</li>
      <li><b style="color: #00C6FF;">3. Integrating Life Skills &amp; Peer Collaboration:</b> Using group discussions and collaborative projects to build communication, empathy, and mutual respect.</li>
      <li><b style="color: #00C6FF;">4. Facilitating Professional Guidance:</b> Connecting struggling students with the school guidance counselor without attaching social stigma.</li>
    </ul>
  </div>
  ...
  <div style="margin: 24px 0; background: rgba(15, 23, 42, 0.75); border-radius: 10px; padding: 18px 20px;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 18px; margin-bottom: 12px;">Q21: What is Mental Health? Discuss in detail its meaning, positive criteria, and the critical importance of mental hygiene in school education.</h3>
    <div style="line-height: 1.8; color: #FFFFFF;">
      <p><b style="color: #00C6FF;">1. Introduction &amp; Concept:</b><br/>
      ...
      <p><b style="color: #00C6FF;">2. Core Positive Criteria of Mental Health:</b></p>
      <ul style="padding-left: 20px;">
        <li><b style="color: #00C6FF;">(a) Realistic Self-Acceptance:</b> Objective awareness of personal strengths and limitations without toxic inferiority.</li>
        <li><b style="color: #00C6FF;">(b) Emotional Self-Regulation:</b> Freedom from overwhelming anxieties, constructive handling of anger, and resilience during crises.</li>
        <li><b style="color: #00C6FF;">(c) Social Empathy &amp; Trust:</b> Capacity to form enduring, respectful relationships and engage in collaborative teamwork.</li>
        <li><b style="color: #00C6FF;">(d) Meaningful Productivity:</b> Channeling mental faculties toward productive learning, career goals, and civic contribution.</li>
      </ul>

      <p><b style="color: #00C6FF;">3. Role of Mental Hygiene in Schools:</b><br/>
  ...
  <!-- Q22 -->
  <div style="margin: 24px 0; background: rgba(15, 23, 42, 0.75); border-radius: 10px; padding: 18px 20px;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 18px; margin-bottom: 12px;">Q22: Critically examine the various factors impacting adolescent mental health (stress, relationship disorders, dysmorphia, and substance abuse) in the contemporary digital era.</h3>
    <div style="line-height: 1.8; color: #FFFFFF;">
      <p><b style="color: #00C6FF;">1. Introduction:</b><br/>
      ...
      <p><b style="color: #00C6FF;">2. Analysis of the Four Critical Factors:</b></p>
      <ul style="padding-left: 20px;">
        <li><b style="color: #00C6FF;">(a) Academic Stress &amp; Burnout:</b> Hyper-competitive exam coaching culture, parental perfectionism, and fear of failure subject teenagers to chronic cognitive overload, leading to insomnia, anxiety, and depressive episodes.</li>
        <li><b style="color: #00C6FF;">(b) Relationship Disorders:</b> Fragmented family structures, parental conflict, and superficial digital connections rob adolescents of genuine emotional anchors, inducing chronic loneliness and attachment trauma.</li>
        <li><b style="color: #00C6FF;">(c) Body Dysmorphia &amp; Digital Comparison:</b> Filter-driven social media platforms promote impossible aesthetic ideals, causing adolescents to obsessively despise their physical bodies, triggering eating disorders and self-loathing.</li>
        <li><b style="color: #00C6FF;">(d) Substance Abuse:</b> Vaping, alcohol, and pharmaceutical drug misuse often begin as maladaptive escapes from mental pain, but quickly cause neurological damage, addiction, and personal destruction.</li>
      </ul>

      <p><b style="color: #00C6FF;">3. Conclusion:</b><br/>
  ...
  <!-- Q23 -->
  <div style="margin: 24px 0; background: rgba(15, 23, 42, 0.75); border-radius: 10px; padding: 18px 20px;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 18px; margin-bottom: 12px;">Q23: Define Stress. Explain in detail the causes, types (Eustress vs Distress), physiological effects, and multi-dimensional management strategies for school students.</h3>
    <div style="line-height: 1.8; color: #FFFFFF;">
      <p><b style="color: #00C6FF;">1. Definition &amp; Types:</b><br/>
      ...
      <p><b style="color: #00C6FF;">2. Causes of Adolescent Stress:</b><br/>
      ...
      <p><b style="color: #00C6FF;">3. Physiological &amp; Psychological Effects:</b><br/>
      ...
      <p><b style="color: #00C6FF;">4. Multi-Dimensional Management Strategies:</b></p>
      <ul style="padding-left: 20px;">
        <li><b style="color: #00C6FF;">(a) Cognitive:</b> Cognitive reframing, positive self-talk, and realistic goal setting.</li>
        <li><b style="color: #00C6FF;">(b) Behavioral:</b> Pomodoro study intervals, disciplined sleep schedules, and prioritizing tasks.</li>
        <li><b style="color: #00C6FF;">(c) Physiological:</b> Aerobic sports, diaphragmatic Pranayama, and progressive muscle relaxation.</li>
        <li><b style="color: #00C6FF;">(d) Emotional:</b> Seeking counseling, peer sharing, and creative artistic expression.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q24 -->
  <div style="margin: 24px 0; background: rgba(15, 23, 42, 0.75); border-radius: 10px; padding: 18px 20px;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 18px; margin-bottom: 12px;">Q24: Discuss the comprehensive role of the home, school, parents, and teachers in the prevention of mental health disorders and the achievement of sound emotional wellbeing.</h3>
    <div style="line-height: 1.8; color: #FFFFFF;">
      <p><b style="color: #00C6FF;">1. The Home &amp; Parents as the Primary Emotional Sanctuary:</b><br/>
      ...
      <p><b style="color: #00C6FF;">2. The School &amp; Teachers as the Social Shield:</b><br/>
      Teachers spend maximum daytime hours with adolescents and serve as frontline guardians:</p>
      <ul style="padding-left: 20px;">
        <li><b style="color: #00C6FF;">(a) Anxiety-Free Classroom Culture:</b> Eradicating humiliation, sarcasm, and corporal punishment; treating mistakes as natural learning steps.</li>
        <li><b style="color: #00C6FF;">(b) Early Screening:</b> Identifying subtle behavioral shifts (withdrawal, sudden grade drops, uncharacteristic lethargy) and initiating gentle support.</li>
        <li><b style="color: #00C6FF;">(c) Institutional Counseling:</b> Establishing dedicated, confidential school guidance cells and mental health clubs.</li>
        <li><b style="color: #00C6FF;">(d) Holistic Life Skills:</b> Promoting the WHO 10 core life skills (stress management, empathy, critical thinking) through co-curricular activities.</li>
      </ul>
  ...
  <div style="margin: 24px 0; background: rgba(15, 23, 42, 0.75); border-radius: 10px; padding: 18px 20px; border-left: 4px solid #00C6FF;">
    <h3 style="color: #00C6FF; font-weight: bold; font-size: 18px; margin-bottom: 12px;">Q25: [Board Examination Case Study] Read the real-world adolescent psychological case scenario below and answer all sub-questions:</h3>
    ...
    <div style="line-height: 1.8; color: #FFFFFF;">
      <p><b style="color: #00C6FF;">(a) Identify the primary stressors and psychological disorders affecting Aarav. (1.5 Marks)</b><br/>
      ...
      <p><b style="color: #00C6FF;">(b) What mistakes did the parents commit from a mental health perspective? (1.5 Marks)</b><br/>
      ...
      <p><b style="color: #00C6FF;">(c) Outline the immediate steps the school teacher and counselor must take. (1.5 Marks)</b><br/>
      ...
      <p><b style="color: #00C6FF;">(d) Formulate a 3-point remedial mental health recovery plan for Aarav. (1.5 Marks)</b><br/>
