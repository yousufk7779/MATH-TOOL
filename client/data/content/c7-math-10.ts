...
export const c7Math10: ChapterContent = {
    ...
    htmlExercises: {
        ...
        <style>
            ...
            .sol-card { background: #1E1E2E; border-radius: 12px; border-left: 5px solid #673AB7; margin-bottom: 25px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.2); }
            .question-header { padding: 15px; color: #673AB7; font-weight: bold; border-bottom: 1px solid rgba(255,255,255,0.05); line-height: 1.6; text-align: justify; }
        ...
        <div class="container">
            <div class="sol-card">
                <div class="question-header">1. Get the algebraic expressions in the following cases using variables, constants and arithmetic operations. <br/>(i) Subtraction of z from y. <br/>(ii) One-half of the sum of numbers x and y. <br/>(v) Numbers x and y both squared and added.</div>
                <div class="sol-body">
                    <div class="sol-step"><b>(i) Subtraction of z from y:</b> <span class="ans-highlight">y - z</span></div>
                    <div class="sol-step"><b>(ii) One-half of the sum of numbers x and y:</b> <span class="ans-highlight"><div class="frac"><span class="num">x + y</span><span class="den">2</span></div></span></div>
                    <div class="sol-step"><b>(v) Numbers x and y both squared and added:</b> <span class="ans-highlight">x² + y²</span></div>
                </div>
            </div>

            <div class="sol-card">
                <div class="question-header">2. (i) Identify the terms and their factors in the following expressions. Show the terms and factors by tree diagrams. <br/>(a) x - 3 <br/>(b) 1 + x + x²</div>
                <div class="sol-body">
            ...
            <div class="sol-card">
                <div class="question-header">3. Identify the numerical coefficients of terms (other than constants) in the following expressions: <br/>(i) 5 - 3t² <br/>(ii) 1.2a + 0.8b</div>
                <div class="sol-body">
            ...
            <div class="sol-card">
                <div class="question-header">5. Classify into monomials, binomials and trinomials: <br/>(i) 4y - 7z <br/>(ii) y² <br/>(iii) x + y - xy</div>
                <div class="sol-body">
            ...
            <div class="sol-card">
                <div class="question-header">6. State whether a given pair of terms is of like or unlike terms: <br/>(i) 1, 100 <br/>(iii) -29x, -29y <br/>(iv) 14xy, 42yx</div>
                <div class="sol-body">
        ...
        <div class="container">
            <div class="sol-card">
                <div class="question-header">1. Simplify combining like terms: <br/>(i) 21b - 32 + 7b - 20b <br/>(ii) -z² + 13z² - 5z + 7z³ - 15z <br/>(iii) p - (p - q) - q - (q - p)</div>
                <div class="sol-body">
            ...
            <div class="sol-card">
                <div class="question-header">2. Add: <br/>(i) 3mn, -5mn, 8mn, -4mn <br/>(ii) t - 8tz, 3tz - z, z - t</div>
                <div class="sol-body">
            ...
            <div class="sol-card">
                <div class="question-header">3. Subtract: <br/>(i) -5y² from y² <br/>(ii) 6xy from -12xy <br/>(iii) (a - b) from (a + b)</div>
                <div class="sol-body">
        ...
        <div class="container">
            <div class="sol-card">
                <div class="question-header">1. If m = 2, find the value of: <br/>(i) m - 2 <br/>(ii) 3m - 5 <br/>(iv) 3m² - 2m - 7</div>
                <div class="sol-body">
            ...
            <div class="sol-card">
                <div class="question-header">2. If p = -2, find the value of: <br/>(i) 4p + 7 <br/>(ii) -3p² + 4p + 7</div>
                <div class="sol-body">
            ...
            <div class="sol-card">
                <div class="question-header">4. If a = 2, b = -2, find the value of: <br/>(i) a² + b² <br/>(ii) a² + ab + b²</div>
                <div class="sol-body">
            ...
            <div class="sol-card">
                <div class="question-header">6. Simplify the expressions and find the value if x is equal to 2: <br/>(i) x + 7 + 4(x - 5) <br/>(ii) 3(x + 2) + 5x - 7</div>
                <div class="sol-body">
            ...
            <div class="sol-card">
                <div class="question-header">10. Simplify the expression and find its value when a = 5 and b = -3: <br/> 2(a² + ab) + 3 - ab</div>
                <div class="sol-body">
        ...
        <div class="container">
            <div class="sol-card">
                <div class="question-header">1. Observe the patterns of digits made from line segments of equal length. How many segments are required to form 5, 10, 100 digits of the kind 6, 4, 8?</div>
                <div class="sol-body">
