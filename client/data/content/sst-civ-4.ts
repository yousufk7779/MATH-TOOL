...
export const sstCiv4: ChapterContent = {
  ...
  mcqs: [
    ...
    },
    {
      id: "sc4-mcq-7",
      question:
        "What is a signed document submitted to an officer where a person makes a sworn statement?",
