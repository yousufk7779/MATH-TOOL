...
export const c7Sci8: ChapterContent = {
  id: "c7-sci-8",
  number: 8,
  title: "Reproduction in Plants",
  introduction:
    '<span style="color: #FFFFFF;">Reproduction is the process by which living organisms produce new individuals of their own kind. In plants, reproduction can be asexual (without seeds) or sexual (with seeds).</span>',
  definitions: [
    {
      term: "Basic Concepts",
      description:
        '<span style="color: #FFFFFF;">Asexual reproduction methods include budding, fragmentation, and spore formation. Sexual reproduction involves the fusion of male and female gametes in flowers.</span>',
    },
  ],
  keyPoints: [
