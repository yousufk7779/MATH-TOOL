...
export const c7Civ6: ChapterContent = {
  ...
  mcqs: [
    ...
    },
    {
      ...
      options: [
        "Planning a meeting",
        "Media choosing which stories to focus on",
    ...
    },
    {
      id: "c7c6-mcq-6",
      question:
        "Khabar Lahriya is a newspaper run by Dalit women in which state?",
    ...
    },
    {
      ...
      options: [
        "Fund the media",
        "Stop media from showing certain stories",
        "Hire journalists",
        "Sell newspapers",
      ],
      correctAnswer: "b",
