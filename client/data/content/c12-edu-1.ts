// Class 12 Education Unit 1: Philosophical Foundations of Education (Official Syllabus - 10 Marks)
// Comprehensive Deep Reference Textbook & Golden 25 Board Examination Blueprint
// Theme Color: #FF512F (Sunset Coral / Fiery Rose matching Chapter 1)
...
export const c12Edu1HtmlOverview = `
<style>
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <!-- STANDALONE CLEAN DIAGRAM 1: THE INTERDEPENDENT COIN (SCIENCE-STYLE WHITE BG) -->
  <div style="background: rgba(15, 23, 42, 0.9); border: 1.5px solid rgba(255, 81, 47, 0.4); border-radius: 10px; padding: 14px 16px; margin: 25px 0; box-shadow: 0 4px 20px rgba(0,0,0,0.35); text-align: center;">
    <div style="display: flex; justify-content: center; align-items: center; background: #FFFDF8; border-radius: 8px; padding: 14px; border: 1px solid rgba(255,255,255,0.2); margin: 0 auto; max-width: 480px;">
      <svg viewBox="0 0 440 220" style="width: 100%; max-width: 460px; height: auto;" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Coin Side 1: Philosophy (Left) -->
        <g transform="translate(40, 25)">
          <circle cx="75" cy="75" r="65" fill="#FFF1F2" stroke="#FF512F" stroke-width="2.5" />
          <text x="75" y="55" font-size="22" text-anchor="middle">🧭</text>
          <text x="75" y="80" font-size="13" font-weight="bold" fill="#9F1239" text-anchor="middle">PHILOSOPHY</text>
          <text x="75" y="98" font-size="10.5" font-weight="600" fill="#0F172A" text-anchor="middle">Contemplative Side</text>
          <text x="75" y="114" font-size="9" fill="#64748B" text-anchor="middle">Ideals &bull; Aims &bull; Values</text>
        </g>

        <!-- Connecting Double Arrows & Text -->
        <g transform="translate(190, 75)">
          <path d="M 0 10 L 60 10" stroke="#FF512F" stroke-width="3" fill="none" />
          <polygon points="60,10 52,5 52,15" fill="#FF512F" />
          <path d="M 60 35 L 0 35" stroke="#2563EB" stroke-width="3" fill="none" />
          <polygon points="0,35 8,30 8,40" fill="#2563EB" />
          <text x="30" y="28" font-size="10" font-weight="bold" fill="#0F172A" text-anchor="middle">Two Sides of</text>
          <text x="30" y="52" font-size="9.5" font-weight="bold" fill="#475569" text-anchor="middle">One Coin</text>
        </g>

        <!-- Coin Side 2: Education (Right) -->
        <g transform="translate(250, 25)">
          <circle cx="75" cy="75" r="65" fill="#EFF6FF" stroke="#2563EB" stroke-width="2.5" />
          <text x="75" y="55" font-size="22" text-anchor="middle">⚙️</text>
          <text x="75" y="80" font-size="13" font-weight="bold" fill="#1E40AF" text-anchor="middle">EDUCATION</text>
          <text x="75" y="98" font-size="10.5" font-weight="600" fill="#0F172A" text-anchor="middle">Dynamic Action Side</text>
          <text x="75" y="114" font-size="9" fill="#64748B" text-anchor="middle">Practice &bull; Method &bull; Life</text>
        </g>

        <!-- Bottom Caption -->
        <text x="220" y="195" font-size="11" font-weight="bold" fill="#0F172A" text-anchor="middle">"Education is the dynamic side of philosophy" &mdash; Sir John Adams</text>
      </svg>
    </div>
    <div style="color: #CBD5E1; font-size: 14px; text-align: center; margin-top: 10px; line-height: 1.5; font-weight: 500;">
      💡 The Inseparable Symbiosis: Philosophy provides the contemplative theoretical compass; Education provides the practical dynamic vehicle to manifest those ideals in human living.
    </div>
  </div>
  ...
  <div style="background: rgba(15, 23, 42, 0.9); border: 1.5px solid rgba(255, 81, 47, 0.4); border-radius: 10px; padding: 14px 16px; margin: 25px 0; box-shadow: 0 4px 20px rgba(0,0,0,0.35); text-align: center;">
    <div style="display: flex; justify-content: center; align-items: center; background: #FFFDF8; border-radius: 8px; padding: 14px; border: 1px solid rgba(255,255,255,0.2); margin: 0 auto; max-width: 500px;">
      <svg viewBox="0 0 480 270" style="width: 100%; max-width: 470px; height: auto;" xmlns="http://www.w3.org/2000/svg">
        <rect x="0" y="0" width="480" height="270" fill="#FFFDF8" rx="8" />

        <!-- Vertical Divider -->
        <line x1="240" y1="15" x2="240" y2="255" stroke="#CBD5E1" stroke-width="1.5" stroke-dasharray="4,4" />

        <!-- Left Column: IDEALISM -->
        <g transform="translate(15, 15)">
          <rect x="0" y="0" width="205" height="32" rx="6" fill="#FF512F" />
          <text x="102" y="21" font-size="13" font-weight="bold" fill="#FFFFFF" text-anchor="middle">IDEALISM (Plato / Kant)</text>
          
          <!-- Metaphysics -->
          <rect x="0" y="42" width="205" height="42" rx="4" fill="#FFF1F2" stroke="#FF512F" stroke-width="1.2" />
          <text x="102" y="58" font-size="10.5" font-weight="bold" fill="#9F1239" text-anchor="middle">Spiritual Metaphysics</text>
          <text x="102" y="73" font-size="9" fill="#475569" text-anchor="middle">Mind/Spirit is supreme &bull; Ideas eternal</text>

          <!-- Aims & Curriculum -->
          <rect x="0" y="92" width="205" height="46" rx="4" fill="#FFF1F2" stroke="#FF512F" stroke-width="1.2" />
          <text x="102" y="108" font-size="10.5" font-weight="bold" fill="#9F1239" text-anchor="middle">Self-Realization &bull; Values</text>
          <text x="102" y="122" font-size="9" fill="#475569" text-anchor="middle">Satyam, Shivam, Sundaram</text>
          <text x="102" y="132" font-size="8.5" fill="#64748B" text-anchor="middle">Humanities, Ethics, Philosophy</text>

          <!-- Pedagogy & Teacher -->
          <rect x="0" y="146" width="205" height="48" rx="4" fill="#FFF1F2" stroke="#FF512F" stroke-width="1.2" />
          <text x="102" y="162" font-size="10.5" font-weight="bold" fill="#9F1239" text-anchor="middle">Teacher-Centric Pedagogy</text>
          <text x="102" y="176" font-size="9" fill="#475569" text-anchor="middle">Socratic Dialogue &bull; Lecture</text>
          <text x="102" y="188" font-size="8.5" fill="#64748B" text-anchor="middle">Teacher is central divine guide (Guru)</text>

          <!-- Discipline -->
          <rect x="0" y="202" width="205" height="34" rx="4" fill="#FFF1F2" stroke="#FF512F" stroke-width="1.2" />
          <text x="102" y="217" font-size="10" font-weight="bold" fill="#9F1239" text-anchor="middle">Impressionistic Discipline</text>
          <text x="102" y="229" font-size="8.5" fill="#475569" text-anchor="middle">Inner moral restraint through example</text>
        </g>

        <!-- Right Column: PRAGMATISM -->
        <g transform="translate(260, 15)">
          <rect x="0" y="0" width="205" height="32" rx="6" fill="#2563EB" />
          <text x="102" y="21" font-size="13" font-weight="bold" fill="#FFFFFF" text-anchor="middle">PRAGMATISM (Dewey)</text>
          
          <!-- Metaphysics -->
          <rect x="0" y="42" width="205" height="42" rx="4" fill="#EFF6FF" stroke="#2563EB" stroke-width="1.2" />
          <text x="102" y="58" font-size="10.5" font-weight="bold" fill="#1E40AF" text-anchor="middle">Dynamic Reality</text>
          <text x="102" y="73" font-size="9" fill="#475569" text-anchor="middle">Reality is in the making &bull; Truth works</text>

          <!-- Aims & Curriculum -->
          <rect x="0" y="92" width="205" height="46" rx="4" fill="#EFF6FF" stroke="#2563EB" stroke-width="1.2" />
          <text x="102" y="108" font-size="10.5" font-weight="bold" fill="#1E40AF" text-anchor="middle">Social Efficiency &bull; Growth</text>
          <text x="102" y="122" font-size="9" fill="#475569" text-anchor="middle">Reconstruction of experience</text>
          <text x="102" y="132" font-size="8.5" fill="#64748B" text-anchor="middle">Activity, Science, Utility, Crafts</text>

          <!-- Pedagogy & Teacher -->
          <rect x="0" y="146" width="205" height="48" rx="4" fill="#EFF6FF" stroke="#2563EB" stroke-width="1.2" />
          <text x="102" y="162" font-size="10.5" font-weight="bold" fill="#1E40AF" text-anchor="middle">Child &amp; Activity-Centric</text>
          <text x="102" y="176" font-size="9" fill="#475569" text-anchor="middle">Learning by Doing &bull; Project Method</text>
          <text x="102" y="188" font-size="8.5" fill="#64748B" text-anchor="middle">Teacher is facilitator &bull; Friend &bull; Partner</text>

          <!-- Discipline -->
          <rect x="0" y="202" width="205" height="34" rx="4" fill="#EFF6FF" stroke="#2563EB" stroke-width="1.2" />
          <text x="102" y="217" font-size="10" font-weight="bold" fill="#1E40AF" text-anchor="middle">Social / Emancipatory Discipline</text>
          <text x="102" y="229" font-size="8.5" fill="#475569" text-anchor="middle">Cooperation in group projects</text>
        </g>
      </svg>
    </div>
    <div style="color: #CBD5E1; font-size: 14px; text-align: center; margin-top: 10px; line-height: 1.5; font-weight: 500;">
      💡 Architectural Contrast: Idealism grounds education in timeless spiritual ideals and teacher-guided moral wisdom; Pragmatism grounds education in dynamic social experimentation and student-driven action.
    </div>
  </div>

  <!-- STANDALONE CLEAN DIAGRAM 3: THE 4 STAGES OF PROJECT METHOD (SCIENCE-STYLE WHITE BG) -->
  <div style="background: rgba(15, 23, 42, 0.9); border: 1.5px solid rgba(37, 99, 235, 0.4); border-radius: 10px; padding: 14px 16px; margin: 25px 0; box-shadow: 0 4px 20px rgba(0,0,0,0.35); text-align: center;">
    <div style="display: flex; justify-content: center; align-items: center; background: #FFFDF8; border-radius: 8px; padding: 14px; border: 1px solid rgba(255,255,255,0.2); margin: 0 auto; max-width: 500px;">
      <svg viewBox="0 0 480 140" style="width: 100%; max-width: 470px; height: auto;" xmlns="http://www.w3.org/2000/svg">
        <rect x="0" y="0" width="480" height="140" fill="#FFFDF8" rx="8" />

        <!-- Stage 1: Purposing -->
        <g transform="translate(10, 20)">
          <rect x="0" y="0" width="100" height="95" rx="6" fill="#EFF6FF" stroke="#2563EB" stroke-width="1.8" />
          <circle cx="50" cy="22" r="14" fill="#2563EB" />
          <text x="50" y="27" font-size="12" font-weight="bold" fill="#FFFFFF" text-anchor="middle">1</text>
          <text x="50" y="52" font-size="11" font-weight="bold" fill="#1E40AF" text-anchor="middle">PURPOSING</text>
          <text x="50" y="68" font-size="8.5" fill="#475569" text-anchor="middle">Selecting the goal</text>
          <text x="50" y="80" font-size="8.5" fill="#475569" text-anchor="middle">from child's need</text>
        </g>

        <!-- Arrow 1 -->
        <path d="M 115 67 L 128 67" stroke="#2563EB" stroke-width="2.5" fill="none" />
        <polygon points="128,67 122,63 122,71" fill="#2563EB" />

        <!-- Stage 2: Planning -->
        <g transform="translate(130, 20)">
          <rect x="0" y="0" width="100" height="95" rx="6" fill="#EFF6FF" stroke="#2563EB" stroke-width="1.8" />
          <circle cx="50" cy="22" r="14" fill="#2563EB" />
          <text x="50" y="27" font-size="12" font-weight="bold" fill="#FFFFFF" text-anchor="middle">2</text>
          <text x="50" y="52" font-size="11" font-weight="bold" fill="#1E40AF" text-anchor="middle">PLANNING</text>
          <text x="50" y="68" font-size="8.5" fill="#475569" text-anchor="middle">Blueprint of steps,</text>
          <text x="50" y="80" font-size="8.5" fill="#475569" text-anchor="middle">tasks, &amp; duties</text>
        </g>

        <!-- Arrow 2 -->
        <path d="M 235 67 L 248 67" stroke="#2563EB" stroke-width="2.5" fill="none" />
        <polygon points="248,67 242,63 242,71" fill="#2563EB" />

        <!-- Stage 3: Executing -->
        <g transform="translate(250, 20)">
          <rect x="0" y="0" width="100" height="95" rx="6" fill="#EFF6FF" stroke="#2563EB" stroke-width="1.8" />
          <circle cx="50" cy="22" r="14" fill="#2563EB" />
          <text x="50" y="27" font-size="12" font-weight="bold" fill="#FFFFFF" text-anchor="middle">3</text>
          <text x="50" y="52" font-size="11" font-weight="bold" fill="#1E40AF" text-anchor="middle">EXECUTING</text>
          <text x="50" y="68" font-size="8.5" fill="#475569" text-anchor="middle">Active physical</text>
          <text x="50" y="80" font-size="8.5" fill="#475569" text-anchor="middle">work &amp; doing</text>
        </g>

        <!-- Arrow 3 -->
        <path d="M 355 67 L 368 67" stroke="#2563EB" stroke-width="2.5" fill="none" />
        <polygon points="368,67 362,63 362,71" fill="#2563EB" />

        <!-- Stage 4: Judging -->
        <g transform="translate(370, 20)">
          <rect x="0" y="0" width="100" height="95" rx="6" fill="#EFF6FF" stroke="#2563EB" stroke-width="1.8" />
          <circle cx="50" cy="22" r="14" fill="#2563EB" />
          <text x="50" y="27" font-size="12" font-weight="bold" fill="#FFFFFF" text-anchor="middle">4</text>
          <text x="50" y="52" font-size="11" font-weight="bold" fill="#1E40AF" text-anchor="middle">JUDGING</text>
          <text x="50" y="68" font-size="8.5" fill="#475569" text-anchor="middle">Self-evaluation &amp;</text>
          <text x="50" y="80" font-size="8.5" fill="#475569" text-anchor="middle">review of results</text>
        </g>
      </svg>
    </div>
    <div style="color: #CBD5E1; font-size: 14px; text-align: center; margin-top: 10px; line-height: 1.5; font-weight: 500;">
      💡 Kilpatrick's 4-Stage Project Method: Purposing (defining a real social goal), Planning (collaborative blueprinting), Executing (practical hands-on implementation), and Judging (critical self-assessment).
    </div>
  </div>
