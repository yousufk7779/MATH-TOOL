      ...
      questions: [
        {
          ...
          number: "1",
          question:
            "<div style='text-align: justify;'>Which of the following has more inertia:<br/>(a) a rubber ball and a stone of the same size?<br/>(b) a bicycle and a train?<br/>(c) a five-rupees coin and a one-rupee coin?</div>",
          solution: [
        ...
        },
        {
          ...
          number: "3",
          question:
            "<div style='text-align: justify;'>Explain why some of the leaves may get detached from a tree if we vigorously shake its branch.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
        ...
        },
        {
          ...
          number: "4",
          question:
            "<div style='text-align: justify;'>Why do you fall in the forward direction when a moving bus brakes to a stop and fall backwards when it accelerates from rest?</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            "<div style='text-align: justify;'>If action is always equal to the reaction, explain how a horse can pull a cart.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
        ...
        },
        {
          ...
          number: "2",
          question:
            "<div style='text-align: justify;'>Explain why it is difficult for a fireman to hold a hose, which ejects large amounts of water at a high velocity.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
        ...
        },
        {
          ...
          number: "3",
          question:
            "<div style='text-align: justify;'>From a rifle of mass 4 kg, a bullet of mass 50 g is fired with an initial velocity of 35 m s⁻¹. Calculate the initial recoil velocity of the rifle.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
            "<div style='text-align: justify;'>Mass of rifle = 4 kg</div>",
            "<div style='text-align: justify;'>Mass of bullet = 50 g = 0.05 kg</div>",
            "<div style='text-align: justify;'>Velocity of bullet = 35 m/s</div>",
            "<br/>",
            "<div style='text-align: justify;'>Using conservation of momentum:</div>",
            "<div style='text-align: justify;'>0 = (0.05 × 35) + (4 × v)</div>",
            "<br/>",
            "<div style='text-align: justify;'>1.75 + 4v = 0</div>",
        ...
        },
        {
          ...
          number: "4",
          question:
            "<div style='text-align: justify;'>Two objects of masses 100 g and 200 g are moving along the same line and direction with velocities of 2 m s⁻¹ and 1 m s⁻¹ respectively. After collision, the first object moves with a velocity of 1.67 m s⁻¹. Determine the velocity of the second object.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
            ...
            "<div style='text-align: justify;'>Using conservation of momentum:</div>",
            "<br/>",
            "<div style='text-align: justify;'>Initial momentum = (0.1×2) + (0.2×1) = 0.2 + 0.2 = 0.4</div>",
            "<br/>",
            "<div style='text-align: justify;'>Final momentum = (0.1×1.67) + (0.2×v)</div>",
            "<br/>",
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            "<div style='text-align: justify;'>An object experiences a net zero external unbalanced force. Is it possible for the object to be travelling with a non-zero velocity? If yes, state the conditions.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
        ...
        },
        {
          ...
          number: "2",
          question:
            "<div style='text-align: justify;'>When a carpet is beaten with a stick, dust comes out of it. Explain.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
        ...
        },
        {
          ...
          number: "3",
          question:
            "<div style='text-align: justify;'>Why is it advised to tie any luggage kept on the roof of a bus with a rope?</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
        ...
        },
        {
          ...
          number: "5",
          question:
            "<div style='text-align: justify;'>A truck starts from rest and rolls down a hill with a constant acceleration. It travels 400 m in 20 s. Find its acceleration and the force acting on it if its mass is 7 tonnes.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
            "<div style='text-align: justify;'>u = 0, s = 400 m, t = 20 s</div>",
            "<br/>",
            "<div style='text-align: justify;'>s = ut + ½at²</div>",
            "<div style='text-align: justify;'>400 = ½a × (20)²</div>",
            "<div style='text-align: justify;'>400 = 200a</div>",
            "<div style='text-align: justify;'>a = 2 m/s²</div>",
            "<br/>",
        ...
        },
        {
          ...
          number: "6",
          question:
            "<div style='text-align: justify;'>A stone of 1 kg is thrown with a velocity of 20 m s⁻¹ across the ice and stops after 50 m. Find the force of friction.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
            "<div style='text-align: justify;'>m = 1 kg, u = 20 m/s, v = 0, s = 50 m</div>",
            "<br/>",
            "<div style='text-align: justify;'>v² = u² + 2as</div>",
            "<div style='text-align: justify;'>0 = 400 + 2a × 50</div>",
            "<div style='text-align: justify;'>0 = 400 + 100a</div>",
            "<div style='text-align: justify;'>a = −4 m/s²</div>",
            "<br/>",
        ...
        },
        {
          ...
          number: "7",
          question:
            "<div style='text-align: justify;'>A 8000 kg engine pulls a train of 5 wagons, each of 2000 kg. The engine exerts a force of 40000 N and friction is 5000 N. Calculate:<br><br>(a) net force<br>(b) acceleration</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
            "<div style='text-align: justify;'>Total mass = 8000 + (5 × 2000) = 18000 kg</div>",
            "<br/>",
            "<div style='text-align: justify;'>Net force = 40000 − 5000 = 35000 N</div>",
            "<br/>",
        ...
        },
        {
          ...
          number: "8",
          question:
            "<div style='text-align: justify;'>An automobile of mass 1500 kg is stopped with a deceleration of 1.7 m/s². Find the force.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
        ...
        },
        {
          ...
          number: "9",
          question:
            "<div style='text-align: justify;'>What is the momentum of an object of mass m moving with velocity v?<br><br>(a) (mv)²<br>(b) mv²<br>(c) ½ mv²<br>(d) mv</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
        ...
        },
        {
          ...
          number: "10",
          question:
            "<div style='text-align: justify;'>A force of 200 N moves a cabinet with constant velocity. Find friction force.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
        ...
        },
        {
          ...
          number: "11",
          question:
            "<div style='text-align: justify;'>Two objects of mass 1.5 kg move in opposite directions with velocity 2.5 m/s. They stick together after collision. Find final velocity.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
            "<div style='text-align: justify;'>m₁ = m₂ = 1.5 kg</div>",
            "<br/>",
            "<div style='text-align: justify;'>Using momentum conservation:</div>",
            "<br/>",
        ...
        },
        {
          ...
          number: "12",
          question:
            "<div style='text-align: justify;'>According to the third law of motion, action and reaction are equal and opposite. A student says they cancel each other, so a massive truck will not move. Comment on this.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
        ...
        },
        {
          ...
          number: "13",
          question:
            "<div style='text-align: justify;'>A hockey ball of mass 200 g moving at 10 m/s is hit and returns with 5 m/s. Find change in momentum.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
            "<div style='text-align: justify;'>Mass = 0.2 kg</div>",
            "<br/>",
            "<div style='text-align: justify;'>Initial momentum = 0.2 × 10 = 2 kg·m/s</div>",
            "<div style='text-align: justify;'>Final momentum = 0.2 × (−5) = −1 kg·m/s</div>",
            "<br/>",
        ...
        },
        {
          ...
          number: "14",
          question:
            "<div style='text-align: justify;'>A bullet of mass 10 g moving at 150 m/s stops in 0.03 s. Find distance and force.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
            "<div style='text-align: justify;'>Mass = 0.01 kg</div>",
            "<br/>",
            "<div style='text-align: justify;'>v = 0, u = 150 m/s, t = 0.03 s</div>",
            "<br/>",
            "<div style='text-align: justify;'>Acceleration:</div>",
            "<div style='text-align: justify;'>a = (v − u)/t = −150 / 0.03 = −5000 m/s²</div>",
            "<br/>",
            "<div style='text-align: justify;'>Distance:</div>",
            "<div style='text-align: justify;'>s = ut + ½at²</div>",
            "<div style='text-align: justify;'>= (150×0.03) + ½×(−5000)×(0.03)²</div>",
        ...
        },
        {
          ...
          number: "15",
          question:
            "<div style='text-align: justify;'>An object of mass 1 kg moving at 10 m/s collides with a stationary block of 5 kg and they stick together. Find momentum before and after collision and final velocity.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
            "<div style='text-align: justify;'>Initial momentum = 1 × 10 = 10 kg·m/s</div>",
            "<br/>",
            "<div style='text-align: justify;'>After collision:</div>",
            "<div style='text-align: justify;'>Total mass = 6 kg</div>",
            "<br/>",
        ...
        },
        {
          ...
          number: "16",
          question:
            "<div style='text-align: justify;'>An object of mass 100 kg is accelerated from 5 m/s to 8 m/s in 6 s. Find initial momentum, final momentum and force.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
            "<div style='text-align: justify;'>Mass = 100 kg</div>",
            "<br/>",
            "<div style='text-align: justify;'>Initial momentum = 100 × 5 = 500 kg·m/s</div>",
            "<div style='text-align: justify;'>Final momentum = 100 × 8 = 800 kg·m/s</div>",
            "<br/>",
        ...
        },
        {
          ...
          number: "17",
          question:
            "<div style='text-align: justify;'>An insect hits a moving car and gets stuck. Different students give different explanations. Comment.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
        ...
        },
        {
          ...
          number: "18",
          question:
            "<div style='text-align: justify;'>A dumb-bell of mass 10 kg falls from height 80 cm. Find momentum just before hitting ground.</div>",
          solution: [
            "<div style='text-align: justify;'>Answer:</div>",
            "<div style='text-align: justify;'>Height = 0.8 m</div>",
            "<br/>",
            "<div style='text-align: justify;'>Using v² = 2gh</div>",
