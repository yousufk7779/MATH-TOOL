...
export const c9SciPhy2: ChapterContent = {
    ...
    definitions: [
        { term: "Force", description: "<div style='text-align: justify;'>A push or pull acting on an object.</div>" },
        { term: "Inertia", description: "<div style='text-align: justify;'>The property of an object to resist any change in its state of rest or motion.</div>" },
        { term: "Momentum", description: "<div style='text-align: justify;'>The quantity of motion of an object. It is given by mass × velocity.</div>" },
        { term: "Balanced Forces", description: "<div style='text-align: justify;'>Forces that cancel each other and do not change the motion of an object.</div>" },
        { term: "Unbalanced Forces", description: "<div style='text-align: justify;'>Forces that change the motion of an object.</div>" }
    ],
    keyPoints: [
            ...
            questions: [
                {
                    id: "c9-phy-2-it-1-1",
                    number: "1",
                    question: "<div style='text-align: justify;'>Which of the following has more inertia:<br/>(a) a rubber ball and a stone of the same size?<br/>(b) a bicycle and a train?<br/>(c) a five-rupees coin and a one-rupee coin?</div>",
                    solution: [
            ...
            questions: [
                {
                    id: "c9-phy-2-it-2-1",
                    number: "1",
                    question: "<div style='text-align: justify;'>If action is always equal to the reaction, explain how a horse can pull a cart.</div>",
                    solution: [
                        "<div style='text-align: justify;'>Answer:</div>",
