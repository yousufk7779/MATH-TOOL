...
<style>
  ...
  .question { color: #FFB74D !important; text-align: justify !important; font-weight: normal !important; font-family: 'Noto Sans', sans-serif !important; }
  ...
  .final-answer { color: #FFB74D !important; text-align: justify !important; font-weight: normal !important; }
  .formula { color: #FFB74D !important; }
  .true-text { color: #FFB74D !important; }
  .false-text { color: #FFB74D !important; }
  ...
  .section-title { color: #FFB74D !important; font-weight: normal !important; border-bottom: 1px solid rgba(255,255,255,0.1) !important; font-family: 'Noto Sans', sans-serif !important; }
  .sub-header { color: #FFB74D !important; font-weight: normal !important; }
...
<body>
    ...
    <div class="content-box">
        ...
        <div class="step"><strong style="color: #FFB74D;">Given: A circle with center O and a tangent XY at a
            point P.</div>
        <div class="step"><strong style="color: #FFB74D;">To Prove: OP is perpendicular to XY (OP ⊥ XY).</div>
        <div class="step"><strong style="color: #FFB74D;">Construction: Take a point Q on tangent XY, other
            than P. Join OQ. Let OQ intersect the circle at point R.</div>
        <div class="step"><strong style="color: #FFB74D;">Proof:</div>
        ...
        <div class="step">Therefore, OP ⊥ XY.</div>
        <div class="step"><strong style="color: #FFB74D;">Final Conclusion: Hence, the tangent at any point of
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: A circle with center O. An external point P.
            Two tangents PQ and PR drawn from P to the circle.</div>
        <div class="step"><strong style="color: #FFB74D;">To Prove: Length PQ = Length PR.</div>
        <div class="step"><strong style="color: #FFB74D;">Construction: Join center O to points P, Q, and R.
        </div>
        <div class="step"><strong style="color: #FFB74D;">Proof:</div>
        <div class="step">PQ is a tangent at Q and OQ is the radius.</div>
        <div class="step">According to <strong style="color: #FFB74D;">Theorem 10.1 (Radius is perpendicular to
                tangent):</div>
        ...
        <div class="step">By <strong style="color: #FFB74D;">RHS Congruence Rule (Right angle - Hypotenuse -
            Side):</div>
        ...
        <div class="step"><strong style="color: #FFB74D;">Final Conclusion: Hence Proved.</div>
...
<body>
    ...
    <div class="content-box">
        ...
        <div class="step"><strong style="color: #FFB74D;">Given: Two concentric circles \\(C_1\\) (larger) and
            \\(C_2\\) (smaller) with center O. Chord AB of circle \\(C_1\\) touches circle \\(C_2\\) at point P.</div>
        <div class="step"><strong style="color: #FFB74D;">To Prove: The chord AB is bisected at the point of
            contact P (i.e., AP = PB).</div>
        <div class="step"><strong style="color: #FFB74D;">Construction: Join OP.</div>
        <div class="step"><strong style="color: #FFB74D;">Proof:</div>
        ...
        <div class="step"><strong style="color: #FFB74D;">Final Conclusion: Hence, the chord is bisected at the
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: A circle with center O. An external point T.
            Two tangents TP and TQ.</div>
        <div class="step"><strong style="color: #FFB74D;">To Prove: \\(\\angle PTQ = 2 \\angle OPQ\\).</div>
        <div class="step"><strong style="color: #FFB74D;">Proof:</div>
        <div class="step">Let \\(\\angle PTQ = \\theta\\).</div>
        <div class="step">TP and TQ are tangents drawn from an external point T.</div>
        <div class="step">According to <strong style="color: #FFB74D;">Theorem 10.2 (Lengths of tangents from
        ...
        <div class="step">Also, according to <strong style="color: #FFB74D;">Theorem 10.1 (Radius is perpendicular
                to tangent):</div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: Chord PQ = 8 cm. Radius OP = 5 cm. Tangents at
            P and Q intersect at T.</div>
        <div class="step"><strong style="color: #FFB74D;">To Find: Length of tangent TP.</div>
        <div class="step"><strong style="color: #FFB74D;">Construction: Join OT (intersecting PQ at R).</div>
        <div class="step"><strong style="color: #FFB74D;">Solution:</div>
        ...
        <div class="step">In right-angled \\(\\triangle OPT\\) (Angle P is \\(90^\\circ\\) by <strong
                style="color: #FFB74D;">Theorem 10.1):</div>
        ...
        <div class="step"><strong style="color: #FFB74D;">Final Conclusion: Hence, the length TP is
            \\(\\frac{20}{3}\\) cm.</div>
    </div>
...
<body>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FFB74D;">Answer: Infinitely many.</div>
        <div class="step"><strong style="color: #FFB74D;">Explanation:</div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: Radius OP = 5 cm. Distance OQ = 12 cm. PQ is a
            tangent at P.</div>
        <div class="step"><strong style="color: #FFB74D;">To Find: Length PQ.</div>
        <div class="step"><strong style="color: #FFB74D;">Solution:</div>
        ...
        <div class="step"><strong style="color: #FFB74D;">Final Conclusion: Hence, the length PQ is
            \\(\\sqrt{119}\\) cm.</div>
    </div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FFB74D;">To Do: Draw a circle and lines parallel to a given
            line (one tangent, one secant).</div>
        <div class="step"><strong style="color: #FFB74D;">Steps of Construction:</div>
        ...
        <div class="step"><strong style="color: #FFB74D;">Final Conclusion: See the construction in the
            diagram.</div>
...
<body>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: Radius OP. Distance OQ = 25 cm. Tangent PQ =
            24 cm.</div>
        <div class="step"><strong style="color: #FFB74D;">To Find: Radius of the circle (OP).</div>
        <div class="step"><strong style="color: #FFB74D;">Solution:</div>
        ...
        <div class="step"><strong style="color: #FFB74D;">Final Conclusion: Hence, the radius of the circle is
            7 cm.</div>
    </div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: Two tangents TP and TQ. Angle at center
            \\(\\angle POQ = 110^\\circ\\).</div>
        <div class="step"><strong style="color: #FFB74D;">To Find: Angle \\(\\angle PTQ\\).</div>
        <div class="step"><strong style="color: #FFB74D;">Solution:</div>
        <div class="step">We know that radius is perpendicular to tangent (<strong style="color: #FFB74D;">Theorem
                10.1).</div>
        ...
        <div class="step"><strong style="color: #FFB74D;">Final Conclusion: Hence, \\(\\angle PTQ\\) is equal to
            \\(70^\\circ\\).</div>
    </div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: Tangents PA and PB are inclined at
            \\(80^\\circ\\) (i.e., \\(\\angle APB = 80^\\circ\\)).</div>
        <div class="step"><strong style="color: #FFB74D;">To Find: Angle \\(\\angle POA\\).</div>
        <div class="step"><strong style="color: #FFB74D;">Solution:</div>
        ...
        <div class="step">Also, radius OA \\(\\perp\\) tangent PA at A (<strong style="color: #FFB74D;">Theorem
                10.1).</div>
        ...
        <div class="step"><strong style="color: #FFB74D;">Final Conclusion: Hence, \\(\\angle POA\\) is equal to
            \\(50^\\circ\\).</div>
    </div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: A circle with center O. PQ is a diameter. AB
            and CD are tangents at P and Q respectively.</div>
        <div class="step"><strong style="color: #FFB74D;">To Prove: Tangent AB is parallel to Tangent CD (AB ||
            CD).</div>
        <div class="step"><strong style="color: #FFB74D;">Proof:</div>
        <div class="step">OP is the radius and AB is the tangent at P.</div>
        <div class="step">By <strong style="color: #FFB74D;">Theorem 10.1: Radius \\(\\perp\\) Tangent.</div>
        ...
        <div class="step"><strong style="color: #FFB74D;">Final Conclusion: Hence, the tangents drawn at the
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: A circle with center O. Tangent AB touches at
            point P.</div>
        <div class="step"><strong style="color: #FFB74D;">To Prove: Perpendicular to AB at P passes through
            center O.</div>
        <div class="step"><strong style="color: #FFB74D;">Proof:</div>
        ...
        <div class="step">However, we know by <strong style="color: #FFB74D;">Theorem 10.1 that the radius is
    ...
    <div class="content-box">
       ...
       <img src="data:image/svg+xml;base64," alt="Radius Calculation">
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: Distance OA = 5 cm. Length of tangent AP = 4
            cm.</div>
        <div class="step"><strong style="color: #FFB74D;">To Find: Radius of the circle (OP).</div>
        <div class="step"><strong style="color: #FFB74D;">Solution:</div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: Two concentric circles with center O. Radii 5
            cm and 3 cm. Chord AB of larger circle touches smaller circle.</div>
        <div class="step"><strong style="color: #FFB74D;">To Find: Length of chord AB.</div>
        <div class="step"><strong style="color: #FFB74D;">Solution:</div>
        ...
        <div class="step">So, OP \\(\\perp\\) AB (by <strong style="color: #FFB74D;">Theorem 10.1).</div>
        ...
        <div class="step"><strong style="color: #FFB74D;">Final Conclusion: Hence, the length of the chord is 8
            cm.</div>
    </div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: A quadrilateral ABCD circumscribing a circle.
            Points of contact P, Q, R, S on sides AB, BC, CD, DA respectively.</div>
        <div class="step"><strong style="color: #FFB74D;">To Prove: \\(AB + CD = AD + BC\\).</div>
        <div class="step"><strong style="color: #FFB74D;">Proof:</div>
        <div class="step">We know tangent lengths from an external point are equal (<strong
                style="color: #FFB74D;">Theorem 10.2).</div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: Parallel tangents XY and X'Y'. Tangent AB
            intersecting XY at A and X'Y' at B.</div>
        <div class="step"><strong style="color: #FFB74D;">To Prove: \\(\\angle AOB = 90^\\circ\\).</div>
        <div class="step"><strong style="color: #FFB74D;">Construction: Join OC.</div>
        <div class="step"><strong style="color: #FFB74D;">Proof:</div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: External point P. Tangents PA and PB.</div>
        <div class="step"><strong style="color: #FFB74D;">To Prove: Angle between tangents (\\(\\angle APB\\)) +
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: Parallelogram ABCD circumscribing a circle.
        </div>
        <div class="step"><strong style="color: #FFB74D;">To Prove: ABCD is a rhombus.</div>
        <div class="step"><strong style="color: #FFB74D;">Proof:</div>
        ...
        <div class="step"><strong style="color: #FFB74D;">Final Conclusion: Hence, ABCD is a rhombus.</div>
    </div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: \\(\\triangle ABC\\) circumscribing a circle.
            Radius \\(r = 4\\) cm. \\(BD = 8\\) cm, \\(CD = 6\\) cm.</div>
        <div class="step"><strong style="color: #FFB74D;">To Find: Lengths of sides AB and AC.</div>
        <div class="step"><strong style="color: #FFB74D;">Solution:</div>
        <div class="step">Let tangent points be D, E, F on sides BC, AC, AB.</div>
        <div class="step">We have \\(BD = 8\\) cm and \\(CD = 6\\) cm.</div>
        <div class="step">Tangents from external point are equal (<strong style="color: #FFB74D;">Theorem
                10.2).</div>
        ...
        <div class="step"><strong style="color: #FFB74D;">Final Conclusion: Hence, AB = 15 cm and AC = 13 cm.
        </div>
    </div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FFB74D;">Given: Quadrilateral ABCD circumscribing a circle
            with center O.</div>
        <div class="step"><strong style="color: #FFB74D;">To Prove: Opposite sides subtend supplementary angles
            at center (\\(\\angle AOB + \\angle COD = 180^\\circ\\)).</div>
        <div class="step"><strong style="color: #FFB74D;">Construction: Join the center O to points of contact
            P, Q, R, S.</div>
        <div class="step"><strong style="color: #FFB74D;">Proof:</div>
        ...
        <div class="step"><strong style="color: #FFB74D;">Final Conclusion: Hence, opposite sides subtend
