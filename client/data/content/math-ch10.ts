...
<style>
  ...
  .content-box { background: rgba(255,255,255,0.03) !important; border: 1px solid rgba(251, 140, 0, 0.2) !important; color: #fff !important; }
  .formula-box { background: rgba(255, 167, 38, 0.1) !important; border-left: 4px solid #FB8C00 !important; color: #fff !important; }
  h1, h2, h3, h4, h5, h6 { color: #FB8C00 !important; }
  .question { color: #FB8C00 !important; text-align: justify !important; font-weight: normal !important; font-family: 'Noto Sans', sans-serif !important; }
  ...
  .final-answer { color: #FB8C00 !important; text-align: justify !important; font-weight: normal !important; }
  .formula { color: #FB8C00 !important; }
  .true-text { color: #FB8C00 !important; }
  .false-text { color: #FB8C00 !important; }
  ...
  .section-title { color: #FB8C00 !important; font-weight: normal !important; border-bottom: 1px solid rgba(255,255,255,0.1) !important; font-family: 'Noto Sans', sans-serif !important; }
  .sub-header { color: #FB8C00 !important; font-weight: normal !important; }
...
<body>
    ...
    <div class="content-box">
        ...
        <div class="step">Circle: A circle is a collection of all points in a plane which are at a
            constant distance (radius) from a fixed point (center).</div>
        <div class="step">Center: The fixed point from which all points on the circle are equidistant.
        </div>
        <div class="step">Radius: The constant distance between the center and any point on the circle.
        </div>
        <div class="step">Chord: A line segment joining any two points on the circumference of the
            circle.</div>
        <div class="step">Diameter: The longest chord which passes through the center of the circle.
            Length of diameter is twice the radius (d = 2r).</div>
        <div class="step">Secant: A line that intersects the circle at two distinct points.</div>
        <div class="step">Tangent: A line that intersects the circle at exactly one point. This point
    ...
    <div class="content-box">
        ...
        <div class="formula-box">
            OP ÃƒÂ¢Ã…Â Ã‚Â¥ XY (Radius is perpendicular to Tangent)
        </div>
    ...
    <div class="content-box">
        ...
        <div class="step">ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ There is no tangent to a circle passing through a point lying inside the circle.</div>
        <div class="step">ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ There is one and only one tangent to a circle passing through a point lying on the circle.
        </div>
        <div class="step">ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ There are exactly two tangents to a circle through a point lying outside the circle.</div>
        <div class="step">ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ The common point of the tangent and the circle is called the point of contact.</div>
        <div class="step">ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ The line containing the radius through the point of contact is also sometimes called the
...
<body>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: A circle with center O. An external point P.
            Two tangents PQ and PR drawn from P to the circle.</div>
        <div class="step"><strong style="color: #FB8C00;">To Prove: Length PQ = Length PR.</div>
        <div class="step"><strong style="color: #FB8C00;">Construction: Join center O to points P, Q, and R.
        </div>
        <div class="step"><strong style="color: #FB8C00;">Proof:</div>
        <div class="step">PQ is a tangent at Q and OQ is the radius.</div>
        <div class="step">According to <strong style="color: #FB8C00;">Theorem 10.1 (Radius is perpendicular to
                tangent):</div>
        <div class="step">\\(\\angle OQP = 90^\\circ\\).</div>
        <div class="step">Similarly, PR is a tangent at R and OR is the radius.</div>
        <div class="step">So, \\(\\angle ORP = 90^\\circ\\).</div>
        <div class="step">Now, consider the right-angled triangles \\(\\triangle OQP\\) and \\(\\triangle ORP\\).</div>
        <div class="step">\\(OQ = OR\\) (Radii of the same circle are equal).</div>
        <div class="step">\\(OP = OP\\) (Common hypotenuse side).</div>
        <div class="step">By <strong style="color: #FB8C00;">RHS Congruence Rule (Right angle - Hypotenuse -
            Side):</div>
        <div class="step">\\(\\triangle OQP \\cong \\triangle ORP\\).</div>
        <div class="step">Since the triangles are congruent, their corresponding parts are equal (CPCT).</div>
        <div class="step">Therefore, \\(PQ = PR\\).</div>
        <div class="step"><strong style="color: #FB8C00;">Final Conclusion: Hence Proved.</div>
...
<body>
    ...
    <div class="content-box">
        ...
        <div class="step"><strong style="color: #FB8C00;">Given: Two concentric circles \\(C_1\\) (larger) and
            \\(C_2\\) (smaller) with center O. Chord AB of circle \\(C_1\\) touches circle \\(C_2\\) at point P.</div>
        <div class="step"><strong style="color: #FB8C00;">To Prove: The chord AB is bisected at the point of
            contact P (i.e., AP = PB).</div>
        <div class="step"><strong style="color: #FB8C00;">Construction: Join OP.</div>
        <div class="step"><strong style="color: #FB8C00;">Proof:</div>
        ...
        <div class="step"><strong style="color: #FB8C00;">Final Conclusion: Hence, the chord is bisected at the
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: A circle with center O. An external point T.
            Two tangents TP and TQ.</div>
        <div class="step"><strong style="color: #FB8C00;">To Prove: \\(\\angle PTQ = 2 \\angle OPQ\\).</div>
        <div class="step"><strong style="color: #FB8C00;">Proof:</div>
        <div class="step">Let \\(\\angle PTQ = \\theta\\).</div>
        <div class="step">TP and TQ are tangents drawn from an external point T.</div>
        <div class="step">According to <strong style="color: #FB8C00;">Theorem 10.2 (Lengths of tangents from
                external point are equal):</div>
        ...
        <div class="step">Also, according to <strong style="color: #FB8C00;">Theorem 10.1 (Radius is perpendicular
                to tangent):</div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: Chord PQ = 8 cm. Radius OP = 5 cm. Tangents at
            P and Q intersect at T.</div>
        <div class="step"><strong style="color: #FB8C00;">To Find: Length of tangent TP.</div>
        <div class="step"><strong style="color: #FB8C00;">Construction: Join OT (intersecting PQ at R).</div>
        <div class="step"><strong style="color: #FB8C00;">Solution:</div>
        ...
        <div class="step">In right-angled \\(\\triangle OPT\\) (Angle P is \\(90^\\circ\\) by <strong
                style="color: #FB8C00;">Theorem 10.1):</div>
        ...
        <div class="step"><strong style="color: #FB8C00;">Final Conclusion: Hence, the length TP is
            \\(\\frac{20}{3}\\) cm.</div>
    </div>
...
<body>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FB8C00;">Answer: Infinitely many.</div>
        <div class="step"><strong style="color: #FB8C00;">Explanation:</div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: Radius OP = 5 cm. Distance OQ = 12 cm. PQ is a
            tangent at P.</div>
        <div class="step"><strong style="color: #FB8C00;">To Find: Length PQ.</div>
        <div class="step"><strong style="color: #FB8C00;">Solution:</div>
        ...
        <div class="step"><strong style="color: #FB8C00;">Final Conclusion: Hence, the length PQ is
            \\(\\sqrt{119}\\) cm.</div>
    </div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FB8C00;">To Do: Draw a circle and lines parallel to a given
            line (one tangent, one secant).</div>
        <div class="step"><strong style="color: #FB8C00;">Steps of Construction:</div>
        ...
        <div class="step">Here, line \\(n\\) touches the circle at one point, so it is a Tangent.</div>
        <div class="step">Line \\(m\\) cuts the circle at two points, so it is a Secant.</div>
        <div class="step">Both lines \\(m\\) and \\(n\\) are parallel to the given line \\(AB\\).</div>
        <div class="step"><strong style="color: #FB8C00;">Final Conclusion: See the construction in the
            diagram.</div>
...
<body>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: Radius OP. Distance OQ = 25 cm. Tangent PQ =
            24 cm.</div>
        <div class="step"><strong style="color: #FB8C00;">To Find: Radius of the circle (OP).</div>
        <div class="step"><strong style="color: #FB8C00;">Solution:</div>
        ...
        <div class="step"><strong style="color: #FB8C00;">Final Conclusion: Hence, the radius of the circle is
            7 cm.</div>
    </div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: Two tangents TP and TQ. Angle at center
            \\(\\angle POQ = 110^\\circ\\).</div>
        <div class="step"><strong style="color: #FB8C00;">To Find: Angle \\(\\angle PTQ\\).</div>
        <div class="step"><strong style="color: #FB8C00;">Solution:</div>
        <div class="step">We know that radius is perpendicular to tangent (<strong style="color: #FB8C00;">Theorem
                10.1).</div>
        ...
        <div class="step"><strong style="color: #FB8C00;">Final Conclusion: Hence, \\(\\angle PTQ\\) is equal to
            \\(70^\\circ\\).</div>
    </div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: Tangents PA and PB are inclined at
            \\(80^\\circ\\) (i.e., \\(\\angle APB = 80^\\circ\\)).</div>
        <div class="step"><strong style="color: #FB8C00;">To Find: Angle \\(\\angle POA\\).</div>
        <div class="step"><strong style="color: #FB8C00;">Solution:</div>
        ...
        <div class="step">Also, radius OA \\(\\perp\\) tangent PA at A (<strong style="color: #FB8C00;">Theorem
                10.1).</div>
        ...
        <div class="step"><strong style="color: #FB8C00;">Final Conclusion: Hence, \\(\\angle POA\\) is equal to
            \\(50^\\circ\\).</div>
    </div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: A circle with center O. PQ is a diameter. AB
            and CD are tangents at P and Q respectively.</div>
        <div class="step"><strong style="color: #FB8C00;">To Prove: Tangent AB is parallel to Tangent CD (AB ||
            CD).</div>
        <div class="step"><strong style="color: #FB8C00;">Proof:</div>
        <div class="step">OP is the radius and AB is the tangent at P.</div>
        <div class="step">By <strong style="color: #FB8C00;">Theorem 10.1: Radius \\(\\perp\\) Tangent.</div>
        ...
        <div class="step"><strong style="color: #FB8C00;">Final Conclusion: Hence, the tangents drawn at the
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: A circle with center O. Tangent AB touches at
            point P.</div>
        <div class="step"><strong style="color: #FB8C00;">To Prove: Perpendicular to AB at P passes through
            center O.</div>
        <div class="step"><strong style="color: #FB8C00;">Proof:</div>
        <div class="step">Let us assume the perpendicular to AB at point P does not pass through center
            O.</div>
        <div class="step">Let it pass through another point O'.</div>
        <div class="step">Then, \\(\\angle O'PB = 90^\\circ\\) (by our assumption).</div>
        <div class="step">However, we know by <strong style="color: #FB8C00;">Theorem 10.1 that the radius is
    ...
    <div class="content-box">
       ...
       <img src="data:image/svg+xml;base64," alt="Radius Calculation">
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: Distance OA = 5 cm. Length of tangent AP = 4
            cm.</div>
        <div class="step"><strong style="color: #FB8C00;">To Find: Radius of the circle (OP).</div>
        <div class="step"><strong style="color: #FB8C00;">Solution:</div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: Two concentric circles with center O. Radii 5
            cm and 3 cm. Chord AB of larger circle touches smaller circle.</div>
        <div class="step"><strong style="color: #FB8C00;">To Find: Length of chord AB.</div>
        <div class="step"><strong style="color: #FB8C00;">Solution:</div>
        ...
        <div class="step">So, OP \\(\\perp\\) AB (by <strong style="color: #FB8C00;">Theorem 10.1).</div>
        ...
        <div class="step"><strong style="color: #FB8C00;">Final Conclusion: Hence, the length of the chord is 8
            cm.</div>
    </div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: A quadrilateral ABCD circumscribing a circle.
            Points of contact P, Q, R, S on sides AB, BC, CD, DA respectively.</div>
        <div class="step"><strong style="color: #FB8C00;">To Prove: \\(AB + CD = AD + BC\\).</div>
        <div class="step"><strong style="color: #FB8C00;">Proof:</div>
        <div class="step">We know tangent lengths from an external point are equal (<strong
                style="color: #FB8C00;">Theorem 10.2).</div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: Parallel tangents XY and X'Y'. Tangent AB
            intersecting XY at A and X'Y' at B.</div>
        <div class="step"><strong style="color: #FB8C00;">To Prove: \\(\\angle AOB = 90^\\circ\\).</div>
        <div class="step"><strong style="color: #FB8C00;">Construction: Join OC.</div>
        <div class="step"><strong style="color: #FB8C00;">Proof:</div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: External point P. Tangents PA and PB.</div>
        <div class="step"><strong style="color: #FB8C00;">To Prove: Angle between tangents (\\(\\angle APB\\)) +
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: Parallelogram ABCD circumscribing a circle.
        </div>
        <div class="step"><strong style="color: #FB8C00;">To Prove: ABCD is a rhombus.</div>
        <div class="step"><strong style="color: #FB8C00;">Proof:</div>
        ...
        <div class="step"><strong style="color: #FB8C00;">Final Conclusion: Hence, ABCD is a rhombus.</div>
    </div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Solution:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: \\(\\triangle ABC\\) circumscribing a circle.
            Radius \\(r = 4\\) cm. \\(BD = 8\\) cm, \\(CD = 6\\) cm.</div>
        <div class="step"><strong style="color: #FB8C00;">To Find: Lengths of sides AB and AC.</div>
        <div class="step"><strong style="color: #FB8C00;">Solution:</div>
        <div class="step">Let tangent points be D, E, F on sides BC, AC, AB.</div>
        <div class="step">We have \\(BD = 8\\) cm and \\(CD = 6\\) cm.</div>
        <div class="step">Tangents from external point are equal (<strong style="color: #FB8C00;">Theorem
                10.2).</div>
        ...
        <div class="step"><strong style="color: #FB8C00;">Final Conclusion: Hence, AB = 15 cm and AC = 13 cm.
        </div>
    </div>
    ...
    <div class="content-box">
        ...
        <div class="solution-header">Proof:</div>
        <div class="step"><strong style="color: #FB8C00;">Given: Quadrilateral ABCD circumscribing a circle
            with center O.</div>
        <div class="step"><strong style="color: #FB8C00;">To Prove: Opposite sides subtend supplementary angles
            at center (\\(\\angle AOB + \\angle COD = 180^\\circ\\)).</div>
        <div class="step"><strong style="color: #FB8C00;">Construction: Join the center O to points of contact
            P, Q, R, S.</div>
        <div class="step"><strong style="color: #FB8C00;">Proof:</div>
        ...
        <div class="step"><strong style="color: #FB8C00;">Final Conclusion: Hence, opposite sides subtend
