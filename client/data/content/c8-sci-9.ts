  ...
  mcqs: [
    {
      id: "c8-sci-9-mcq-1",
      question:
        "<div style='text-align: justify;'>The rise of water in a dropper when its bulb is released is due to:</div>",
      options: [
    ...
    },
    {
      id: "c8-sci-9-mcq-2",
      question:
        "<div style='text-align: justify;'>Which of the following is a non-contact force?</div>",
      options: [
    ...
    },
    {
      id: "c8-sci-9-mcq-3",
      question:
        "<div style='text-align: justify;'>Pressure is defined as:</div>",
      options: [
        "<div style='text-align: justify;'>(a) Force / Area</div>",
        "<div style='text-align: justify;'>(b) Area / Force</div>",
        "<div style='text-align: justify;'>(c) Force × Area</div>",
        "<div style='text-align: justify;'>(d) Mass / Area</div>",
      ],
      correctAnswer: "a",
    },
    {
      id: "c8-sci-9-mcq-4",
      question:
        "<div style='text-align: justify;'>The S.I. unit of pressure is:</div>",
      options: [
        "<div style='text-align: justify;'>(a) Newton</div>",
        "<div style='text-align: justify;'>(b) Pascal</div>",
    ...
    },
    {
      id: "c8-sci-9-mcq-5",
      question:
        "<div style='text-align: justify;'>Which of the following is a contact force?</div>",
      options: [
        ...
        "<div style='text-align: justify;'>(d) Muscular force</div>",
      ],
      correctAnswer: "d",
    },
    {
      id: "c8-sci-9-mcq-6",
      question:
        "<div style='text-align: justify;'>A force can change the:</div>",
      options: [
        "<div style='text-align: justify;'>(a) Speed of an object</div>",
        "<div style='text-align: justify;'>(b) Direction of motion</div>",
        "<div style='text-align: justify;'>(c) Shape of an object</div>",
        "<div style='text-align: justify;'>(d) All of the above</div>",
      ],
      correctAnswer: "d",
    },
    {
      id: "c8-sci-9-mcq-7",
      question:
        "<div style='text-align: justify;'>The force of gravity is a/an:</div>",
      options: [
        "<div style='text-align: justify;'>(a) Contact force</div>",
        "<div style='text-align: justify;'>(b) Attractive force</div>",
        "<div style='text-align: justify;'>(c) Repulsive force</div>",
        "<div style='text-align: justify;'>(d) Both a and b</div>",
      ],
      correctAnswer: "b",
    },
    {
      id: "c8-sci-9-mcq-8",
      question:
        "<div style='text-align: justify;'>Atmospheric pressure ________ as we go higher up from the surface of the Earth.</div>",
      options: [
        "<div style='text-align: justify;'>(a) Increases</div>",
        "<div style='text-align: justify;'>(b) Decreases</div>",
        "<div style='text-align: justify;'>(c) Remains the same</div>",
    ...
    },
    {
      id: "c8-sci-9-mcq-9",
      question:
        "<div style='text-align: justify;'>The pressure exerted by a liquid ________ with the depth of the liquid column.</div>",
      options: [
        "<div style='text-align: justify;'>(a) Decreases</div>",
        "<div style='text-align: justify;'>(b) Increases</div>",
        "<div style='text-align: justify;'>(c) Does not change</div>",
        "<div style='text-align: justify;'>(d) First increases then decreases</div>",
      ],
      correctAnswer: "b",
    },
    {
      id: "c8-sci-9-mcq-10",
      question:
        "<div style='text-align: justify;'>A push or a pull on an object is called:</div>",
      options: [
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            "<div style='text-align: justify;'>Give two examples each of situations in which you push or pull to change the state of motion of objects?</div>",
          solution: [
        ...
        },
        {
          ...
          number: "2",
          question:
            "<div style='text-align: justify;'>Give two examples of situations in which applied force causes a change in the shape of an object?</div>",
          solution: [
        ...
        },
        {
          ...
          number: "6",
          question:
            "<div style='text-align: justify;'>A blacksmith hammers a hot piece of iron while making a tool. How does the force due to hammering effect the piece of iron?</div>",
          solution: [
        ...
        },
        {
          ...
          number: "7",
          question:
            "<div style='text-align: justify;'>An inflated balloon was pressed against a wall after it has been rubbed with a piece of synthetic cloth. It was found that the balloon sticks to the wall. What force might be responsible for the attraction between the balloon and the wall?</div>",
          solution: [
        ...
        },
        {
          ...
          number: "8",
          question:
            "<div style='text-align: justify;'>Name the forces acting on a plastic bucket containing water held above ground level in your hand. Discuss why the forces acting on the bucket do not bring a change in its state of motion.</div>",
          solution: [
        ...
        },
        {
          ...
          number: "9",
          question:
            "<div style='text-align: justify;'>A rocket has been fired upwards to launch a satellite in its orbit. Name the two forces acting on the rocket immediately after leaving the launching pad.</div>",
          solution: [
        ...
        },
        {
          ...
          number: "10",
          question:
            "<div style='text-align: justify;'>When we press the bulb of a dropper with its nozzle kept in water, air in the dropper is seen to escape in the form of bubbles. Once we release the pressure on the bulb, water gets filled in the dropper. The rise of water in the dropper is due to:<br/>(a) pressure of water<br/>(b) gravity of the earth<br/>(c) shape of rubber bulb<br/>(d) atmospheric pressure</div>",
          solution: [
