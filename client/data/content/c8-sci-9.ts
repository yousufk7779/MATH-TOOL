...
export const c8Sci9: ChapterContent = {
  ...
  mcqs: [
    ...
    {
      id: "c8-sci-9-mcq-3",
      question: "<div style='text-align: justify;'>Pressure is defined as:</div>",
      options: [
    ...
    {
      id: "c8-sci-9-mcq-4",
      question: "<div style='text-align: justify;'>The S.I. unit of pressure is:</div>",
      options: [
    ...
    {
      id: "c8-sci-9-mcq-5",
      question: "<div style='text-align: justify;'>Which of the following is a contact force?</div>",
      options: [
    ...
    {
      id: "c8-sci-9-mcq-6",
      question: "<div style='text-align: justify;'>A force can change the:</div>",
      options: [
    ...
    {
      id: "c8-sci-9-mcq-7",
      question: "<div style='text-align: justify;'>The force of gravity is a/an:</div>",
      options: [
    ...
    {
      id: "c8-sci-9-mcq-8",
      question: "<div style='text-align: justify;'>Atmospheric pressure ________ as we go higher up from the surface of the Earth.</div>",
      options: [
    ...
    {
      id: "c8-sci-9-mcq-9",
      question: "<div style='text-align: justify;'>The pressure exerted by a liquid ________ with the depth of the liquid column.</div>",
      options: [
    ...
    {
      id: "c8-sci-9-mcq-10",
      question: "<div style='text-align: justify;'>A push or a pull on an object is called:</div>",
      options: [
