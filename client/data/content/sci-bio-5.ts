...
export const sciBio5: ChapterContent = {
  ...
  introduction:
    "We live on a beautiful planet filled with forests, rivers, animals, and humans. Everything around us that affects our life makes up our environment. Let's learn how living things depend on each other and how our actions impact nature.",
  definitions: [
    {
      term: "Environment",
      description:
        "Everything around us, including all living things (plants, animals, people) and non-living things (air, water, soil).",
    },
    {
      term: "Ecosystem",
      description:
        "A community of living organisms interacting with their non-living physical environment. Examples: a forest, a pond, or even an aquarium.",
    },
    {
      term: "Producers",
      description:
        "Organisms that can make their own food using sunlight. All green plants and some bacteria are producers.",
    },
    {
      term: "Consumers",
      description:
        "Organisms that depend on others for food. This includes all animals. They can be herbivores, carnivores, or omnivores.",
    },
    {
      term: "Decomposers",
      description:
        "Microorganisms (like bacteria and fungi) that break down dead remains of plants and animals, returning nutrients back to the soil.",
    },
    {
      term: "Food Chain",
      description:
        "A simple, straight sequence representing 'who eats whom' in an ecosystem, showing the flow of energy.",
    },
    {
      term: "Food Web",
      description:
    ...
    },
    {
      term: "Ozone Layer",
      description:
        "A protective shield of gas (O3) high up in the atmosphere that blocks harmful Ultraviolet (UV) radiation from the Sun.",
    },
    {
      term: "Biological Magnification",
      description:
        "The harmful accumulation of toxic chemicals (like pesticides) in the bodies of organisms, which increases at each step of a food chain.",
    },
  ],
  keyPoints: [
  ...
  mcqs: [
    {
      id: "sb5-mcq-1",
      question:
        "<div style='text-align: justify;'>Which of the following constitutes a food chain?</div>",
      options: [
    ...
    },
    {
      id: "sb5-mcq-2",
      question:
        "<div style='text-align: justify;'>Which group of organisms are not included in the 'consumers' category?</div>",
      options: [
    ...
    },
    {
      id: "sb5-mcq-3",
      question:
        "<div style='text-align: justify;'>What percentage of solar energy is typically captured by green plants?</div>",
      options: [
    ...
    },
    {
      id: "sb5-mcq-4",
      question:
        "<div style='text-align: justify;'>The depletion of the ozone layer is primarily caused by:</div>",
      options: [
    ...
    },
    {
      id: "sb5-mcq-5",
      question:
        "<div style='text-align: justify;'>Biological magnification involves the accumulation of:</div>",
      options: [
    ...
    },
    {
      id: "sb5-mcq-6",
      question:
        "<div style='text-align: justify;'>In an ecosystem, the flow of energy is always:</div>",
      options: [
    ...
    },
    {
      id: "sb5-mcq-7",
      question:
        "<div style='text-align: justify;'>What percentage of energy is generally transferred from one trophic level to the next higher trophic level?</div>",
      options: [
        "<div style='text-align: justify;'>(a) 1%</div>",
        "<div style='text-align: justify;'>(b) 10%</div>",
    ...
    },
    {
      id: "sb5-mcq-8",
      question:
        "<div style='text-align: justify;'>Which of the following organisms are known as 'Nature's Cleaners'?</div>",
      options: [
    ...
    },
    {
      id: "sb5-mcq-9",
      question:
        "<div style='text-align: justify;'>Which of the following is a non-biodegradable waste substance?</div>",
      options: [
    ...
    },
    {
      id: "sb5-mcq-10",
      question:
        "<div style='text-align: justify;'>An ecosystem consists of which of the following components?</div>",
      options: [
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            "<div style='text-align: justify;'>Why are some substances biodegradable and some non-biodegradable?</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>Biodegradable substances are broken down by natural enzymes, while non-biodegradable ones are synthetic and resist biological breakdown.</div>",
        },
        {
          id: "sb5-it1-q2",
          number: "2",
          question:
            "<div style='text-align: justify;'>Give any two ways in which biodegradable substances would affect the environment.</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>They can cause foul odors during decomposition and serve as breeding grounds for disease-causing pests.</div>",
        },
        {
          id: "sb5-it1-q3",
          number: "3",
          question:
            "<div style='text-align: justify;'>Give any two ways in which non-biodegradable substances would affect the environment.</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>They persist for long periods causing persistent pollution and lead to biological magnification in food chains.</div>",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            "<div style='text-align: justify;'>What are trophic levels? Give an example of food chain and state the different trophic levels in it.</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>Trophic levels are various steps in a food chain. In Grass -> Goat -> Human, Grass is the producer level, and Human is the secondary consumer level.</div>",
        },
        {
          id: "sb5-it2-q2",
          number: "2",
          question:
            "<div style='text-align: justify;'>What is the role of decomposers in the ecosystem?</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>Decomposers recycle nutrients back into the soil and keep the environment clean by breaking down dead organic matter.</div>",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            "<div style='text-align: justify;'>What is ozone and how does it affect any ecosystem?</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>Ozone is a molecule of 3 oxygen atoms. It shields the Earth from harmful UV rays, preventing diseases like skin cancer and protecting the ecosystem.</div>",
        },
        {
          id: "sb5-it3-q2",
          number: "2",
          question:
            "<div style='text-align: justify;'>How can you help in reducing the problem of waste disposal? Give any two methods?</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>We can help by composting biodegradable waste into manure and recycling non-biodegradable items like plastics and metals.</div>",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            "<div style='text-align: justify;'>The term Ecosystem was introduced by:<br/>(a) Miller<br/>(b) Haldane<br/>(c) Tansley<br/>(d) Darwin</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>(c) Tansley. The term was coined by A.G. Tansley in 1935.</div>",
        },
        {
          id: "sb5-ex-q2",
          number: "2",
          question:
            "<div style='text-align: justify;'>In a food chain, there is:<br/>(a) Bidirectional flow of energy<br/>(b) Zig zag flow of energy<br/>(c) Multi directional flow of energy<br/>(d) Unidirectional flow of energy</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>(d) Unidirectional flow. Energy moves only one way from producers to consumers.</div>",
        },
        {
          id: "sb5-ex-q3",
          number: "3",
          question:
            "<div style='text-align: justify;'>Nature’s cleaners are:<br/>(a) Producers<br/>(b) Consumers<br/>(c) Decomposers<br/>(d) Carnivores</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>(c) Decomposers. They clean the environment by breaking down dead organic matter.</div>",
        },
        {
          id: "sb5-ex-q4",
          number: "4",
          question:
            "<div style='text-align: justify;'>Which of the following groups contain only biodegradable items?<br/>(a) Grass, flowers and leather<br/>(b) Grass, wood and plastic<br/>(c) Fruit-peels, cake and lime-juice<br/>(d) Cake, wood and grass</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>(c) and (d) are biodegradable. Fruit-peels, cake, lime-juice, wood, and grass are all natural materials.</div>",
        },
        {
          id: "sb5-ex-q5",
          number: "5",
          question:
            "<div style='text-align: justify;'>Which of the following constitute a food-chain?<br/>(a) Grass, wheat and mango<br/>(b) Grass, goat and human<br/>(c) Goat, cow and elephant<br/>(d) Grass, fish and goat</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>(b) Grass, goat and human. This is a valid sequence of producer and consumers.</div>",
        },
        {
          id: "sb5-ex-q6",
          number: "6",
          question:
            "<div style='text-align: justify;'>Which of the following are environment-friendly practices?<br/>(a) Carrying cloth-bags for shopping<br/>(b) Switching off unnecessary lights/fans<br/>(c) Walking to school instead of using a scooter<br/>(d) All of the above</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>(d) All. These practices conserve energy and reduce environmental footprints.</div>",
        },
        {
          id: "sb5-ex-q7",
          number: "7",
          question:
            "<div style='text-align: justify;'>What will happen if we kill all the organisms in one trophic level?</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>It will disrupt the ecosystem; higher levels will starve, while lower levels will overpopulate, collapsing the balance.</div>",
        },
        {
          id: "sb5-ex-q8",
          number: "8",
          question:
            "<div style='text-align: justify;'>Will the impact of removing all the organisms in a trophic level be different for different trophic levels? Can the organisms of any trophic level be removed without causing any damage to the ecosystem?</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>Yes, the impact varies by level, but removing any level will inevitably damage the ecosystem's energy transfer system.</div>",
        },
        {
          id: "sb5-ex-q9",
          number: "9",
          question:
            "<div style='text-align: justify;'>What is biological magnification? Will the levels of this magnification be different at different levels of the ecosystem?</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>Magnification is the accumulation of toxins up the food chain. It is highest at the top level and lowest at the bottom.</div>",
        },
        {
          id: "sb5-ex-q10",
          number: "10",
          question:
            "<div style='text-align: justify;'>What are the problems caused by the non-biodegradable wastes that we generate?</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>They cause soil and water pollution, clog drains, harm livestock, and lead to toxic accumulation in food chains.</div>",
        },
        {
          id: "sb5-ex-q11",
          number: "11",
          question:
            "<div style='text-align: justify;'>If all the waste we generate is biodegradable, will this have no impact on the environment?</div>",
          solution: [
          ...
          answer:
            "<div style='text-align: justify;'>Large amounts of biodegradable waste still impact nature by causing odors, hygiene issues, and oxygen depletion in water.</div>",
        },
        {
          id: "sb5-ex-q12",
          number: "12",
          question:
            "<div style='text-align: justify;'>Why is damage to the ozone layer a cause for concern? What steps are being taken to limit this damage?</div>",
          solution: [
            "<div style='text-align: justify;'><p><b>Answers:</b></p></div>",
          ...
          answer:
            "<div style='text-align: justify;'>Damage allows harmful UV rays to reach Earth, causing cancer and environmental harm. CFC production has been frozen globally to limit this.</div>",
        },
      ],
    },
  ],
