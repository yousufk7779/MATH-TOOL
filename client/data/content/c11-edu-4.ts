...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <div style="background: rgba(142, 45, 226, 0.06); border: 1.5px solid ${themeColor}; border-radius: 12px; padding: 18px; margin-bottom: 25px;">
    <h2 class="text-center" style="color: ${themeColor}; margin: 0 0 6px 0; font-size: 20px; font-weight: bold;">🏛️ Quick Glossary &amp; Core Sociological Terms</h2>
    ...
    <div style="display: flex; flex-direction: column; gap: 12px;">
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid ${themeColor}; border-radius: 6px;">
        <b style="color: ${themeColor}; font-size: 16px; display: block; margin-bottom: 4px;">1. Educational Sociology:</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid ${themeColor}; border-radius: 6px;">
        <b style="color: ${themeColor}; font-size: 16px; display: block; margin-bottom: 4px;">2. Culture (Colere):</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid ${themeColor}; border-radius: 6px;">
        <b style="color: ${themeColor}; font-size: 16px; display: block; margin-bottom: 4px;">3. Material vs. Non-Material Culture:</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid ${themeColor}; border-radius: 6px;">
        <b style="color: ${themeColor}; font-size: 16px; display: block; margin-bottom: 4px;">4. Cultural Lag (W. F. Ogburn):</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid ${themeColor}; border-radius: 6px;">
        <b style="color: ${themeColor}; font-size: 16px; display: block; margin-bottom: 4px;">5. Social Change:</b>
  ...
  <!-- SECTION 4.1 -->
  <h2 style="color: ${themeColor}; border-bottom: 2px solid ${themeColor}; padding-bottom: 6px; margin-top: 30px;">4.1 Educational Sociology: Meaning and Scope</h2>
  ...
  <h3 style="color: ${themeColor}; margin-top: 24px;">(i) Emergence and Meaning of Educational Sociology</h3>
  <p>The application of sociological principles to the field of education is known as Educational Sociology. <b style="color: ${themeColor};">George Payne</b> is widely recognized as the <b>"Father of Educational Sociology"</b> following his groundbreaking 1928 publication, <i>'Principles of Educational Sociology'</i>.</p>

  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: ${themeColor};">George Payne's Definition:</b> <i>"By Educational Sociology we mean the science which describes and explains the institutions, social groups and social processes... in which and through which the individual gains and organizes his experiences."</i></li>
    <li><b style="color: ${themeColor};">Emile Durkheim's Definition:</b> <i>"Education is the influence exercised by adult generations on those that are not yet ready for social life. Its object is to arouse and develop in the child those physical, intellectual and moral states which are required of him by society."</i></li>
    <li><b style="color: ${themeColor};">A. K. C. Ottaway's Definition:</b> <i>"Educational Sociology is the scientific study of the relationship between education and society."</i></li>
  </ul>

  <!-- DISTINCTION BOX -->
  <div style="background: rgba(142, 45, 226, 0.08); border-left: 4px solid ${themeColor}; padding: 12px 16px; border-radius: 6px; margin: 16px 0;">
    <p style="margin: 0; color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      <b>Crucial Academic Distinction &bull; Educational Sociology vs. Sociology of Education:</b><br>
      &bull; <b style="color: ${themeColor};">Educational Sociology:</b> A practical, applied, problem-solving discipline that utilizes sociological findings to reform schools, improve curricula, and eliminate social prejudices.<br>
      &bull; <b style="color: ${themeColor};">Sociology of Education:</b> A purely theoretical, descriptive branch of general sociology that analyzes the educational system as a social institution alongside the family, church, and state.
    </p>
  </div>

  <h3 style="color: ${themeColor}; margin-top: 24px;">(ii) Scope of Educational Sociology</h3>
  ...
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: ${themeColor}; font-size: 16px;">1. Social Agencies of Education:</b>
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: ${themeColor}; font-size: 16px;">2. Social Interaction within the School:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: ${themeColor}; font-size: 16px;">3. Social Stratification and Equal Opportunity:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: ${themeColor}; font-size: 16px;">4. Socialization and Cultural Transmission:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <!-- SECTION 4.2 -->
  <h2 style="color: ${themeColor}; border-bottom: 2px solid ${themeColor}; padding-bottom: 6px; margin-top: 35px;">4.2 Culture: Meaning, Components, and Characteristics</h2>

  <p>Culture is the distinctive hallmark of human civilization. Animals possess biology, instincts, and habitats, but only human beings create, preserve, and transmit <b>Culture</b>. Etymologically, "culture" is derived from the Latin verb <b style="color: ${themeColor};">Colere</b>, which means <i>'to cultivate'</i> or <i>'to till and refine'</i>.</p>

  <h3 style="color: ${themeColor}; margin-top: 20px;">(i) Renowned Sociological Definitions of Culture</h3>
  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: ${themeColor};">Edward Burnett Tylor (1871 Classic Definition):</b> <i>"Culture is that complex whole which includes knowledge, belief, art, morals, law, custom, and any other capabilities and habits acquired by man as a member of society."</i></li>
    <li><b style="color: ${themeColor};">MacIver and Page:</b> <i>"Culture is the expression of our nature in our modes of living and thinking, in our everyday intercourse, in art, in literature, in recreation and enjoyment."</i></li>
  </ul>

  <h3 style="color: ${themeColor}; margin-top: 20px;">(ii) Components of Culture: Material vs. Non-Material Culture</h3>
  ...
  <h3 style="color: ${themeColor}; margin-top: 20px;">(iii) Essential Characteristics of Culture</h3>
  <div style="display: flex; flex-direction: column; gap: 10px; margin: 12px 0;">
    <div style="background: rgba(15, 23, 42, 0.7); padding: 10px 14px; border-left: 3px solid ${themeColor}; border-radius: 4px;">
      <b style="color: ${themeColor};">1. Culture is Learned:</b> Culture is not inherited through biological genes. A human infant born in India but raised in England acquires British language, food habits, and culture.
    </div>
    <div style="background: rgba(15, 23, 42, 0.7); padding: 10px 14px; border-left: 3px solid ${themeColor}; border-radius: 4px;">
      <b style="color: ${themeColor};">2. Culture is Social &amp; Shared:</b> It is never the exclusive property of a solitary individual; it belongs collectively to the social group.
    </div>
    <div style="background: rgba(15, 23, 42, 0.7); padding: 10px 14px; border-left: 3px solid ${themeColor}; border-radius: 4px;">
      <b style="color: ${themeColor};">3. Culture is Transmissive:</b> It is passed down across successive generations through language, symbolic communication, and formal schooling.
    </div>
    <div style="background: rgba(15, 23, 42, 0.7); padding: 10px 14px; border-left: 3px solid ${themeColor}; border-radius: 4px;">
      <b style="color: ${themeColor};">4. Culture is Dynamic &amp; Adaptive:</b> It is never static. It continuously absorbs fresh inventions, scientific discoveries, and intercultural influences.
    </div>
    <div style="background: rgba(15, 23, 42, 0.7); padding: 10px 14px; border-left: 3px solid ${themeColor}; border-radius: 4px;">
      <b style="color: ${themeColor};">5. Culture is Super-Organic:</b> It outlives the mortal lifespan of individual creators, continuing across centuries.
    </div>
  </div>

  <!-- SECTION 4.3 -->
  <h2 style="color: ${themeColor}; border-bottom: 2px solid ${themeColor}; padding-bottom: 6px; margin-top: 35px;">4.3 Relationship Between Culture and Education</h2>
  ...
  <h3 style="color: ${themeColor}; margin-top: 20px;">(i) Impact of Culture on Education</h3>
  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: ${themeColor};">Determines Aims of Education:</b> A democratic culture formulates educational aims centered on liberty, critical inquiry, and equality; a totalitarian culture demands blind obedience.</li>
    <li><b style="color: ${themeColor};">Shapes Curriculum Content:</b> School subjects, literature, and history textbooks directly reflect the values, achievements, and ideals of the prevailing culture.</li>
    <li><b style="color: ${themeColor};">Influences Methods of Teaching:</b> An authoritarian culture fosters rote dictation, whereas a progressive culture mandates dialogic, student-centered discussions.</li>
    <li><b style="color: ${themeColor};">Defines the Teacher's Role:</b> In ancient Indian Gurukul culture, the Guru was revered as a spiritual father; in modern secular culture, the teacher acts as a democratic facilitator.</li>
  </ul>

  <h3 style="color: ${themeColor}; margin-top: 20px;">(ii) Impact and Role of Education in Culture</h3>
  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: ${themeColor};">1. Preservation of Cultural Heritage:</b> Without schools and universities, ancient literature, philosophies, music, and scientific discoveries would vanish with passing generations.</li>
    <li><b style="color: ${themeColor};">2. Transmission of Culture:</b> Education acts as the bridge transmitting cultural wisdom from older adults to younger children.</li>
    <li><b style="color: ${themeColor};">3. Refinement and Purification of Culture:</b> Education is not a blind mirror; it acts as a critical filter. It weeds out obsolete superstitions, caste discrimination, gender oppression, and dogma.</li>
    <li><b style="color: ${themeColor};">4. Acculturation and Cultural Synthesis:</b> In diverse societies like India, education synthesizes diverse regional traditions with modern democratic and technological ideals.</li>
  </ul>

  <!-- SECTION 4.4 -->
  <h2 style="color: ${themeColor}; border-bottom: 2px solid ${themeColor}; padding-bottom: 6px; margin-top: 35px;">4.4 Social Change: Concept and Significance</h2>
  ...
  <h3 style="color: ${themeColor}; margin-top: 20px;">(i) Definitions of Social Change</h3>
  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: ${themeColor};">MacIver and Page:</b> <i>"Social change is a change in social relationships."</i></li>
    <li><b style="color: ${themeColor};">Kingsley Davis:</b> <i>"By social change is meant only such alterations as occur in the structure and functions of society."</i></li>
    <li><b style="color: ${themeColor};">M. D. Jenson:</b> <i>"Social change describes variations in, or modifications of, any aspect of social processes, patterns or interaction."</i></li>
  </ul>

  <h3 style="color: ${themeColor}; margin-top: 20px;">(ii) Factors Causing Social Change</h3>
  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: ${themeColor};">Technological Factors:</b> Inventions such as the steam engine, electricity, smartphones, and Artificial Intelligence revolutionize work, transport, and communication.</li>
    <li><b style="color: ${themeColor};">Economic Factors:</b> Industrialization, urbanization, global market integration, and division of labor transform rural societies into urban metropolises.</li>
    <li><b style="color: ${themeColor};">Biological &amp; Demographic Factors:</b> Population explosions, migration, changing birth/death rates, and urbanization remodel social life.</li>
    <li><b style="color: ${themeColor};">Ideological &amp; Political Factors:</b> Powerful revolutionary ideas &mdash; democracy, liberty, gender equality, socialism &mdash; topple feudal regimes.</li>
  </ul>

  <!-- SECTION 4.5 -->
  <h2 style="color: ${themeColor}; border-bottom: 2px solid ${themeColor}; padding-bottom: 6px; margin-top: 35px;">4.5 Social Change and Education</h2>
  ...
  <h3 style="color: ${themeColor}; margin-top: 20px;">(i) Education as an Agent (Cause) of Social Change</h3>
  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: ${themeColor};">Awakens Critical Consciousness:</b> Education dispels blind superstition, fatalism, and passive acceptance of social injustices.</li>
    <li><b style="color: ${themeColor};">Spreads Democratic &amp; Constitutional Values:</b> In modern India, education has been the foremost weapon against the caste hierarchy, untouchability, child marriage, and the subjugation of women.</li>
    <li><b style="color: ${themeColor};">Generates Scientific &amp; Technical Skills:</b> Universities produce doctors, engineers, agronomists, and IT innovators who power economic transformation.</li>
    <li><b style="color: ${themeColor};">Stabilizes Social Change:</b> Rapid social change risks societal chaos. Education stabilizes change by anchoring youth in core ethical values while adapting to new realities.</li>
  </ul>

  <h3 style="color: ${themeColor}; margin-top: 20px;">(ii) Education as a Product (Effect) of Social Change</h3>
  <p>When society undergoes technological, industrial, or political transformation, education is forced to remodel itself:</p>
  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: ${themeColor};">From Gurukuls to Smart Classrooms:</b> Ancient agricultural societies needed oral recitation; the modern digital economy demands computer coding, digital literacy, and AI-driven platforms.</li>
    <li><b style="color: ${themeColor};">Curricular Reforms:</b> Emerging social concerns (climate crisis, gender justice, cyber safety) compel boards to introduce environmental science and computer studies.</li>
  </ul>
  ...
  <div style="background: rgba(30, 41, 59, 0.7); border: 1px solid rgba(255, 255, 255, 0.1); border-left: 4px solid #8E2DE2; border-radius: 8px; padding: 14px 18px; margin: 25px 0;">
    <h4 style="color: #8E2DE2; margin: 0 0 6px 0; font-size: 16px;">🏛️ Modern Relevance: Sociological Vision of NEP 2020</h4>
    <p style="margin: 0; color: #CBD5E1; font-size: 14.5px; line-height: 1.6;">
      ...
      <br>&bull; <b>Promoting Equity &amp; Inclusion:</b> Creates Special Education Zones (SEZs) and gender inclusion funds for Socio-Economically Disadvantaged Groups (SEDGs).
      <br>&bull; <b>Cultural Synthesis:</b> Revives Indian languages, local art, and indigenous knowledge systems (IKS) alongside cutting-edge global 21st-century digital competencies.
    </p>
  </div>
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <!-- SECTION A HEADER -->
  <div style="background: rgba(142, 45, 226, 0.15); border-left: 5px solid ${themeColor}; padding: 10px 16px; border-radius: 4px; margin: 15px 0 20px 0;">
  ...
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: ${themeColor}; font-size: 16px; margin: 0 0 8px 0;">Q1: What is the etymological origin of the word 'Sociology'?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      'Sociology' is derived from the Latin word <b style="color: ${themeColor};">'Socius'</b> (meaning companion or society) and the Greek word <b style="color: ${themeColor};">'Logos'</b> (meaning science or study). Auguste Comte coined the term in 1839.
    </div>
  </div>

  <!-- Q2 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: ${themeColor}; font-size: 16px; margin: 0 0 8px 0;">Q2: Who is regarded as the "Father of Educational Sociology"?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: ${themeColor};">George Payne</b> is regarded as the Father of Educational Sociology after publishing his landmark 1928 book, <i>'Principles of Educational Sociology'</i>.
    </div>
  </div>

  <!-- Q3 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: ${themeColor}; font-size: 16px; margin: 0 0 8px 0;">Q3: State Emile Durkheim's sociological definition of Education.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      According to <b style="color: ${themeColor};">Emile Durkheim:</b>
  ...
  <!-- Q4 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: ${themeColor}; font-size: 16px; margin: 0 0 8px 0;">Q4: What is the primary difference between Educational Sociology and Sociology of Education?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      &bull; <b style="color: ${themeColor};">Educational Sociology:</b> Practical, applied problem-solving discipline for schooling.<br>
      &bull; <b style="color: ${themeColor};">Sociology of Education:</b> Theoretical, analytical study of education as a social institution.
    </div>
  </div>

  <!-- Q5 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: ${themeColor}; font-size: 16px; margin: 0 0 8px 0;">Q5: What is the Latin origin of the word 'Culture'?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      'Culture' originates from the Latin verb <b style="color: ${themeColor};">'Colere'</b>, which means <i>'to cultivate'</i>, <i>'to till the ground'</i>, or to refine human intellectual and moral faculties.
    </div>
  </div>

  <!-- Q6 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: ${themeColor}; font-size: 16px; margin: 0 0 8px 0;">Q6: State E. B. Tylor's classic definition of Culture.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      According to <b style="color: ${themeColor};">E. B. Tylor:</b>
  ...
  <!-- Q7 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: ${themeColor}; font-size: 16px; margin: 0 0 8px 0;">Q7: Differentiate between Material and Non-Material Culture.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      &bull; <b style="color: ${themeColor};">Material Culture:</b> Tangible, physical objects (buildings, tools, smartphones, vehicles).<br>
      &bull; <b style="color: ${themeColor};">Non-Material Culture:</b> Intangible mental creations (values, beliefs, morals, language, laws).
    </div>
  </div>

  <!-- Q8 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: ${themeColor}; font-size: 16px; margin: 0 0 8px 0;">Q8: Who coined the term "Cultural Lag" and what does it mean?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      Coined by <b style="color: ${themeColor};">William F. Ogburn</b>. It refers to the gap when material technology changes rapidly, but non-material values and customs lag behind.
    </div>
  </div>

  <!-- Q9 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: ${themeColor}; font-size: 16px; margin: 0 0 8px 0;">Q9: Define "Social Change" according to MacIver and Page.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      According to <b style="color: ${themeColor};">MacIver and Page:</b>
      <br><b style="color: ${themeColor};">"Social change is a change in social relationships."</b> It refers to modifications in social structures and behavioral patterns.
    </div>
  </div>

  <!-- Q10 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: ${themeColor}; font-size: 16px; margin: 0 0 8px 0;">Q10: Mention any two major technological factors that cause social change.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      &bull; <b style="color: ${themeColor};">Internet and Mobile Communication:</b> Instant global connectivity.<br>
      &bull; <b style="color: ${themeColor};">Industrial Automation &amp; AI:</b> Transformation of employment, labor, and urban lifestyles.
    </div>
  </div>

  <!-- Q11 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: ${themeColor}; font-size: 16px; margin: 0 0 8px 0;">Q11: State two ways in which Education acts as an Agent of Social Change.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
  ...
  <!-- Q12 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: ${themeColor}; font-size: 16px; margin: 0 0 8px 0;">Q12: How is Education a "Product" of Social Change?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
  ...
  <!-- SECTION B HEADER -->
  <div style="background: rgba(142, 45, 226, 0.15); border-left: 5px solid ${themeColor}; padding: 10px 16px; border-radius: 4px; margin: 30px 0 20px 0;">
    <h2 style="color: ${themeColor}; margin: 0; font-size: 18px; font-weight: bold;">
  ...
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: ${themeColor}; font-size: 16.5px; margin: 0 0 10px 0;">Q13: Explain the meaning and four major areas under the Scope of Educational Sociology.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      ...
      <br>&bull; <b style="color: ${themeColor};">Social Agencies of Education:</b> Studies the educational responsibilities of family, school, peer groups, and mass media.
      <br>&bull; <b style="color: ${themeColor};">Classroom Social Dynamics:</b> Investigates teacher-student relationships, sociometric groupings, and classroom morale.
      <br>&bull; <b style="color: ${themeColor};">Social Stratification &amp; Equity:</b> Analyzes the obstacles posed by caste, gender, and economic poverty to educational access.
      <br>&bull; <b style="color: ${themeColor};">Socialization Process:</b> Explains how the school transmits democratic values and converts raw human infants into cultured citizens.
    </div>
  </div>

  <!-- Q14 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: ${themeColor}; font-size: 16.5px; margin: 0 0 10px 0;">Q14: Explain four essential characteristics of Culture.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      Culture exhibits distinctive sociological attributes:
      <br>&bull; <b style="color: ${themeColor};">Culture is Learned:</b> It is acquired socially after birth through experience, language, and imitation &mdash; not inherited through genes.
      <br>&bull; <b style="color: ${themeColor};">Culture is Shared:</b> It is the collective common heritage of a social group, never private individual property.
      <br>&bull; <b style="color: ${themeColor};">Culture is Transmissive:</b> It is handed down through generations via oral traditions, literature, and educational institutions.
      <br>&bull; <b style="color: ${themeColor};">Culture is Dynamic &amp; Adaptive:</b> It evolves continuously by absorbing scientific discoveries and intercultural contacts.
    </div>
  </div>

  <!-- Q15 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: ${themeColor}; font-size: 16.5px; margin: 0 0 10px 0;">Q15: Explain W. F. Ogburn's theory of "Cultural Lag" with a concrete modern example.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      Cultural Lag explains sociological imbalance during historical transitions:
      <br>&bull; <b style="color: ${themeColor};">Core Concept:</b> W. F. Ogburn observed that material culture (tools, technology) moves forward rapidly, while non-material culture (customs, laws, ethics) changes slowly.
      <br>&bull; <b style="color: ${themeColor};">The Resulting Lag:</b> The gap between fast-moving technology and slow-moving ethics creates social disorganization.
      <br>&bull; <b style="color: ${themeColor};">Modern Example:</b> Internet and smartphones spread instantly across society, but cyber ethics, privacy laws, and digital etiquette lagged behind, resulting in cybercrime and addiction.
      <br>&bull; <b style="color: ${themeColor};">Role of Education:</b> Education bridges this lag by cultivating moral wisdom to responsibly utilize technological advancements.
    </div>
  </div>

  <!-- Q16 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: ${themeColor}; font-size: 16.5px; margin: 0 0 10px 0;">Q16: How does Culture influence Education? State four distinct ways.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      The prevailing cultural matrix shapes every facet of the educational system:
      <br>&bull; <b style="color: ${themeColor};">Determines Educational Aims:</b> Democratic cultures prioritize personal liberty and equality; religious cultures emphasize spiritual virtues.
      <br>&bull; <b style="color: ${themeColor};">Shapes Curriculum Content:</b> School textbooks, literature, and social sciences directly mirror the heritage and ideals of the society.
      <br>&bull; <b style="color: ${themeColor};">Guides Teaching Methods:</b> Progressive cultures mandate dialogic inquiry and experiments; orthodox cultures promote rote memorization.
      <br>&bull; <b style="color: ${themeColor};">Defines the Teacher's Role:</b> Determines whether the teacher acts as an authoritarian master or as an empathetic democratic guide.
    </div>
  </div>

  <!-- Q17 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: ${themeColor}; font-size: 16.5px; margin: 0 0 10px 0;">Q17: Explain the role of Education in the Preservation and Refinement of Culture.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      Education serves as the cultural guardian and filter for human civilization:
      <br>&bull; <b style="color: ${themeColor};">Preservation of Heritage:</b> Archives, libraries, and universities conserve ancient philosophies, scientific lore, and classical literature.
      <br>&bull; <b style="color: ${themeColor};">Transmission Across Generations:</b> Acts as the pipeline delivering accumulated societal knowledge to the younger generation.
      <br>&bull; <b style="color: ${themeColor};">Critical Refinement:</b> Education evaluates traditional customs, discarding superstitions, caste prejudices, and gender subjugation.
      <br>&bull; <b style="color: ${themeColor};">Cultural Innovation:</b> Stimulates original research, artistic expression, and intercultural synthesis.
    </div>
  </div>

  <!-- Q18 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: ${themeColor}; font-size: 16.5px; margin: 0 0 10px 0;">Q18: State four major factors responsible for bringing about Social Change.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      Social change is driven by multiple interrelated forces:
      <br>&bull; <b style="color: ${themeColor};">Technological Inventions:</b> Electricity, automobiles, computers, and AI fundamentally alter communication and human lifestyles.
      <br>&bull; <b style="color: ${themeColor};">Economic Industrialization:</b> Factory production and urbanization break joint families and rural agrarian structures.
      <br>&bull; <b style="color: ${themeColor};">Ideological &amp; Political Movements:</b> Ideas of democracy, human rights, and feminism dismantle feudal hierarchies.
      <br>&bull; <b style="color: ${themeColor};">Demographic &amp; Environmental Factors:</b> Population growth, migration, and climate shifts force institutional adaptations.
    </div>
  </div>

  <!-- Q19 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: ${themeColor}; font-size: 16.5px; margin: 0 0 10px 0;">Q19: Explain how Education acts as an Instrument of Social Change in India.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      In developing nations like India, education spearheads social transformation:
      <br>&bull; <b style="color: ${themeColor};">Eliminating Social Injustices:</b> Eradicates untouchability, child marriage, dowry evils, and gender subjugation.
      <br>&bull; <b style="color: ${themeColor};">Instilling Constitutional Values:</b> Inculcates secularism, democracy, fundamental rights, and the rule of law.
      <br>&bull; <b style="color: ${themeColor};">Promoting Social Mobility:</b> Enables disadvantaged rural youth to gain technical qualifications and enter high-income professions.
      <br>&bull; <b style="color: ${themeColor};">Fostering Scientific Temper:</b> Replaces fatalistic superstitions with empirical inquiry and critical reasoning.
    </div>
  </div>

  <!-- Q20 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: ${themeColor}; font-size: 16.5px; margin: 0 0 10px 0;">Q20: What are the primary obstacles and resistance to Social Change through Education?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      Educational social reform often confronts formidable barriers:
      <br>&bull; <b style="color: ${themeColor};">Orthodox Traditions &amp; Dogma:</b> Deep-rooted religious fundamentalism and caste prejudices resist modern progressive ideas.
      <br>&bull; <b style="color: ${themeColor};">Cultural Lag:</b> Emotional reluctance of communities to abandon outdated customs even when technology advances.
      <br>&bull; <b style="color: ${themeColor};">Economic Poverty:</b> Impoverished families prioritize immediate child labor over long-term schooling.
      <br>&bull; <b style="color: ${themeColor};">Systemic Institutional Inertia:</b> Rigid bureaucratic curricula and inadequate school funding slow reform implementation.
    </div>
  </div>
  ...
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 18px; margin-bottom: 20px;">
    <h3 style="color: ${themeColor}; font-size: 17px; margin: 0 0 12px 0;">Q21: Define Educational Sociology. Distinguish it from Sociology of Education, and elaborate its comprehensive scope.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.7;">
      ...
      <br><br>
      <b style="color: ${themeColor};">2. Core Distinction &amp; Scope:</b><br>
      &bull; <b>Educational Sociology vs. Sociology of Education:</b>
      ...
      <br>&bull; <b>Comprehensive Scope:</b>
  ...
  <!-- Q22 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 18px; margin-bottom: 20px;">
    <h3 style="color: ${themeColor}; font-size: 17px; margin: 0 0 12px 0;">Q22: Define Culture. Analyze its components and characteristics, and explain the concept of Cultural Lag with modern relevance.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.7;">
      <b style="color: ${themeColor};">1. Introduction:</b><br>
      ...
      <br><br>
      <b style="color: ${themeColor};">2. Components, Characteristics, and Cultural Lag:</b><br>
      &bull; <b>Dual Components:</b>
      ...
      <br>&bull; <b>Key Characteristics:</b> Culture is learned (non-biological), shared, transmissive across generations, dynamic, and integrated.
      <br>&bull; <b>W. F. Ogburn's Theory of Cultural Lag:</b>
      ...
      <br><br>
      <b style="color: ${themeColor};">3. Conclusion &amp; Role of Education:</b><br>
  ...
  <!-- Q23 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 18px; margin-bottom: 20px;">
    <h3 style="color: ${themeColor}; font-size: 17px; margin: 0 0 12px 0;">Q23: Critically examine the symbiotic relationship between Culture and Education. How do they mutually shape each other?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.7;">
      <b style="color: ${themeColor};">1. Introduction:</b><br>
      ...
      <br><br>
      <b style="color: ${themeColor};">2. Two-Way Mutual Interaction:</b><br>
      &bull; <b>A. Impact of Culture on Education:</b>
      ...
      <br>&bull; <b>B. Role of Education in Culture:</b>
  ...
  <!-- Q24 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 18px; margin-bottom: 20px;">
    <h3 style="color: ${themeColor}; font-size: 17px; margin: 0 0 12px 0;">Q24: What is Social Change? Analyze its nature, characteristics, and the major factors responsible for social transformation.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.7;">
      <b style="color: ${themeColor};">1. Introduction:</b><br>
      ...
      <br><br>
      <b style="color: ${themeColor};">2. Nature and Driving Factors:</b><br>
      &bull; <b>Key Characteristics:</b> Social change is universal (occurs in all societies), continuous (never permanently halted), temporal (unfolds over time), and multi-causal.
      <br>&bull; <b>Primary Driving Factors:</b>
      ...
      <br><br>
      <b style="color: ${themeColor};">3. Conclusion &amp; Significance:</b><br>
  ...
  <!-- Q25 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(142, 45, 226, 0.3); border-radius: 8px; padding: 18px; margin-bottom: 20px;">
    <h3 style="color: ${themeColor}; font-size: 17px; margin: 0 0 12px 0;">Q25: "Education is both an Agent and a Product of Social Change." Discuss this dynamic two-way relationship with reference to modern Indian society and NEP 2020.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.7;">
      <b style="color: ${themeColor};">1. Introduction:</b><br>
      ...
      <br><br>
      <b style="color: ${themeColor};">2. In-Depth Comparative Analysis:</b><br>
      &bull; <b>Education as an Agent (Cause) of Social Change:</b>
      ...
      <br>&bull; <b>Education as a Product (Effect) of Social Change:</b>
      ...
      <br>&bull; <b>NEP 2020's Sociological Vision:</b>
