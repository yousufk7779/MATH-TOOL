...
export const c7Geo8: ChapterContent = {
  ...
  introduction:
    "Union Territories of J&K and Ladakh are known for their unique geographical features and culture.",
  definitions: [],
  keyPoints: [],
  formulas: [],
  crux: [],
  mcqs: [
    ...
    },
    {
      id: "c7g8-mcq-4",
      question:
        "Which of these is a famous traditional multi-course meal of Kashmir?",
