...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <div style="background: rgba(255, 138, 101, 0.06); border: 1.5px solid #FF8A65; border-radius: 12px; padding: 18px; margin-bottom: 25px;">
    <h2 class="text-center" style="color: #FF8A65; font-weight: bold; margin: 0 0 6px 0; font-size: 20px; font-weight: bold;">🧭 Quick Glossary &amp; Core Guidance Concepts</h2>
    ...
    <div style="display: flex; flex-direction: column; gap: 12px;">
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FF8A65; border-radius: 6px;">
        <b style="color: #FF8A65; font-size: 16px; display: block; margin-bottom: 4px;">1. Guidance:</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FF8A65; border-radius: 6px;">
        <b style="color: #FF8A65; font-size: 16px; display: block; margin-bottom: 4px;">2. Counseling:</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FF8A65; border-radius: 6px;">
        <b style="color: #FF8A65; font-size: 16px; display: block; margin-bottom: 4px;">3. Educational Guidance:</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FF8A65; border-radius: 6px;">
        <b style="color: #FF8A65; font-size: 16px; display: block; margin-bottom: 4px;">4. Vocational Guidance:</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FF8A65; border-radius: 6px;">
        <b style="color: #FF8A65; font-size: 16px; display: block; margin-bottom: 4px;">5. Carl Rogers' Client-Centered Approach:</b>
  ...
  <!-- SECTION 5.1 -->
  <h2 style="color: #FF8A65; font-weight: bold; border-bottom: 2px solid #FF8A65; padding-bottom: 6px; margin-top: 30px;">5.1 Meaning and Principles of Guidance</h2>
  ...
  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 24px;">(i) Standard Definitions of Guidance</h3>
  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: #FF8A65;">Arthur J. Jones:</b> <i>"Guidance involves personal help given by someone; it is designed to assist a person to decide where he wants to go, what he wants to do, or how he can best accomplish his purpose."</i></li>
    <li><b style="color: #FF8A65;">Crow and Crow:</b> <i>"Guidance is assistance made available by personally qualified and adequately trained men or women to an individual of any age to help him manage his own life activities, develop his own point of view, make his own decisions, and carry his own burdens."</i></li>
    <li><b style="color: #FF8A65;">Ruth Strang:</b> <i>"Guidance is a process of helping every individual, through his own efforts, to discover and develop his potentialities for his personal happiness and social usefulness."</i></li>
  </ul>

  <!-- PRINCIPLES OF GUIDANCE -->
  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 24px;">(ii) Universal Principles of Guidance</h3>
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">1. Guidance is a Continuous, Lifelong Process:</b>
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">2. Respect for Individual Differences:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">3. Guidance is for All, Not Only Problem Cases:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FF8A65; font-size: 16px;">4. Guidance Leads to Self-Direction (Not Imposition):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <!-- SECTION 5.2 -->
  <h2 style="color: #FF8A65; font-weight: bold; border-bottom: 2px solid #FF8A65; padding-bottom: 6px; margin-top: 35px;">5.2 Purpose of Guidance for Children and Adolescents</h2>
  ...
  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 20px;">(i) Why Guidance is Vital for Children</h3>
  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: #FF8A65;">Transition from Home to School:</b> Helps tender toddlers overcome separation anxiety and adjust to unfamiliar classroom routines.</li>
    <li><b style="color: #FF8A65;">Early Detection of Learning Deficits:</b> Identifies speech difficulties, hearing impairments, dyslexia, and ADHD before they cause permanent academic trauma.</li>
    <li><b style="color: #FF8A65;">Fostering Social Socialization:</b> Teaches sharing, cooperation, empathy, and emotional self-control in peer groups.</li>
  </ul>

  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 20px;">(ii) Purpose of Guidance for Adolescents</h3>
  <div style="display: flex; flex-direction: column; gap: 10px; margin: 14px 0;">
    <div style="background: rgba(15, 23, 42, 0.7); padding: 10px 14px; border-left: 3px solid #FF8A65; border-radius: 4px;">
      <b style="color: #FF8A65;">1. Coping with Physical &amp; Hormonal Changes:</b> Adolescents experience sudden growth spurts, sexual maturation, and bodily consciousness. Guidance dispels anxiety and misinformation.
    </div>
    <div style="background: rgba(15, 23, 42, 0.7); padding: 10px 14px; border-left: 3px solid #FF8A65; border-radius: 4px;">
      <b style="color: #FF8A65;">2. Resolving Identity Crisis &amp; Emotional Turbulence:</b> As Erik Erikson noted, teenagers battle "Identity vs. Role Confusion." Guidance provides emotional grounding and healthy self-esteem.
    </div>
    <div style="background: rgba(15, 23, 42, 0.7); padding: 10px 14px; border-left: 3px solid #FF8A65; border-radius: 4px;">
      <b style="color: #FF8A65;">3. Overcoming Peer Pressure &amp; Substance Abuse:</b> Shields youth from destructive temptations (smoking, drugs, alcoholism, cyber delinquency, aggressive gangs).
    </div>
    <div style="background: rgba(15, 23, 42, 0.7); padding: 10px 14px; border-left: 3px solid #FF8A65; border-radius: 4px;">
      <b style="color: #FF8A65;">4. Career &amp; Stream Decision-Making:</b> Helps Class 10 and 12 students choose academic streams (Arts, Science, Commerce, Vocational) aligned with real aptitudes rather than parental coercion.
    </div>
  </div>

  <!-- SECTION 5.3 -->
  <h2 style="color: #FF8A65; font-weight: bold; border-bottom: 2px solid #FF8A65; padding-bottom: 6px; margin-top: 35px;">5.3 Counseling: Meaning, Scope, and Importance</h2>
  ...
  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 20px;">(i) Definitions of Counseling</h3>
  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: #FF8A65;">Carl Rogers:</b> <i>"Counseling is a continuous series of direct contacts with the individual which aims to assist him in changing his attitudes and conduct."</i></li>
    <li><b style="color: #FF8A65;">Wrenn:</b> <i>"Counseling is a personal and dynamic relationship between two individuals &mdash; an approach to problem-solving where the client is helped to grow towards self-reliance."</i></li>
    <li><b style="color: #FF8A65;">Gustad:</b> <i>"Counseling is a learning-oriented process carried on in a simple, one-to-one social environment."</i></li>
  </ul>
  ...
  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 20px;">(ii) Three Major Types/Approaches to Counseling</h3>
  <div style="display: flex; flex-direction: column; gap: 10px; margin: 14px 0;">
    <div style="background: rgba(15, 23, 42, 0.7); padding: 10px 14px; border-left: 3px solid #FF8A65; border-radius: 4px;">
  ...
  <!-- SECTION 5.4 -->
  <h2 style="color: #FF8A65; font-weight: bold; border-bottom: 2px solid #FF8A65; padding-bottom: 6px; margin-top: 35px;">5.4 Role of the Teacher in Guidance and Counseling</h2>
  ...
  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 20px;">(i) Multifaceted Functions of the Teacher as a Guide</h3>
  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: #FF8A65;">Primary Observer &amp; Talent Scout:</b> Identifies hidden creative sparks, unusual aptitudes, or sudden declines in performance.</li>
    <li><b style="color: #FF8A65;">Creating a Warm Classroom Climate:</b> Builds an emotionally safe, non-judgmental atmosphere where students are not mocked for mistakes.</li>
    <li><b style="color: #FF8A65;">Diagnosing Learning Impediments:</b> Pinpoints specific academic bottlenecks (dyscalculia, reading deficits, exam panic) and provides remedial instruction.</li>
    <li><b style="color: #FF8A65;">Referral Agent:</b> Acts as the vital bridge recognizing severe emotional distress (depression, suicidal ideation) and referring the child to the professional counselor.</li>
  </ul>

  <!-- SECTION 5.5 -->
  <h2 style="color: #FF8A65; font-weight: bold; border-bottom: 2px solid #FF8A65; padding-bottom: 6px; margin-top: 35px;">5.5 Role of Other Stakeholders in Guidance and Counseling</h2>
  ...
  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 20px;">(i) Detailed Roles of Stakeholders</h3>
  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: #FF8A65;">1. Parents &amp; Family:</b> The primary psychological foundation. Parents must avoid imposing unfulfilled personal ambitions on their children, eliminate harsh comparison with siblings, and provide affectionate acceptance.</li>
    <li><b style="color: #FF8A65;">2. School Administration (Principal):</b> Allocates physical counseling rooms, ensures confidentiality, organizes career exhibitions, and funds psychological testing batteries.</li>
    <li><b style="color: #FF8A65;">3. Peer Groups:</b> Well-guided peer counseling programs allow teenagers to share anxieties with empathetic friends without fear of adult reprimand.</li>
    <li><b style="color: #FF8A65;">4. Community &amp; Health Agencies:</b> Medical clinics, mental health NGOs, and youth employment exchanges provide real-world vocational internships and clinical psychiatric care.</li>
  </ul>

  <!-- SECTION 5.6 -->
  <h2 style="color: #FF8A65; font-weight: bold; border-bottom: 2px solid #FF8A65; padding-bottom: 6px; margin-top: 35px;">5.6 Role of Professional Counselors in Schools</h2>
  ...
  <h3 style="color: #FF8A65; font-weight: bold; margin-top: 20px;">(i) Key Professional Responsibilities</h3>
  <ul style="padding-left: 20px; line-height: 1.8;">
    <li><b style="color: #FF8A65;">Administering Standardized Psychological Tests:</b> Conducts valid assessments of Intelligence (IQ), Differential Aptitude Tests (DAT), interest inventories, and personality scales.</li>
    <li><b style="color: #FF8A65;">Individual Therapeutic Counseling:</b> Conducts private, confidential therapeutic sessions for trauma, grief, cyber addiction, acute depression, and severe family conflict.</li>
    <li><b style="color: #FF8A65;">Crisis Intervention:</b> Manages emergency situations such as bullying, panic attacks, self-harm risks, and school violence.</li>
    <li><b style="color: #FF8A65;">Organizing Career Information Bureaus:</b> Maintains career libraries, bulletin boards, and invites university representatives and industry experts.</li>
    <li><b style="color: #FF8A65;">Parent &amp; Teacher Consultations:</b> Advises parents and teachers on constructive behavioral management strategies without breaching client privacy.</li>
  </ul>
  ...
  <div style="background: rgba(30, 41, 59, 0.7); border: 1px solid rgba(255, 255, 255, 0.1); border-left: 4px solid #FF8A65; border-radius: 8px; padding: 14px 18px; margin: 25px 0;">
    <h4 style="color: #FF8A65; font-weight: bold; margin: 0 0 6px 0; font-size: 16px;">🏛️ Modern Relevance: NEP 2020 &amp; 'MANODARPAN' Initiative</h4>
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <!-- SECTION A HEADER -->
  <div style="background: rgba(255, 138, 101, 0.15); border-left: 5px solid #FF8A65; padding: 10px 16px; border-radius: 4px; margin: 15px 0 20px 0;">
    <h2 style="color: #FF8A65; font-weight: bold; margin: 0; font-size: 18px; font-weight: bold;">
  ...
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin: 0 0 8px 0;">Q1: Define Guidance according to Arthur J. Jones.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      According to <b style="color: #FF8A65;">Arthur J. Jones:</b>
  ...
  <!-- Q2 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin: 0 0 8px 0;">Q2: What are the three foundational pillars or types of Guidance?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      The three foundational types of guidance are:
      <br>&bull; <b style="color: #FF8A65;">Educational Guidance</b>
      <br>&bull; <b style="color: #FF8A65;">Vocational Guidance</b>
      <br>&bull; <b style="color: #FF8A65;">Personal &amp; Social Guidance</b>
    </div>
  </div>

  <!-- Q3 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin: 0 0 8px 0;">Q3: State the core principle regarding the continuity of Guidance.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      Guidance is a <b style="color: #FF8A65;">continuous, lifelong process</b>. It is not an isolated one-time emergency event; it starts in childhood and extends through life.
    </div>
  </div>

  <!-- Q4 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin: 0 0 8px 0;">Q4: How did G. Stanley Hall describe the period of Adolescence?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      Psychologist G. Stanley Hall famously termed adolescence as a period of <b style="color: #FF8A65;">"Storm and Stress"</b> (<i>Sturm und Drang</i>), marked by rapid biological, hormonal, and emotional turbulence.
    </div>
  </div>

  <!-- Q5 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin: 0 0 8px 0;">Q5: Define Counseling according to Carl Rogers.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      According to <b style="color: #FF8A65;">Carl Rogers:</b>
  ...
  <!-- Q6 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin: 0 0 8px 0;">Q6: State two primary differences between Guidance and Counseling.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      &bull; <b style="color: #FF8A65; font-weight: bold;">Scope:</b> Guidance is a broad umbrella service; counseling is its specialized, intimate core.<br>
      &bull; <b style="color: #FF8A65; font-weight: bold;">Setting:</b> Guidance can be given to large groups; counseling is strictly confidential, face-to-face, and one-on-one.
    </div>
  </div>

  <!-- Q7 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin: 0 0 8px 0;">Q7: Who developed the "Client-Centered" or Non-Directive approach to Counseling?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      Eminent American psychologist <b style="color: #FF8A65;">Carl Rogers</b> developed the Client-Centered (Non-Directive) approach, emphasizing unconditional positive regard and client self-discovery.
    </div>
  </div>

  <!-- Q8 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin: 0 0 8px 0;">Q8: What is Directive Counseling and who was its chief proponent?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      Pioneered by <b style="color: #FF8A65;">E. G. Williamson</b>. In Directive Counseling, the counselor is counselor-centered: actively analyzing data, diagnosing the problem, and prescribing solutions.
    </div>
  </div>

  <!-- Q9 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin: 0 0 8px 0;">Q9: What is Eclectic Counseling?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      Formulated by <b style="color: #FF8A65;">F. C. Thorne</b>, Eclectic Counseling is a flexible synthesis that judiciously combines directive and non-directive techniques to match the unique client.
    </div>
  </div>

  <!-- Q10 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin: 0 0 8px 0;">Q10: State the primary role of the classroom teacher as a "Referral Agent".</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
  ...
  <!-- Q11 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin: 0 0 8px 0;">Q11: What is the 'MANODARPAN' initiative launched by the Ministry of Education?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
  ...
  <!-- Q12 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 14px 16px; margin-bottom: 16px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16px; margin: 0 0 8px 0;">Q12: State one ethical duty of a professional counselor regarding student information.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      Maintaining <b style="color: #FF8A65;">strict professional confidentiality</b> &mdash; never disclosing personal counseling disclosures to peers, other teachers, or public records without consent.
    </div>
  </div>

  <!-- SECTION B HEADER -->
  <div style="background: rgba(255, 138, 101, 0.15); border-left: 5px solid #FF8A65; padding: 10px 16px; border-radius: 4px; margin: 30px 0 20px 0;">
    <h2 style="color: #FF8A65; font-weight: bold; margin: 0; font-size: 18px; font-weight: bold;">
  ...
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16.5px; margin: 0 0 10px 0;">Q13: State and explain four core principles of an effective Guidance program.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      Guidance rests on foundational psychological principles:
      <br>&bull; <b style="color: #FF8A65;">Universal Service for All:</b> Guidance is not restricted to problem children; it caters to average, gifted, and slow learners alike.
      <br>&bull; <b style="color: #FF8A65;">Continuous and Developmental:</b> It operates across all educational and developmental stages from infancy to old age.
      <br>&bull; <b style="color: #FF8A65;">Promotes Self-Direction:</b> Guidance does not make decisions for the individual; it trains the person to make autonomous choices.
      <br>&bull; <b style="color: #FF8A65;">Respect for Individual Uniqueness:</b> Programs are tailored to the distinct aptitudes, abilities, and interests of each learner.
    </div>
  </div>

  <!-- Q14 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16.5px; margin: 0 0 10px 0;">Q14: Explain the primary objectives and purpose of Guidance for Adolescents.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      Adolescents require targeted guidance to navigate intense developmental changes:
      <br>&bull; <b style="color: #FF8A65;">Coping with Bodily Growth:</b> Provides scientific counseling regarding puberty, hormonal surges, and bodily changes.
      <br>&bull; <b style="color: #FF8A65;">Resolving Identity Crisis:</b> Helps adolescents resolve role confusion and establish a coherent self-concept and self-esteem.
      <br>&bull; <b style="color: #FF8A65;">Resisting Harmful Peer Pressures:</b> Fortifies moral resilience against smoking, substance abuse, and cyber deviance.
      <br>&bull; <b style="color: #FF8A65;">Stream and Career Choice:</b> Guides the realistic selection of academic streams (Arts, Science, Vocational) based on aptitude.
    </div>
  </div>

  <!-- Q15 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16.5px; margin: 0 0 10px 0;">Q15: Compare Directive Counseling and Non-Directive Counseling across four points.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      These two approaches represent contrasting counseling philosophies:
      <br>&bull; <b style="color: #FF8A65;">Proponents:</b> Directive was founded by E. G. Williamson; Non-Directive was developed by Carl Rogers.
      <br>&bull; <b style="color: #FF8A65;">Center of Process:</b> Directive is counselor-centered; Non-Directive is client-centered.
      <br>&bull; <b style="color: #FF8A65;">Role of Counselor:</b> In Directive, the counselor diagnoses and prescribes; in Non-Directive, the counselor facilitates self-discovery without advising.
      <br>&bull; <b style="color: #FF8A65;">Focus:</b> Directive focuses on the objective problem; Non-Directive focuses on the emotional growth of the individual.
    </div>
  </div>

  <!-- Q16 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16.5px; margin: 0 0 10px 0;">Q16: Describe four key functions of the Classroom Teacher in Guidance and Counseling.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      The teacher acts as the frontline observer and mentor in the school:
      <br>&bull; <b style="color: #FF8A65;">Continuous Behavioral Observation:</b> Detects sudden academic drops, withdrawal, anxiety, or aggression in students.
      <br>&bull; <b style="color: #FF8A65;">Providing Remedial Instruction:</b> Diagnoses learning bottlenecks in specific subjects and provides study skills guidance.
      <br>&bull; <b style="color: #FF8A65;">Maintaining Anecdotal Records:</b> Keeps cumulative objective records of student talents, attendance, and social behaviors.
      <br>&bull; <b style="color: #FF8A65;">Referral to Specialists:</b> Connects severely distressed or traumatized students with professional school counselors.
    </div>
  </div>

  <!-- Q17 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16.5px; margin: 0 0 10px 0;">Q17: Explain the vital role of Parents in the school Guidance program.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      Parents form the foundational emotional anchor in a child's development:
      <br>&bull; <b style="color: #FF8A65;">Providing Emotional Security:</b> Offers unconditional love and acceptance, shielding the child from external anxieties.
      <br>&bull; <b style="color: #FF8A65;">Avoiding Unrealistic Pressure:</b> Refrains from imposing parental unfulfilled ambitions or making destructive sibling comparisons.
      <br>&bull; <b style="color: #FF8A65;">Sharing Developmental History:</b> Supplies counselors with background insights regarding home environment, childhood illnesses, and trauma.
      <br>&bull; <b style="color: #FF8A65;">Reinforcing Guidance at Home:</b> Partners with teachers to implement consistent behavioral and study routines.
    </div>
  </div>

  <!-- Q18 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16.5px; margin: 0 0 10px 0;">Q18: What are the primary functions of a Professional School Counselor?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      A certified school counselor carries specialized clinical responsibilities:
      <br>&bull; <b style="color: #FF8A65;">Psychological Assessment:</b> Administers standardized IQ tests, aptitude batteries (DAT), and personality scales.
      <br>&bull; <b style="color: #FF8A65;">Individual Confidential Therapy:</b> Conducts private therapeutic sessions for anxiety, grief, depression, and trauma.
      <br>&bull; <b style="color: #FF8A65;">Crisis Intervention:</b> Manages emergencies like bullying, panic attacks, and self-harm risks.
      <br>&bull; <b style="color: #FF8A65;">Career Bureau Management:</b> Coordinates career exhibitions, university visits, and vocational counseling.
    </div>
  </div>

  <!-- Q19 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16.5px; margin: 0 0 10px 0;">Q19: Explain the concept and significance of Vocational Guidance.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      Vocational guidance aligns human abilities with occupational avenues:
      <br>&bull; <b style="color: #FF8A65;">Core Purpose:</b> Assists an individual to choose, prepare for, enter into, and succeed in a suitable occupation.
      <br>&bull; <b style="color: #FF8A65;">Prevents Career Mismatch:</b> Stops students from entering fields where they lack aptitude, preventing future frustration.
      <br>&bull; <b style="color: #FF8A65;">Dignity of Labor:</b> Highlights diverse technical and craft careers alongside traditional white-collar professions.
      <br>&bull; <b style="color: #FF8A65;">National Economic Growth:</b> Optimizes human resource allocation by fitting the right person to the right job.
    </div>
  </div>

  <!-- Q20 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 16px; margin-bottom: 18px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 16.5px; margin: 0 0 10px 0;">Q20: How does Peer Group influence act as both a challenge and an asset in Guidance?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.65;">
      Peer relations exert powerful dual impacts on adolescent behavior:
      <br>&bull; <b style="color: #FF8A65;">As a Challenge:</b> Negative peer pressure can draw vulnerable teenagers into smoking, bullying, truancy, and drug experimentation.
      <br>&bull; <b style="color: #FF8A65;">As a Challenge:</b> Fear of peer rejection often forces students to conceal emotional pain and academic struggles.
      <br>&bull; <b style="color: #FF8A65;">As an Asset:</b> Positive peer groups provide emotional belonging, shared identity, and mutual academic support.
      <br>&bull; <b style="color: #FF8A65;">Peer Counseling:</b> Trained peer mentors often reach troubled students far more quickly than adult authority figures.
    </div>
  </div>
  ...
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 18px; margin-bottom: 20px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 17px; margin: 0 0 12px 0;">Q21: Define Guidance. Elaborate its foundational principles and discuss the three major types of Guidance.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.7;">
      <b style="color: #FF8A65;">1. Introduction:</b><br>
      ...
      <br><br>
      <b style="color: #FF8A65;">2. Foundational Principles &amp; Major Types:</b><br>
      &bull; <b style="color: #FF8A65; font-weight: bold;">Universal Principles:</b> Guidance is continuous across the lifespan, addresses all students (not just problem cases), respects individual uniqueness, and never imposes decisions.
      <br>&bull; <b style="color: #FF8A65; font-weight: bold;">Three Major Types of Guidance:</b>
      ...
      <br><br>
      <b style="color: #FF8A65;">3. Conclusion &amp; Educational Implication:</b><br>
  ...
  <!-- Q22 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 18px; margin-bottom: 20px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 17px; margin: 0 0 12px 0;">Q22: Why is Guidance especially vital during Adolescence? Analyze the major physical, emotional, and career crises faced by teenagers.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.7;">
      <b style="color: #FF8A65;">1. Introduction:</b><br>
      ...
      <br><br>
      <b style="color: #FF8A65;">2. Analysis of Adolescent Crises:</b><br>
      &bull; <b style="color: #FF8A65; font-weight: bold;">Physical &amp; Hormonal Transformations:</b> Rapid puberty growth spurts, voice alterations, and sexual maturation often induce severe bodily self-consciousness, shame, and anxiety if unguided.
      <br>&bull; <b style="color: #FF8A65; font-weight: bold;">Identity Crisis &amp; Emotional Turbulence:</b> Erikson's "Identity vs. Role Confusion" manifests intensely. Mood swings, rebellion against parental authority, and existential insecurity require non-judgmental counseling.
      <br>&bull; <b style="color: #FF8A65; font-weight: bold;">Peer Pressure &amp; Risk-Taking:</b> Desperate desire for peer acceptance often leads to smoking, alcohol, drug experimentation, aggression, and cyber delinquency.
      <br>&bull; <b style="color: #FF8A65; font-weight: bold;">Academic &amp; Career Decision Paralysis:</b> Choosing between competitive streams after Class 10 creates immense exam stress, parental pressure, and fear of failure.
      <br><br>
      <b style="color: #FF8A65;">3. Conclusion &amp; Educational Implication:</b><br>
  ...
  <!-- Q23 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 18px; margin-bottom: 20px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 17px; margin: 0 0 12px 0;">Q23: Define Counseling. Distinguish it comprehensively from Guidance and evaluate Directive, Non-Directive, and Eclectic counseling.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.7;">
      <b style="color: #FF8A65;">1. Introduction:</b><br>
      ...
      <br><br>
      <b style="color: #FF8A65;">2. Comprehensive Distinction &amp; Three Approaches:</b><br>
      &bull; <b style="color: #FF8A65; font-weight: bold;">Guidance vs. Counseling:</b> Guidance is a broad preventive umbrella addressing academic, career, and social choices, often administered in groups. Counseling is a specific, remedial, one-on-one confidential therapeutic intervention for deep emotional conflicts.
      <br>&bull; <b style="color: #FF8A65; font-weight: bold;">Three Major Approaches:</b>
  ...
  <!-- Q24 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 18px; margin-bottom: 20px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 17px; margin: 0 0 12px 0;">Q24: Discuss the indispensable role of the Classroom Teacher in Guidance and Counseling. How do teachers and professional counselors collaborate?</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.7;">
      <b style="color: #FF8A65;">1. Introduction:</b><br>
      ...
      <br><br>
      <b style="color: #FF8A65;">2. Multifaceted Teacher Functions &amp; Collaboration:</b><br>
      &bull; <b style="color: #FF8A65; font-weight: bold;">Primary Observer:</b> Notices subtle behavioral red flags &mdash; sudden silence, chronic absenteeism, drop in grades, and social withdrawal.
      <br>&bull; <b style="color: #FF8A65; font-weight: bold;">Curriculum &amp; Study Guide:</b> Instructs students in time management, note-taking, memory techniques, and overcoming specific subject difficulties.
      <br>&bull; <b style="color: #FF8A65; font-weight: bold;">Creating an Empathetic Classroom Culture:</b> Eliminates bullying and sarcastic humiliation, creating an emotionally safe learning space.
      <br>&bull; <b style="color: #FF8A65; font-weight: bold;">Teacher-Counselor Synergy:</b>
  ...
  <!-- Q25 -->
  <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(255, 138, 101, 0.3); border-radius: 8px; padding: 18px; margin-bottom: 20px;">
    <h3 style="color: #FF8A65; font-weight: bold; font-size: 17px; margin: 0 0 12px 0;">Q25: "Guidance is a collaborative multi-stakeholder ecosystem." Discuss the roles of Parents, School Administration, and Community, with reference to NEP 2020 and MANODARPAN.</h3>
    <div style="color: #FFFFFF; font-size: 15px; line-height: 1.7;">
      <b style="color: #FF8A65;">1. Introduction:</b><br>
      ...
      <br><br>
      <b style="color: #FF8A65;">2. Multi-Stakeholder Ecosystem Analysis:</b><br>
      &bull; <b style="color: #FF8A65; font-weight: bold;">Parents &amp; Families:</b> Provide unconditional emotional warmth. Parents must cease projecting unfulfilled ambitions onto their children and collaborate transparently with school counselors.
      <br>&bull; <b style="color: #FF8A65; font-weight: bold;">School Administration &amp; Principals:</b> Provide infrastructure &mdash; soundproof counseling rooms, testing inventories, career libraries, and organizing orientation seminars.
      <br>&bull; <b style="color: #FF8A65; font-weight: bold;">Community &amp; Mental Health Agencies:</b> Medical clinics, psychiatric hospitals, child welfare NGOs, and vocational industries provide specialized clinical care and vocational internship exposure.
      <br>&bull; <b style="color: #FF8A65; font-weight: bold;">NEP 2020 &amp; MANODARPAN Initiative:</b>
