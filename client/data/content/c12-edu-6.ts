...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <div style="background: rgba(253, 200, 48, 0.08); border: 1.5px solid #FDC830; border-radius: 12px; padding: 18px; margin-bottom: 25px;">
    <h2 class="text-center" style="color: #FDC830; font-weight: bold; margin: 0 0 6px 0; font-size: 20px; font-weight: bold;">🌟 Quick Glossary &amp; Core Inclusive Education Concepts</h2>
    ...
    <div style="display: flex; flex-direction: column; gap: 12px;">
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FDC830; border-radius: 6px;">
        <b style="color: #FDC830; font-size: 16px; display: block; margin-bottom: 4px;">1. Exceptional Child (Samuel A. Kirk):</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FDC830; border-radius: 6px;">
        <b style="color: #FDC830; font-size: 16px; display: block; margin-bottom: 4px;">2. Positive vs. Negative Deviations:</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FDC830; border-radius: 6px;">
        <b style="color: #FDC830; font-size: 16px; display: block; margin-bottom: 4px;">3. Learning Disability (LD):</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FDC830; border-radius: 6px;">
        <b style="color: #FDC830; font-size: 16px; display: block; margin-bottom: 4px;">4. Individualized Education Plan (IEP):</b>
      ...
      <div style="background: rgba(0,0,0,0.25); padding: 14px 16px; border-left: 4px solid #FDC830; border-radius: 6px;">
        <b style="color: #FDC830; font-size: 16px; display: block; margin-bottom: 4px;">5. RPWD Act, 2016:</b>
  ...
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(253, 200, 48, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FDC830; font-size: 16px;">1. Positive Deviations (The Super-Normal / Gifted &amp; Creative):</b>
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(253, 200, 48, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FDC830; font-size: 16px;">2. Negative Deviations (The Sub-Normal / Impaired &amp; Learning Disabled):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <!-- SECTION 6.2 -->
  <h2 style="color: #FDC830; font-weight: bold; border-bottom: 2px solid #FDC830; padding-bottom: 6px; margin-top: 35px;">6.2 Categories of exceptional children</h2>
  ...
  <h3 style="color: #FDC830; font-weight: bold; margin-top: 24px;">(i) Gifted Children &mdash; Meaning and Educational Planning</h3>
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #FDC830; border-radius: 8px; padding: 14px 16px; margin: 14px 0;">
    <p style="margin: 0 0 8px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #FDC830;">Concept &amp; Renzulli's Formulation:</b> Gifted children are those who display consistently superior cognitive functioning, extraordinary speed of learning, high creative originality, and intense task commitment. In Lewis Terman's Stanford-Binet classification, children with an <b>IQ of 140 and above</b> are designated as gifted. Joseph Renzulli's <i>Three-Ring Conception</i> defines giftedness as the confluence of: (1) Above-average intellectual ability, (2) High creativity, and (3) High task commitment.
    </p>
    <p style="margin: 8px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
      <b style="color: #FDC830;">Salient Characteristics:</b>
    </p>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 4px 0 10px 0; color: #FFFFFF;">
      <li><b style="color: #FDC830;">Rapid Information Processing:</b> Grasps abstract mathematical and linguistic principles with minimal drill or explanation.</li>
      <li><b style="color: #FDC830;">Voracious Curiosity &amp; Breadth of Interest:</b> Asks probing existential and scientific questions far ahead of their chronological age.</li>
      <li><b style="color: #FDC830;">Divergent &amp; Non-Linear Thinking:</b> Generates novel, unorthodox solutions to open-ended problems.</li>
      <li><b style="color: #FDC830;">Perfectionism &amp; Vulnerability to Boredom:</b> Becomes deeply restless, frustrated, or disruptive if forced to undergo monotonous repetitive blackboard exercises.</li>
    </ul>

    <p style="margin: 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
      <b style="color: #FDC830;">Educational Planning for Gifted Children:</b>
    </p>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 4px 0 0 0; color: #FFFFFF;">
      <li><b style="color: #FDC830;">1. Enrichment Programmes (Universally Recommended):</b> Keeping the child in the regular heterogeneous classroom with peers of their chronological age, but providing advanced, challenging supplementary assignments, independent research projects, creative writing opportunities, and science olympiad mentoring.</li>
      <li><b style="color: #FDC830;">2. Acceleration (Grade Skipping):</b> Advancing the child by one or two grades ahead of their chronological age. While intellectually stimulating, it risks severe emotional and social maladjustment due to physical and emotional immaturity among older classmates.</li>
      <li><b style="color: #FDC830;">3. Ability Grouping / Cluster Grouping:</b> Grouping gifted learners together for specialized honors seminars or advanced laboratory hours while integrating them for social and sports activities.</li>
    </ul>
  </div>

  <!-- CATEGORY 2: LEARNING DISABILITY (LD) -->
  <h3 style="color: #FDC830; font-weight: bold; margin-top: 24px;">(ii) Learning Disability &mdash; Concept, Types and Educational Planning (IEP)</h3>
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #FDC830; border-radius: 8px; padding: 14px 16px; margin: 14px 0;">
    <p style="margin: 0 0 8px 0; color: #FFFFFF; font-size: 15px; line-height: 1.6;">
      <b style="color: #FDC830;">Concept &amp; Nature:</b> The term <i>Learning Disability</i> was introduced in 1963 by <b>Dr. Samuel A. Kirk</b>. It refers to a neurological disorder that affects one or more of the basic psychological processes involved in understanding or using language (spoken or written). Crucially, a child with LD possesses <b>normal or above-average general intelligence</b>, and their difficulties are NOT the result of visual handicaps, hearing loss, motor disabilities, or mental retardation. There is a glaring discrepancy between their high cognitive potential and their low academic achievement.
    </p>

    <h4 style="color: #FDC830; font-weight: bold; margin: 12px 0 6px 0; font-size: 15px;">Prominent Types of Specific Learning Disabilities:</h4>
    <div style="display: flex; flex-direction: column; gap: 8px; margin-bottom: 12px;">
      <div style="background: rgba(0,0,0,0.3); padding: 10px 14px; border-radius: 6px;">
        <b style="color: #FDC830; font-weight: bold;">1. Dyslexia (Reading Disability):</b> Severe difficulty in phonological decoding, word recognition, spelling, and reading fluency. The student frequently reverses letters (confusing 'b' and 'd', 'p' and 'q') or words (reading 'was' as 'saw').
      </div>
      <div style="background: rgba(0,0,0,0.3); padding: 10px 14px; border-radius: 6px;">
        <b style="color: #FDC830; font-weight: bold;">2. Dyscalculia (Mathematical Disability):</b> Severe difficulty in understanding numerical quantities, mathematical symbols (+, &minus;, &times;), spatial math concepts, calculating time, and recalling multiplication tables.
      </div>
      <div style="background: rgba(0,0,0,0.3); padding: 10px 14px; border-radius: 6px;">
        <b style="color: #FDC830; font-weight: bold;">3. Dysgraphia (Writing Disability):</b> Severe impairment in fine motor coordination and spatial letter formation, resulting in illegible handwriting, inconsistent letter spacing, extreme physical hand cramps, and difficulty putting coherent thoughts onto paper.
      </div>
      <div style="background: rgba(0,0,0,0.3); padding: 10px 14px; border-radius: 6px;">
        <b style="color: #FDC830; font-weight: bold;">4. Dyspraxia (Motor Coordination Disability):</b> Developmental coordination disorder affecting gross and fine motor planning &mdash; causing clumsiness, difficulty in balancing, running, tying shoelaces, or buttoning shirts.
      </div>
    </div>

    <h4 style="color: #FDC830; font-weight: bold; margin: 12px 0 6px 0; font-size: 15px;">Educational Planning &mdash; Individualized Education Plan (IEP):</h4>
    <p style="margin: 0 0 6px 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
      An <b style="color: #FDC830;">Individualized Education Plan (IEP)</b> is a formal, personalized pedagogical blueprint collaboratively designed by a multidisciplinary team (class teacher, special educator, school psychologist, speech pathologist, and parents) tailored specifically to a student's diagnostic profile.
    </p>
    <ul style="padding-left: 20px; line-height: 1.8; margin: 0; color: #FFFFFF;">
      <li><b style="color: #FDC830;">Key Components of an IEP:</b>
  ...
  <h3 style="color: #FDC830; font-weight: bold; margin-top: 24px;">(ii) Evolutionary Paradigm: Segregation &rarr; Integration &rarr; Inclusion</h3>
  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(239, 68, 68, 0.4); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FDC830; font-weight: bold; font-size: 16px;">1. Segregation (Old Historical Model):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(253, 200, 48, 0.4); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FDC830; font-size: 16px;">2. Integration / Mainstreaming (Transitional Model):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(16, 185, 129, 0.4); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FDC830; font-weight: bold; font-size: 16px;">3. Inclusion (Modern Universal Paradigm):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <h3 style="color: #FDC830; font-weight: bold; margin-top: 24px;">(iii) Need and Importance of Inclusive Education</h3>
  <ul style="padding-left: 20px; line-height: 1.8; color: #FFFFFF;">
    <li><b style="color: #FDC830;">1. Upholding Human Rights &amp; Constitutional Mandates:</b> Education is a fundamental human right (Article 21A of the Indian Constitution and RTE Act 2009). Segregation is a violation of fundamental human dignity.</li>
    <li><b style="color: #FDC830;">2. Psychosocial Growth for All Children:</b> Disabled children develop confidence, self-worth, and real-world social competence. Simultaneously, general classmates develop empathy, compassion, altruism, and freedom from prejudice.</li>
    <li><b style="color: #FDC830;">3. Economic &amp; National Viability:</b> Building segregated special institutions in every village is economically impossible. Integrating special educators into regular neighborhood schools is cost-effective and democratic.</li>
  </ul>

  <!-- SECTION 6.4 -->
  <h2 style="color: #FDC830; font-weight: bold; border-bottom: 2px solid #FDC830; padding-bottom: 6px; margin-top: 35px;">6.4 An overview of RPWD Act, 2016</h2>

  <p>The <b style="color: #FDC830;">Rights of Persons with Disabilities (RPWD) Act, 2016</b> was passed by the Parliament of India in December 2016, replacing the archaic PWD Act of 1995. This legislation harmonizes Indian national law with the <i>United Nations Convention on the Rights of Persons with Disabilities (UNCRPD)</i>, moving away from a medical/charity model to a rights-based empowerment framework:</p>

  <div style="display: flex; flex-direction: column; gap: 12px; margin: 16px 0;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(253, 200, 48, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FDC830; font-size: 16px;">1. Dramatic Expansion of Recognized Disabilities (from 7 to 21):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
        The 2016 Act expanded legal disability categories from 7 to <b>21 conditions</b>. For the first time, <b style="color: #FDC830;">Specific Learning Disabilities (Dyslexia, Dysgraphia, Dyscalculia)</b>, <b>Autism Spectrum Disorder (ASD)</b>, <b>Cerebral Palsy</b>, <b>Multiple Sclerosis</b>, <b>Parkinson's Disease</b>, <b>Acid Attack Victims</b>, <b>Dwarfism</b>, and blood disorders (Thalassemia, Hemophilia, Sickle Cell Disease) received comprehensive statutory protection.
      </p>
    </div>

    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(253, 200, 48, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FDC830; font-size: 16px;">2. Revolutionary Educational Mandates (Chapter III):</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(253, 200, 48, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FDC830; font-size: 16px;">3. Enhanced Reservation Quotas:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
    ...
    <div style="background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(253, 200, 48, 0.3); border-radius: 8px; padding: 14px 16px;">
      <b style="color: #FDC830; font-size: 16px;">4. Severe Punitive Penalties for Discrimination:</b>
      <p style="margin: 6px 0 0 0; color: #FFFFFF; font-size: 14.5px; line-height: 1.6;">
  ...
  <div style="background: rgba(15, 23, 42, 0.85); border: 1.5px solid #FDC830; border-radius: 10px; padding: 16px; margin: 25px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 17px; font-weight: bold; margin: 0 0 12px 0;">
    ...
    <div style="overflow-x: auto;">
      <table style="width: 100%; border-collapse: collapse; font-size: 14px; color: #F8FAFC;">
        <thead>
          <tr style="background: rgba(253, 200, 48, 0.25); border-bottom: 2px solid #FDC830;">
        ...
        <tbody>
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
            <td style="padding: 10px; font-weight: bold; color: #FDC830;">Target Group</td>
          ...
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
            <td style="padding: 10px; font-weight: bold; color: #FDC830;">Location</td>
          ...
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
            <td style="padding: 10px; font-weight: bold; color: #FDC830;">Core Philosophy</td>
          ...
          <tr>
            <td style="padding: 10px; font-weight: bold; color: #FDC830;">Curriculum</td>
  ...
  <div style="background: rgba(15, 23, 42, 0.85); border-left: 4px solid #38EF7D; border-radius: 8px; padding: 14px 16px; margin: 20px 0;">
    <h4 style="color: #FDC830; font-weight: bold; margin: 0 0 6px 0; font-size: 16px; font-weight: bold;">
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <div style="background: rgba(253, 200, 48, 0.08); border-left: 4px solid #FDC830; border-radius: 6px; padding: 14px 16px; margin-bottom: 24px;">
    <h3 style="color: #FDC830; font-weight: bold; margin: 0 0 6px 0; font-size: 18px; font-weight: bold;">🎯 Golden 25 Board Examination Q &amp; A Blueprint</h3>
  ...
  <!-- ======================================================================== -->
  <h2 style="color: #FDC830; font-weight: bold; border-bottom: 2px solid #FDC830; padding-bottom: 6px; margin-top: 25px;">
    Section A: Very Short Answer Questions (1 &amp; 2 Marks)
  </h2>

  <!-- Q1 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q1: Define an 'Exceptional Child' according to Samuel A. Kirk.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      According to <b style="color: #FDC830;">Samuel A. Kirk</b>, an exceptional child is one who deviates from the average or normal child in mental, physical, or social characteristics to such an extent that he requires a modification of school practices, special services, or supplementary instruction to develop to his maximum capacity.
    </p>
  </div>

  <!-- Q2 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q2: Distinguish between positive and negative deviations with one example of each.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #FDC830;">Positive Deviations</b> diverge above the normal statistical mean in ability (e.g., <b style="color: #FDC830;">Gifted and Creative Prodigies</b> with IQ 140+). <b style="color: #FDC830;">Negative Deviations</b> diverge below the normal mean or possess functional deficits (e.g., <b style="color: #FDC830;">Dyslexic or Visually Impaired children</b>).
    </p>
  </div>

  <!-- Q3 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q3: Who is a 'Gifted Child'? What is Lewis Terman's IQ threshold for giftedness?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      A <b style="color: #FDC830;">Gifted Child</b> possesses consistently superior cognitive capability, rapid learning rate, and high creativity. According to <b style="color: #FDC830;">Lewis Terman</b>, a child with an <b style="color: #FDC830;">IQ of 140 and above</b> is classified as gifted.
    </p>
  </div>

  <!-- Q4 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q4: What is meant by 'Enrichment' in the educational planning of gifted children?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #FDC830;">Enrichment</b> means keeping the gifted child in the regular classroom with chronological peers while providing deeper, more challenging, creative learning assignments and independent research projects to prevent boredom.
    </p>
  </div>

  <!-- Q5 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q5: Define Learning Disability (LD). Who coined this term?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      A <b style="color: #FDC830;">Learning Disability</b> is a neurological disorder that affects the brain's processing of language and academic skills despite normal intelligence. The term was coined by <b style="color: #FDC830;">Dr. Samuel A. Kirk</b> in 1963.
    </p>
  </div>

  <!-- Q6 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q6: What is Dyslexia?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #FDC830;">Dyslexia</b> is a specific learning disability characterized by severe difficulty in reading, word recognition, phonological decoding, and spelling (often confusing letters like 'b' and 'd').
    </p>
  </div>

  <!-- Q7 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q7: What is Dyscalculia?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #FDC830;">Dyscalculia</b> is a specific learning disability involving severe difficulty in comprehending mathematical concepts, numerical symbols, mental arithmetic, and calculating time.
    </p>
  </div>

  <!-- Q8 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q8: What is Dysgraphia?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #FDC830;">Dysgraphia</b> is a specific learning disability affecting writing ability, resulting in extremely distorted, illegible handwriting, inconsistent letter sizing, cramped hand grip, and difficulty translating thoughts to paper.
    </p>
  </div>

  <!-- Q9 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q9: What does IEP stand for? Name its two primary components.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      IEP stands for <b style="color: #FDC830;">Individualized Education Plan</b>. Two core components are: (1) <b style="color: #FDC830;">Present Level of Educational Performance (PLEP)</b>; (2) <b style="color: #FDC830;">Measurable Annual Learning Goals and Accommodations</b>.
    </p>
  </div>

  <!-- Q10 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q10: Define Inclusive Education.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      <b style="color: #FDC830;">Inclusive Education</b> is a philosophy and system where all children &mdash; irrespective of physical, intellectual, socio-economic, or linguistic differences &mdash; learn together in regular neighborhood classrooms through modified teaching practices.
    </p>
  </div>

  <!-- Q11 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q11: In which year was the RPWD Act passed by the Indian Parliament, and how many disability categories does it recognize?</h3>
    <p style="color: #FFFFFF; margin: 0;">
      The <b style="color: #FDC830;">RPWD Act</b> was passed in <b style="color: #FDC830;">December 2016</b>, expanding the recognized disability categories from 7 to <b style="color: #FDC830;">21 conditions</b>.
    </p>
  </div>

  <!-- Q12 -->
  <div style="margin: 18px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q12: State the educational reservation percentage mandated in higher education under the RPWD Act 2016.</h3>
    <p style="color: #FFFFFF; margin: 0;">
      The RPWD Act 2016 mandates a minimum of <b style="color: #FDC830;">5% reservation of seats</b> in all government and government-aided higher educational institutions for persons with benchmark disabilities.
    </p>
  </div>
  ...
  <div style="margin: 20px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q13: Explain the concept of exceptionality through the normal probability curve (positive vs. negative deviations).</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      ...
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FDC830;">1. The Statistical Norm:</b> The vast majority (~68%) cluster around the center (IQ 90–110), representing the average child who thrives under standard curriculum.</li>
        <li><b style="color: #FDC830;">2. Positive Deviations:</b> The right tail of the curve represents children with superior traits (IQ 130–140+; Gifted, Talented, Creative Genius) who learn faster and require enrichment.</li>
        <li><b style="color: #FDC830;">3. Negative Deviations:</b> The left tail represents children with deficits (IQ &lt; 70 or sensory/neurological handicaps) who need special accommodations.</li>
        <li><b style="color: #FDC830;">4. Educational Need:</b> Both positive and negative deviations require individualized educational modifications, as both fail under a one-size-fits-all curriculum.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q14 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q14: Describe four prominent intellectual and behavioral characteristics of gifted children.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Gifted students exhibit distinct cognitive and emotional hallmarks:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FDC830;">1. Rapid Cognitive Mastery:</b> They learn new concepts at extraordinary speed, retaining vast amounts of information with minimal repetition.</li>
        <li><b style="color: #FDC830;">2. Divergent &amp; Abstract Thinking:</b> They excel in abstract reasoning, seeing hidden connections, and proposing creative solutions to complex problems.</li>
        <li><b style="color: #FDC830;">3. Insatiable Curiosity:</b> They demonstrate an intense passion for learning, asking profound, probing questions far beyond their syllabus.</li>
        <li><b style="color: #FDC830;">4. High Task Commitment &amp; Perfectionism:</b> When intrigued by a topic, they display relentless focus (Renzulli's task commitment), though monotonous drills cause severe restlessness.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q15 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q15: Discuss the educational strategies suitable for gifted students (Acceleration vs. Enrichment).</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Educators employ two primary administrative strategies for gifted children:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FDC830;">1. Acceleration (Double Promotion):</b> Skipping grades or early admission to higher classes. While keeping them intellectually challenged, it risks emotional and social alienation from physically older peers.</li>
        <li><b style="color: #FDC830;">2. Enrichment (Pedagogical Broadening):</b> Keeping the child in their natural age-grade while providing deeper, advanced curriculum materials, independent research, and creative projects.</li>
        <li><b style="color: #FDC830;">3. Cluster &amp; Ability Grouping:</b> Grouping gifted peers for honors seminars while maintaining regular social integration for physical sports and arts.</li>
        <li><b style="color: #FDC830;">4. Expert Consensus:</b> Enrichment is universally preferred because it safeguards socio-emotional maturity while nurturing intellectual gifts.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q16 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q16: Explain four major types of Specific Learning Disabilities commonly observed in schools.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Learning disabilities are neurological variations in cognitive processing:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FDC830;">1. Dyslexia:</b> Impairment in reading and phonological decoding, causing letter inversions (b/d, p/q) and slow, halting reading comprehension.</li>
        <li><b style="color: #FDC830;">2. Dysgraphia:</b> Impairment in handwriting and fine motor coordination, resulting in cramped writing posture, illegible scripts, and disorganized paper layout.</li>
        <li><b style="color: #FDC830;">3. Dyscalculia:</b> Impairment in mathematical operations, recognizing math symbols, calculating time, and remembering number facts.</li>
        <li><b style="color: #FDC830;">4. Dyspraxia:</b> Developmental coordination disorder affecting motor planning, resulting in physical clumsiness and difficulty in balancing or tying shoelaces.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q17 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q17: Describe the meaning, purpose, and multidisciplinary structure of an Individualized Education Plan (IEP).</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      The IEP is the cornerstone of special needs education:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FDC830;">1. Definition &amp; Purpose:</b> A personalized, written educational contract designed to meet the unique learning needs of a child with disabilities, ensuring measurable academic progress.</li>
        <li><b style="color: #FDC830;">2. Multidisciplinary Team:</b> Collaboratively created by the regular teacher, special educator, school psychologist, speech/occupational therapist, and the child's parents.</li>
        <li><b style="color: #FDC830;">3. Core Contents:</b> Baseline performance data (PLEP), SMART annual goals, specialized instructional materials, and testing accommodations (extra time, scribes).</li>
        <li><b style="color: #FDC830;">4. Periodic Review:</b> Mandates quarterly evaluation and annual formal revision to adapt to the child's evolving mastery.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q18 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q18: Analyze the social, psychological, and constitutional need for Inclusive Education.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Inclusive education is an imperative on multiple fronts:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FDC830;">1. Constitutional Justice:</b> Article 21A, the RTE Act 2009, and the RPWD Act 2016 guarantee equal, non-discriminatory educational access for all children.</li>
        <li><b style="color: #FDC830;">2. Eradication of Psychological Stigma:</b> Segregation breeds crippling inferiority complexes; inclusion builds self-esteem and social belongingness.</li>
        <li><b style="color: #FDC830;">3. Fostering Empathy in General Peers:</b> Typical children who learn alongside disabled peers develop genuine empathy, compassion, and respect for diversity.</li>
        <li><b style="color: #FDC830;">4. National Democratic Integration:</b> An inclusive school prepares children for an inclusive, democratic adult society.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q19 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q19: Trace the evolutionary transition from Segregation to Integration to Inclusion.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Special education has evolved through three distinct paradigms:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FDC830;">1. Segregation (19th &amp; early 20th Century):</b> Disabled children were placed in isolated special institutions, based on a charity/medical model viewing them as broken.</li>
        <li><b style="color: #FDC830;">2. Integration (Late 20th Century):</b> Disabled children entered regular schools, but the burden of fitting into a rigid system fell on the child. If they failed, they were removed.</li>
        <li><b style="color: #FDC830;">3. Inclusion (Post-Salamanca 1994 to Present):</b> The entire regular school transforms its curriculum, physical architecture, and pedagogy to welcome and support every unique learner.</li>
      </ul>
    </div>
  </div>
  ...
  <!-- Q20 -->
  <div style="margin: 20px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 16px; margin-bottom: 6px;">Q20: Highlight four key educational provisions of the Rights of Persons with Disabilities (RPWD) Act, 2016.</h3>
    <div style="color: #FFFFFF; line-height: 1.7;">
      Chapter III of the RPWD Act 2016 outlines transformative educational mandates:
      <ul style="padding-left: 20px; margin: 6px 0 0 0;">
        <li><b style="color: #FDC830;">1. Free Education from 6 to 18 Years:</b> Guarantees free schooling in appropriate neighborhood schools for children with benchmark disabilities.</li>
        <li><b style="color: #FDC830;">2. Barrier-Free Accessibility:</b> Mandates accessible school campuses, ramps, modified toilets, and transport facilities.</li>
        <li><b style="color: #FDC830;">3. Provision of Assistive Materials:</b> Mandates free provision of textbooks, learning materials in Braille, audio formats, and Indian Sign Language.</li>
        <li><b style="color: #FDC830;">4. 5% Higher Education Quota:</b> Reserves a minimum of 5% seats in all government higher education institutions for students with benchmark disabilities.</li>
      </ul>
    </div>
  </div>
  ...
  <div style="margin: 22px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q21: Comprehensive Exposition of Exceptional Children: Concept of Positive and Negative Deviations, Identification, and Classroom Provisions.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #FDC830;">I. Concept of Exceptionality:</b><br />
      ...
      <p><b style="color: #FDC830;">II. Detailed Analysis of Deviations:</b><br />
      (1) <b style="color: #FDC830;">Positive Deviations (Gifted &amp; Creative):</b> Children with IQ 130–140+, insatiable curiosity, and divergent problem-solving skills. They require enrichment programs, creative projects, and honors curricula to prevent disengagement.<br />
      (2) <b style="color: #FDC830;">Negative Deviations (Disabilities &amp; Deficits):</b> Children with Learning Disabilities (Dyslexia, Dyscalculia), sensory impairments (blindness, deafness), and orthopedically impaired children who require barrier-free architecture, assistive technologies, and personalized IEP accommodations.</p>

      <p><b style="color: #FDC830;">III. Pedagogical Conclusion:</b><br />
  ...
  <!-- Q22 -->
  <div style="margin: 22px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q22: Critical Analysis of Learning Disabilities: Neurological Basis, Detailed Typology, and Step-by-Step IEP Formulation.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #FDC830;">I. Meaning &amp; Neurological Nature:</b><br />
      ...
      <p><b style="color: #FDC830;">II. The Four Core Typologies:</b><br />
      (1) <b style="color: #FDC830;">Dyslexia:</b> Reading/decoding deficits, letter inversions (b/d, p/q), word reversals.<br />
      (2) <b style="color: #FDC830;">Dysgraphia:</b> Motor-writing deficits, cramped pencil grip, illegible handwriting.<br />
      (3) <b style="color: #FDC830;">Dyscalculia:</b> Arithmetic reasoning deficits, inability to comprehend numbers and time.<br />
      (4) <b style="color: #FDC830;">Dyspraxia:</b> Motor planning impairment causing physical clumsiness.</p>

      <p><b style="color: #FDC830;">III. Step-by-Step IEP Formulation:</b><br />
  ...
  <!-- Q23 -->
  <div style="margin: 22px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q23: Inclusive Education as a Global Paradigm: Concept, Need, Importance, and Systemic Barriers in Indian Schools.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #FDC830;">I. The Inclusive Philosophy:</b><br />
      ...
      <p><b style="color: #FDC830;">II. Threefold Need and Importance:</b><br />
      (1) <b style="color: #FDC830;">Constitutional &amp; Legal:</b> Enforces Right to Education (Article 21A) and the RPWD Act 2016.<br />
      (2) <b style="color: #FDC830;">Psychosocial:</b> Eliminates social segregation, builds self-worth in disabled youth, and nurtures empathy and altruism in typical classmates.<br />
      (3) <b style="color: #FDC830;">Economic:</b> Utilizing regular neighborhood schools with roving special educators is vastly more cost-effective than isolated special schools.</p>

      <p><b style="color: #FDC830;">III. Systemic Barriers in Indian Schools:</b><br />
  ...
  <!-- Q24 -->
  <div style="margin: 22px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q24: Exhaustive Overview of the Rights of Persons with Disabilities (RPWD) Act, 2016.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #FDC830;">I. Legislative Background:</b><br />
      ...
      <p><b style="color: #FDC830;">II. Landmark Provisions:</b><br />
      (1) <b style="color: #FDC830;">Expansion to 21 Disability Categories:</b> Includes Specific Learning Disabilities, Autism Spectrum Disorder, Cerebral Palsy, Multiple Sclerosis, Dwarfism, Acid Attack Victims, and blood disorders (Thalassemia, Hemophilia).<br />
      (2) <b style="color: #FDC830;">Educational Rights (Chapter III):</b> Free, barrier-free education for children with benchmark disabilities (40%+) from ages 6 to 18; provision of accessible learning materials in Braille and sign language.<br />
      (3) <b style="color: #FDC830;">Reservation Quotas:</b> 5% reservation in higher education institutions and 4% reservation in government jobs.<br />
      (4) <b style="color: #FDC830;">Penal Provisions:</b> Imposes fines and imprisonment (up to 5 years) for discrimination, humiliation, or atrocities against persons with disabilities.</p>
    </div>
  </div>

  <!-- Q25 -->
  <div style="margin: 22px 0;">
    <h3 style="color: #FDC830; font-weight: bold; font-size: 17px; margin-bottom: 8px;">Q25: Real-World Classroom Inclusion Case Study: Diagnostic Evaluation and 4-Tier Inclusive Remediation Blueprint.
    </h3>
    <div style="color: #FFFFFF; line-height: 1.75;">
      <p><b style="color: #FDC830;">Case Profile:</b><br />
      ...
      <p><b style="color: #FDC830;">I. Diagnostic Evaluation:</b><br />
      (1) <b style="color: #FDC830;">Condition:</b> Classic symptoms of <b>Developmental Dyslexia</b> (specific phonological reading deficit with normal/above-normal verbal IQ).<br />
      (2) <b style="color: #FDC830;">Secondary Psychological Injury:</b> Severe school anxiety, avoidance behaviors, and loss of self-esteem triggered by teacher labeling and peer bullying.</p>

      <p><b style="color: #FDC830;">II. Four-Tier Inclusive Remediation Blueprint:</b><br />
      (1) <b style="color: #FDC830;">Sensitization &amp; Peer Anti-Bullying:</b> The school counselor conducts a sensitivity session, immediately eradicating derogatory labels and establishing a peer-buddy system.<br />
      (2) <b style="color: #FDC830;">Multisensory Phonics Training:</b> Special educator deploys Orton-Gillingham multisensory techniques (tracing sand-letters while vocalizing sounds, color-coded vowels).<br />
      (3) <b style="color: #FDC830;">Formal IEP Accommodations:</b> Providing 20 minutes extra time per hour in exams, permitting oral examination alternatives, and using assistive text-to-speech software.<br />
      (4) <b style="color: #FDC830;">Celebrating Strengths:</b> Giving Rohan leadership in science debates and creative drama, restoring his self-worth and joy in schooling.</p>
    </div>
  </div>
