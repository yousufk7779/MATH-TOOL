...
export const c7Sci13: ChapterContent = {
  id: "c7-sci-13",
  number: 13,
  title: "Wastewater Story",
  introduction:
    '<span style="color: #FFFFFF;">Water is essential for life, but human activities often pollute it. Wastewater is used water containing impurities. Managing wastewater is crucial for public health.</span>',
  definitions: [
    {
      term: "Basic Concepts",
      description:
        '<span style="color: #FFFFFF;">Sewage is liquid waste containing domestic and industrial impurities. A wastewater treatment plant (WWTP) cleans water before releasing it.</span>',
    },
  ],
  keyPoints: [
  ...
  exercises: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          number: "2",
          question:
            "What is sewage? Why is it harmful to discharge untreated sewage?",
          solution: [
  ...
  mcqs: [
    ...
    },
    {
      id: "c7-sci-13-mcq-9",
      question:
        "Eucalyptous trees are planted along sewage ponds because they:",
      options: [
        "(a) Absorb surplus wastewater rapidly",
        "(b) Release oxygen",
        "(c) Give shade",
        "(d) None",
      ],
