...
export const mathCh1: ChapterContent = {
  ...
  examples: [
    ...
    },
    {
      ...
      number: "2",
      question:
        '<span style="font-weight: normal;">Find the LCM and HCF of 6 and 20 by the prime factorisation method.</span>',
      solution: [
    ...
    },
    {
      ...
      number: "3",
      question:
        '<span style="font-weight: normal;">Find the HCF of 96 and 404 by the prime factorisation method. Hence, find their<br/>LCM.</span>',
      solution: [
        '<span style="font-weight: normal;">Solution:</span>',
        "Prime factorization:",
        "96 = 2 × 2 × 2 × 2 × 2 × 3 = 2⁵ × 3",
    ...
    },
    {
      ...
      number: "4",
      question:
        '<span style="font-weight: normal;">Find the HCF and LCM of 6, 72 and 120, using the prime factorisation method.</span>',
      solution: [
        '<span style="font-weight: normal;">Solution:</span>',
        "Prime factorization:",
        "6 = 2 × 3",
    ...
    },
    {
      ...
      number: "5",
      question:
        '<span style="font-weight: normal;">Prove that √3 is irrational.</span>',
      solution: [
    ...
    },
    {
      ...
      number: "6",
      question:
        '<span style="font-weight: normal;">Show that 5 - √3 is irrational.</span>',
      solution: [
        '<span style="font-weight: normal;">Proof:</span>',
    ...
    },
    {
      ...
      number: "7",
      question:
        '<span style="font-weight: normal;">Show that 3√2 is irrational.</span>',
      solution: [
        '<span style="font-weight: normal;">Proof:</span>',
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            '<span style="font-weight: normal;">Express each number as a product of its prime factors:</span>',
          solution: [
          ...
          answer:
            "140 = 2² × 5 × 7 | 156 = 2² × 3 × 13 | 3825 = 3² × 5² × 17 | 5005 = 5 × 7 × 11 × 13 | 7429 = 17 × 19 × 23",
        },
        {
          id: "q2",
          number: "2",
          question:
            '<span style="font-weight: normal;">Find the LCM and HCF of the following pairs of integers and verify that LCM × HCF =<br/>product of the two numbers.</span>',
          solution: [
          ...
          answer:
            "LHS = RHS. Hence Verified. | LHS = RHS. Hence Verified. | LHS = RHS. Hence Verified.",
        },
        {
          id: "q3",
          number: "3",
          question:
            '<span style="font-weight: normal;">Find the LCM and HCF of the following integers by applying the prime factorisation<br/>method.</span>',
          solution: [
          ...
          answer:
            "HCF = 3, LCM = 420 | HCF = 1, LCM = 11339 | HCF = 1, LCM = 1800",
        },
        {
          id: "q4",
          number: "4",
          question:
            '<span style="font-weight: normal;">Given that HCF (306, 657) = 9, find LCM (306, 657).</span>',
          solution: [
        ...
        },
        {
          ...
          number: "5",
          question:
            '<span style="font-weight: normal;">Check whether 6ⁿ can end with the digit 0 for any natural number n.</span>',
          solution: [
            '<span style="font-weight: normal;">Solution:</span>',
        ...
        },
        {
          ...
          number: "6",
          question:
            '<span style="font-weight: normal;">Explain why 7 × 11 × 13 + 13 and 7 × 6 × 5 × 4 × 3 × 2 × 1 + 5 are composite numbers.</span>',
          solution: [
            '<span style="font-weight: normal;">Solution:</span>',
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            '<span style="font-weight: normal;">Prove that √5 is irrational.</span>',
          solution: [
            '<span style="font-weight: normal;">Given:</span>',
            "Number √5.",
        ...
        },
        {
          ...
          number: "2",
          question:
            '<span style="font-weight: normal;">Prove that 3 + 2√5 is irrational.</span>',
          solution: [
            '<span style="font-weight: normal;">Given:</span>',
            "Number 3 + 2√5.",
            '<span style="font-weight: normal;">To Prove:</span>',
        ...
        },
        {
          ...
          number: "3",
          question:
            '<span style="font-weight: normal;">Prove that the following are irrationals:</span>',
          solution: [
          ...
          answer:
            "Hence, <sup>1</sup>&frasl;<sub>√2</sub> is irrational. | Hence, 7√5 is irrational. | Hence, 6 + √2 is irrational.",
        },
      ],
    },
  ],
  mcqs: [
    {
      id: "mcq1",
      question:
        '<span style="font-weight: normal;">The HCF of 135 and 225 is:</span>',
    ...
    },
    {
      id: "mcq2",
      question:
        '<span style="font-weight: normal;">Every composite number can be expressed as a product of:</span>',
      options: [
        "(A) Odd numbers",
        "(B) Even numbers",
        "(C) Prime numbers",
    ...
    },
    {
      id: "mcq3",
      question:
        '<span style="font-weight: normal;">For any two positive integers a and b, the relationship between HCF and LCM is:</span>',
      options: [
        "(A) HCF + LCM = a × b",
        "(B) HCF - LCM = a × b",
        "(C) HCF × LCM = a × b",
    ...
    },
    {
      id: "mcq5",
      question:
        '<span style="font-weight: normal;">The prime factorization of 15 is:</span>',
      options: ["(A) 2 × 7", "(B) 3 × 5", "(C) 2 × 3 × 5", "(D) 5 × 5"],
      correctAnswer: "B",
    },
    {
      id: "mcq6",
      question:
        '<span style="font-weight: normal;">If a number n ends with the digit 0, then its prime factorization must contain:</span>',
      options: [
        "(A) Both 2 and 3",
        "(B) Both 2 and 5",
        "(C) Both 3 and 5",
    ...
    },
    {
      id: "mcq7",
      question:
        '<span style="font-weight: normal;">The sum of a rational and an irrational number is always:</span>',
      options: [
        "(A) Rational",
        "(B) Irrational",
        "(C) Zero",
    ...
    },
    {
      id: "mcq8",
      question:
        '<span style="font-weight: normal;">Which of the following is an irrational number?</span>',
    ...
    },
    {
      id: "mcq9",
      question:
        '<span style="font-weight: normal;">The LCM of 12 and 15 is:</span>',
    ...
    },
    {
      id: "mcq10",
      question:
        '<span style="font-weight: normal;">The product of a non-zero rational number and an irrational number is:</span>',
      options: [
        "(A) Always rational",
        "(B) Always irrational",
