      ...
      questions: [
        {
          ...
          number: "1",
          question:
            '<div style="text-align: justify;">Why does a compass needle get deflected when brought near a bar magnet?</div>',
          solution: [
          ...
          answer:
            "A compass needle is a tiny bar magnet. When brought near a bar magnet, its poles experience attractive and repulsive forces due to the magnetic field of the bar magnet, causing it to deflect and align along the field lines.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            '<div style="text-align: justify;">Draw magnetic field lines around a bar magnet.</div>',
          solution: [
          ...
          answer:
            "Field lines emerge from N pole, loop around and enter S pole. Inside the magnet they go from S to N forming closed continuous loops.",
        },
        {
          id: "sp4-it-2-2",
          number: "2",
          question:
            '<div style="text-align: justify;">List the properties of magnetic field lines.</div>',
          solution: [
          ...
          answer:
            "Properties: emerge from N to S outside; S to N inside; closed continuous loops; denser near poles; never intersect; have a definite direction.",
        },
        {
          id: "sp4-it-2-3",
          number: "3",
          question:
            '<div style="text-align: justify;">Why don\u2019t two magnetic field lines intersect each other?</div>',
          solution: [
          ...
          answer:
            "Two field lines never intersect because at any point the magnetic field has only one direction. If they crossed, it would imply two directions at the same point, which is impossible.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            '<div style="text-align: justify;">Consider a circular loop of wire lying in the plane of the table. Let the current pass through the loop clockwise. Apply the right-hand rule to find out the direction of the magnetic field inside and outside the loop.</div>',
          solution: [
          ...
          answer:
            "Using the right-hand rule: Inside the loop, the field points downwards into the table. Outside the loop, the field points upwards out of the table.",
        },
        {
          id: "sp4-it-3-2",
          number: "2",
          question:
            '<div style="text-align: justify;">The magnetic field in a given region is uniform. Draw a diagram to represent it.</div>',
          solution: [
          ...
          answer:
            "A uniform magnetic field is represented by parallel, straight, and equally spaced magnetic field lines pointing in the same direction.",
        },
        {
          id: "sp4-it-3-3",
          number: "3",
          question:
            '<div style="text-align: justify;">Choose the correct option. The magnetic field inside a long straight solenoid-carrying current<br>(a) is zero.<br>(b) decreases as we move towards its end.<br>(c) increases as we move towards its end.<br>(d) is the same at all points.</div>',
          solution: [
          ...
          answer:
            "Correct: (d). The field lines are parallel and straight inside a solenoid, indicating a uniform magnetic field that is the same at all points.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            '<div style="text-align: justify;">Which of the following property of a proton can change while it moves freely in a magnetic field? (There may be more than one correct answer.)<br/>(a) mass<br/>(b) speed<br/>(c) velocity<br/>(d) momentum</div>',
          solution: [
          ...
          answer:
            "(c) velocity and (d) momentum. The magnetic force changes the direction of the proton, thus changing its velocity and momentum, while speed and mass remain constant.",
        },
        {
          id: "sp4-it-4-q2",
          number: "2",
          question:
            '<div style="text-align: justify;">In Activity 13.7, how do we think the displacement of rod AB will be affected if<br/>(i) current in rod AB is increased;<br/>(ii) a stronger horseshoe magnet is used; and<br/>(iii) length of the rod AB is increased?</div>',
          solution: [
          ...
          answer:
            "In all three cases (increased current, stronger magnet, or increased length), the magnetic force acting on the rod increases, resulting in a greater displacement of the rod AB.",
        },
        {
          id: "sp4-it-4-q3",
          number: "3",
          question:
            '<div style="text-align: justify;">A positively-charged particle (alpha-particle) projected towards west is deflected towards north by a magnetic field. The direction of magnetic field is<br/>(a) towards south<br/>(b) towards east<br/>(c) downward<br/>(d) upward</div>',
          solution: [
          ...
          answer:
            "(d) upward. By applying Fleming's Left-Hand Rule with current towards West and force towards North, the magnetic field direction is found to be Upward.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            '<div style="text-align: justify;">State Flemingâ€™s left-hand rule.</div>',
          solution: [
          ...
          answer:
            "If the thumb, forefinger, and middle finger of the left hand are held mutually perpendicular, the forefinger points to the magnetic field, the middle finger to the current, and the thumb to the force/motion.",
        },
        {
          id: "sp4-it-5-q2",
          number: "2",
          question:
            '<div style="text-align: justify;">What is the principle of an electric motor?</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "An electric motor works on the principle that when a current-carrying coil is placed in a magnetic field, it experiences a force that causes it to rotate.",
        },
        {
          id: "sp4-it-5-q3",
          number: "3",
          question:
            '<div style="text-align: justify;">What is the role of the split ring in an electric motor?</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "The split ring acts as a commutator, reversing the direction of current every half rotation to keep the coil rotating in a single direction.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            '<div style="text-align: justify;">Explain different ways to induce current in a coil.</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "Current is induced in a coil by the relative motion between a magnet and a coil, or by changing the magnetic field linked with it.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            '<div style="text-align: justify;">State the principle of an electric generator.</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
        ...
        },
        {
          ...
          number: "2",
          question:
            '<div style="text-align: justify;">Name some sources of direct current.</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "Dry cells, batteries, and DC generators are sources of direct current.",
        },
        {
          id: "sp4-it-7-q3",
          number: "3",
          question:
            '<div style="text-align: justify;">Which sources produce alternating current?</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "AC generators and power plant generators produce alternating current.",
        },
        {
          id: "sp4-it-7-q4",
          number: "4",
          question:
            '<div style="text-align: justify;">Choose the correct option.<br>A rectangular coil of copper wires is rotated in a magnetic field. The direction of the induced current changes once in each<br>(a) two revolutions<br>(b) one revolution<br>(c) half revolution<br>(d) one-fourth revolution</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
      ...
      questions: [
        {
          ...
          number: "1",
          question:
            '<div style="text-align: justify;">Name two safety measures commonly used in electric circuits and appliances.</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
        ...
        },
        {
          ...
          number: "2",
          question:
            '<div style="text-align: justify;">An electric oven of 2 kW power rating is operated in a domestic electric circuit (220 V) that has a current rating of 5 A. What result do you expect? Explain.</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "The fuse will melt and break the circuit because the current drawn (9.09 A) exceeds the circuit rating (5 A).",
        },
        {
          id: "sp4-it-8-q3",
          number: "3",
          question:
            '<div style="text-align: justify;">What precaution should be taken to avoid the overloading of domestic electric circuits?</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "Avoid connecting too many appliances to one socket and ensure the total current is within the circuit's rating.",
        },
      ],
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          number: "3",
          question:
            '<div style="text-align: justify;">The device used for producing electric current is called a:<br>(a) generator.<br>(b) galvanometer.<br>(c) ammeter.<br>(d) motor.</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
        ...
        },
        {
          ...
          number: "5",
          question:
            '<div style="text-align: justify;">At the time of short circuit, the current in the circuit:<br>(a) reduces substantially.<br>(b) does not change.<br>(c) increases heavily.<br>(d) vary continuously.</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
        ...
        },
        {
          ...
          number: "7",
          question:
            '<div style="text-align: justify;">List two methods of producing magnetic fields.</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "Using permanent magnets and passing electric current through a conductor.",
        },
        {
          id: "sp4-ex-q8",
          number: "8",
          question:
            '<div style="text-align: justify;">How does a solenoid behave like a magnet? Can you determine the north and south poles of a currentâ€“carrying solenoid with the help of a bar magnet? Explain.</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "A solenoid behaves like a bar magnet. Poles are determined by attraction/repulsion with a known bar magnet.",
        },
        {
          id: "sp4-ex-q9",
          number: "9",
          question:
            '<div style="text-align: justify;">When is the force experienced by a currentâ€“carrying conductor placed in a magnetic field largest?</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "Largest force occurs when the conductor is perpendicular to the magnetic field.",
        },
        {
          id: "sp4-ex-q10",
          number: "10",
          question:
            '<div style="text-align: justify;">Imagine that you are sitting in a chamber with your back to one wall. An electron beam, moving horizontally from back wall towards the front wall, is deflected by a strong magnetic field to your right side. What is the direction of magnetic field?</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
        ...
        },
        {
          ...
          number: "11",
          question:
            '<div style="text-align: justify;">Draw a labelled diagram of an electric motor. Explain its principle and working. What is the function of a split ring in an electric motor?</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
            '<div style="text-align: center; margin: 15px 0;"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==" style="width: 300px; height: auto; background-color: #000; border-radius: 8px;"/></div>',
          ...
          answer:
            "Electric motor works on the principle of force on a current conductor in a field. Split rings reverse current to enable rotation.",
        },
        {
          id: "sp4-ex-q12",
          number: "12",
          question:
            '<div style="text-align: justify;">Name some devices in which electric motors are used.</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "Fans, washing machines, mixers, refrigerators, and water pumps.",
        },
        {
          id: "sp4-ex-q13",
          number: "13",
          question:
            '<div style="text-align: justify;">A coil of insulated copper wire is connected to a galvanometer. What will happen if a bar magnet is (i) Pushed into the coil, (ii) Withdrawn from inside the coil, (iii) held stationary inside the coil?</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "(i) Momentary deflection, (ii) Deflection in opposite direction, (iii) No deflection.",
        },
        {
          id: "sp4-ex-q14",
          number: "14",
          question:
            '<div style="text-align: justify;">Two circular coils A and B are placed close to each other. If the current in the coil A is changed, will some current be induced in the coil B? Give reason.</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "Yes, due to electromagnetic induction caused by the changing magnetic field of coil A.",
        },
        {
          id: "sp4-ex-q15",
          number: "15",
          question:
            '<div style="text-align: justify;">State the rule to determine the direction of a (i) magnetic field produced around a straight conductor-carrying current, (ii) force experienced by a current-carrying straight conductor placed in a magnetic field which is perpendicular to it, and (iii) current induced in a coil due to its rotation in a magnetic field.</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
        ...
        },
        {
          ...
          number: "16",
          question:
            '<div style="text-align: justify;">Explain the underlying principle and working of an electric generator by drawing a labelled diagram. What is the function of brushes?</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "Principle: Electromagnetic Induction. Working: Rotating a coil in a magnetic field induces current. Brushes transfer the induced current to the external circuit.",
        ...
        },
        {
          ...
          number: "17",
          question:
            '<div style="text-align: justify;">When does an electric short circuit occur?</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "When live and neutral wires touch directly, leading to low resistance and a huge current surge.",
        },
        {
          id: "sp4-ex-q18",
          number: "18",
          question:
            '<div style="text-align: justify;">What is the function of an earth wire? Why is it necessary to earth metallic appliances?</div>',
          solution: [
            '<div style="text-align: justify;"><span style="color:#ff2e6e"><b>Answer:</b></span></div>',
          ...
          answer:
            "Safety: It drains leakage current to the ground, preventing electric shocks from faulty appliances.",
        },
      ],
    },
  ],
