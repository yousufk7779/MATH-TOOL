...
export const sciPhy2: ChapterContent = {
  ...
  introduction:
    "Let's explore how our eyes work like a living camera. We will also learn about the beautiful natural phenomena like rainbows and the blue color of the sky, which happen because of light.",
  definitions: [
    {
      term: "Accommodation",
      description:
        "The ability of the eye lens to adjust its focus so we can see near and far objects clearly.",
    },
    {
      term: "Near Point",
      description:
        "The closest distance at which the eye can see an object clearly. For a normal young adult, it is about 25 cm.",
    },
    {
      term: "Far Point",
      description:
    ...
    },
    {
      term: "Dispersion",
      description:
        "The splitting of white light into its seven beautiful colors when it passes through a prism.",
    },
    {
      term: "Spectrum",
      description:
        "The beautiful band of seven colors (VIBGYOR) formed when white light is dispersed.",
    },
    {
      term: "Scattering",
      description:
        "When light hits small particles (like dust or air molecules) and spreads out in all directions.",
    },
  ],
  keyPoints: [
  ...
  mcqs: [
    {
      id: "sp2-mcq-1",
      question:
        "Which part of the eye acts like a screen where images are formed?",
    ...
    },
    {
      ...
      options: [
        "(a) Near objects clearly",
        "(b) Far objects clearly",
        "(c) Any object clearly",
        "(d) Colors correctly",
      ],
      correctAnswer: "b",
    },
    ...
    },
    {
      id: "sp2-mcq-8",
      question:
        "The color of light that deviates the most on passing through a glass prism is:",
    ...
    },
    {
      id: "sp2-mcq-10",
      question:
        "The loss of power of accommodation of the eye with old age is called:",
      options: [
        "(a) Myopia",
        "(b) Hypermetropia",
        "(c) Presbyopia",
