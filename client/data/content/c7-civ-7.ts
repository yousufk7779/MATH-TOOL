...
export const c7Civ7: ChapterContent = {
    ...
    introduction: "There are many kinds of markets that we visit for our everyday needs.",
    definitions: [],
    keyPoints: [],
    formulas: [],
    crux: [],
    mcqs: [
        {
            id: "c7c7-mcq-1",
            question: "A market that is held on a specific day of the week is called:",
            options: ["Neighbourhood shop", "Weekly market", "Mall", "Wholesale market"],
            correctAnswer: "b"
        },
        {
            id: "c7c7-mcq-2",
            question: "Shop owners in weekly markets are usually:",
            options: ["Big Businessmen", "Small traders", "Government officers", "Farmers"],
            correctAnswer: "b"
        },
        {
            id: "c7c7-mcq-3",
            question: "Multi-storeyed air-conditioned buildings with shops are called:",
        ...
        },
        {
            ...
            options: ["One who sells directly to consumers", "One who buys in large quantities", "One who produces goods", "One who works in a mall"],
            correctAnswer: "b"
        },
        {
            id: "c7c7-mcq-6",
            question: "The last link in the chain of markets who sells to consumers is:",
        ...
        },
        {
            ...
            options: ["They are of bad quality", "They have no shop rent or electricity bills", "They are sold by the government", "They are old"],
            correctAnswer: "b"
        },
        {
            id: "c7c7-mcq-8",
        ...
        },
        {
            ...
            options: ["Weekly market traders", "Retailers in malls", "Wholesalers", "Hawkers"],
            correctAnswer: "b"
        }
    ],
    summary: [],
