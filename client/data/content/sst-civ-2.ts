...
export const sstCiv2: ChapterContent = {
  ...
  isHtmlView: true,
  htmlOverview:
    '<div style="padding: 10px; color: #fff; text-align: justify; font-family: sans-serif;">\n    <p style="line-height: 1.6; font-size: 17px;">In a huge country like India, it is impossible for one government sitting in New Delhi to solve the local problems of a small village in Kerala. That\'s why power is divided! This system of dividing power between a central authority and its various states is called Federalism.</p>\n    <h3 style="color: #7986CB; text-align: left; margin-top: 20px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 5px;">Key Definitions</h3>\n    <p style="line-height: 1.5; margin-bottom: 10px;"><b style="color: #7986CB;">Federalism:</b> A system of government where power is structurally divided between a central authority (Union government) and its constituent units (State governments).</p>\n    <p style="line-height: 1.5; margin-bottom: 10px;"><b style="color: #7986CB;">Unitary System:</b> The opposite of federalism. There is only one level of government, or sub-units are strictly subordinate to the central government. The center can order the states what to do.</p>\n    <p style="line-height: 1.5; margin-bottom: 10px;"><b style="color: #7986CB;">Jurisdiction:</b> The area over which someone has legal authority. In India, the Constitution clearly defines the jurisdiction of the Center and the States through three lists.</p>\n    <p style="line-height: 1.5; margin-bottom: 10px;"><b style="color: #7986CB;">Coalition Government:</b> A government formed by the coming together of at least two political parties. Usually, partners in a coalition form a political alliance and adopt a common programme.</p>\n    <p style="line-height: 1.5; margin-bottom: 10px;"><b style="color: #7986CB;">Decentralisation:</b> When power is specifically taken away from Central and State governments and given to local government (Panchayats and Municipalities).</p>\n    <h3 style="color: #7986CB; text-align: left; margin-top: 25px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 5px;">Important Points</h3>\n    <ul style="text-align: left; padding-left: 20px; line-height: 1.6; font-size: 16px;">\n        <li style="margin-bottom: 8px;">Federalism has two objectives: To strongly safeguard and promote the unity of the country, and to highly accommodate regional diversity.</li>\n        <li style="margin-bottom: 8px;">There are two routes to form a federation: \'Coming Together\' (independent states forming a bigger unit, e.g., USA, Australia) and \'Holding Together\' (a large country deciding to divide its power, e.g., India, Spain, Belgium).</li>\n        <li style="margin-bottom: 8px;">The Indian Constitution divides power into three lists: Union List (National importance: Defence, Foreign Affairs), State List (Local importance: Police, Agriculture), and Concurrent List (Common interest: Education, Forests).</li>\n        <li style="margin-bottom: 8px;">If there is a conflict between central law and state law on a Concurrent List subject, the Central law totally prevails.</li>\n        <li style="margin-bottom: 8px;">A major step towards decentralisation in India was taken in 1992. The Constitution was amended to make the third-tier of democracy (Panchayats and Municipalities) vastly more powerful and effective.</li>\n        <li style="margin-bottom: 8px;">The creation of Linguistic States (states formed based on language spoken) was the first and a major test for democratic politics in India. It actually made the country more united and administration easier.</li>\n    </ul>\n    <h3 style="color: #7986CB; text-align: left; margin-top: 25px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 5px;">Summary</h3>\n    <p style="line-height: 1.6; font-size: 16px;">Federalism allows a large, diverse country like India to be strongly united while respecting local, regional differences. The Constitution clearly outlines the exact power distribution between the Union and State governments through three specific lists. The era of coalition governments in India (since 1990) has significantly strengthened federalism, making it extremely difficult for the Center to arbitrarily dismiss State governments. Decentralisation (the 1992 constitutional amendment) established robust local self-governments, genuinely deepening democracy at the grassroots level.</p>\n</div>',
  htmlExercises: {
    "sc2-ex-1":
      '<div style="padding: 10px; color: #fff; text-align: justify; font-family: sans-serif;">\n    <div style="margin-bottom: 25px; ">\n        <p style="color: #7986CB; font-weight: bold; margin-bottom: 8px; font-size: 17px;">Q1. Point out one feature in the practice of federalism in India that is similar to and one feature that is different from that of Belgium.</p>\n        <p style="color: #E0E0E0; line-height: 1.6; font-size: 15px; margin-top: 5px;">Similar Feature: Both India and Belgium have essentially created a \'Holding Together\' federation where the central government boldly shares its powers with regional/state governments to beautifully accommodate diversity.</p>\n        <p style="color: #E0E0E0; line-height: 1.6; font-size: 15px; margin-top: 5px;">Different Feature: In Belgium, the regional governments have substantial constitutional powers that are completely independent of the central government. In India, the Central Government (Union) is deliberately designed to be significantly more powerful than the State governments (e.g., Union laws override State laws in the Concurrent list).</p>\n    </div>\n    <div style="margin-bottom: 25px; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 15px;">\n        <p style="color: #7986CB; font-weight: bold; margin-bottom: 8px; font-size: 17px;">Q2. What is the main difference between a federal form of government and a unitary one? Explain with an example.</p>\n        <p style="color: #E0E0E0; line-height: 1.6; font-size: 15px; margin-top: 5px;">In a strictly Unitary system, there is only one dominant level of government. If sub-units (states) exist, they are completely subordinate to the center. The central government can confidently pass orders to the local governments. Example: Sri Lanka heavily operates as a unitary system.</p>\n        <p style="color: #E0E0E0; line-height: 1.6; font-size: 15px; margin-top: 5px;">In a Federal system, power is meticulously divided between a central authority and its states. The central government absolutely CANNOT explicitly order the state government to do something because the state has its own constitutionally guaranteed powers. Example: India heavily operates as a federal system.</p>\n    </div>\n    <div style="margin-bottom: 25px; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 15px;">\n        <p style="color: #7986CB; font-weight: bold; margin-bottom: 8px; font-size: 17px;">Q3. State any two huge differences between the local government before and deeply after the highly crucial Constitutional amendment in 1992.</p>\n        <p style="color: #E0E0E0; line-height: 1.6; font-size: 15px; margin-top: 5px;">Before 1992: Elections to overwhelmingly vital local governments (Panchayats) were generally not held regularly. Also, local governments largely did not have very much distinct power or independent resources of their own.</p>\n        <p style="color: #E0E0E0; line-height: 1.6; font-size: 15px; margin-top: 5px;">After 1992: It became constitutionally completely mandatory to thoroughly hold impressively regular elections to strictly local government bodies. Furthermore, at least fully one-third of all immensely crucial positions enthusiastically became legally reserved absolutely for incredibly capable women.</p>\n    </div>\n</div>',
  },
};
