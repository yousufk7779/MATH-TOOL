  ...
  mcqs: [
    {
      id: "c8-sci-6-mcq-1",
      question:
        "<div style='text-align: justify;'>Which of the following is a Kharif crop?</div>",
      options: [
    ...
    },
    {
      id: "c8-sci-6-mcq-2",
      question:
        "<div style='text-align: justify;'>The process of loosening and turning the soil is called:</div>",
      options: [
    ...
    },
    {
      id: "c8-sci-6-mcq-3",
      question:
        "<div style='text-align: justify;'>Which of the following is a Rabi crop?</div>",
      options: [
        "<div style='text-align: justify;'>(a) Paddy</div>",
        "<div style='text-align: justify;'>(b) Maize</div>",
        "<div style='text-align: justify;'>(c) Wheat</div>",
        "<div style='text-align: justify;'>(d) Cotton</div>",
      ],
      correctAnswer: "c",
    },
    {
      id: "c8-sci-6-mcq-4",
      question:
        "<div style='text-align: justify;'>The supply of water to crops at appropriate intervals is called:</div>",
      options: [
        "<div style='text-align: justify;'>(a) Tilling</div>",
        "<div style='text-align: justify;'>(b) Sowing</div>",
        "<div style='text-align: justify;'>(c) Irrigation</div>",
        "<div style='text-align: justify;'>(d) Harvesting</div>",
      ],
      correctAnswer: "c",
    },
    {
      id: "c8-sci-6-mcq-5",
      question:
        "<div style='text-align: justify;'>Undesirable plants that grow naturally along with the crop are called:</div>",
      options: [
        "<div style='text-align: justify;'>(a) Herbs</div>",
        "<div style='text-align: justify;'>(b) Weeds</div>",
        "<div style='text-align: justify;'>(c) Shrubs</div>",
        "<div style='text-align: justify;'>(d) Grass</div>",
      ],
      correctAnswer: "b",
    },
    {
      id: "c8-sci-6-mcq-6",
      question:
        "<div style='text-align: justify;'>An organic substance obtained from the decomposition of plant or animal wastes is:</div>",
      options: [
        "<div style='text-align: justify;'>(a) Fertilizer</div>",
        "<div style='text-align: justify;'>(b) Manure</div>",
        "<div style='text-align: justify;'>(c) Pesticide</div>",
        "<div style='text-align: justify;'>(d) Insecticide</div>",
      ],
      correctAnswer: "b",
    },
    {
      id: "c8-sci-6-mcq-7",
      question:
        "<div style='text-align: justify;'>NPK (Nitrogen, Phosphorus, Potassium) is a type of:</div>",
      options: [
        "<div style='text-align: justify;'>(a) Manure</div>",
        "<div style='text-align: justify;'>(b) Fertilizer</div>",
        "<div style='text-align: justify;'>(c) Weedicide</div>",
        "<div style='text-align: justify;'>(d) Pesticide</div>",
      ],
      correctAnswer: "b",
    },
    {
      id: "c8-sci-6-mcq-8",
      question:
        "<div style='text-align: justify;'>The process of cutting and gathering a mature crop is known as:</div>",
      options: [
        "<div style='text-align: justify;'>(a) Sowing</div>",
        "<div style='text-align: justify;'>(b) Threshing</div>",
        "<div style='text-align: justify;'>(c) Harvesting</div>",
        "<div style='text-align: justify;'>(d) Winnowing</div>",
      ],
      correctAnswer: "c",
    },
    {
      id: "c8-sci-6-mcq-9",
      question:
        "<div style='text-align: justify;'>Chemicals which are used to control or kill weeds are called:</div>",
      options: [
        "<div style='text-align: justify;'>(a) Insecticides</div>",
        "<div style='text-align: justify;'>(b) Pesticides</div>",
        "<div style='text-align: justify;'>(c) Weedicides</div>",
        "<div style='text-align: justify;'>(d) Fertilizers</div>",
      ],
      correctAnswer: "c",
    },
    {
      id: "c8-sci-6-mcq-10",
      question:
        "<div style='text-align: justify;'>Large scale rearing of animals for food and other products is called:</div>",
      options: [
        "<div style='text-align: justify;'>(a) Agriculture</div>",
        "<div style='text-align: justify;'>(b) Horticulture</div>",
        "<div style='text-align: justify;'>(c) Animal Husbandry</div>",
        "<div style='text-align: justify;'>(d) Pisciculture</div>",
      ],
      correctAnswer: "c",
    },
  ],
      ...
      questions: [
        {
          ...
          number: "I",
          question:
            "<div style='text-align: justify;'><b>Name the following:</b><br/>1. Five requirements essential for obtaining good crop production.<br/>2. Two types of fertilizers.<br/>3. Some chemicals used to protect crops from insects pests and weeds.<br/>4. Some animal products.<br/>5. Members of a colony of bees.</div>",
          solution: [
