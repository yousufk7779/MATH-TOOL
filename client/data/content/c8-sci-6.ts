...
export const c8Sci6: ChapterContent = {
  ...
  mcqs: [
    ...
    {
      id: "c8-sci-6-mcq-3",
      question: "<div style='text-align: justify;'>Which of the following is a Rabi crop?</div>",
      options: [
    ...
    {
      id: "c8-sci-6-mcq-4",
      question: "<div style='text-align: justify;'>The supply of water to crops at appropriate intervals is called:</div>",
      options: [
    ...
    {
      id: "c8-sci-6-mcq-5",
      question: "<div style='text-align: justify;'>Undesirable plants that grow naturally along with the crop are called:</div>",
      options: [
    ...
    {
      id: "c8-sci-6-mcq-6",
      question: "<div style='text-align: justify;'>An organic substance obtained from the decomposition of plant or animal wastes is:</div>",
      options: [
    ...
    {
      id: "c8-sci-6-mcq-7",
      question: "<div style='text-align: justify;'>NPK (Nitrogen, Phosphorus, Potassium) is a type of:</div>",
      options: [
    ...
    {
      id: "c8-sci-6-mcq-8",
      question: "<div style='text-align: justify;'>The process of cutting and gathering a mature crop is known as:</div>",
      options: [
    ...
    {
      id: "c8-sci-6-mcq-9",
      question: "<div style='text-align: justify;'>Chemicals which are used to control or kill weeds are called:</div>",
      options: [
    ...
    {
      id: "c8-sci-6-mcq-10",
      question: "<div style='text-align: justify;'>Large scale rearing of animals for food and other products is called:</div>",
      options: [
