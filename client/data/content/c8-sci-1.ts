...
export const c8Sci1: ChapterContent = {
  id: "c8-sci-1",
  number: 1,
  title: "Micro-Organisms: Friend and Foe",
  introduction:
    "<div style='text-align: justify;'>Microorganisms are tiny organisms that are invisible to the naked eye. They play a vital role in our lives, acting as both friends (beneficial in many ways) and foes (causing diseases and spoilage).</div>",
  definitions: [
    {
      term: "Microorganisms",
      description:
        "<div style='text-align: justify;'>Organisms which are too small to be seen with the naked eye and can only be seen through a microscope.</div>",
    },
    {
      term: "Pathogens",
      description:
        "<div style='text-align: justify;'>Disease-causing microorganisms in humans, animals, and plants.</div>",
    },
    {
      term: "Antibiotics",
      description:
        "<div style='text-align: justify;'>Medicines that kill or stop the growth of disease-causing microorganisms.</div>",
    },
    {
      term: "Fermentation",
      description:
        "<div style='text-align: justify;'>The process of conversion of sugar into alcohol by the action of yeast.</div>",
    },
    {
      term: "Nitrogen Fixation",
      description:
        "<div style='text-align: justify;'>The process of converting atmospheric nitrogen into nitrogenous compounds that plants can use.</div>",
    },
  ],
  keyPoints: [
    "<div style='text-align: justify;'>Microorganisms are classified into four major groups: bacteria, fungi, protozoa, and some algae. Viruses are also considered microscopic but are different from other microorganisms.</div>",
    "<div style='text-align: justify;'>Microorganisms are used for the production of curd, bread, alcohol, and medicines like antibiotics.</div>",
    "<div style='text-align: justify;'>Pathogens spread through air, water, food, or physical contact, causing diseases like cholera, common cold, and malaria.</div>",
    "<div style='text-align: justify;'>Food can be preserved by using chemicals, salt, sugar, oil, vinegar, and by heat and cold treatments (Pasteurization).</div>",
    "<div style='text-align: justify;'>Rhizobium bacteria fix nitrogen in the root nodules of leguminous plants, enhancing soil fertility.</div>",
  ],
  crux: [
    "<div style='text-align: justify;'><b>Useful Microbes:</b> Yeast (baking), Lactobacillus (curd), Rhizobium (nitrogen fixation).</div>",
    "<div style='text-align: justify;'><b>Harmful Microbes:</b> Pathogens (diseases), food spoilage.</div>",
    "<div style='text-align: justify;'><b>Prevention:</b> Vaccines, antibiotics, food preservation, hygiene.</div>",
  ],
  formulas: [],
  mcqs: [
    {
      ...
      options: [
        ...
        "<div style='text-align: justify;'>(c) Hydrochloric acid</div>",
        "<div style='text-align: justify;'>(d) Oxygen</div>",
      ],
      correctAnswer: "b",
    },
    {
      ...
      options: [
        ...
        "<div style='text-align: justify;'>(c) Alcohol</div>",
        "<div style='text-align: justify;'>(d) Yeast</div>",
      ],
      correctAnswer: "b",
    },
    {
      ...
      options: [
        ...
        "<div style='text-align: justify;'>(c) Housefly</div>",
        "<div style='text-align: justify;'>(d) Butterfly</div>",
      ],
      correctAnswer: "a",
    },
    {
      ...
      options: [
        ...
        "<div style='text-align: justify;'>(c) Dragonfly</div>",
        "<div style='text-align: justify;'>(d) Spider</div>",
      ],
      correctAnswer: "b",
    },
    {
      ...
      options: [
        ...
        "<div style='text-align: justify;'>(c) Growth of yeast cells</div>",
        "<div style='text-align: justify;'>(d) Kneading</div>",
      ],
      correctAnswer: "c",
    },
    {
      ...
      options: [
        ...
        "<div style='text-align: justify;'>(c) Fermentation</div>",
        "<div style='text-align: justify;'>(d) Infection</div>",
      ],
      correctAnswer: "c",
    },
    {
      ...
      options: [
        ...
        "<div style='text-align: justify;'>(c) Protozoa</div>",
    ...
    },
    {
      ...
      options: [
        ...
        "<div style='text-align: justify;'>(c) Flagella</div>",
        "<div style='text-align: justify;'>(d) Tentacles</div>",
      ],
      correctAnswer: "b",
    },
    {
      ...
      options: [
        ...
        "<div style='text-align: justify;'>(c) Viral diseases</div>",
        "<div style='text-align: justify;'>(d) All of these</div>",
      ],
      correctAnswer: "b",
    },
    {
      ...
      options: [
        ...
        "<div style='text-align: justify;'>(c) Vibrio cholera</div>",
        "<div style='text-align: justify;'>(d) Bacillus anthracis</div>",
      ],
      correctAnswer: "b",
    },
  ],
  examples: [],
  summary: [
    "<div style='text-align: justify;'>Microorganisms are all around us, but they are too small to be seen without a microscope.</div>",
    "<div style='text-align: justify;'>They live in all types of environments, from ice-cold climates to hot springs.</div>",
    "<div style='text-align: justify;'>Some microbes are useful for making food, medicine, and cleaning the environment.</div>",
    "<div style='text-align: justify;'>Others cause diseases in plants and animals and can spoil food.</div>",
    "<div style='text-align: justify;'>We can protect ourselves through vaccination, use of antibiotics, and proper food preservation techniques.</div>",
  ],
  exercises: [
    {
      id: "c8-sci-1-ex1",
