...
export const otherSubjectsData: Record<string, Record<string, Chapter[]>> = {
  ...
  "Class 8": {
    "Mathematics": [
      ...
      { id: "c8-math-6", number: 6, name: "Cubes and Cube Roots", color: "#F06292" },
      { id: "c8-math-7", number: 7, name: "Comparing Quantities", color: "#6200EA" },
      { id: "c8-math-8", number: 8, name: "Algebraic Expressions and Identities", color: "#FF6D00" },
      { id: "c8-math-9", number: 9, name: "Mensuration", color: "#0091EA" },
      { id: "c8-math-10", number: 10, name: "Exponents and Powers", color: "#FFD600" },
      { id: "c8-math-11", number: 11, name: "Direct and Inverse Proportion", color: "#00D4FF" },
      { id: "c8-math-12", number: 12, name: "Factorisation", color: "#00BFA5" },
      { id: "c8-math-13", number: 13, name: "Introduction to Graphs", color: "#E040FB" },
    ]
  },
  "Class 7": {
    "Mathematics": [
      { id: "c7-math-1", number: 1, name: "Integers", color: "#FF9800" },
      { id: "c7-math-2", number: 2, name: "Fractions and Decimals", color: "#FF4081" },
      { id: "c7-math-3", number: 3, name: "Data Handling", color: "#FFAB00" },
      { id: "c7-math-4", number: 4, name: "Simple Equations", color: "#2196F3" },
      { id: "c7-math-5", number: 5, name: "Lines and Angles", color: "#43A047" },
