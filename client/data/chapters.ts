...
export const otherSubjectsData: Record<string, Record<string, Chapter[]>> = {
  ...
  "Class 10 Social Science": {
    ...
    Geography: [
      ...
      { id: "sst-geo-3", number: 3, name: "Water Resources", color: "#00C6FF" },
      { id: "sst-geo-4", number: 4, name: "Agriculture", color: "#00FFAB" },
      {
        id: "sst-geo-5",
        number: 5,
    ...
    Civics: [
      { id: "sst-civ-1", number: 1, name: "Power Sharing", color: "#AB47BC" },
      { id: "sst-civ-2", number: 2, name: "Federalism", color: "#7986CB" },
      {
        id: "sst-civ-3",
        number: 3,
    ...
    Economics: [
      { id: "sst-eco-1", number: 1, name: "Development", color: "#FDC830" },
      {
        id: "sst-eco-2",
        number: 2,
      ...
      { id: "sst-eco-5", number: 5, name: "Consumer Rights", color: "#8E2DE2" },
    ],
  },
...
export function getChapterGradient(chapter: Chapter | string): string[] {
  ...
  if (chapterId === "c11-chem-4") return ["#43A047", "#388E3C"];
