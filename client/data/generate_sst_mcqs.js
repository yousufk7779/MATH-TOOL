...
const mcqs = [
  // --- HISTORY (Our Pasts - II) ---
  {
    id: "c7-h-1",
    question:
      "Which century marked the beginning of the Medieval period in India?",
    options: [
      "(A) 5th Century",
      "(B) 8th Century",
      "(C) 12th Century",
  ...
  },
  {
    id: "c7-h-2",
    question:
      "Who was the chronicler of the 13th century who used the term 'Hindustan'?",
    options: [
      "(A) Amir Khusrau",
      "(B) Minhaj-i-Siraj",
      "(C) Babur",
  ...
  },
  {
    id: "c7-h-5",
    question:
      "Which new crop was introduced to the subcontinent during this period?",
  ...
  },
  {
    id: "c7-h-20",
    question:
      "The style of architecture using two vertical columns and a horizontal beam is:",
  ...
  },
  {
    id: "c7-h-23",
    question:
      "The English and Dutch attempted to control which port on the Andhra coast?",
  ...
  },
  {
    ...
    options: [
      "(A) Oil on canvas",
      "(B) Water color on cloth or paper",
      "(C) Charcoal on walls",
      "(D) Ink on stone",
    ],
    correctAnswer: "B",
  ...
  },
  {
    id: "c7-g-6",
    question:
      "The change of state of rocks from one form to another is called:",
    options: [
      "(A) Rock cycle",
      "(B) Rock change",
      "(C) Rock mixing",
  ...
  },
  {
    ...
    subject: "geography",
    chapterId: "c7-geo-6",
    chapterTitle: "Human Environment Interactions - The Tropical and the Subtropical Region",
  },
  {
    id: "c7-g-18",
    question: "Manioc is the staple food of:",
    options: ["(A) Ganga Basin", "(B) Africa", "(C) Amazon", "(D) Brahmaputra Basin"],
    correctAnswer: "C",
    subject: "geography",
    chapterId: "c7-geo-6",
    chapterTitle: "Human Environment Interactions - The Tropical and the Subtropical Region",
  },
  {
    ...
    options: ["(A) Orange", "(B) Hooghly", "(C) Bhagirathi", "(D) Ganga"],
    correctAnswer: "B",
    subject: "geography",
    chapterId: "c7-geo-6",
    chapterTitle: "Human Environment Interactions - The Tropical and the Subtropical Region",
  ...
  },
  {
    id: "c7-c-3",
    question:
      "The African-American woman who started the Civil Rights Movement was:",
    options: [
      "(A) Rosa Parks",
      "(B) Kamala Harris",
      "(C) Michelle Obama",
...
fs.writeFileSync(
  path.join(__dirname, "easy_mcqs_sst_c7.json"),
