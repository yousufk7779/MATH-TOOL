...
function Class7SocialScienceScreen() {
    const navigation = useNavigation<NavigationProp>();
    const route = useRoute<RouteProp<RootStackParamList, "Class7SocialScience">>();
    const { width, height } = useWindowDimensions();
    const isLandscape = width > height;

    const className = "Class 7";
    const subjectName = "Class 7 Social Science";
                ...
                <View style={styles.buttonsContainer}>
                    ...
                    <View style={styles.buttonWrapper}>
                        <ColorButton
                            ...
                            onPress={() => navigation.navigate("ChapterList", { subject: subjectName, topic: "History" })}
                        />
                    </View>
                    ...
                    <View style={styles.buttonWrapper}>
                        <ColorButton
                            ...
                            onPress={() => navigation.navigate("ChapterList", { subject: subjectName, topic: "Geography" })}
                        />
                    </View>
                    ...
                    <View style={styles.buttonWrapper}>
                        <ColorButton
                            ...
                            onPress={() => navigation.navigate("ChapterList", { subject: subjectName, topic: "Civics" })}
                        />
                    </View>
                </View>
            </ScrollView>
...
export default memo(Class7SocialScienceScreen);
