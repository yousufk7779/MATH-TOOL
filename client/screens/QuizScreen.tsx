...
export default function QuizScreen() {
  ...
  const startQuiz = useCallback(
    async (subject: string = "Mathematics") => {
      ...
      if (
        ...
        Alert.alert(
          "Quiz Coming Soon",
          `Quiz content for ${className} is coming soon!`,
        );
        return;
      }
      ...
      setLoading(true);
      try {
        const newQuestions = await generateQuizAsync(
          10,
          subject,
          className || "Class 10",
    ...
    return (
      <View style={styles.quizContainer} key={currentQuestionIndex}>
        ...
        <View style={styles.questionCard}>
          <ParsedText style={styles.questionText}>
            {question.question}
          </ParsedText>
        </View>
              ...
              <ThemedText
                style={[
                  styles.resultPercentageBig,
                  {
                    color:
                      percentage >= 50
                        ? JiguuColors.arithmetic
                        : JiguuColors.triangles,
                  },
                ]}
              >
                {percentage}%
              </ThemedText>
              <ThemedText style={styles.resultScoreLabel}>
                TOTAL SCORE
              </ThemedText>
  ...
  return (
    <ScreenWrapper
      showBackButton={viewState !== "active"}
      hideHomeButton
      homeRoute={homeRoute}
    >
      <ScrollView
