...
function Class10SocialScienceScreen() {
    ...
    const route = useRoute<RouteProp<RootStackParamList, "Class10SocialScience">>();
                ...
                <View style={styles.buttonsContainer}>
                    ...
                    <View style={styles.buttonWrapper}>
                        <ColorButton
                            ...
                            onPress={() => navigation.navigate("ChapterList", { subject: subjectName, topic: "History", className: className })}
                        />
                    </View>
                    ...
                    <View style={styles.buttonWrapper}>
                        <ColorButton
                            ...
                            onPress={() => navigation.navigate("ChapterList", { subject: subjectName, topic: "Geography", className: className })}
                        />
                    </View>
                    ...
                    <View style={styles.buttonWrapper}>
                        <ColorButton
                            ...
                            onPress={() => navigation.navigate("ChapterList", { subject: subjectName, topic: "Civics", className: className })}
                        />
                    </View>
                    ...
                    <View style={styles.buttonWrapper}>
                        <ColorButton
                            ...
                            onPress={() => navigation.navigate("ChapterList", { subject: subjectName, topic: "Economics", className: className })}
                        />
                    </View>
                </View>
            </ScrollView>
