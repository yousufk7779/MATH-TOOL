  ...
  return (
    <View style={styles.container}>
      <Svg height="160" width="300" viewBox="0 0 300 160">
        ...
        <SvgText x="100" y="100" fill="#333" fontSize="12" textAnchor="middle">
          A
        </SvgText>

        {/* Center B */}
        <Circle cx="120" cy="80" r="3" fill="#000" />
        <SvgText x="120" y="100" fill="#333" fontSize="12" textAnchor="middle">
          B
        </SvgText>

        {/* L1: Center A, Radius 20, Top */}
        <Path
          d="M 120 80 A 20 20 0 0 0 80 80"
          stroke="#FF5722"
          strokeWidth="2"
          fill="none"
        />
        ...
        <Path
          d="M 80 80 A 40 40 0 0 0 160 80"
          stroke="#2196F3"
          strokeWidth="2"
          fill="none"
        />
        ...
        <Path
          d="M 160 80 A 60 60 0 0 0 40 80"
          stroke="#4CAF50"
          strokeWidth="2"
          fill="none"
        />
  ...
  return (
    <View style={styles.container}>
      <Svg height="160" width="300" viewBox="0 0 300 160">
        ...
        <SvgText x={startX + 50} y={20} fill="#333" fontSize="12">
          Pattern continues upwards...
        </SvgText>
      </Svg>
    </View>
  );
    ...
    <View style={styles.container}>
      <Svg height="120" width="320" viewBox="0 0 320 120">
        ...
        <Rect
          ...
          stroke="#FFA000"
        />
        <SvgText x="40" y="100" fill="#333" fontSize="12" textAnchor="middle">
          Bucket
        </SvgText>

        {/* Potato 1 at 5m (scale: 1m = 15px? 5m = 75px + 40 = 115) */}
        <Circle cx="115" cy="80" r="6" fill="#795548" />
        <SvgText x="115" y="100" fill="#333" fontSize="12" textAnchor="middle">
          1st
        </SvgText>
        <Line
          x1="40"
          ...
          strokeDasharray="4,4"
        />
        <SvgText x="77" y="35" fill="#333" fontSize="12" textAnchor="middle">
          5m
        </SvgText>

        {/* Potato 2 at 8m (3m more -> 45px more -> 160) */}
        <Circle cx="160" cy="80" r="6" fill="#795548" />
        <SvgText x="160" y="100" fill="#333" fontSize="12" textAnchor="middle">
          2nd
        </SvgText>
        <Line
          x1="115"
          ...
          strokeDasharray="4,4"
        />
        <SvgText x="137" y="35" fill="#333" fontSize="12" textAnchor="middle">
          3m
        </SvgText>

        {/* Potato 3 at 11m (3m more -> 45px more -> 205) */}
        <Circle cx="205" cy="80" r="6" fill="#795548" />
        <SvgText x="205" y="100" fill="#333" fontSize="12" textAnchor="middle">
          3rd
        </SvgText>
        <Line
          x1="160"
          ...
          strokeDasharray="4,4"
        />
        <SvgText x="182" y="35" fill="#333" fontSize="12" textAnchor="middle">
          3m
        </SvgText>

        <SvgText x="260" y="80" fill="#333" fontSize="12">
          ... and so on
        </SvgText>
      </Svg>
    </View>
