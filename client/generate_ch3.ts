...
import { mathCh3 } from "./data/content/math-ch3";

const HTML_DIR = path.join(__dirname, "assets", "chapters", "chapter3");
...
<style>
  ...
  .sub-question { color: #AB47BC !important; text-align: justify !important; font-weight: bold !important; font-family: 'Noto Sans', sans-serif !important; }
  ...
  * { font-family: 'Noto Sans', sans-serif !important; }
  ...
  strong[style*="color: #FF6B6B"] { color: #AB47BC !important; }
  strong[style*="color: #ff6b6b"] { color: #AB47BC !important; }
...
export const mathCh3: ChapterContent = {
  ...
  introduction: ${JSON.stringify(mathCh3.introduction)},
  definitions: ${JSON.stringify(mathCh3.definitions, null, 2)},
  keyPoints: ${JSON.stringify(mathCh3.keyPoints, null, 2)},
  formulas: ${JSON.stringify(mathCh3.formulas, null, 2)},
  crux: ${JSON.stringify(mathCh3.crux, null, 2)},
  summary: ${JSON.stringify(mathCh3.summary, null, 2)},
  examples: [],
  exercises: [
  ...
  mcqs: ${JSON.stringify(mathCh3.mcqs, null, 2)},
  isHtmlView: true,
  htmlExercises: {
    examples: \`${examples}\`,
    exercise1: \`${exercise1}\`,
...
console.log("math-ch3.ts generated successfully with WebView HTML support and standard native MCQs!");
