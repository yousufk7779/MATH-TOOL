...
if (q5Start !== -1) {
  ...
  if (solStart !== -1) {
    const firstResult = content.indexOf(
      "**Therefore, the required values are sin Q",
      solStart,
    );
    if (firstResult !== -1) {
      ...
      if (q6Start !== -1) {
        ...
        content =
          content.substring(0, firstResultEnd) +
          "\n            ]" +
          answerStr +
          content.substring(q6Start + 10);
