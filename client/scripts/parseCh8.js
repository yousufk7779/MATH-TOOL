  ...
  definitions: [
    {
      ...
      description:
        "The primary ratios linking specific side lengths (Perpendicular, Base, Hypotenuse) to an angle θ.",
    },
    ...
    $(el)
      ...
      .each((j, child) => {
        ...
        if ($(child).hasClass("sub-question")) {
          ...
          $(child).hasClass("section-title") ||
          $(child).hasClass("solution-header")
        ) {
          solutionSteps.push(
            `<span style="font-weight: 700; color: #2E7D32;">${cleanText($(child).text())}</span>`,
          );
