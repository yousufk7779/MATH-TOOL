...
files.forEach((file) => {
  ...
  content = content.replace(
    /fontFamily: ["']Kalam_[467]00(Regular|SemiBold|Bold)["']/g,
    'fontFamily: "NotoSans_$1"',
  );
  content = content.replace(
    /fontFamily: ["']Inter_[467]00(Regular|SemiBold|Bold)["']/g,
    'fontFamily: "NotoSans_$1"',
  );
