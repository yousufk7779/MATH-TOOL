...
content += "          solution: [\n";
content +=
  "            \"<div style='color: #FFFFFF; text-align: justify;'>Below is the labeled diagram of the human eye:<br/><br/><center><img src='data:image/png;base64," +
  b64Eye +
  "' style='max-width: 90%; border-radius: 8px; margin: 10px 0; border: 1px solid #ddd;'/></center></div>\",\n";
content += "          ],\n";
content += '          answer: "",\n';
content += "        },\n";
content += "        {\n";
...
content += "          solution: [\n";
content +=
  "            \"<div style='color: #FFFFFF; text-align: justify;'>Below is the ray diagram for the two mirrors at right angles:<br/><br/><center><img src='data:image/png;base64," +
  b64Mirrors +
  "' style='max-width: 90%; border-radius: 8px; margin: 10px 0; border: 1px solid #ddd;'/></center></div>\",\n";
content += "          ],\n";
content += '          answer: "",\n';
