...
const eyeHtml = `<div style="text-align: center; margin: 15px 0;">
    <img src="data:image/png;base64,${b64Eye}" style="max-width: 95%; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.2); border: 1px solid #444;" />
    <p style="color: #bbb; font-size: 0.8em; margin-top: 5px;">Fig 11.1: Structure of the Human Eye</p>
</div>`;

const mirrorHtml = `<div style="text-align: center; margin: 15px 0;">
    <img src="data:image/png;base64,${b64Mirrors}" style="max-width: 95%; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.2); border: 1px solid #444;" />
    <p style="color: #bbb; font-size: 0.8em; margin-top: 5px;">Fig 11.2: Ray Diagram (Mirrors at 90°)</p>
</div>`;

const template = `import { ChapterContent } from "../chapterContent";
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          solution: [
            "<div style='color: #FFFFFF; text-align: justify;'>Below is the labeled diagram of the human eye:<br/>${eyeHtml}</div>",
          ],
          answer: "",
        },
        {
        ...
        },
        {
          ...
          solution: [
            "<div style='color: #FFFFFF; text-align: justify;'>Below is the ray diagram for the two mirrors at right angles:<br/>${mirrorHtml}</div>",
          ],
          answer: "",
        },
        {
