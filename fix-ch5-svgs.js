...
async function run() {
    ...
    let content = fs.readFileSync('client/data/content/math-ch5.ts', 'utf8');
    ...
    fs.writeFileSync('client/data/content/math-ch5.ts', content);
    console.log('Saved updated math-ch5.ts');
}
