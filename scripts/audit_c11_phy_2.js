...
const file = path.join(__dirname, '../client/data/content/c11-phy-2.ts');
const content = fs.readFileSync(file, 'utf-8');

console.log('=== AUDITING CLASS 11 PHYSICS CHAPTER 2 ===\n');
...
const qMatches = content.match(/<h3 style=\\"color: #8E2DE2; margin: 0 0 10px 0; font-size: 17px; font-weight: bold; line-height: 1\.5;\\">Q\d+:/g) || [];
...
const mcqRegex = /"id": "c11-phy-2-mcq-(\d+)"/g;
...
const hasImport = ccContent.includes('c11Phy2HtmlOverview, c11Phy2HtmlSolutions, c11Phy2Mcqs } from "./content/c11-phy-2"');
const hasWiring = ccContent.includes('ch11Phy2.mcqs = c11Phy2Mcqs;');

if (hasImport && hasWiring) {
  console.log('✅ PASSED: client/data/chapterContent.ts correctly imports and connects c11-phy-2 overview, solutions, and mcqs.');
} else {
