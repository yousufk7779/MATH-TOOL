...
function defBox(title, content, si = '', dim = '') {
  ...
  return `<div style="background: rgba(15, 23, 42, 0.85); border: 1.2px solid rgba(255, 81, 47, 0.4); border-left: 5px solid ${themeColor}; border-radius: 8px; padding: 14px 18px; margin: 18px 0;">
...
function analogyBox(title, content) {
  return `<div style="background: rgba(30, 41, 59, 0.7); border: 1.2px dashed #38BDF8; border-radius: 8px; padding: 12px 16px; margin: 16px 0;">
    <div style="color: #38BDF8; font-size: 15px; font-weight: bold; margin-bottom: 4px;">💡 REAL-WORLD INTUITION: ${title}</div>
...
function stepDerivationBox(title, steps) {
  ...
  `).join('');
  return `<div style="background: rgba(15, 23, 42, 0.95); border: 1.5px solid rgba(255, 81, 47, 0.5); border-radius: 10px; padding: 16px 18px; margin: 20px 0;">
