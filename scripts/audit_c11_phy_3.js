...
const file = path.join(__dirname, '../client/data/content/c11-phy-3.ts');
const content = fs.readFileSync(file, 'utf-8');

console.log('=== AUDITING CLASS 11 PHYSICS CHAPTER 3 ===\n');
...
const qMatches = content.match(/<h3 style=\\"color: #FF8A65; margin: 0 0 10px 0; font-size: 17px; font-weight: bold; line-height: 1\.5;\\">Q\d+:/g) || [];
...
const mcqRegex = /"id": "c11-phy-3-mcq-(\d+)"/g;
...
const hasImport = ccContent.includes('c11Phy3HtmlOverview, c11Phy3HtmlSolutions, c11Phy3Mcqs } from "./content/c11-phy-3"');
const hasWiring = ccContent.includes('ch11Phy3.mcqs = c11Phy3Mcqs;');

if (hasImport && hasWiring) {
  console.log('✅ PASSED: client/data/chapterContent.ts correctly imports and connects c11-phy-3 overview, solutions, and mcqs.');
} else {
