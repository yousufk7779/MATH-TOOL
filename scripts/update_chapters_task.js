...
const chapsData = {
  chapter1: {
    ...
    summary:
      "Real numbers connect abstract algebra to tangible measurement. The relationship HCF × LCM = a × b holds true for any two positive integers.",
  },
  chapter2: {
    ...
    summary:
      "Polynomials offer a way to model multiple outcomes algebraically and graphically. Their roots determine where the function crosses the axis.",
  },
  chapter3: {
    title: "Chapter 3: Pair of Linear Equations in Two Variables",
    intro:
      "Two linear equations in the same two variables x and y form a pair of linear equations. They geometrically represent two straight lines on a Cartesian plane.",
  ...
  chapter4: {
    ...
    intro:
      "A quadratic equation is a second-degree polynomial equation in a single variable x, typically written in the standard form ax² + bx + c = 0.",
    ...
    summary:
      "Quadratic equations naturally model situations involving gravity, area, and parabolic trajectories. The discriminant is the fastest tool to check root validity.",
  },
  chapter5: {
  ...
  chapter6: {
    ...
    intro:
      "A triangle is a closed shape with three angles. This chapter dives beyond basic properties into the fascinating world of geometric similarity.",
    ...
    summary:
      "Similarity forms the bedrock of trigonometry and scaling. It distinguishes exactness (congruence) from scaled replicas (similarity).",
  },
  chapter7: {
    ...
    summary:
      "Plotting maps, GPS tracking, and digital drawing heavily rely on coordinate geometry to calculate spatial distances and section proportions.",
  },
  chapter8: {
    title: "Chapter 8: Introduction to Trigonometry",
    intro:
      "Trigonometry is the study of relationships between the sides and angles of a right-angled triangle. It implies measuring the elements of a triangle.",
  ...
  chapter9: {
    ...
    intro:
      "This chapter applies trigonometric ratios practically, allowing calculation of heights and distances of objects you cannot directly measure.",
    ...
    summary:
      "From navigating planes to designing skyscraper heights, applied trigonometry removes the need for impossible physical measurements.",
  },
  chapter10: {
    title: "Chapter 10: Circles",
    intro:
      "A circle is the locus of all points in a plane equidistant from a fixed center. This chapter predominantly examines the properties of lines touching circles.",
    ...
    summary:
      "Circles represent flawless symmetry. Their interacting tangents shape gears, belts, and wheels in fundamental mechanical physics.",
  },
  chapter11: {
    title: "Chapter 11: Areas Related to Circles",
    intro:
      "Extending beyond simple area (πr²), this covers the calculation of areas of specific subsections of a circle based on central angles.",
    ...
    summary:
      "These specialized area formulas allow precise calculation in real scenarios, such as wiped windshield area or architectural window panes.",
  },
  chapter12: {
    title: "Chapter 12: Surface Areas and Volumes",
    intro:
      "A transition from 2D plane geometry to 3D solid geometry, analyzing objects like cubes, cylinders, cones, and spheres, or combinations thereof.",
    ...
    summary:
      "Volume capacity and surface packaging optimization strictly depend on these formulas across shipping, manufacturing, and plumbing industries.",
  },
  chapter13: {
    title: "Chapter 13: Statistics",
    intro:
      "Statistics is the systematic collection, representation, and mathematical analysis of vast quantities of numerical data.",
    ...
    summary:
      "Without statistics, data is just arbitrary numbers. These tools consolidate massive datasets into single, comprehensible summary values.",
  },
  chapter14: {
    title: "Chapter 14: Probability",
    intro:
      "Probability fundamentally models the mathematical certainty or uncertainty of random events, ranging securely from impossible to absolutely sure.",
    ...
    summary:
      "Probability quantifies chance, making it invaluable for actuarial sciences, weather forecasting, game theory, and long-term risk assessment.",
  },
};
...
`;
      ...
      if (
        !content.includes("max-height: 250px;") &&
