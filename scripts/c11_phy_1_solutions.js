const { themeColor } = require('./c11_phy_1_helpers');
const { getVsaQuestions } = require('./c11_phy_1_solutions_part1');
const { getSaQuestions } = require('./c11_phy_1_solutions_part2');
const { getLaQuestions } = require('./c11_phy_1_solutions_part3');
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.7; font-size: 16px;">
  ...
  <!-- TITLE BANNER -->
  <div style="background: rgba(255, 81, 47, 0.05); border: 1.5px solid ${themeColor}; border-radius: 12px; padding: 18px; margin-bottom: 25px; text-align: center;">
    ...
    <p style="color: #CBD5E1; margin: 0; font-size: 15px; text-align: center !important;">
      Class 11 Physics Unit I: Physical World and Measurement &bull; Units and Measurements (05 Marks)
    </p>
  </div>
  ...
  <div style="margin-top: 25px; margin-bottom: 15px; border-bottom: 2px solid ${themeColor}; padding-bottom: 8px;">
    ...
    <p style="color: #94A3B8; margin: 4px 0 0 0; font-size: 14px;">
      Fundamental definitions, 1-line physical reasoning, SI base and supplementary units, and basic dimensions.
    </p>
  </div>
  ${vsaHtml}
  ...
  <div style="margin-top: 35px; margin-bottom: 15px; border-bottom: 2px solid ${themeColor}; padding-bottom: 8px;">
    ...
    <p style="color: #94A3B8; margin: 4px 0 0 0; font-size: 14px;">
      Conceptual derivations, error propagation analysis, unit conversions, and dimensional consistency proofs.
    </p>
  </div>
  ${saHtml}
  ...
  <div style="margin-top: 35px; margin-bottom: 15px; border-bottom: 2px solid ${themeColor}; padding-bottom: 8px;">
    ...
    <p style="color: #94A3B8; margin: 4px 0 0 0; font-size: 14px;">
      Comprehensive multi-step board derivations, dimensional deducing of universal formulas, and master chapter synthesis.
    </p>
  </div>
  ${laHtml}
