...
console.log('=== AUDITING CLASS 11 PHYSICS CHAPTER 10 (UNIT X: OSCILLATIONS AND WAVES) ===\n');

let passed = true;

// 1. Check file existence and size
if (!fs.existsSync(targetFile)) {
  console.error('FAIL: c11-phy-10.ts does not exist!');
  process.exit(1);
}
...
const mcqIdMatches = content.match(/c11-phy-10-mcq-\d+/g);
...
const hasImport = ccContent.includes('c11Phy10HtmlOverview') &&
                  ccContent.includes('c11Phy10HtmlSolutions') &&
                  ccContent.includes('c11Phy10Mcqs');
const hasWiring = ccContent.includes('ch11Phy10.mcqs = c11Phy10Mcqs;');
...
console.log('\n================================================================');
if (passed) {
  console.log('>>> ALL QUALITY GATES PASSED PERFECTLY FOR CHAPTER 10! <<<');
} else {
