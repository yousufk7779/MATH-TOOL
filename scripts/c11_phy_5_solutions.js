const { themeColor } = require('./c11_phy_5_helpers');
const { getSolutionsPart1 } = require('./c11_phy_5_solutions_part1');
const { getSolutionsPart2 } = require('./c11_phy_5_solutions_part2');
const { getSolutionsPart3 } = require('./c11_phy_5_solutions_part3');
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.7; font-size: 16px;">
  ...
  <div style="background: rgba(171, 71, 188, 0.05); border: 1.5px solid ${themeColor}; border-radius: 12px; padding: 18px; margin-bottom: 25px; text-align: center;">
    ...
    <p style="color: #CBD5E1; margin: 0; font-size: 15px; text-align: center !important;">
      Class 11 Physics Unit V: Motion of System of Particles and Rigid Body (06 Marks) &bull; Official Syllabus Coverage
    </p>
  </div>
