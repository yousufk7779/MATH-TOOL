...
console.log('--- CHAPTER 5 AUDIT: COORDINATION COMPOUNDS ---');
...
// 4. MCQs
const mcqMatches = content.match(/"id":\s*"c12-chem-5-mcq-\d+"/g) || [];
...
// 8. MCQs verification
const mcqChunk = content.match(/export const c12Chem5Mcqs = (\[[\s\S]*?\]);\n/)[1];
