...
const filePath = path.join(__dirname, '..', 'client', 'data', 'content', 'c11-phy-6.ts');
const content = fs.readFileSync(filePath, 'utf8');

const matchOverview = content.match(/export const c11Phy6HtmlOverview = ([\s\S]*?);\n\nexport const/);
...
console.log("=== CHAPTER 6 (GRAVITATION) AUDIT ===");
...
const mcqCount = (sol.match(/MCQ\s*\d+|SECTION 1/gi) || []).length;
