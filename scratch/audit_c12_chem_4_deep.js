...
console.log('--- CHAPTER 4 AUDIT: d- AND f-BLOCK ELEMENTS ---');
...
// 4. MCQs
const mcqMatches = content.match(/"id":\s*"c12-chem-4-mcq-\d+"/g) || [];
...
// 8. MCQs verification
const mcqChunk = content.match(/export const c12Chem4Mcqs = (\[[\s\S]*?\]);\n/)[1];
