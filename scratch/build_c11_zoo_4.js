...
// Read cropped base64 json for Zoo 4
...
console.log("Generating full c11-zoo-4.ts file for Class 11 Zoology Chapter 4: Human Physiology...");
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.7; font-size: 16px;">
  ...
  <!-- MASTER HUMAN PHYSIOLOGY HD POSTER CHART -->
  <div style="text-align: center; margin-bottom: 25px;">
    <h2 style="color: ${themeColor}; font-size: 20px; font-weight: bold; margin-bottom: 8px;" class="text-center">🫀 HUMAN PHYSIOLOGY: COMPREHENSIVE STUDY GUIDE &amp; DIAGRAMS (HD)</h2>
    <img src="${croppedB64.masterB64}" style="max-width: 100%; border-radius: 12px; border: 2px solid ${themeColor}; box-shadow: 0 6px 20px rgba(0,176,255,0.3);" />
    <p style="color: ${themeColor}; font-size: 13px; margin-top: 6px; font-weight: bold;" class="text-center">Figure 4.0: Comprehensive Human Physiology Master Reference Chart (Official NCERT Unit-IV Standard)</p>
  </div>
  ...
  ${renderHDCard(croppedB64.respiratory_system, "Figure 4.1: Human Respiratory System Architecture, Alveolar Gas Exchange &amp; Mechanism of Breathing Flowchart")}
  ...
  ${renderHDCard(croppedB64.heart_and_ecg, "Figure 4.2: Human Heart Internal Anatomy, 4 Chambers, Major Blood Vessels &amp; Standard ECG Trace Graph")}
  ...
  ${renderHDCard(croppedB64.excretory_and_nephron, "Figure 4.3: Human Excretory System Anatomy &amp; Fine Structure of Nephron (Glomerulus, Henle's Loop, Collecting Duct)")}
  ...
  ${renderHDCard(croppedB64.skeleton_and_joints, "Figure 4.4: Human Skeleton Overview, Types of Synovial Joints &amp; Muscle Tissue Classification")}
  ...
  ${renderHDCard(croppedB64.neuron_and_reflex, "Figure 4.5: Structure of Typical Neuron, Chemical Synapse Impulse Transmission &amp; Reflex Arc Pathway")}
  ...
  ${renderHDCard(croppedB64.endocrine_system, "Figure 4.6: Human Endocrine Glands Overview &amp; Mechanism of Hormone Action (Protein vs Steroid Hormones)")}
...
// Generate Solutions HTML (100 Questions)
...
// High-Level Full Reference Book Content with 100% Exact Official NCERT Syllabus and HD Diagrams
...
console.log("Successfully generated full c11-zoo-4.ts file for Class 11 Zoology Chapter 4: Human Physiology!");
