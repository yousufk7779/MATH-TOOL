...
// =============================================================================
// DIAGRAM 1: COULOMB'S LAW & SUPERPOSITION PRINCIPLE (EXACT MATCH TO REFERENCE)
// =============================================================================
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 920 520" width="100%" height="100%" style="background: linear-gradient(135deg, #0B0F19 0%, #111827 50%, #070A10 100%);">
  <defs>
    <radialGradient id="qRedGlow" cx="35%" cy="35%" r="65%">
      <stop offset="0%" stop-color="#FF8A65"/>
      <stop offset="100%" stop-color="#FF512F"/>
    </radialGradient>
    <radialGradient id="qCyanGlow" cx="35%" cy="35%" r="65%">
      <stop offset="0%" stop-color="#38BDF8"/>
      <stop offset="100%" stop-color="#0284C7"/>
    </radialGradient>
    <radialGradient id="qGoldGlow" cx="35%" cy="35%" r="65%">
      <stop offset="0%" stop-color="#FDE047"/>
      <stop offset="100%" stop-color="#EAB308"/>
    </radialGradient>
    <marker id="mRed" markerWidth="9" markerHeight="9" refX="7" refY="4.5" orient="auto">
      <path d="M0,0 L9,4.5 L0,9 Z" fill="#FF512F"/>
    </marker>
    <marker id="mCyan" markerWidth="9" markerHeight="9" refX="7" refY="4.5" orient="auto">
      <path d="M0,0 L9,4.5 L0,9 Z" fill="#00E5FF"/>
    </marker>
    <marker id="mGreen" markerWidth="9" markerHeight="9" refX="7" refY="4.5" orient="auto">
      <path d="M0,0 L9,4.5 L0,9 Z" fill="#76FF03"/>
    </marker>
    <marker id="mYellow" markerWidth="9" markerHeight="9" refX="7" refY="4.5" orient="auto">
  ...
  <g transform="translate(15, 15)">
    ...
    <!-- Charge q1 at top -->
    <circle cx="170" cy="140" r="22" fill="url(#qRedGlow)" stroke="#FFFFFF" stroke-width="1.5"/>
    <text x="170" y="146" text-anchor="middle" fill="#FFFFFF" font-family="sans-serif" font-size="15" font-weight="bold">q₁</text>

    <!-- Charge q2 at bottom right -->
    <circle cx="340" cy="270" r="22" fill="url(#qCyanGlow)" stroke="#FFFFFF" stroke-width="1.5"/>
    <text x="340" y="276" text-anchor="middle" fill="#FFFFFF" font-family="sans-serif" font-size="15" font-weight="bold">q₂</text>

    <!-- Position Vector r1 -->
    <line x1="65" y1="400" x2="155" y2="158" stroke="#94A3B8" stroke-width="2.5" marker-end="url(#mYellow)"/>
    <text x="90" y="270" fill="#FFD700" font-family="sans-serif" font-size="16" font-weight="bold">r⃗₁</text>

    <!-- Position Vector r2 -->
    <line x1="65" y1="400" x2="322" y2="282" stroke="#94A3B8" stroke-width="2.5" marker-end="url(#mYellow)"/>
    <text x="200" y="365" fill="#FFD700" font-family="sans-serif" font-size="16" font-weight="bold">r⃗₂</text>

    <!-- Displacement Vector r21 = r2 - r1 -->
    <line x1="170" y1="140" x2="322" y2="256" stroke="#00E5FF" stroke-width="3" marker-end="url(#mCyan)"/>
    <text x="270" y="195" fill="#00E5FF" font-family="sans-serif" font-size="15.5" font-weight="bold">r⃗₂₁ = r⃗₂ - r⃗₁</text>

    <!-- Force Arrows F12 and F21 -->
    <line x1="170" y1="140" x2="90" y2="80" stroke="#FF512F" stroke-width="3" marker-end="url(#mRed)"/>
    <text x="140" y="75" fill="#FF512F" font-family="sans-serif" font-size="15" font-weight="bold">F⃗₁₂ = -F⃗₂₁</text>

    <line x1="340" y1="270" x2="415" y2="330" stroke="#FF512F" stroke-width="3" marker-end="url(#mRed)"/>
    <text x="365" y="355" fill="#FF512F" font-family="sans-serif" font-size="15" font-weight="bold">F⃗₂₁</text>
  ...
  <g transform="translate(470, 15)">
    ...
    <circle cx="180" cy="250" r="22" fill="url(#qGoldGlow)" stroke="#FFFFFF" stroke-width="1.8"/>
    <text x="180" y="256" text-anchor="middle" fill="#0B0F19" font-family="sans-serif" font-size="15" font-weight="bold">+q₀</text>

    <!-- Source charges q1, q2, q3 -->
    <circle cx="150" cy="90" r="18" fill="url(#qRedGlow)"/>
    <text x="150" y="95" text-anchor="middle" fill="#FFFFFF" font-family="sans-serif" font-size="14" font-weight="bold">q₁</text>

    <circle cx="65" cy="380" r="18" fill="url(#qCyanGlow)"/>
    <text x="65" y="385" text-anchor="middle" fill="#FFFFFF" font-family="sans-serif" font-size="14" font-weight="bold">q₂</text>

    <circle cx="340" cy="380" r="18" fill="url(#qCyanGlow)"/>
    <text x="340" y="385" text-anchor="middle" fill="#FFFFFF" font-family="sans-serif" font-size="14" font-weight="bold">q₃</text>

    <!-- Force Vectors F1, F2, F3 acting on q0 -->
    <line x1="180" y1="250" x2="200" y2="350" stroke="#76FF03" stroke-width="2.5" marker-end="url(#mGreen)"/>
    <text x="160" y="335" fill="#76FF03" font-family="sans-serif" font-size="15" font-weight="bold">F⃗₁</text>

    <line x1="180" y1="250" x2="270" y2="150" stroke="#76FF03" stroke-width="2.5" marker-end="url(#mGreen)"/>
    <text x="220" y="180" fill="#76FF03" font-family="sans-serif" font-size="15" font-weight="bold">F⃗₂</text>

    <line x1="180" y1="250" x2="90" y2="160" stroke="#76FF03" stroke-width="2.5" marker-end="url(#mGreen)"/>
    <text x="110" y="200" fill="#76FF03" font-family="sans-serif" font-size="15" font-weight="bold">F⃗₃</text>
    ...
    <line x1="180" y1="250" x2="350" y2="150" stroke="#FF512F" stroke-width="3.5" marker-end="url(#mRed)"/>
    <text x="315" y="125" fill="#FF512F" font-family="sans-serif" font-size="16.5" font-weight="bold">F⃗_net = ∑ F⃗ᵢ</text>
...
// =============================================================================
// DIAGRAM 2: ELECTRIC FIELD PATTERNS & FIELD LINES (EXACT MATCH TO REFERENCE)
// =============================================================================
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 920 520" width="100%" height="100%" style="background: linear-gradient(135deg, #0B0F19 0%, #111827 50%, #070A10 100%);">
  <defs>
    ...
    <marker id="mGreen2" markerWidth="8" markerHeight="8" refX="6" refY="4" orient="auto">
  ...
  <g transform="translate(15, 15)">
    ...
    <g transform="translate(230, 55)">
      ...
      <line x1="30" y1="130" x2="84" y2="184" stroke="#00E5FF" stroke-width="2" marker-end="url(#mCyan2)"/>
      <line x1="170" y1="270" x2="116" y2="216" stroke="#00E5FF" stroke-width="2" marker-end="url(#mCyan2)"/>
      <line x1="170" y1="130" x2="116" y2="184" stroke="#00E5FF" stroke-width="2" marker-end="url(#mCyan2)"/>
      <line x1="30" y1="270" x2="84" y2="216" stroke="#00E5FF" stroke-width="2" marker-end="url(#mCyan2)"/>
...
// =============================================================================
// DIAGRAM 3: ELECTRIC DIPOLE (AXIAL & EQUATORIAL) (EXACT MATCH TO REFERENCE)
// =============================================================================
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 920 520" width="100%" height="100%" style="background: linear-gradient(135deg, #0B0F19 0%, #111827 50%, #070A10 100%);">
  ...
  <g transform="translate(15, 15)">
    ...
    <text x="140" y="165" text-anchor="middle" fill="#FFD700" font-family="sans-serif" font-size="16" font-weight="bold">p⃗</text>
    ...
    <text x="360" y="180" text-anchor="middle" fill="#76FF03" font-family="sans-serif" font-size="16" font-weight="bold">E⃗_axial ∥ p⃗</text>
  ...
  <g transform="translate(470, 15)">
    ...
    <text x="150" y="320" text-anchor="middle" fill="#FFD700" font-family="sans-serif" font-size="14.5" font-weight="bold">p⃗</text>
    ...
    <g transform="translate(180, 200)">
      ...
      <line x1="0" y1="0" x2="80" y2="-80" stroke="#38BDF8" stroke-width="2.5" marker-end="url(#mCyan3)"/>
      <text x="50" y="-90" fill="#38BDF8" font-family="sans-serif" font-size="15" font-weight="bold">E⃗_equal</text>
    ...
    <text x="320" y="406" text-anchor="middle" fill="#00E5FF" font-family="sans-serif" font-size="15.5" font-weight="bold">E⃗_equatorial ∥ -p⃗</text>
...
// =============================================================================
// DIAGRAM 4: TORQUE & ELECTRIC FLUX (EXACT MATCH TO REFERENCE)
// =============================================================================
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 920 520" width="100%" height="100%" style="background: linear-gradient(135deg, #0B0F19 0%, #111827 50%, #070A10 100%);">
  ...
  <g transform="translate(15, 15)">
    ...
    <text x="385" y="85" fill="#00E5FF" font-family="sans-serif" font-size="18" font-weight="bold">E⃗</text>
    ...
    <text x="330" y="145" fill="#76FF03" font-family="sans-serif" font-size="16" font-weight="bold">+qE⃗</text>

    <!-- Force -qE -->
    <line x1="120" y1="320" x2="35" y2="320" stroke="#76FF03" stroke-width="3" marker-end="url(#mGreen4)"/>
    <text x="45" y="345" fill="#76FF03" font-family="sans-serif" font-size="16" font-weight="bold">-qE⃗</text>
    ...
    <!-- Torque equation -->
    <text x="217" y="420" text-anchor="middle" fill="#FF512F" font-family="monospace" font-size="16.5" font-weight="bold">τ⃗ = p⃗ × E⃗ &nbsp;|&nbsp; τ = p E sin θ</text>
  ...
  <g transform="translate(470, 15)">
    <rect x="0" y="0" width="435" height="490" rx="14" fill="rgba(15,23,42,0.92)" stroke="#FF512F" stroke-width="1.8"/>
    <text x="217" y="34" text-anchor="middle" fill="#FF512F" font-family="sans-serif" font-size="16.5" font-weight="bold">ELECTRIC FLUX (Φ_E)</text>
    ...
    <text x="390" y="115" fill="#00E5FF" font-family="sans-serif" font-size="17" font-weight="bold">E⃗</text>
    ...
    <text x="315" y="180" fill="#76FF03" font-family="sans-serif" font-size="17" font-weight="bold">dA⃗</text>

    <path d="M 270 215 A 25 25 0 0 0 280 230" fill="none" stroke="#FFD700" stroke-width="2"/>
    <text x="290" y="235" fill="#FFD700" font-family="sans-serif" font-size="16" font-weight="bold">θ</text>

    <!-- Formula Box -->
    <rect x="50" y="380" width="335" height="50" rx="8" fill="rgba(255,215,0,0.12)" stroke="#FFD700" stroke-width="1.5"/>
    <text x="217" y="412" text-anchor="middle" fill="#FFD700" font-family="sans-serif" font-size="17" font-weight="bold">Formula: Φ_E = ∮ E⃗ · dA⃗</text>
...
// =============================================================================
// DIAGRAM 5: GAUSS'S THEOREM APPLICATIONS (EXACT MATCH TO REFERENCE)
// =============================================================================
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 920 520" width="100%" height="100%" style="background: linear-gradient(135deg, #0B0F19 0%, #111827 50%, #070A10 100%);">
  ...
  <g transform="translate(15, 15)">
    ...
    <text x="210" y="70" text-anchor="middle" fill="#76FF03" font-family="sans-serif" font-size="16" font-weight="bold">E⃗ ∥ dA⃗</text>

    <text x="217" y="375" text-anchor="middle" fill="#00E5FF" font-family="sans-serif" font-size="14.5" font-weight="bold">E⃗ ∥ dA⃗ only on curved surface</text>
    <text x="217" y="410" text-anchor="middle" fill="#76FF03" font-family="monospace" font-size="17" font-weight="bold">E = λ / (2πε₀ r)</text>
  ...
  <g transform="translate(470, 15)">
    ...
    <text x="217" y="375" text-anchor="middle" fill="#00E5FF" font-family="monospace" font-size="16" font-weight="bold">E_out = [ 1 / (4πε₀) ] (Q / r²)</text>
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.75; font-size: 16px;">
  ...
  <p>Here, <b>ε₀ = 8.854 × 10<sup>-12</sup> C² N⁻¹ m⁻²</b> is the <b>Absolute Permittivity of Free Space</b> (pronounced <i>Epsilon-Nought</i>). In a dielectric medium with dielectric constant K, the force reduces to F_med = F_vac / K.</p>
  ...
  ${svg3DCardWrapper("1. COULOMB'S LAW & SUPERPOSITION PRINCIPLE", "Fig 1.1: Coulomb's Law in Vector Form (F₁₂ = -F₂₁) & Fig 1.2: Superposition Principle (F_net = ∑ Fᵢ).", svg1_coulomb_superposition)}
  ...
  <p><i>Note on Symbol ∥:</i> The symbol <b>∥</b> means <b>Parallel to</b>. Thus, <b>E⃗_axial ∥ p⃗</b> means the axial field vector is parallel to the dipole moment vector, while <b>E⃗_equatorial ∥ -p⃗</b> means the equatorial field vector is anti-parallel (opposite in direction) to the dipole moment vector.</p>

  ${svg3DCardWrapper("3. ELECTRIC DIPOLE (AXIAL & EQUATORIAL)", "Fig 3.1: Field at Axial Point P (E_axial ∥ p⃗) & Fig 3.2: Field at Equatorial Point Q (E_eq ∥ -p⃗). Ratio E_axial / E_eq = 2 : 1.", svg3_dipole_axial_equatorial)}
  ...
  ${defBox("Torque on Electric Dipole (τ⃗)", "When an electric dipole of moment p⃗ is placed in a uniform electric field E⃗ at angle θ, equal and opposite forces F⃗ = ±q E⃗ act on charges forming a couple that exerts a restoring torque: τ⃗ = p⃗ × E⃗, with magnitude τ = p E sin θ [N m].")}
  ...
  ${svg3DCardWrapper("4. TORQUE & ELECTRIC FLUX", "Fig 4.1: Torque on a Dipole in Uniform Field (τ⃗ = p⃗ × E⃗) & Fig 4.2: Electric Flux (Φ_E = ∮ E⃗ · dA⃗).", svg4_torque_flux)}
  ...
  <ul style="margin-left: 20px; line-height: 1.8;">
    <li><b>(i) Infinitely Long Straight Wire:</b> E = λ / (2π ε₀ r), where λ is linear charge density.</li>
    <li><b>(ii) Uniformly Charged Thin Spherical Shell:</b> Outside (r ≥ R): E_out = Q / (4π ε₀ r²); Inside (r < R): E_in = 0 (Electrostatic Shielding).</li>
  </ul>

  ${svg3DCardWrapper("5. GAUSS'S THEOREM APPLICATIONS", "Fig 5.1: Long Wire E = λ/(2πε₀ r) & Fig 5.2: Spherical Shell E_out = Q/(4πε₀ r²), E_in = 0.", svg5_gauss_wire_shell)}
...
// High-Level Pradeep's / S.L. Arora Digital Reference Book Content & NCERT Solutions (5 Exact Large Vibrant Topic-Wise SVGs matching Reference Sheet)
...
console.log("Successfully rebuilt c12-phy-1.ts with the exact 5 large, colorful diagrams!");
