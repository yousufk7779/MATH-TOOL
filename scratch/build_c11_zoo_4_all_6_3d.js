...
const imgFiles = {
  ...
  skeleton_and_joints: 'c11_zoo4_3d_skeleton_and_joints',
  neuron_and_reflex: 'c11_zoo4_3d_neuron_and_reflex',
...
for (const [key, baseName] of Object.entries(imgFiles)) {
  ...
  if (p) {
    ...
    console.log(`Loaded 3D medical illustration for ${key}: ${buf.length} bytes`);
  } else {
    console.error(`ERROR: Missing file for ${key}`);
  }
}
...
console.log("Generating c11-zoo-4.ts with ALL 6 high-definition 3D medical illustrations and NO captions...");
...
// High-Level Full Reference Book Content with ALL 6 3D Medical Biology Illustrations (No Captions Below Images)
...
console.log("Successfully generated c11-zoo-4.ts with ALL 6 3D Medical Illustrations and NO captions under images!");
