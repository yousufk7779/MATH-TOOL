const fs = require("fs");
const imagePath =
  "C:/Users/hp/.gemini/antigravity/brain/51c3a93b-e2d0-423c-86d0-6f44d0e4c30a/media__1777199806160.png";
...
const targetRegex =
  /src=\\"https:\/\/cdn\.teachoo\.com\/66b9767f-8647-4ca4-b378-d42f0b15e196\/name-a,b,c,d,e-and-f-in-the-following-diagram-showing-change-in-its-state-teachoo\.jpg\\"/;
const targetRegexB64 =
  /src=\\".*d a t a : i m a g e \/ p n g ; b a s e 6 4 ,.*\\"/; // Fallback if it already has weird data
...
if (targetRegex.test(content)) {
  ...
  if (content.includes(brokenStart)) {
    ...
    if (startIdx !== -1) {
      ...
      const newContent =
        content.substring(0, srcStartIdx) + b64 + content.substring(srcEndIdx);
