...
try {
  const imgPath =
    "C:\\Users\\hp\\.gemini\\antigravity\\brain\\66ae3c29-3950-406e-bfcb-f1822305deb2\\media__1777318995626.png";
  ...
  const imgTag =
    "<div style='text-align: center; width: 100%; overflow: hidden;'><img src='data:image/png;base64," +
    newB64 +
    "' width='100%' style='width: 100%; height: auto;' /></div>";

  // Replace the table with the image in the question field
  const newContent =
    content.substring(0, startIdx) +
    imgTag +
    content.substring(endIdx + tableEnd.length);
