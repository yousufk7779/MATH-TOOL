...
const imgFiles = {
  ...
  skeleton_and_joints: 'c11_zoo4_3d_skeleton_joints',
  neuron_and_reflex: 'c11_zoo4_3d_neuron_reflex',
  endocrine_system: 'c11_zoo4_3d_endocrine_system'
};
...
function findImageFile(baseName) {
  ...
  for (const ext of exts) {
    const fullPath = path.join(brainDir, baseName + ext);
    if (fs.existsSync(fullPath)) return fullPath;
  }
  // Try searching directory for matching prefix
...
for (const [key, baseName] of Object.entries(imgFiles)) {
  ...
  if (p) {
    ...
    console.log(`Loaded freshly AI-generated 3D image ${key}: ${buf.length} bytes`);
  } else {
    console.error(`Missing image file for ${key} (${baseName})`);
    allFound = false;
  }
}

if (!allFound) {
  console.log("Not all fresh AI 3D images are generated yet.");
} else {
  console.log("All 6 fresh AI 3D images loaded successfully! Assembling c11-zoo-4.ts...");
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.7; font-size: 16px;">
  ...
  ${renderHDCard(b64Data.respiratory_system, "Figure 4.1: 3D High-Definition Medical Biology Illustration of Human Respiratory System, Alveolar Gas Exchange &amp; Breathing Mechanism")}
  ...
  ${renderHDCard(b64Data.heart_and_ecg, "Figure 4.2: 3D High-Definition Medical Biology Illustration of Structure of Human Heart (4 Chambers, Valves) &amp; Standard ECG Trace")}
  ...
  ${renderHDCard(b64Data.excretory_and_nephron, "Figure 4.3: 3D High-Definition Medical Biology Illustration of Human Excretory System &amp; Nephron Fine Architecture")}
  ...
  ${renderHDCard(b64Data.skeleton_and_joints, "Figure 4.4: 3D High-Definition Medical Biology Illustration of Human Skeleton &amp; Synovial Joints Classification")}
  ...
  ${renderHDCard(b64Data.neuron_and_reflex, "Figure 4.5: 3D High-Definition Medical Biology Illustration of Typical Neuron Structure, Synapse &amp; Reflex Arc")}
  ...
  ${renderHDCard(b64Data.endocrine_system, "Figure 4.6: 3D High-Definition Medical Biology Illustration of Human Endocrine Glands &amp; Mechanism of Hormone Action")}
...
`;
  ...
  console.log("Successfully generated c11-zoo-4.ts with freshly AI-generated 3D Medical Biology Diagrams!");
}
