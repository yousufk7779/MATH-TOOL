...
// Helper to convert raw SVG string to base64 data URI
function svgToBase64(svgStr) {
  const b64 = Buffer.from(svgStr).toString('base64');
  return `data:image/svg+xml;base64,${b64}`;
}

// 1. Respiratory System SVG
const respiratorySVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 850 550" width="100%" height="100%">
  <rect width="850" height="550" rx="16" fill="#090414" stroke="#00B0FF" stroke-width="2.5"/>
  <text x="425" y="38" font-family="system-ui, sans-serif" font-size="22" font-weight="bold" fill="#00B0FF" text-anchor="middle">HUMAN RESPIRATORY SYSTEM &amp; ALVEOLAR GAS EXCHANGE</text>

  <!-- LEFT: Respiratory System -->
  <g transform="translate(30, 60)">
    <rect width="380" height="460" rx="12" fill="#0D0722" stroke="#00B0FF" stroke-width="1.5"/>
    <text x="190" y="30" font-family="sans-serif" font-size="17" font-weight="bold" fill="#00B0FF" text-anchor="middle">Respiratory Tract Architecture</text>
    
    <!-- Nasal & Pharynx -->
    <path d="M 120 70 Q 140 70 150 90 L 150 140" fill="none" stroke="#E0E0E0" stroke-width="4"/>
    <circle cx="120" cy="70" r="10" fill="#42A5F5"/>
    <text x="50" y="75" font-family="sans-serif" font-size="13" font-weight="bold" fill="#E0E0E0">Nasal Cavity</text>
    <line x1="100" y1="72" x2="110" y2="72" stroke="#00B0FF" stroke-width="1.5"/>

    <text x="50" y="115" font-family="sans-serif" font-size="13" font-weight="bold" fill="#E0E0E0">Pharynx &amp; Larynx</text>
    <line x1="135" y1="112" x2="150" y2="112" stroke="#00B0FF" stroke-width="1.5"/>

    <!-- Trachea -->
    <path d="M 150 140 L 150 220" fill="none" stroke="#00E5FF" stroke-width="10" stroke-dasharray="4 4"/>
    <text x="40" y="180" font-family="sans-serif" font-size="13" font-weight="bold" fill="#00E5FF">Trachea (Windpipe)</text>
    <line x1="130" y1="178" x2="145" y2="178" stroke="#00E5FF" stroke-width="1.5"/>

    <!-- Lungs -->
    <path d="M 150 220 Q 90 240 80 340 Q 80 390 140 380 L 150 220 Z" fill="rgba(255, 64, 129, 0.4)" stroke="#FF4081" stroke-width="2"/>
    <path d="M 150 220 Q 210 240 220 340 Q 220 390 160 380 L 150 220 Z" fill="rgba(255, 64, 129, 0.4)" stroke="#FF4081" stroke-width="2"/>
    <text x="35" y="320" font-family="sans-serif" font-size="14" font-weight="bold" fill="#FF4081">Right Lung</text>
    <text x="230" y="320" font-family="sans-serif" font-size="14" font-weight="bold" fill="#FF4081">Left Lung</text>

    <!-- Bronchioles -->
    <path d="M 150 220 L 110 270 M 110 270 L 95 310 M 110 270 L 130 310" stroke="#FFF" stroke-width="2"/>
    <path d="M 150 220 L 190 270 M 190 270 L 170 310 M 190 270 L 205 310" stroke="#FFF" stroke-width="2"/>

    <!-- Diaphragm -->
    <path d="M 60 410 Q 150 370 240 410" fill="none" stroke="#FFD54F" stroke-width="6"/>
    <text x="150" y="435" font-family="sans-serif" font-size="14" font-weight="bold" fill="#FFD54F" text-anchor="middle">Diaphragm Muscle</text>
  </g>

  <!-- RIGHT: Alveoli & Gas Exchange -->
  <g transform="translate(440, 60)">
    <rect width="380" height="460" rx="12" fill="#0D0722" stroke="#00E5FF" stroke-width="1.5"/>
    <text x="190" y="30" font-family="sans-serif" font-size="17" font-weight="bold" fill="#00E5FF" text-anchor="middle">Alveolar Capillary Gas Exchange</text>

    <!-- Alveolus Circle -->
    <circle cx="190" cy="180" r="90" fill="rgba(0, 229, 255, 0.15)" stroke="#00E5FF" stroke-width="3"/>
    <text x="190" y="130" font-family="sans-serif" font-size="16" font-weight="bold" fill="#00E5FF" text-anchor="middle">Alveolus Cavity</text>
    
    <!-- Capillary Vessel -->
    <path d="M 60 180 C 100 280 280 280 320 180" fill="none" stroke="#FF1744" stroke-width="12"/>
    <text x="190" y="270" font-family="sans-serif" font-size="14" font-weight="bold" fill="#FF1744" text-anchor="middle">Pulmonary Capillary Blood</text>

    <!-- Gas Exchange Arrows -->
    <path d="M 160 180 L 160 220" stroke="#66BB6A" stroke-width="4" marker-end="url(#arrow)"/>
    <text x="140" y="200" font-family="sans-serif" font-size="14" font-weight="bold" fill="#66BB6A">O₂</text>

    <path d="M 220 220 L 220 180" stroke="#FF5252" stroke-width="4" marker-end="url(#arrow)"/>
    <text x="235" y="200" font-family="sans-serif" font-size="14" font-weight="bold" fill="#FF5252">CO₂</text>

    <!-- Breathing Mechanism Box -->
    <rect x="25" y="310" width="330" height="130" rx="8" fill="#06020C" stroke="#FFD54F" stroke-width="1.2"/>
    <text x="190" y="335" font-family="sans-serif" font-size="15" font-weight="bold" fill="#FFD54F" text-anchor="middle">Breathing Mechanism Flowchart</text>
    <text x="40" y="370" font-family="sans-serif" font-size="13" font-weight="bold" fill="#E0E0E0">Inspiration: Diaphragm contracts &rarr; Thorax expands</text>
    <text x="40" y="400" font-family="sans-serif" font-size="13" font-weight="bold" fill="#E0E0E0">Expiration: Diaphragm relaxes &rarr; Thorax contracts</text>
    <text x="40" y="425" font-family="sans-serif" font-size="12" fill="#B0BEC5">Intra-pulmonary pressure gradient controls air flow</text>
  </g>
</svg>`;

// 2. Heart & ECG SVG
const heartECGSVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 850 550" width="100%" height="100%">
  <rect width="850" height="550" rx="16" fill="#090414" stroke="#00B0FF" stroke-width="2.5"/>
  <text x="425" y="38" font-family="system-ui, sans-serif" font-size="22" font-weight="bold" fill="#00B0FF" text-anchor="middle">STRUCTURE OF HUMAN HEART &amp; STANDARD ECG TRACE</text>

  <!-- LEFT: Heart Anatomy -->
  <g transform="translate(30, 60)">
    <rect width="380" height="460" rx="12" fill="#0D0722" stroke="#FF1744" stroke-width="1.5"/>
    <text x="190" y="30" font-family="sans-serif" font-size="17" font-weight="bold" fill="#FF1744" text-anchor="middle">4-Chambered Heart Anatomy</text>

    <!-- Heart Outline -->
    <path d="M 120 120 C 80 180 80 320 190 410 C 300 320 300 180 260 120 Z" fill="rgba(255, 23, 68, 0.25)" stroke="#FF1744" stroke-width="3"/>
    
    <!-- Septum -->
    <line x1="190" y1="120" x2="190" y2="400" stroke="#FFF" stroke-width="4"/>
    <line x1="90" y1="230" x2="290" y2="230" stroke="#FFF" stroke-width="4"/>

    <!-- Chambers Labels -->
    <rect x="105" y="150" width="70" height="50" rx="6" fill="#1565C0"/>
    <text x="140" y="180" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Right Atrium</text>

    <rect x="205" y="150" width="70" height="50" rx="6" fill="#C62828"/>
    <text x="240" y="180" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Left Atrium</text>

    <rect x="105" y="270" width="70" height="60" rx="6" fill="#1565C0"/>
    <text x="140" y="305" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Right Ventricle</text>

    <rect x="205" y="270" width="70" height="60" rx="6" fill="#C62828"/>
    <text x="240" y="305" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Left Ventricle</text>

    <!-- Major Vessels -->
    <text x="190" y="80" font-family="sans-serif" font-size="14" font-weight="bold" fill="#FF5252" text-anchor="middle">Aorta &amp; Pulmonary Artery</text>
    <text x="190" y="440" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFD54F" text-anchor="middle">SA Node (Pacemaker) &amp; AV Valves</text>
  </g>

  <!-- RIGHT: ECG Trace -->
  <g transform="translate(440, 60)">
    <rect width="380" height="460" rx="12" fill="#0D0722" stroke="#00E5FF" stroke-width="1.5"/>
    <text x="190" y="30" font-family="sans-serif" font-size="17" font-weight="bold" fill="#00E5FF" text-anchor="middle">Standard ECG Graph Trace</text>

    <!-- ECG Wave Path -->
    <path d="M 40 220 L 90 220 Q 110 180 125 220 L 140 240 L 155 90 L 175 270 L 190 220 L 230 220 Q 255 160 280 220 L 340 220" fill="none" stroke="#00E5FF" stroke-width="4"/>

    <!-- Wave Labels -->
    <circle cx="110" cy="195" r="14" fill="#FFD54F"/>
    <text x="110" y="200" font-family="sans-serif" font-size="12" font-weight="bold" fill="#000" text-anchor="middle">P</text>
    <text x="110" y="165" font-family="sans-serif" font-size="12" font-weight="bold" fill="#FFD54F" text-anchor="middle">Atrial Depol.</text>

    <circle cx="155" cy="80" r="16" fill="#FF1744"/>
    <text x="155" y="85" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">QRS</text>
    <text x="155" y="55" font-family="sans-serif" font-size="12" font-weight="bold" fill="#FF1744" text-anchor="middle">Ventricular Depol.</text>

    <circle cx="260" cy="180" r="14" fill="#66BB6A"/>
    <text x="260" y="185" font-family="sans-serif" font-size="12" font-weight="bold" fill="#000" text-anchor="middle">T</text>
    <text x="260" y="150" font-family="sans-serif" font-size="12" font-weight="bold" fill="#66BB6A" text-anchor="middle">Ventricular Repol.</text>

    <!-- ECG Summary Box -->
    <rect x="25" y="310" width="330" height="130" rx="8" fill="#06020C" stroke="#00B0FF" stroke-width="1.2"/>
    <text x="190" y="335" font-family="sans-serif" font-size="15" font-weight="bold" fill="#00B0FF" text-anchor="middle">ECG Clinical Parameters</text>
    <text x="40" y="365" font-family="sans-serif" font-size="13" fill="#E0E0E0">• P-Wave: Atrial contraction / depolarization</text>
    <text x="40" y="390" font-family="sans-serif" font-size="13" fill="#E0E0E0">• QRS Complex: Ventricular contraction</text>
    <text x="40" y="415" font-family="sans-serif" font-size="13" fill="#E0E0E0">• T-Wave: Ventricular recovery / relaxation</text>
  </g>
</svg>`;

// 3. Excretory & Nephron SVG
const excretoryNephronSVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 850 550" width="100%" height="100%">
  <rect width="850" height="550" rx="16" fill="#090414" stroke="#00B0FF" stroke-width="2.5"/>
  <text x="425" y="38" font-family="system-ui, sans-serif" font-size="22" font-weight="bold" fill="#00B0FF" text-anchor="middle">HUMAN EXCRETORY SYSTEM &amp; NEPHRON FINE STRUCTURE</text>

  <!-- LEFT: Excretory System -->
  <g transform="translate(30, 60)">
    <rect width="380" height="460" rx="12" fill="#0D0722" stroke="#FF9800" stroke-width="1.5"/>
    <text x="190" y="30" font-family="sans-serif" font-size="17" font-weight="bold" fill="#FF9800" text-anchor="middle">Human Excretory Organs</text>

    <!-- Kidneys -->
    <path d="M 100 120 C 70 160 70 220 100 250 C 130 220 120 160 100 120 Z" fill="#C62828" stroke="#FF5252" stroke-width="2"/>
    <text x="50" y="180" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FF5252">Right Kidney</text>

    <path d="M 280 120 C 250 160 260 220 280 250 C 310 220 310 160 280 120 Z" fill="#C62828" stroke="#FF5252" stroke-width="2"/>
    <text x="300" y="180" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FF5252">Left Kidney</text>

    <!-- Ureters -->
    <path d="M 110 220 Q 140 310 165 350" stroke="#FFD54F" stroke-width="4" fill="none"/>
    <path d="M 270 220 Q 240 310 215 350" stroke="#FFD54F" stroke-width="4" fill="none"/>
    <text x="190" y="290" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFD54F" text-anchor="middle">Ureters</text>

    <!-- Bladder & Urethra -->
    <circle cx="190" cy="380" r="30" fill="rgba(255, 213, 79, 0.3)" stroke="#FFD54F" stroke-width="2"/>
    <text x="190" y="385" font-family="sans-serif" font-size="12" font-weight="bold" fill="#FFF" text-anchor="middle">Bladder</text>

    <line x1="190" y1="410" x2="190" y2="440" stroke="#FFF" stroke-width="5"/>
    <text x="190" y="455" font-family="sans-serif" font-size="12" font-weight="bold" fill="#FFF" text-anchor="middle">Urethra</text>
  </g>

  <!-- RIGHT: Nephron Structure -->
  <g transform="translate(440, 60)">
    <rect width="380" height="460" rx="12" fill="#0D0722" stroke="#00B0FF" stroke-width="1.5"/>
    <text x="190" y="30" font-family="sans-serif" font-size="17" font-weight="bold" fill="#00B0FF" text-anchor="middle">Nephron Fine Architecture</text>

    <!-- Glomerulus & Bowman's Capsule -->
    <path d="M 70 100 C 40 100 40 160 100 160 C 130 160 130 100 70 100" fill="none" stroke="#FF1744" stroke-width="4"/>
    <circle cx="70" cy="130" r="20" fill="#FF1744"/>
    <text x="60" y="80" font-family="sans-serif" font-size="12" font-weight="bold" fill="#FF1744">Glomerulus &amp; Bowman's</text>

    <!-- PCT & Loop of Henle -->
    <path d="M 100 140 Q 140 120 170 160 L 170 320 Q 190 380 210 320 L 210 160 Q 250 120 280 160 L 280 410" fill="none" stroke="#00E5FF" stroke-width="5"/>

    <!-- Region Labels -->
    <text x="140" y="110" font-family="sans-serif" font-size="12" font-weight="bold" fill="#00E5FF">PCT</text>
    <text x="190" y="395" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFD54F" text-anchor="middle">Loop of Henle</text>
    <text x="250" y="110" font-family="sans-serif" font-size="12" font-weight="bold" fill="#00E5FF">DCT</text>
    <text x="310" y="300" font-family="sans-serif" font-size="13" font-weight="bold" fill="#66BB6A">Collecting Duct</text>

    <!-- Counter Current Box -->
    <rect x="25" y="415" width="330" height="35" rx="6" fill="#06020C" stroke="#00B0FF" stroke-width="1"/>
    <text x="190" y="437" font-family="sans-serif" font-size="12" font-weight="bold" fill="#00B0FF" text-anchor="middle">Osmolar Gradient: 300 mOsmol/L (Cortex) &rarr; 1200 (Medulla)</text>
  </g>
</svg>`;

// 4. Skeleton & Joints SVG
const skeletonJointsSVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 850 550" width="100%" height="100%">
  <rect width="850" height="550" rx="16" fill="#090414" stroke="#00B0FF" stroke-width="2.5"/>
  <text x="425" y="38" font-family="system-ui, sans-serif" font-size="22" font-weight="bold" fill="#00B0FF" text-anchor="middle">HUMAN SKELETON OVERVIEW &amp; SYNOVIAL JOINTS</text>

  <!-- LEFT: Skeleton -->
  <g transform="translate(30, 60)">
    <rect width="380" height="460" rx="12" fill="#0D0722" stroke="#FFF" stroke-width="1.5"/>
    <text x="190" y="30" font-family="sans-serif" font-size="17" font-weight="bold" fill="#FFF" text-anchor="middle">Human Skeleton (206 Bones)</text>

    <!-- Skull -->
    <circle cx="190" cy="80" r="25" fill="#FFF" stroke="#B0BEC5" stroke-width="2"/>
    <text x="230" y="85" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF">Skull (Axial)</text>

    <!-- Spine & Ribcage -->
    <line x1="190" y1="105" x2="190" y2="280" stroke="#FFF" stroke-width="6"/>
    <ellipse cx="190" cy="160" rx="45" ry="35" fill="none" stroke="#FFF" stroke-width="2"/>
    <text x="250" y="165" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF">Ribcage &amp; Sternum</text>

    <!-- Pelvis & Limbs -->
    <path d="M 150 280 L 230 280 L 190 320 Z" fill="#FFF"/>
    <line x1="165" y1="320" x2="155" y2="440" stroke="#FFF" stroke-width="5"/>
    <line x1="215" y1="320" x2="225" y2="440" stroke="#FFF" stroke-width="5"/>
    <text x="190" y="455" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Limbs (Appendicular)</text>
  </g>

  <!-- RIGHT: Joints Classification -->
  <g transform="translate(440, 60)">
    <rect width="380" height="460" rx="12" fill="#0D0722" stroke="#FFD54F" stroke-width="1.5"/>
    <text x="190" y="30" font-family="sans-serif" font-size="17" font-weight="bold" fill="#FFD54F" text-anchor="middle">Types of Synovial Joints</text>

    <g transform="translate(20, 50)">
      <rect x="0" y="0" width="160" height="85" rx="6" fill="#1565C0"/>
      <text x="80" y="30" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Ball &amp; Socket</text>
      <text x="80" y="60" font-family="sans-serif" font-size="11" fill="#E0E0E0" text-anchor="middle">Shoulder &amp; Hip</text>

      <rect x="180" y="0" width="160" height="85" rx="6" fill="#2E7D32"/>
      <text x="260" y="30" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Hinge Joint</text>
      <text x="260" y="60" font-family="sans-serif" font-size="11" fill="#E0E0E0" text-anchor="middle">Knee &amp; Elbow</text>

      <rect x="0" y="105" width="160" height="85" rx="6" fill="#C62828"/>
      <text x="80" y="135" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Pivot Joint</text>
      <text x="80" y="165" font-family="sans-serif" font-size="11" fill="#E0E0E0" text-anchor="middle">Atlas &amp; Axis (C1-C2)</text>

      <rect x="180" y="105" width="160" height="85" rx="6" fill="#6A1B9A"/>
      <text x="260" y="135" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Saddle Joint</text>
      <text x="260" y="165" font-family="sans-serif" font-size="11" fill="#E0E0E0" text-anchor="middle">Thumb Carpals</text>
    </g>

    <!-- Muscle Types -->
    <rect x="25" y="270" width="330" height="165" rx="8" fill="#06020C" stroke="#00B0FF" stroke-width="1.2"/>
    <text x="190" y="295" font-family="sans-serif" font-size="15" font-weight="bold" fill="#00B0FF" text-anchor="middle">Muscle Tissue Types</text>
    <text x="40" y="325" font-family="sans-serif" font-size="13" fill="#E0E0E0">1. Skeletal Muscle: Striated, Voluntary</text>
    <text x="40" y="355" font-family="sans-serif" font-size="13" fill="#E0E0E0">2. Cardiac Muscle: Striated, Involuntary (Heart)</text>
    <text x="40" y="385" font-family="sans-serif" font-size="13" fill="#E0E0E0">3. Smooth Muscle: Non-striated, Involuntary (Viscera)</text>
    <text x="40" y="415" font-family="sans-serif" font-size="12" fill="#FFD54F">Sliding Filament: Ca²⁺ binds Troponin C &rarr; Actin slides</text>
  </g>
</svg>`;

// 5. Neuron & Reflex Arc SVG
const neuronReflexSVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 850 550" width="100%" height="100%">
  <rect width="850" height="550" rx="16" fill="#090414" stroke="#00B0FF" stroke-width="2.5"/>
  <text x="425" y="38" font-family="system-ui, sans-serif" font-size="22" font-weight="bold" fill="#00B0FF" text-anchor="middle">STRUCTURE OF NEURON, SYNAPSE &amp; REFLEX ARC</text>

  <!-- LEFT: Typical Neuron -->
  <g transform="translate(30, 60)">
    <rect width="380" height="460" rx="12" fill="#0D0722" stroke="#FFD54F" stroke-width="1.5"/>
    <text x="190" y="30" font-family="sans-serif" font-size="17" font-weight="bold" fill="#FFD54F" text-anchor="middle">Typical Neuron Structure</text>

    <!-- Soma & Dendrites -->
    <circle cx="90" cy="150" r="35" fill="#FFD54F"/>
    <text x="90" y="155" font-family="sans-serif" font-size="12" font-weight="bold" fill="#000" text-anchor="middle">Soma</text>
    <path d="M 60 130 L 30 110 M 60 170 L 30 190 M 90 115 L 90 85 M 120 130 L 150 110" stroke="#FFD54F" stroke-width="3"/>
    <text x="40" y="75" font-family="sans-serif" font-size="12" font-weight="bold" fill="#FFD54F">Dendrites</text>

    <!-- Axon & Myelin -->
    <line x1="125" y1="150" x2="340" y2="150" stroke="#FFF" stroke-width="8"/>
    <rect x="150" y="140" width="40" height="20" rx="4" fill="#00E5FF"/>
    <rect x="210" y="140" width="40" height="20" rx="4" fill="#00E5FF"/>
    <rect x="270" y="140" width="40" height="20" rx="4" fill="#00E5FF"/>
    <text x="230" y="125" font-family="sans-serif" font-size="12" font-weight="bold" fill="#00E5FF" text-anchor="middle">Myelin Sheath</text>
    <text x="200" y="180" font-family="sans-serif" font-size="11" fill="#FFF">Nodes of Ranvier</text>

    <!-- Synapse Box -->
    <rect x="25" y="230" width="330" height="200" rx="8" fill="#06020C" stroke="#00E5FF" stroke-width="1.2"/>
    <text x="190" y="255" font-family="sans-serif" font-size="15" font-weight="bold" fill="#00E5FF" text-anchor="middle">Chemical Synapse Kinetics</text>
    <text x="40" y="290" font-family="sans-serif" font-size="13" fill="#E0E0E0">• Pre-synaptic membrane releases Acetylcholine</text>
    <text x="40" y="320" font-family="sans-serif" font-size="13" fill="#E0E0E0">• Neurotransmitter crosses Synaptic Cleft</text>
    <text x="40" y="350" font-family="sans-serif" font-size="13" fill="#E0E0E0">• Binds Post-synaptic receptors &rarr; Na+ influx</text>
    <text x="40" y="380" font-family="sans-serif" font-size="13" fill="#E0E0E0">• Resting Potential: -70 mV | Action: +30 mV</text>
  </g>

  <!-- RIGHT: Reflex Arc -->
  <g transform="translate(440, 60)">
    <rect width="380" height="460" rx="12" fill="#0D0722" stroke="#66BB6A" stroke-width="1.5"/>
    <text x="190" y="30" font-family="sans-serif" font-size="17" font-weight="bold" fill="#66BB6A" text-anchor="middle">Reflex Arc Neural Pathway</text>

    <!-- Stimulus to Effector -->
    <rect x="40" y="80" width="100" height="50" rx="6" fill="#FF1744"/>
    <text x="90" y="110" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Stimulus / Receptor</text>

    <path d="M 140 105 L 240 105" stroke="#FFD54F" stroke-width="4" marker-end="url(#arrow)"/>
    <text x="190" y="95" font-family="sans-serif" font-size="11" font-weight="bold" fill="#FFD54F" text-anchor="middle">Afferent Neuron</text>

    <rect x="240" y="80" width="100" height="50" rx="6" fill="#9C27B0"/>
    <text x="290" y="110" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Spinal Cord CNS</text>

    <path d="M 290 130 L 290 220 L 140 220" stroke="#00E5FF" stroke-width="4" marker-end="url(#arrow)"/>
    <text x="215" y="210" font-family="sans-serif" font-size="11" font-weight="bold" fill="#00E5FF" text-anchor="middle">Efferent Motor Neuron</text>

    <rect x="40" y="195" width="100" height="50" rx="6" fill="#66BB6A"/>
    <text x="90" y="225" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Effector Muscle</text>

    <!-- Summary Box -->
    <rect x="25" y="290" width="330" height="140" rx="8" fill="#06020C" stroke="#66BB6A" stroke-width="1.2"/>
    <text x="190" y="315" font-family="sans-serif" font-size="15" font-weight="bold" fill="#66BB6A" text-anchor="middle">Autonomic &amp; Somatic PNS</text>
    <text x="40" y="345" font-family="sans-serif" font-size="13" fill="#E0E0E0">• CNS: Brain &amp; Spinal Cord (Integration)</text>
    <text x="40" y="375" font-family="sans-serif" font-size="13" fill="#E0E0E0">• Sympathetic: Fight-or-Flight (Emergency)</text>
    <text x="40" y="405" font-family="sans-serif" font-size="13" fill="#E0E0E0">• Parasympathetic: Rest-and-Digest</text>
  </g>
</svg>`;

// 6. Endocrine System SVG
const endocrineSVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 850 550" width="100%" height="100%">
  <rect width="850" height="550" rx="16" fill="#090414" stroke="#00B0FF" stroke-width="2.5"/>
  <text x="425" y="38" font-family="system-ui, sans-serif" font-size="22" font-weight="bold" fill="#00B0FF" text-anchor="middle">HUMAN ENDOCRINE GLANDS &amp; HORMONE ACTION</text>

  <!-- LEFT: Endocrine Glands -->
  <g transform="translate(30, 60)">
    <rect width="380" height="460" rx="12" fill="#0D0722" stroke="#AB47BC" stroke-width="1.5"/>
    <text x="190" y="30" font-family="sans-serif" font-size="17" font-weight="bold" fill="#AB47BC" text-anchor="middle">Major Human Endocrine Glands</text>

    <g transform="translate(40, 50)">
      <rect x="0" y="0" width="300" height="45" rx="6" fill="#1565C0"/>
      <text x="150" y="27" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Hypothalamus &amp; Pituitary (Master Gland)</text>

      <rect x="0" y="55" width="300" height="45" rx="6" fill="#2E7D32"/>
      <text x="150" y="82" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Thyroid &amp; Parathyroid (T3, T4, PTH)</text>

      <rect x="0" y="110" width="300" height="45" rx="6" fill="#C62828"/>
      <text x="150" y="137" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Adrenal Glands (Cortisol &amp; Adrenaline)</text>

      <rect x="0" y="165" width="300" height="45" rx="6" fill="#FF8F00"/>
      <text x="150" y="192" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Pancreas (Insulin &amp; Glucagon)</text>

      <rect x="0" y="220" width="300" height="45" rx="6" fill="#6A1B9A"/>
      <text x="150" y="247" font-family="sans-serif" font-size="13" font-weight="bold" fill="#FFF" text-anchor="middle">Gonads: Testis &amp; Ovary (Sex Steroids)</text>
    </g>

    <!-- Non-Endocrine Hormones -->
    <rect x="25" y="335" width="330" height="100" rx="6" fill="#06020C" stroke="#AB47BC" stroke-width="1"/>
    <text x="190" y="360" font-family="sans-serif" font-size="13" font-weight="bold" fill="#AB47BC" text-anchor="middle">Non-Endocrine Tissue Hormones</text>
    <text x="35" y="385" font-family="sans-serif" font-size="12" fill="#E0E0E0">• ANF (Heart) | Erythropoietin (Kidney)</text>
    <text x="35" y="410" font-family="sans-serif" font-size="12" fill="#E0E0E0">• Gastrin, Secretin, CCK, GIP (G.I. Tract)</text>
  </g>

  <!-- RIGHT: Mechanism of Action -->
  <g transform="translate(440, 60)">
    <rect width="380" height="460" rx="12" fill="#0D0722" stroke="#00B0FF" stroke-width="1.5"/>
    <text x="190" y="30" font-family="sans-serif" font-size="17" font-weight="bold" fill="#00B0FF" text-anchor="middle">Mechanism of Hormone Action</text>

    <!-- Protein Hormone Box -->
    <rect x="25" y="60" width="330" height="170" rx="8" fill="#06020C" stroke="#00E5FF" stroke-width="1.2"/>
    <text x="190" y="85" font-family="sans-serif" font-size="15" font-weight="bold" fill="#00E5FF" text-anchor="middle">1. Protein / Peptide Hormones</text>
    <text x="40" y="115" font-family="sans-serif" font-size="13" fill="#E0E0E0">• Water-soluble (e.g. Insulin, Pituitary H.)</text>
    <text x="40" y="145" font-family="sans-serif" font-size="13" fill="#E0E0E0">• Binds Cell-Membrane Receptors</text>
    <text x="40" y="175" font-family="sans-serif" font-size="13" fill="#E0E0E0">• Generates 2nd Messengers (cAMP, IP₃, Ca²⁺)</text>
    <text x="40" y="205" font-family="sans-serif" font-size="13" fill="#E0E0E0">• Triggers rapid intracellular cascade</text>

    <!-- Steroid Hormone Box -->
    <rect x="25" y="250" width="330" height="170" rx="8" fill="#06020C" stroke="#FFD54F" stroke-width="1.2"/>
    <text x="190" y="275" font-family="sans-serif" font-size="15" font-weight="bold" fill="#FFD54F" text-anchor="middle">2. Steroid / Lipid Hormones</text>
    <text x="40" y="305" font-family="sans-serif" font-size="13" fill="#E0E0E0">• Lipid-soluble (e.g. Cortisol, Estrogen)</text>
    <text x="40" y="335" font-family="sans-serif" font-size="13" fill="#E0E0E0">• Crosses Plasma Membrane directly</text>
    <text x="40" y="365" font-family="sans-serif" font-size="13" fill="#E0E0E0">• Binds Intracellular Nuclear Receptors</text>
    <text x="40" y="395" font-family="sans-serif" font-size="13" fill="#E0E0E0">• Directly regulates DNA Gene Expression</text>
  </g>
</svg>`;

const svgCards = {
  respiratory_system: svgToBase64(respiratorySVG),
  heart_and_ecg: svgToBase64(heartECGSVG),
  excretory_and_nephron: svgToBase64(excretoryNephronSVG),
  skeleton_and_joints: svgToBase64(skeletonJointsSVG),
  neuron_and_reflex: svgToBase64(neuronReflexSVG),
  endocrine_system: svgToBase64(endocrineSVG)
};
...
console.log("Generating 100% custom-designed vector SVG split c11-zoo-4.ts file...");
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.7; font-size: 16px;">
  ...
  ${renderHDCard(svgCards.respiratory_system, "Figure 4.1: Human Respiratory System Architecture, Alveolar Gas Exchange &amp; Mechanism of Breathing Flowchart")}
  ...
  ${renderHDCard(svgCards.heart_and_ecg, "Figure 4.2: Structure of Human Heart, 4 Chambers, Major Vessels &amp; Standard ECG Trace Graph")}
  ...
  ${renderHDCard(svgCards.excretory_and_nephron, "Figure 4.3: Human Excretory System Organs &amp; Fine Structure of Nephron (Glomerulus, Henle's Loop, PCT/DCT)")}
  ...
  ${renderHDCard(svgCards.skeleton_and_joints, "Figure 4.4: Human Skeleton Overview, Types of Synovial Joints &amp; Muscle Tissue Classification")}
  ...
  ${renderHDCard(svgCards.neuron_and_reflex, "Figure 4.5: Structure of Typical Neuron, Chemical Synapse Impulse Transmission &amp; Reflex Arc Pathway")}
  ...
  ${renderHDCard(svgCards.endocrine_system, "Figure 4.6: Human Endocrine Glands Overview &amp; Mechanism of Hormone Action (Protein vs Steroid Hormones)")}
...
// Solutions HTML from existing logic
...
// High-Level Full Reference Book Content with 100% Custom Vector SVG Diagrams
...
console.log("Successfully generated c11-zoo-4.ts with 100% custom vector SVG diagrams and no top poster image!");
