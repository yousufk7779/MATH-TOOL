...
const content = fs.readFileSync('client/data/content/c12-chem-9.ts', 'utf8');

console.log('--- CHAPTER 9 AUDIT: AMINES ---');
...
// 4. MCQs
const mcqMatches = content.match(/"id":\s*"c12-chem-9-mcq-\d+"/g) || [];
...
// 8. MCQs verification
const mcqChunk = content.match(/export const c12Chem9Mcqs = (\[[\s\S]*?\]);\n/)[1];
