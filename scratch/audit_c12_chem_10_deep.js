...
console.log('--- CHAPTER 10 AUDIT: BIOMOLECULES ---');
...
// 4. MCQs
const mcqMatches = content.match(/"id":\s*"c12-chem-10-mcq-\d+"/g) || [];
...
// 8. MCQs verification
const mcqChunk = content.match(/export const c12Chem10Mcqs = (\[[\s\S]*?\]);\n/)[1];
