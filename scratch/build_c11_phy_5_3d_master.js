...
function svg3DCardWrapper(title, caption, svgContent) {
  ...
  <div style="background: #0B0F19; border: 1.8px solid ${themeColor}; border-radius: 16px; padding: 16px; margin: 24px 0; box-shadow: 0 10px 30px rgba(171, 71, 188, 0.25);">
    <div style="color: ${themeColor}; font-weight: bold; font-size: 16.5px; margin-bottom: 10px; text-align: center; text-transform: uppercase; letter-spacing: 0.8px; display: flex; align-items: center; justify-content: center; gap: 8px;">
      <span style="background: rgba(171, 71, 188, 0.2); padding: 4px 10px; border-radius: 20px; border: 1px solid ${themeColor}; font-size: 13px;">3D Volumetric Render</span>
      <span>${title}</span>
    </div>
