...
// 3D Diagram Card Wrapper with glowing borders and dark slate container (No redundant badge)
function svg3DCardWrapper(title, caption, svgContent) {
  ...
  <div style="background: #0B0F19; border: 1.8px solid ${themeColor}; border-radius: 16px; padding: 16px; margin: 24px 0; box-shadow: 0 10px 30px rgba(171, 71, 188, 0.25);">
    <div style="color: ${themeColor}; font-weight: bold; font-size: 17px; margin-bottom: 12px; text-align: center; letter-spacing: 0.8px;">
      📍 ${title}
    </div>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 450" width="100%" height="100%" style="background: linear-gradient(135deg, #0B0F19 0%, #111827 50%, #070A10 100%);">
  ...
  <!-- 3D Axes -->
  <line x1="100" y1="360" x2="730" y2="360" stroke="#00E5FF" stroke-width="2" marker-end="url(#arrowCyan1)"/>
  <line x1="100" y1="360" x2="100" y2="40" stroke="#76FF03" stroke-width="2" marker-end="url(#arrowGreen1)"/>
  <line x1="100" y1="360" x2="30" y2="420" stroke="#FFD700" stroke-width="2" marker-end="url(#arrowGold1)"/>

  <text x="740" y="365" fill="#00E5FF" font-family="sans-serif" font-size="16" font-weight="bold">X</text>
  <text x="95" y="30" fill="#76FF03" font-family="sans-serif" font-size="16" font-weight="bold">Y</text>
  <text x="15" y="435" fill="#FFD700" font-family="sans-serif" font-size="16" font-weight="bold">Z</text>
  <text x="75" y="380" fill="#94A3B8" font-family="sans-serif" font-size="14" font-weight="bold">O (0,0,0)</text>

  <!-- 3D Drop Shadows -->
  <ellipse cx="240" cy="330" rx="20" ry="8" fill="rgba(0,0,0,0.6)"/>
  <ellipse cx="600" cy="285" rx="30" ry="12" fill="rgba(0,0,0,0.6)"/>
  <ellipse cx="480" cy="300" rx="14" ry="6" fill="rgba(0,0,0,0.6)"/>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 450" width="100%" height="100%" style="background: linear-gradient(135deg, #0B0F19 0%, #111827 50%, #070A10 100%);">
  ...
  <!-- 3D Perspective Ground Grid -->
  <polygon points="60,390 740,390 660,330 140,330" fill="rgba(148,163,184,0.06)" stroke="#334155" stroke-width="1.5"/>
  <line x1="60" y1="390" x2="140" y2="330" stroke="#475569" stroke-width="1"/>
  <line x1="230" y1="390" x2="270" y2="330" stroke="#475569" stroke-width="1"/>
  <line x1="400" y1="390" x2="400" y2="330" stroke="#475569" stroke-width="1"/>
  <line x1="570" y1="390" x2="530" y2="330" stroke="#475569" stroke-width="1"/>
  <line x1="740" y1="390" x2="660" y2="330" stroke="#475569" stroke-width="1"/>
  <text x="80" y="415" fill="#94A3B8" font-family="sans-serif" font-size="14">3D Ground Plane</text>

  <!-- 3D Shadow of Parabolic Path -->
  <path d="M 100 360 Q 400 340 700 360" fill="none" stroke="rgba(0,0,0,0.6)" stroke-width="6"/>

  <!-- Uninterrupted Parabolic CM Trajectory in 3D Space -->
  <path d="M 100 360 Q 400 50 700 360" fill="none" stroke="#AB47BC" stroke-width="4" stroke-dasharray="10,6" filter="url(#glowStrong2)"/>
  <text x="470" y="115" fill="#AB47BC" font-family="sans-serif" font-size="15" font-weight="bold">Uninterrupted Parabolic CM Trajectory</text>
  ...
  <path d="M 400 200 Q 360 280 330 370" fill="none" stroke="#00E5FF" stroke-width="2.5" stroke-dasharray="4,4"/>
  <circle cx="330" cy="370" r="7" fill="#00E5FF" filter="url(#glowStrong2)"/>
  <text x="245" y="380" fill="#00E5FF" font-family="sans-serif" font-size="13" font-weight="bold">Fragment m₂</text>

  <path d="M 400 200 Q 570 240 730 350" fill="none" stroke="#76FF03" stroke-width="2.5" stroke-dasharray="4,4"/>
  <circle cx="730" cy="350" r="11" fill="#76FF03" filter="url(#glowStrong2)"/>
  <text x="660" y="380" fill="#76FF03" font-family="sans-serif" font-size="13" font-weight="bold">Fragment m₃</text>

  <!-- Explanation Card Top Left -->
  <rect x="70" y="40" width="320" height="90" rx="10" fill="rgba(15,23,42,0.9)" stroke="#AB47BC" stroke-width="1.8"/>
  <text x="85" y="68" fill="#76FF03" font-family="sans-serif" font-size="14.5" font-weight="bold">Newton's 2nd Law for System:</text>
  <text x="85" y="92" fill="#FFFFFF" font-family="monospace" font-size="15" font-weight="bold">F_ext = M A_cm = M g</text>
  <text x="85" y="115" fill="#94A3B8" font-family="sans-serif" font-size="13">Internal forces cancel out (∑ F_int = 0)</text>
</svg>`;
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 450" width="100%" height="100%" style="background: linear-gradient(135deg, #0B0F19 0%, #111827 50%, #070A10 100%);">
  ...
  <g transform="translate(40, 30)">
    <text x="90" y="30" fill="#00E5FF" font-family="sans-serif" font-size="17" font-weight="bold">1. 3D Uniform Rod (Length L)</text>

    <!-- 3D Rod Shadow -->
    <ellipse cx="180" cy="230" rx="140" ry="12" fill="rgba(0,0,0,0.5)"/>

    <!-- 3D Rod Body -->
    <rect x="40" y="140" width="280" height="38" rx="6" fill="url(#rod3DGrad3)" stroke="#38BDF8" stroke-width="1.5"/>
    <ellipse cx="320" cy="159" rx="10" ry="19" fill="#0284C7" stroke="#38BDF8" stroke-width="1.5"/>
    <ellipse cx="40" cy="159" rx="10" ry="19" fill="#38BDF8" stroke="#38BDF8" stroke-width="1.5"/>

    <!-- Element dm -->
    <rect x="172" y="140" width="16" height="38" fill="#FF512F"/>
    <text x="155" y="120" fill="#FF512F" font-family="sans-serif" font-size="13.5" font-weight="bold">dm = λ dx</text>

    <!-- CM Sphere -->
    <circle cx="180" cy="159" r="8" fill="#FFD700" stroke="#FFFFFF" stroke-width="2"/>
    <line x1="180" y1="159" x2="180" y2="255" stroke="#FFD700" stroke-dasharray="4,4" stroke-width="2"/>

    <!-- Formula Badge -->
    <rect x="110" y="270" width="140" height="42" rx="8" fill="rgba(255,215,0,0.15)" stroke="#FFD700" stroke-width="1.5"/>
    <text x="125" y="297" fill="#FFD700" font-family="monospace" font-size="16.5" font-weight="bold">X_cm = L / 2</text>
  </g>
  ...
  <g transform="translate(420, 30)">
    <text x="40" y="30" fill="#AB47BC" font-family="sans-serif" font-size="17" font-weight="bold">2. 3D Semi-Circular Ring & Disc</text>

    <!-- Base Axes -->
    <line x1="40" y1="280" x2="300" y2="280" stroke="#475569" stroke-width="2"/>
    <line x1="170" y1="280" x2="170" y2="60" stroke="#475569" stroke-width="2"/>
    <text x="175" y="75" fill="#94A3B8" font-family="sans-serif" font-size="13">Y</text>
    <text x="175" y="295" fill="#94A3B8" font-family="sans-serif" font-size="13">O</text>

    <!-- 3D Ring Shadow -->
    <ellipse cx="170" cy="290" rx="100" ry="12" fill="rgba(0,0,0,0.5)"/>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 450" width="100%" height="100%" style="background: linear-gradient(135deg, #0B0F19 0%, #111827 50%, #070A10 100%);">
  ...
  <polygon points="120,350 420,350 620,250 320,250" fill="rgba(148,163,184,0.08)" stroke="#475569" stroke-width="2"/>
  <line x1="120" y1="350" x2="620" y2="250" stroke="#334155" stroke-dasharray="4,4"/>
  <line x1="420" y1="350" x2="320" y2="250" stroke="#334155" stroke-dasharray="4,4"/>

  <!-- Pivot Point O -->
  <circle cx="320" cy="300" r="9" fill="#FFFFFF" filter="url(#glowGreen4)"/>
  <text x="280" y="320" fill="#FFFFFF" font-family="sans-serif" font-size="15" font-weight="bold">Pivot (O)</text>
  ...
  <path d="M 360 280 A 40 25 0 0 0 330 255" fill="none" stroke="#76FF03" stroke-width="2.5" stroke-dasharray="4,4"/>
  <text x="180" y="170" fill="#76FF03" font-family="sans-serif" font-size="13.5">Right-Hand Thumb Rule Direction</text>

  <!-- Formula Panel -->
  <rect x="50" y="45" width="240" height="95" rx="10" fill="rgba(118,255,3,0.1)" stroke="#76FF03" stroke-width="1.8"/>
  <text x="65" y="75" fill="#FFFFFF" font-family="monospace" font-size="16" font-weight="bold">τ = r × F</text>
  <text x="65" y="100" fill="#76FF03" font-family="monospace" font-size="15">|τ| = r F sin θ</text>
  <text x="65" y="125" fill="#94A3B8" font-family="sans-serif" font-size="13">SI Unit: N m</text>
</svg>`;
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 450" width="100%" height="100%" style="background: linear-gradient(135deg, #0B0F19 0%, #111827 50%, #070A10 100%);">
  ...
  <g transform="translate(60, 30)">
    <text x="70" y="30" fill="#00E5FF" font-family="sans-serif" font-size="16.5" font-weight="bold">1. Arms Extended (Large I₁)</text>

    <!-- 3D Rotating Platform -->
    <ellipse cx="170" cy="320" rx="110" ry="25" fill="rgba(0,229,255,0.15)" stroke="#00E5FF" stroke-width="2"/>
    <ellipse cx="170" cy="315" rx="110" ry="25" fill="rgba(2,132,199,0.3)" stroke="#00E5FF" stroke-width="2"/>

    <!-- Central Axis -->
    <line x1="170" y1="50" x2="170" y2="320" stroke="#AB47BC" stroke-width="3" stroke-dasharray="6,6"/>

    <!-- 3D Figure Silhouette -->
    <circle cx="170" cy="90" r="20" fill="#E2E8F0"/>
    <line x1="170" y1="110" x2="170" y2="240" stroke="#E2E8F0" stroke-width="10"/>

    <!-- Extended Arms & Dumbbells -->
    <line x1="60" y1="140" x2="280" y2="140" stroke="#FF512F" stroke-width="8"/>
    <circle cx="60" cy="140" r="14" fill="url(#weightGrad5)"/>
    <circle cx="280" cy="140" r="14" fill="url(#weightGrad5)"/>

    <!-- Slow Rotation Arrow -->
    <path d="M 120 70 A 50 20 0 0 1 220 70" fill="none" stroke="#00E5FF" stroke-width="3"/>

    <text x="75" y="285" fill="#00E5FF" font-family="sans-serif" font-size="15" font-weight="bold">Large I₁ &nbsp;|&nbsp; Slow ω₁</text>
  </g>
  ...
  <g transform="translate(460, 30)">
    <text x="70" y="30" fill="#76FF03" font-family="sans-serif" font-size="16.5" font-weight="bold">2. Arms Tucked In (Small I₂)</text>

    <!-- 3D Rotating Platform -->
    <ellipse cx="170" cy="320" rx="110" ry="25" fill="rgba(118,255,3,0.15)" stroke="#76FF03" stroke-width="2"/>
    <ellipse cx="170" cy="315" rx="110" ry="25" fill="rgba(74,222,128,0.3)" stroke="#76FF03" stroke-width="2"/>
    ...
    <line x1="135" y1="140" x2="205" y2="140" stroke="#FF512F" stroke-width="8"/>
    <circle cx="135" cy="140" r="14" fill="url(#weightGrad5)"/>
    <circle cx="205" cy="140" r="14" fill="url(#weightGrad5)"/>
    ...
    <text x="75" y="285" fill="#76FF03" font-family="sans-serif" font-size="15" font-weight="bold">Small I₂ &nbsp;|&nbsp; Fast ω₂</text>
  </g>

  <!-- Bottom Formula Banner -->
  <rect x="200" y="375" width="400" height="45" rx="10" fill="rgba(0,0,0,0.5)" stroke="#AB47BC" stroke-width="1.8"/>
  <text x="215" y="403" fill="#FFFFFF" font-family="monospace" font-size="16" font-weight="bold">I₁ ω₁ = I₂ ω₂ &nbsp; ⇒ &nbsp; ω₂ = (I₁ / I₂) ω₁</text>
</svg>`;
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 480" width="100%" height="100%" style="background: linear-gradient(135deg, #0B0F19 0%, #111827 50%, #070A10 100%);">
  ...
  <rect x="25" y="20" width="750" height="54" rx="12" fill="rgba(171,71,188,0.28)" stroke="#AB47BC" stroke-width="2"/>
  <text x="135" y="53" fill="#00E5FF" font-family="sans-serif" font-size="19" font-weight="bold">TRANSLATIONAL MOTION (1D)</text>
  <text x="475" y="53" fill="#76FF03" font-family="sans-serif" font-size="19" font-weight="bold">ROTATIONAL MOTION (FIXED AXIS)</text>

  <!-- Row 1: Inertia (Cell Height 72px, Font 17.5px) -->
  <g transform="translate(25, 88)">
    <rect x="0" y="0" width="365" height="72" rx="10" fill="rgba(0,229,255,0.06)" stroke="rgba(0,229,255,0.3)" stroke-width="1.5"/>
    <text x="25" y="43" fill="#FFFFFF" font-family="sans-serif" font-size="17.5">Mass (Inertia): <tspan fill="#00E5FF" font-weight="bold" font-size="20">m</tspan></text>

    <rect x="385" y="0" width="365" height="72" rx="10" fill="rgba(118,255,3,0.06)" stroke="rgba(118,255,3,0.3)" stroke-width="1.5"/>
    <text x="405" y="43" fill="#FFFFFF" font-family="sans-serif" font-size="17.5">Moment of Inertia: <tspan fill="#76FF03" font-weight="bold" font-size="20">I = ∑ m r²</tspan></text>
  </g>

  <!-- Row 2: Kinematics (Cell Height 72px, Font 17.5px) -->
  <g transform="translate(25, 172)">
    <rect x="0" y="0" width="365" height="72" rx="10" fill="rgba(0,229,255,0.06)" stroke="rgba(0,229,255,0.3)" stroke-width="1.5"/>
    <text x="25" y="43" fill="#FFFFFF" font-family="sans-serif" font-size="17.5">Velocity / Accel: <tspan fill="#00E5FF" font-weight="bold" font-size="20">v,  a = dv/dt</tspan></text>

    <rect x="385" y="0" width="365" height="72" rx="10" fill="rgba(118,255,3,0.06)" stroke="rgba(118,255,3,0.3)" stroke-width="1.5"/>
    <text x="405" y="43" fill="#FFFFFF" font-family="sans-serif" font-size="17.5">Angular Vel / Accel: <tspan fill="#76FF03" font-weight="bold" font-size="20">ω,  α = dω/dt</tspan></text>
  </g>

  <!-- Row 3: Force vs Torque (Cell Height 72px, Font 17.5px) -->
  <g transform="translate(25, 256)">
    <rect x="0" y="0" width="365" height="72" rx="10" fill="rgba(0,229,255,0.06)" stroke="rgba(0,229,255,0.3)" stroke-width="1.5"/>
    <text x="25" y="43" fill="#FFFFFF" font-family="sans-serif" font-size="17.5">Newton's 2nd Law: <tspan fill="#00E5FF" font-weight="bold" font-size="20">F = m a</tspan></text>

    <rect x="385" y="0" width="365" height="72" rx="10" fill="rgba(118,255,3,0.06)" stroke="rgba(118,255,3,0.3)" stroke-width="1.5"/>
    <text x="405" y="43" fill="#FFFFFF" font-family="sans-serif" font-size="17.5">Rotational 2nd Law: <tspan fill="#76FF03" font-weight="bold" font-size="20">τ = I α</tspan></text>
  </g>

  <!-- Row 4: Momentum & Energy (Cell Height 78px, Font 17px) -->
  <g transform="translate(25, 340)">
    <rect x="0" y="0" width="365" height="78" rx="10" fill="rgba(0,229,255,0.06)" stroke="rgba(0,229,255,0.3)" stroke-width="1.5"/>
    <text x="25" y="32" fill="#FFFFFF" font-family="sans-serif" font-size="16.5">Momentum: <tspan fill="#00E5FF" font-weight="bold" font-size="18.5">p = m v</tspan></text>
    <text x="25" y="60" fill="#FFFFFF" font-family="sans-serif" font-size="16.5">Kinetic Energy: <tspan fill="#00E5FF" font-weight="bold" font-size="18.5">E_k = ½ m v²</tspan></text>

    <rect x="385" y="0" width="365" height="78" rx="10" fill="rgba(118,255,3,0.06)" stroke="rgba(118,255,3,0.3)" stroke-width="1.5"/>
    <text x="405" y="32" fill="#FFFFFF" font-family="sans-serif" font-size="16.5">Angular Momentum: <tspan fill="#76FF03" font-weight="bold" font-size="18.5">L = I ω</tspan></text>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 450" width="100%" height="100%" style="background: linear-gradient(135deg, #0B0F19 0%, #111827 50%, #070A10 100%);">
  ...
  <g transform="translate(40, 20)">
    <text x="40" y="30" fill="#00E5FF" font-family="sans-serif" font-size="16.5" font-weight="bold">1. Actual 3D Mass Distribution</text>

    <!-- Axis Z-Z' -->
    <line x1="160" y1="50" x2="160" y2="360" stroke="#AB47BC" stroke-width="3" stroke-dasharray="6,6"/>
    <text x="150" y="40" fill="#AB47BC" font-family="sans-serif" font-size="14" font-weight="bold">Z</text>
    <text x="150" y="380" fill="#AB47BC" font-family="sans-serif" font-size="14" font-weight="bold">Z'</text>

    <!-- 3D Volumetric Solid Shape -->
    <path d="M 130 90 Q 300 60 270 230 Q 230 340 90 280 Q 60 160 130 90 Z" fill="rgba(2,132,199,0.18)" stroke="#38BDF8" stroke-width="2.5"/>
    ...
    <text x="180" y="112" fill="#FFD700" font-family="sans-serif" font-size="13.5">m₁, r₁</text>

    <circle cx="260" cy="230" r="9" fill="url(#sphereCyan8)"/>
    <line x1="160" y1="230" x2="260" y2="230" stroke="#94A3B8" stroke-dasharray="3,3"/>
    <text x="195" y="222" fill="#00E5FF" font-family="sans-serif" font-size="13.5">m₂, r₂</text>

    <text x="60" y="345" fill="#FFFFFF" font-family="monospace" font-size="15.5" font-weight="bold">I = m₁r₁² + m₂r₂² + ...</text>
  </g>

  <!-- Equivalence Symbol -->
  <g transform="translate(390, 190)">
    <text x="-15" y="10" fill="#FFD700" font-family="sans-serif" font-size="30" font-weight="bold">≡</text>
  </g>

  <!-- Right Side: Single Concentrated Mass M at Gyration Radius k -->
  <g transform="translate(440, 20)">
    <text x="40" y="30" fill="#76FF03" font-family="sans-serif" font-size="16.5" font-weight="bold">2. Concentrated Mass M at Radius k</text>

    <!-- Axis Z-Z' -->
    <line x1="160" y1="50" x2="160" y2="360" stroke="#AB47BC" stroke-width="3" stroke-dasharray="6,6"/>

    <!-- 3D Mass M Sphere -->
    <circle cx="280" cy="200" r="22" fill="url(#sphereCyan8)" stroke="#FFFFFF" stroke-width="2"/>
    <text x="265" y="170" fill="#76FF03" font-family="sans-serif" font-size="16" font-weight="bold">Mass M</text>

    <!-- Distance k Arrow -->
    <line x1="160" y1="200" x2="280" y2="200" stroke="#FFD700" stroke-width="4"/>
    <line x1="160" y1="188" x2="160" y2="212" stroke="#FFD700" stroke-width="2"/>
    <line x1="280" y1="188" x2="280" y2="212" stroke="#FFD700" stroke-width="2"/>
    <text x="210" y="190" fill="#FFD700" font-family="sans-serif" font-size="18.5" font-weight="bold">k</text>

    <text x="80" y="315" fill="#FFFFFF" font-family="monospace" font-size="16.5" font-weight="bold">I = M k²</text>
    <text x="80" y="345" fill="#76FF03" font-family="monospace" font-size="16.5" font-weight="bold">k = √( I / M )</text>
  </g>
</svg>`;
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 460" width="100%" height="100%" style="background: linear-gradient(135deg, #0B0F19 0%, #111827 50%, #070A10 100%);">
  ...
  <g transform="translate(25, 20)">
    <rect x="0" y="0" width="365" height="195" rx="12" fill="rgba(255,255,255,0.03)" stroke="#AB47BC" stroke-width="1.5"/>
    <text x="20" y="32" fill="#00E5FF" font-family="sans-serif" font-size="16" font-weight="bold">1. Thin Circular Ring (Transverse Axis)</text>

    <ellipse cx="120" cy="120" rx="68" ry="30" fill="none" stroke="url(#ringGold3D9)" stroke-width="8"/>
    <line x1="120" y1="45" x2="120" y2="180" stroke="#AB47BC" stroke-width="3" stroke-dasharray="4,4"/>

    <text x="215" y="98" fill="#FFFFFF" font-family="monospace" font-size="18" font-weight="bold">I = M R²</text>
    <text x="215" y="130" fill="#94A3B8" font-family="sans-serif" font-size="15">k = R</text>
  </g>

  <!-- 2. 3D Circular Disc -->
  <g transform="translate(410, 20)">
    <rect x="0" y="0" width="365" height="195" rx="12" fill="rgba(255,255,255,0.03)" stroke="#AB47BC" stroke-width="1.5"/>
    <text x="20" y="32" fill="#76FF03" font-family="sans-serif" font-size="16" font-weight="bold">2. Circular Disc (Transverse Axis)</text>

    <ellipse cx="120" cy="120" rx="68" ry="30" fill="url(#discCyan3D9)" stroke="#00E5FF" stroke-width="2"/>
    <line x1="120" y1="45" x2="120" y2="180" stroke="#AB47BC" stroke-width="3" stroke-dasharray="4,4"/>

    <text x="215" y="98" fill="#FFFFFF" font-family="monospace" font-size="18" font-weight="bold">I = ½ M R²</text>
    <text x="215" y="130" fill="#94A3B8" font-family="sans-serif" font-size="15">k = R / √2</text>
  </g>

  <!-- 3. 3D Metallic Rod -->
  <g transform="translate(25, 235)">
    <rect x="0" y="0" width="365" height="195" rx="12" fill="rgba(255,255,255,0.03)" stroke="#AB47BC" stroke-width="1.5"/>
    <text x="20" y="32" fill="#FFD700" font-family="sans-serif" font-size="16" font-weight="bold">3. Metallic Rod (Central Axis)</text>

    <rect x="45" y="110" width="150" height="20" rx="4" fill="url(#rod3DGrad9)" stroke="#38BDF8" stroke-width="1"/>
    <line x1="120" y1="45" x2="120" y2="180" stroke="#AB47BC" stroke-width="3" stroke-dasharray="4,4"/>

    <text x="215" y="98" fill="#FFFFFF" font-family="monospace" font-size="18" font-weight="bold">I = <sup>1</sup>/₁₂ M L²</text>
    <text x="215" y="130" fill="#94A3B8" font-family="sans-serif" font-size="14">End Axis: I = <sup>1</sup>/₃ M L²</text>
  </g>

  <!-- 4. 3D Volumetric Solid Sphere -->
  <g transform="translate(410, 235)">
    <rect x="0" y="0" width="365" height="195" rx="12" fill="rgba(255,255,255,0.03)" stroke="#AB47BC" stroke-width="1.5"/>
    <text x="20" y="32" fill="#FF512F" font-family="sans-serif" font-size="16" font-weight="bold">4. Solid Sphere (Diameter Axis)</text>

    <circle cx="120" cy="115" r="45" fill="url(#sphere3DGrad9)"/>
    <ellipse cx="120" cy="115" rx="45" ry="14" fill="none" stroke="rgba(255,255,255,0.4)" stroke-dasharray="3,3"/>
    <line x1="120" y1="45" x2="120" y2="180" stroke="#AB47BC" stroke-width="3" stroke-dasharray="4,4"/>

    <text x="215" y="98" fill="#FFFFFF" font-family="monospace" font-size="18" font-weight="bold">I = <sup>2</sup>/₅ M R²</text>
    <text x="215" y="130" fill="#94A3B8" font-family="sans-serif" font-size="14">Hollow: I = <sup>2</sup>/₃ M R²</text>
  </g>
</svg>`;


// Construct final Overview HTML
...
<div style="padding: 12px; color: #E0E0E0; text-align: justify; font-family: system-ui, -apple-system, sans-serif; line-height: 1.7; font-size: 16px;">
  ...
  ${svg3DCardWrapper("Conservation of Angular Momentum Model", "3D Volumetric platform model comparing extended arms (large I₁, slow ω₁) vs tucked arms (small I₂, fast ω₂).", svg5_3d_angular_momentum)}
  ...
  ${svg3DCardWrapper("Analogous Linear and Rotational Motion Variables Comparison", "Enhanced 3D Dual-Column Matrix linking translational (m, v, a, F, p, E_k) and rotational (I, ω, α, τ, L, E_rot) variables with enlarged fonts and cell height.", svg7_3d_linear_rotational_chart)}
