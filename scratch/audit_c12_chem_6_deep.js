...
console.log('--- CHAPTER 6 AUDIT: HALOALKANES AND HALOARENES ---');
...
// 4. MCQs
const mcqMatches = content.match(/"id":\s*"c12-chem-6-mcq-\d+"/g) || [];
...
// 8. MCQs verification
const mcqChunk = content.match(/export const c12Chem6Mcqs = (\[[\s\S]*?\]);\n/)[1];
