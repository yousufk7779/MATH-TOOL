...
const content = fs.readFileSync('client/data/content/c12-chem-7.ts', 'utf8');

console.log('--- CHAPTER 7 AUDIT: ALCOHOLS, PHENOLS AND ETHERS ---');
...
// 4. MCQs
const mcqMatches = content.match(/"id":\s*"c12-chem-7-mcq-\d+"/g) || [];
...
// 8. MCQs verification
const mcqChunk = content.match(/export const c12Chem7Mcqs = (\[[\s\S]*?\]);\n/)[1];
