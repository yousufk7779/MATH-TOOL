...
console.log('--- CHAPTER 3 AUDIT: CHEMICAL KINETICS ---');
...
// 4. MCQs
const mcqMatches = content.match(/"id":\s*"c12-chem-3-mcq-\d+"/g) || [];
...
// 8. MCQs verification
const mcqChunk = content.match(/export const c12Chem3Mcqs = (\[[\s\S]*?\]);\n/)[1];
