...
const loopB64 = fs
  .readFileSync("d:/All NCERT SOLUTIONS/loop_b64.txt", "utf8")
  .trim();
const uniformB64 = fs
  .readFileSync("d:/All NCERT SOLUTIONS/uniform_b64.txt", "utf8")
  .trim();
...
const questions = [
  {
    ...
    solution: [
      ...
      '<div style="text-align: center; margin: 20px 0;"><img src="data:image/png;base64,' +
        loopB64 +
        '" style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" /></div>',
...
if (startIndex !== -1) {
  ...
  if (questionsIndex !== -1) {
    ...
    content =
      content.slice(0, questionsIndex) +
      replacement +
      content.slice(questionsIndex + questionsSearch.length);
