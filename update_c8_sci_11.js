...
const pathEye = 'C:\\Users\\hp\\.gemini\\antigravity\\brain\\03ee5b4a-e2c1-43ac-867b-0b6e5c8fd885\\human_eye_labeled_diagram_1777803875925.png';
const b64Eye = fs.readFileSync(pathEye).toString('base64');

const pathMirrors = 'C:\\Users\\hp\\.gemini\\antigravity\\brain\\03ee5b4a-e2c1-43ac-867b-0b6e5c8fd885\\two_mirrors_ray_diagram_1777803903797.png';
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          solution: [
            "<div style='color: #FFFFFF; text-align: justify;'>Below is the labeled diagram of the human eye:<br/><br/><center><img src='data:image/png;base64,${b64Eye}' style='max-width: 100%; border-radius: 8px; margin: 10px 0;'/></center></div>",
          ],
          answer: "",
        },
        {
        ...
        },
        {
          ...
          solution: [
            "<div style='color: #FFFFFF; text-align: justify;'>Below is the ray diagram for the two mirrors at right angles:<br/><br/><center><img src='data:image/png;base64,${b64Mirrors}' style='max-width: 100%; border-radius: 8px; margin: 10px 0;'/></center></div>",
          ],
          answer: "",
        },
        {
...
console.log('Successfully updated Chapter 11 content with diagrams.');
